...
describe('echo command', () => {
  describe('Basic Output', () => {
    ...
    it('should output single argument', () => {
      const result = echoCommand.execute(['hello']);
    ...
    it('should join multiple arguments with spaces', () => {
      const result = echoCommand.execute(['one', 'two', 'three', 'four']);

      expect(result.output).toBe('one two three four');
    });

    it('should preserve multiple spaces in arguments', () => {
      const result = echoCommand.execute(['text', 'with', 'spaces']);
  ...
  describe('Stdin Passthrough (Pipes)', () => {
    ...
    it('should prefer arguments over stdin when both provided', () => {
      const result = echoCommand.execute(['explicit text'], 'stdin text');
  ...
  describe('Edge Cases', () => {
    ...
    it('should handle unicode characters', () => {
      const result = echoCommand.execute(['Hello', '世界', '🌍']);
    ...
    it('should handle very long strings', () => {
      ...
      const result = echoCommand.execute([longText]);
    ...
    it('should handle only -e flag', () => {
      const result = echoCommand.execute(['-e']);
    ...
    it('should not have raw flag set', () => {
      const result = echoCommand.execute(['test']);
