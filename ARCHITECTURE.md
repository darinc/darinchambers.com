...
**Last Updated:** 2026-06-14 (v0.28.0)
...
**Example**: All 41 commands implement this interface (ls, cd, cat, about, blog, etc.)
...
- **Bundle Size**: ~124KB gzipped (~417KB raw: ~396KB JS, ~21KB CSS)
