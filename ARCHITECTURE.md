...
**Last Updated:** 2026-06-14 (v0.29.0)
...
**Example**: All 42 commands implement this interface (ls, cd, cat, about, blog, etc.)
...
- **Bundle Size**: ~125KB gzipped (~417KB raw: ~396KB JS, ~21KB CSS)
