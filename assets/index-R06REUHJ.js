(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))n(r);new MutationObserver(r=>{for(const i of r)if(i.type==="childList")for(const s of i.addedNodes)s.tagName==="LINK"&&s.rel==="modulepreload"&&n(s)}).observe(document,{childList:!0,subtree:!0});function t(r){const i={};return r.integrity&&(i.integrity=r.integrity),r.referrerPolicy&&(i.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?i.credentials="include":r.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function n(r){if(r.ep)return;r.ep=!0;const i=t(r);fetch(r.href,i)}})();const Ke=new Map;function Zo(){Ke.forEach(e=>{e.stopAnimation()}),Ke.clear(),document.querySelectorAll(".boot-overlay").forEach(e=>{e.remove()})}function hr(o){o.style.animation="boot-overlay-fade 0.3s ease forwards",o.addEventListener("animationend",()=>{o.remove()},{once:!0}),setTimeout(()=>{o.parentNode&&o.remove()},500)}function pn(o){Zo();const e=o.dataset.bootType??"boot";e==="boot"&&document.querySelectorAll(".boot-overlay").forEach(r=>{hr(r)});const t={element:o,bootType:e,overlay:null,cleanupFns:[],stopAnimation:()=>{t.cleanupFns.forEach(n=>n()),t.cleanupFns=[],t.overlay?.parentNode&&(hr(t.overlay),t.overlay=null),Ke.delete(o)}};if(Ke.set(o,t),e==="shutdown"||e==="reboot"){const n=o.querySelector("[data-boot-overlay]");if(n){t.overlay=n;const i=getComputedStyle(n).animationDelay,s=parseFloat(i)*(i.includes("ms")?1:1e3);setTimeout(()=>{Ke.has(o)&&n.parentNode&&document.body.appendChild(n)},s)}}Jo(o,t)}function Jo(o,e){const t=document.getElementById("terminal-output");if(t){const l=()=>{e.stopAnimation()};t.addEventListener("scroll",l,{once:!0}),e.cleanupFns.push(()=>{t.removeEventListener("scroll",l)})}const n=l=>{l.key==="Shift"||l.key==="Control"||l.key==="Alt"||l.key==="Meta"||e.stopAnimation()};setTimeout(()=>{Ke.has(o)&&(document.addEventListener("keydown",n,{once:!0}),e.cleanupFns.push(()=>{document.removeEventListener("keydown",n)}))},100);const r=()=>{e.stopAnimation()};setTimeout(()=>{Ke.has(o)&&(document.addEventListener("click",r,{once:!0}),e.cleanupFns.push(()=>{document.removeEventListener("click",r)}))},100);const i=new MutationObserver(()=>{o.nextElementSibling&&(e.stopAnimation(),i.disconnect())});t&&(i.observe(t,{childList:!0,subtree:!0}),e.cleanupFns.push(()=>{i.disconnect()}));const s=new MutationObserver(()=>{document.body.contains(o)||(e.stopAnimation(),s.disconnect())});s.observe(document.body,{childList:!0,subtree:!0}),e.cleanupFns.push(()=>{s.disconnect()})}function Qo(){const o=new MutationObserver(n=>{n.forEach(r=>{r.addedNodes.forEach(i=>{if(i.nodeType===Node.ELEMENT_NODE){const s=i;s.classList.contains("boot-sequence")&&pn(s),s.querySelectorAll(".boot-sequence").forEach(a=>{pn(a)})}})})}),e=document.getElementById("terminal-output");e&&o.observe(e,{childList:!0,subtree:!0}),document.querySelectorAll(".boot-sequence").forEach(n=>{pn(n)})}const Ge=new Map;function ei(){Ge.forEach(e=>{e.stopAnimation()}),Ge.clear(),document.querySelectorAll(".bsod-overlay").forEach(e=>{e.remove()})}function ti(o){o.style.animation="bsod-fade-out 0.3s ease forwards",o.addEventListener("animationend",()=>{o.remove()},{once:!0}),setTimeout(()=>{o.parentNode&&o.remove()},500)}function ni(o,e){const t=o.querySelector("[data-bsod-progress]");if(!t)return;let n=0;const r=setInterval(()=>{if(!Ge.has(o)){clearInterval(r);return}n=(n+1)%101,t.textContent=String(n)},100);e.cleanupFns.push(()=>{clearInterval(r)})}function ri(o,e){const t=o.querySelector("[data-bsod-cursor]");if(!t)return;let n=!0;const r=setInterval(()=>{if(!Ge.has(o)){clearInterval(r);return}n=!n,t.style.visibility=n?"visible":"hidden"},530);e.cleanupFns.push(()=>{clearInterval(r)})}function fn(o){ei();const e=o.dataset.bsodStyle??"modern",t={element:o,style:e,cleanupFns:[],stopAnimation:()=>{t.cleanupFns.forEach(n=>n()),t.cleanupFns=[],o.parentNode&&ti(o),Ge.delete(o)}};Ge.set(o,t),document.body.appendChild(o),e==="modern"?ni(o,t):ri(o,t),oi(o,t)}function oi(o,e){const t=document.getElementById("terminal-output"),n=l=>{l.key==="Shift"||l.key==="Control"||l.key==="Alt"||l.key==="Meta"||e.stopAnimation()};setTimeout(()=>{Ge.has(o)&&(document.addEventListener("keydown",n,{once:!0}),e.cleanupFns.push(()=>{document.removeEventListener("keydown",n)}))},100);const r=()=>{e.stopAnimation()};setTimeout(()=>{Ge.has(o)&&(document.addEventListener("click",r,{once:!0}),e.cleanupFns.push(()=>{document.removeEventListener("click",r)}))},100);const i=new MutationObserver(l=>{for(const a of l)for(const d of a.addedNodes)if(d!==o&&d.nodeType===Node.ELEMENT_NODE){e.stopAnimation(),i.disconnect();return}});t&&(i.observe(t,{childList:!0,subtree:!0}),e.cleanupFns.push(()=>{i.disconnect()}));const s=new MutationObserver(()=>{document.body.contains(o)||(e.stopAnimation(),s.disconnect())});s.observe(document.body,{childList:!0,subtree:!0}),e.cleanupFns.push(()=>{s.disconnect()})}function ii(){const o=new MutationObserver(n=>{n.forEach(r=>{r.addedNodes.forEach(i=>{if(i.nodeType===Node.ELEMENT_NODE){const s=i;s.hasAttribute("data-bsod")&&fn(s),s.querySelectorAll("[data-bsod]").forEach(a=>{fn(a)})}})})}),e=document.getElementById("terminal-output");e&&o.observe(e,{childList:!0,subtree:!0}),document.querySelectorAll("[data-bsod]").forEach(n=>{fn(n)})}const zt=new Map;function eo(o,e){return{width:o,height:e,cells:new Uint8Array(o*e),generation:0}}function Pn(o,e,t){return o.cells[t*o.width+e]}function se(o,e,t,n){o.cells[t*o.width+e]=n}function pr(o,e){return(o%e+e)%e}function si(o,e,t){let n=0;for(let r=-1;r<=1;r++)for(let i=-1;i<=1;i++){if(i===0&&r===0)continue;const s=pr(e+i,o.width),l=pr(t+r,o.height);Pn(o,s,l)>0&&n++}return n}function ai(o){const e=eo(o.width,o.height);e.generation=o.generation+1;for(let t=0;t<o.height;t++)for(let n=0;n<o.width;n++){const r=si(o,n,t);Pn(o,n,t)>0?se(e,n,t,r===2||r===3?1:0):se(e,n,t,r===3?2:0)}return e}function to(o,e){for(let t=0;t<o.cells.length;t++)o.cells[t]=Math.random()<e?1:0}function li(o,e){const t=Math.floor(o.width/2),n=Math.floor(o.height/2);switch(e){case"acorn":se(o,t+1,n-1,1),se(o,t+3,n,1),se(o,t,n+1,1),se(o,t+1,n+1,1),se(o,t+4,n+1,1),se(o,t+5,n+1,1),se(o,t+6,n+1,1);break;case"glider":se(o,t+1,n-1,1),se(o,t-1,n,1),se(o,t+1,n,1),se(o,t,n+1,1),se(o,t+1,n+1,1);break;case"blinker":se(o,t-1,n,1),se(o,t,n,1),se(o,t+1,n,1);break;default:to(o,.3)}}function fr(){const o=getComputedStyle(document.documentElement);return{accent:o.getPropertyValue("--terminal-accent").trim(),dim:o.getPropertyValue("--terminal-dim").trim(),bg:o.getPropertyValue("--terminal-bg").trim()}}function gr(o,e,t,n,r){o.fillStyle=t.bg,o.fillRect(0,0,o.canvas.width,o.canvas.height);for(let i=0;i<e.height;i++)for(let s=0;s<e.width;s++){const l=Pn(e,s,i);l!==0&&(o.fillStyle=l===2?t.accent:t.dim,o.globalAlpha=l===2?1:.7,o.fillRect(s*n,i*r,n,r))}o.globalAlpha=1}function no(){zt.forEach(o=>{o.stopAnimation()}),zt.clear()}function ci(o,e){const t=()=>{e.stopAnimation()};window.addEventListener("scroll",t,{once:!0});const n=new MutationObserver(l=>{for(const a of l)if(a.type==="childList"&&a.addedNodes.length>0){for(const d of a.addedNodes)if(d instanceof HTMLElement&&d.classList.contains("output-line")){e.stopAnimation(),n.disconnect();return}}}),r=document.querySelector(".terminal-output");r&&n.observe(r,{childList:!0});const i=new MutationObserver(()=>{document.body.contains(o)||(e.stopAnimation(),i.disconnect())});i.observe(document.body,{childList:!0,subtree:!0});const s=e.stopAnimation;e.stopAnimation=()=>{window.removeEventListener("scroll",t),n.disconnect(),i.disconnect(),s()}}function $r(o,e,t,n){no();const r=o.getContext("2d");if(!r)return;const i=o.dataset.speed,s=o.dataset.density,l=o.dataset.pattern,a=i?parseFloat(i):e,d=s?parseFloat(s):t,_=l??n,$=10,g=Math.floor(o.width/$),E=Math.floor(o.height/$),A=o.width/g,M=o.height/E,I=eo(g,E);_&&_!=="random"?li(I,_):to(I,d);const T={animationId:null,grid:I,canvas:o,speed:a,lastUpdate:performance.now(),cellWidth:A,cellHeight:M,stopAnimation:()=>{T.animationId!==null&&(cancelAnimationFrame(T.animationId),T.animationId=null),zt.delete(o)}};zt.set(o,T);const F=fr();gr(r,T.grid,F,T.cellWidth,T.cellHeight);function D(O){if(!T.animationId)return;const P=1e3/T.speed;if(O-T.lastUpdate>=P){T.grid=ai(T.grid);const Y=fr();r&&gr(r,T.grid,Y,T.cellWidth,T.cellHeight),T.lastUpdate=O}T.animationId=requestAnimationFrame(D)}T.animationId=requestAnimationFrame(D),ci(o,T)}function di(){new MutationObserver(e=>{for(const t of e)if(t.type==="childList"){for(const n of t.addedNodes)if(n instanceof HTMLElement){n.classList.contains("life-grid")&&n instanceof HTMLCanvasElement&&$r(n,2,.3);const r=n.querySelectorAll(".life-grid");r.length>0&&requestAnimationFrame(()=>{r.forEach(i=>{$r(i,2,.3)})})}}}).observe(document.body,{childList:!0,subtree:!0})}function ro(){return typeof window<"u"&&typeof window.matchMedia=="function"&&window.matchMedia("(prefers-reduced-motion: reduce)").matches}const ct=new Map;function ui(){ct.forEach(e=>{e.stopAnimation()}),ct.clear(),document.querySelectorAll(".matrix-rain").forEach(e=>{e.querySelectorAll(".matrix-column").forEach(n=>{n.style.animationPlayState="paused"})})}function gn(o){ct.forEach((i,s)=>{i.stopAnimation(),s.querySelectorAll(".matrix-column").forEach(a=>{a.style.animationPlayState="paused"})}),ct.clear();const e=o.dataset.matrixChars??"";if(!e){console.warn("[Matrix] No character set found in data-matrix-chars");return}if(ro())return;const t={animationId:null,frameCount:0,matrixChars:e,rainElement:o,stopAnimation:()=>{t.animationId&&(cancelAnimationFrame(t.animationId),t.animationId=null),ct.delete(o)}};ct.set(o,t);function n(){return e[Math.floor(Math.random()*e.length)]}function r(){t.frameCount++,o.querySelectorAll(".matrix-column").forEach(s=>{const l=s.querySelectorAll(".matrix-char"),a=parseInt(s.dataset.trailLength??"20");l.forEach((d,_)=>{if(d.classList.contains("matrix-char-bright"))(t.frameCount%45===0||t.frameCount%60===0&&Math.random()<.5)&&(d.textContent=n());else{const g=a-_-1,E=Math.max(8,Math.floor(g/2));t.frameCount%E===0&&Math.random()<.3&&(d.textContent=n())}})}),t.animationId=requestAnimationFrame(r)}t.animationId=requestAnimationFrame(r),_i(o,t)}function _i(o,e){const t=document.getElementById("terminal-output");if(t){const i=()=>{e.stopAnimation()};t.addEventListener("scroll",i,{once:!0})}const n=new MutationObserver(()=>{o.nextElementSibling&&(e.stopAnimation(),n.disconnect())});t&&n.observe(t,{childList:!0,subtree:!0});const r=new MutationObserver(()=>{document.body.contains(o)||(e.stopAnimation(),r.disconnect())});r.observe(document.body,{childList:!0,subtree:!0})}function mi(){const o=new MutationObserver(n=>{n.forEach(r=>{r.addedNodes.forEach(i=>{if(i.nodeType===Node.ELEMENT_NODE){const s=i;s.classList.contains("matrix-rain")&&gn(s),s.querySelectorAll(".matrix-rain").forEach(a=>{gn(a)})}})})}),e=document.getElementById("terminal-output");e&&o.observe(e,{childList:!0,subtree:!0}),document.querySelectorAll(".matrix-rain").forEach(n=>{gn(n)})}const It=new Map;function hi(o){return()=>(o=o*1103515245+12345&2147483647,o/2147483647)}function $n(){It.forEach(t=>{t.cleanupFns.forEach(n=>n()),t.styleElement.remove(),t.container.remove()}),It.clear(),document.querySelectorAll(".melt-container").forEach(t=>t.remove()),document.querySelectorAll("style[data-melt-styles]").forEach(t=>t.remove())}function pi(o,e,t){const n=/linear-gradient\(\s*(\d+)deg\s*,\s*(.+)\)/.exec(e);if(!n)return null;const r=parseInt(n[1]),i=n[2];let s,l,a,d;s=t.left,l=t.top,a=t.right,d=t.top;const _=o.createLinearGradient(s,l,a,d),$=i.matchAll(/(#[0-9a-fA-F]{6}|rgb[a]?\([^)]+\))\s*(\d+)?%?/g);for(const g of $){const E=g[1],A=g[2]?parseInt(g[2])/100:0;try{_.addColorStop(A,E)}catch{}}return _}function Tn(o,e,t,n){try{const r=document.createTreeWalker(e,NodeFilter.SHOW_TEXT,null);let i;for(;i=r.nextNode();){const s=i.textContent||"";if(!s.trim())continue;const l=i.parentElement;if(!l)continue;const a=getComputedStyle(l),d=a.fontSize,_=a.fontFamily,$=a.fontWeight,g=document.createRange();if(g.selectNodeContents(i),typeof g.getClientRects!="function")continue;const E=g.getClientRects();if(E.length===0)continue;const M=(a.getPropertyValue("-webkit-background-clip")||a.backgroundClip)==="text";let I=a.color||n;if(M){const F=l.getBoundingClientRect(),D=a.backgroundImage;if(D?.includes("linear-gradient")){const O=pi(o,D,F);O&&(I=O)}}o.fillStyle=I;const T=parseInt($)>=600?"bold ":"";o.font=`${T}${d} ${_||t}`;for(const F of E)F.width>0&&F.height>0&&o.fillText(s,F.left,F.top+F.height*.85)}}catch{}}function fi(){const o=window.innerWidth,e=window.innerHeight,t=document.createElement("canvas");t.width=o,t.height=e;const n=t.getContext("2d"),r=getComputedStyle(document.documentElement),i=r.getPropertyValue("--terminal-bg").trim()||"#0a0a0a",s=r.getPropertyValue("--terminal-fg").trim()||"#00ff00",l=r.getPropertyValue("--terminal-font-family")||"monospace";n.fillStyle=i,n.fillRect(0,0,o,e);const a=document.querySelector("header");a&&Tn(n,a,l,s);const d=document.getElementById("terminal-output");d&&Tn(n,d,l,s);const _=document.querySelector(".terminal-input-container");return _&&Tn(n,_,l,s),t}function Tr(o){$n();const e=window.innerWidth,t=window.innerHeight,n=document.createElement("style");n.setAttribute("data-melt-styles",""),n.textContent=`
    @keyframes melt-drop {
      0% {
  ...
  `,document.head.appendChild(n);const r=document.createElement("div");r.className="melt-container";const s=fi().toDataURL("image/png"),l=12,a=Math.ceil(e/l),d=hi(Date.now());for(let E=0;E<a;E++){const A=document.createElement("div");A.className="melt-column",A.style.left=`${E*l}px`,A.style.width=`${l}px`,A.style.height=`${t}px`,A.style.backgroundImage=`url(${s})`,A.style.backgroundPosition=`-${E*l}px 0`,A.style.backgroundSize=`${e}px ${t}px`;const I=Math.abs(E-a/2)/(a/2)*.4+d()*.3,T=2.5+d()*1.5;A.style.animation=`melt-drop ${T}s ease-in ${I}s forwards`,r.appendChild(A)}const _=document.createElement("div");_.className="melt-message",_.textContent="yeah, you probably shouldn't do that",_.style.animation="melt-message-fade 0.5s ease-out 2s forwards",r.appendChild(_),document.body.appendChild(r);const $={container:r,styleElement:n,cleanupFns:[]};It.set(o,$);const g=setTimeout(()=>{It.has(o)&&$n()},6500);$.cleanupFns.push(()=>clearTimeout(g)),setTimeout(()=>{if(!It.has(o))return;const E=()=>$n(),A=I=>{["Shift","Control","Alt","Meta"].includes(I.key)||E()},M=()=>E();document.addEventListener("keydown",A,{once:!0}),document.addEventListener("click",M,{once:!0}),$.cleanupFns.push(()=>{document.removeEventListener("keydown",A),document.removeEventListener("click",M)})},500)}function gi(){const o=new MutationObserver(t=>{t.forEach(n=>{n.addedNodes.forEach(r=>{if(r.nodeType===Node.ELEMENT_NODE){const i=r;i.hasAttribute("data-melt")&&Tr(i),i.querySelectorAll("[data-melt]").forEach(l=>{Tr(l)})}})})}),e=document.getElementById("terminal-output");e&&o.observe(e,{childList:!0,subtree:!0}),o.observe(document.body,{childList:!0,subtree:!0})}class B{flags=new Map;positionals=[];static VALUE_FLAGS=new Set(["f","L","w"]);constructor(e){const t=[];for(const n of e)if(n.startsWith("-")&&!n.startsWith("--")&&n.length>2)for(let r=1;r<n.length;r++)t.push(`-${n[r]}`);else t.push(n);for(let n=0;n<t.length;n++){const r=t[n];if(r.startsWith("--")){const i=r.substring(2),s=t[n+1];s!==void 0&&!s.startsWith("--")&&!s.startsWith("-")?(this.flags.set(i,s),n++):this.flags.set(i,!0)}else if(r.startsWith("-")&&r.length===2){const i=r.substring(1),s=t[n+1];s!==void 0&&!s.startsWith("-")&&(B.VALUE_FLAGS.has(i)||/^\d+$/.test(s))?(this.flags.set(i,s),n++):this.flags.set(i,!0)}else this.positionals.push(r)}}getFlag(e){return this.flags.get(e)}hasFlag(e){return this.flags.has(e)}getPositional(e){return this.positionals[e]}getAllFlags(){return new Map(this.flags)}getAllPositionals(){return[...this.positionals]}get positionalCount(){return this.positionals.length}}function $i(o){return{name:"alias",description:"Create or display command aliases",execute:(e,t)=>{if(new B(e).hasFlag("help"))return{output:`Usage: alias [name='command']
...
`)}}const r=e.join(" "),i=/^(\S+)=(.+)$/.exec(r);if(!i)return{output:`Usage: alias name='command'
       alias (to list all aliases)`,error:!0};const[,s,l]=i;try{return o.setAlias(s,l),{output:`Alias created: ${s}='${l}'`}}catch(a){return{output:a instanceof Error?a.message:String(a),error:!0}}}}}const Ti={name:"date",description:"Display current date and time",execute:(o,e)=>new B(o).hasFlag("help")?{output:`Usage: date

Description:
  Display the current date and time in the system's default format

Examples:
  date                 # Show current date and time`}:{output:new Date().toString()}},Ai={name:"echo",description:"Display a line of text",execute:(o,e)=>{if(new B(o).hasFlag("help"))return{output:`Usage: echo [options] [text...]
...
`).replace(/\\t/g,"	").replace(/\\r/g,"\r").replace(/\\b/g,"\b").replace(/\\f/g,"\f").replace(/\\v/g,"\v").replace(/\\\\/g,"\\")),{output:i}}};function yi(o){return{name:"env",description:"Display all environment variables",execute:(e,t)=>{if(new B(e).hasFlag("help"))return{output:`Usage: env
...
`)}}catch(r){return{output:r instanceof Error?r.message:String(r),error:!0}}}}}const Ar=["There is no escape.","You can check out any time you like, but you can never leave.","no","no thank you","nope","exit: permission denied: too interesting to leave",`logout
Connection to darinchambers.com closed.

...just kidding. Welcome back.`];function Ei(o,e,t,n){return{name:"exit",description:"Exit the current session",aliases:["logout"],execute:(r,i)=>{if(new B(r).hasFlag("help"))return{output:`Usage: exit
...
Examples:
  ...
  logout               # Same as exit`};if(o.getUsername()==="root")return o.setUsername("darin"),e.setVariable("HOME","/home/darin"),e.setVariable("USER","darin"),e.setVariable("PWD","/home/darin"),t.changeDirectory("/home/darin"),n(t.getShortPath()),{output:""};const l=Math.floor(Math.random()*Ar.length);return{output:Ar[l]}}}}function Li(o){return{name:"export",description:"Set or display environment variables",execute:(e,t)=>{if(new B(e).hasFlag("help"))return{output:`Usage: export [VAR=value] [VAR]
...
`)}}catch(r){return{output:r instanceof Error?r.message:String(r),error:!0}}}}}function Ii(o){return{name:"history",description:"Display command history",execute:(e,t)=>{if(new B(e).hasFlag("help"))return{output:`Usage: history
...
`)}}}}function bi(o){return{name:"man",description:"Display manual pages for commands",execute:async(e,t)=>{const n=new B(e);if(n.hasFlag("help"))return{output:`Usage: man <command>
...
For example, try 'man help'.`,error:!0};const i=r[0].toLowerCase();if(!o.getCommandNames().includes(i))return{output:`No manual entry for ${r[0]}`,error:!0};const a=o.getCommands().find(F=>F.name===i),d=a?a.description:i,$=(await o.dispatch(`${i} --help`)).output,g=`${i}(1)`,E="User Commands",A=Math.max(0,60-g.length*2-E.length),M=`${g}${" ".repeat(Math.floor(A/2))}${E}${" ".repeat(Math.ceil(A/2))}${g}`,I=["help","which"].filter(F=>F!==i).map(F=>`${F}(1)`).join(", ");return{output:[M,"","NAME",`    ${i} - ${d}`,"",$,"","SEE ALSO",`    ${I}`].join(`
`)}}}}function De(o){return o.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;")}class yr{static parse(e){if(!e.trim().startsWith("---"))return{frontmatter:null,content:e};const t=e.split(`
...
`)}}function Fn(){return{async:!1,breaks:!1,extensions:null,gfm:!0,hooks:null,pedantic:!1,renderer:null,silent:!1,tokenizer:null,walkTokens:null}}var Qe=Fn();function oo(o){Qe=o}var bt={exec:()=>null};function j(o,e=""){let t=typeof o=="string"?o:o.source,n={replace:(r,i)=>{let s=typeof i=="string"?i:i.source;return s=s.replace(ge.caret,"$1"),t=t.replace(r,s),n},getRegex:()=>new RegExp(t,e)};return n}var wi=(()=>{try{return!!new RegExp("(?<=1)(?<!1)")}catch{return!1}})(),ge={codeRemoveIndent:/^(?: {1,4}| {0,3}\t)/gm,outputLinkReplace:/\\([\[\]])/g,indentCodeCompensation:/^(\s+)(?:```)/,beginningSpace:/^\s+/,endingHash:/#$/,startingSpaceChar:/^ /,endingSpaceChar:/ $/,nonSpaceChar:/[^ ]/,newLineCharGlobal:/\n/g,tabCharGlobal:/\t/g,multipleSpaceGlobal:/\s+/g,blankLine:/^[ \t]*$/,doubleBlankLine:/\n[ \t]*\n[ \t]*$/,blockquoteStart:/^ {0,3}>/,blockquoteSetextReplace:/\n {0,3}((?:=+|-+) *)(?=\n|$)/g,blockquoteSetextReplace2:/^ {0,3}>[ \t]?/gm,listReplaceTabs:/^\t+/,listReplaceNesting:/^ {1,4}(?=( {4})*[^ ])/g,listIsTask:/^\[[ xX]\] +\S/,listReplaceTask:/^\[[ xX]\] +/,listTaskCheckbox:/\[[ xX]\]/,anyLine:/\n.*\n/,hrefBrackets:/^<(.*)>$/,tableDelimiter:/[:|]/,tableAlignChars:/^\||\| *$/g,tableRowBlankLine:/\n[ \t]*$/,tableAlignRight:/^ *-+: *$/,tableAlignCenter:/^ *:-+: *$/,tableAlignLeft:/^ *:-+ *$/,startATag:/^<a /i,endATag:/^<\/a>/i,startPreScriptTag:/^<(pre|code|kbd|script)(\s|>)/i,endPreScriptTag:/^<\/(pre|code|kbd|script)(\s|>)/i,startAngleBracket:/^</,endAngleBracket:/>$/,pedanticHrefTitle:/^([^'"]*[^\s])\s+(['"])(.*)\2/,unicodeAlphaNumeric:/[\p{L}\p{N}]/u,escapeTest:/[&<>"']/,escapeReplace:/[&<>"']/g,escapeTestNoEncode:/[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/,escapeReplaceNoEncode:/[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/g,unescapeTest:/&(#(?:\d+)|(?:#x[0-9A-Fa-f]+)|(?:\w+));?/ig,caret:/(^|[^\[])\^/g,percentDecode:/%25/g,findPipe:/\|/g,splitPipe:/ \|/,slashPipe:/\\\|/g,carriageReturn:/\r\n|\r/g,spaceLine:/^ +$/gm,notSpaceStart:/^\S*/,endingNewline:/\n$/,listItemRegex:o=>new RegExp(`^( {0,3}${o})((?:[	 ][^\\n]*)?(?:\\n|$))`),nextBulletRegex:o=>new RegExp(`^ {0,${Math.min(3,o-1)}}(?:[*+-]|\\d{1,9}[.)])((?:[ 	][^\\n]*)?(?:\\n|$))`),hrRegex:o=>new RegExp(`^ {0,${Math.min(3,o-1)}}((?:- *){3,}|(?:_ *){3,}|(?:\\* *){3,})(?:\\n+|$)`),fencesBeginRegex:o=>new RegExp(`^ {0,${Math.min(3,o-1)}}(?:\`\`\`|~~~)`),headingBeginRegex:o=>new RegExp(`^ {0,${Math.min(3,o-1)}}#`),htmlBeginRegex:o=>new RegExp(`^ {0,${Math.min(3,o-1)}}<(?:[a-z].*>|!--)`,"i")},Si=/^(?:[ \t]*(?:\n|$))+/,Ci=/^((?: {4}| {0,3}\t)[^\n]+(?:\n(?:[ \t]*(?:\n|$))*)?)+/,vi=/^ {0,3}(`{3,}(?=[^`\n]*(?:\n|$))|~{3,})([^\n]*)(?:\n|$)(?:|([\s\S]*?)(?:\n|$))(?: {0,3}\1[~`]* *(?=\n|$)|$)/,St=/^ {0,3}((?:-[\t ]*){3,}|(?:_[ \t]*){3,}|(?:\*[ \t]*){3,})(?:\n+|$)/,Ri=/^ {0,3}(#{1,6})(?=\s|$)(.*)(?:\n+|$)/,Hn=/(?:[*+-]|\d{1,9}[.)])/,io=/^(?!bull |blockCode|fences|blockquote|heading|html|table)((?:.|\n(?!\s*?\n|bull |blockCode|fences|blockquote|heading|html|table))+?)\n {0,3}(=+|-+) *(?:\n+|$)/,so=j(io).replace(/bull/g,Hn).replace(/blockCode/g,/(?: {4}| {0,3}\t)/).replace(/fences/g,/ {0,3}(?:`{3,}|~{3,})/).replace(/blockquote/g,/ {0,3}>/).replace(/heading/g,/ {0,3}#{1,6}/).replace(/html/g,/ {0,3}<[^\n>]+>\n/).replace(/\|table/g,"").getRegex(),xi=j(io).replace(/bull/g,Hn).replace(/blockCode/g,/(?: {4}| {0,3}\t)/).replace(/fences/g,/ {0,3}(?:`{3,}|~{3,})/).replace(/blockquote/g,/ {0,3}>/).replace(/heading/g,/ {0,3}#{1,6}/).replace(/html/g,/ {0,3}<[^\n>]+>\n/).replace(/table/g,/ {0,3}\|?(?:[:\- ]*\|)+[\:\- ]*\n/).getRegex(),Un=/^([^\n]+(?:\n(?!hr|heading|lheading|blockquote|fences|list|html|table| +\n)[^\n]+)*)/,Ni=/^[^\n]+/,Bn=/(?!\s*\])(?:\\[\s\S]|[^\[\]\\])+/,ki=j(/^ {0,3}\[(label)\]: *(?:\n[ \t]*)?([^<\s][^\s]*|<.*?>)(?:(?: +(?:\n[ \t]*)?| *\n[ \t]*)(title))? *(?:\n+|$)/).replace("label",Bn).replace("title",/(?:"(?:\\"?|[^"\\])*"|'[^'\n]*(?:\n[^'\n]+)*\n?'|\([^()]*\))/).getRegex(),Oi=j(/^( {0,3}bull)([ \t][^\n]+?)?(?:\n|$)/).replace(/bull/g,Hn).getRegex(),Kt="address|article|aside|base|basefont|blockquote|body|caption|center|col|colgroup|dd|details|dialog|dir|div|dl|dt|fieldset|figcaption|figure|footer|form|frame|frameset|h[1-6]|head|header|hr|html|iframe|legend|li|link|main|menu|menuitem|meta|nav|noframes|ol|optgroup|option|p|param|search|section|summary|table|tbody|td|tfoot|th|thead|title|tr|track|ul",Wn=/<!--(?:-?>|[\s\S]*?(?:-->|$))/,Mi=j("^ {0,3}(?:<(script|pre|style|textarea)[\\s>][\\s\\S]*?(?:</\\1>[^\\n]*\\n+|$)|comment[^\\n]*(\\n+|$)|<\\?[\\s\\S]*?(?:\\?>\\n*|$)|<![A-Z][\\s\\S]*?(?:>\\n*|$)|<!\\[CDATA\\[[\\s\\S]*?(?:\\]\\]>\\n*|$)|</?(tag)(?: +|\\n|/?>)[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$)|<(?!script|pre|style|textarea)([a-z][\\w-]*)(?:attribute)*? */?>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$)|</(?!script|pre|style|textarea)[a-z][\\w-]*\\s*>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$))","i").replace("comment",Wn).replace("tag",Kt).replace("attribute",/ +[a-zA-Z:_][\w.:-]*(?: *= *"[^"\n]*"| *= *'[^'\n]*'| *= *[^\s"'=<>`]+)?/).getRegex(),ao=j(Un).replace("hr",St).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("|lheading","").replace("|table","").replace("blockquote"," {0,3}>").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)]) ").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",Kt).getRegex(),Di=j(/^( {0,3}> ?(paragraph|[^\n]*)(?:\n|$))+/).replace("paragraph",ao).getRegex(),Gn={blockquote:Di,code:Ci,def:ki,fences:vi,heading:Ri,hr:St,html:Mi,lheading:so,list:Oi,newline:Si,paragraph:ao,table:bt,text:Ni},Er=j("^ *([^\\n ].*)\\n {0,3}((?:\\| *)?:?-+:? *(?:\\| *:?-+:? *)*(?:\\| *)?)(?:\\n((?:(?! *\\n|hr|heading|blockquote|code|fences|list|html).*(?:\\n|$))*)\\n*|$)").replace("hr",St).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("blockquote"," {0,3}>").replace("code","(?: {4}| {0,3}	)[^\\n]").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)]) ").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",Kt).getRegex(),Pi={...Gn,lheading:xi,table:Er,paragraph:j(Un).replace("hr",St).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("|lheading","").replace("table",Er).replace("blockquote"," {0,3}>").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)]) ").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",Kt).getRegex()},Fi={...Gn,html:j(`^ *(?:comment *(?:\\n|\\s*$)|<(tag)[\\s\\S]+?</\\1> *(?:\\n{2,}|\\s*$)|<tag(?:"[^"]*"|'[^']*'|\\s[^'"/>\\s]*)*?/?> *(?:\\n{2,}|\\s*$))`).replace("comment",Wn).replace(/tag/g,"(?!(?:a|em|strong|small|s|cite|q|dfn|abbr|data|time|code|var|samp|kbd|sub|sup|i|b|u|mark|ruby|rt|rp|bdi|bdo|span|br|wbr|ins|del|img)\\b)\\w+(?!:|[^\\w\\s@]*@)\\b").getRegex(),def:/^ *\[([^\]]+)\]: *<?([^\s>]+)>?(?: +(["(][^\n]+[")]))? *(?:\n+|$)/,heading:/^(#{1,6})(.*)(?:\n+|$)/,fences:bt,lheading:/^(.+?)\n {0,3}(=+|-+) *(?:\n+|$)/,paragraph:j(Un).replace("hr",St).replace("heading",` *#{1,6} *[^
]`).replace("lheading",so).replace("|table","").replace("blockquote"," {0,3}>").replace("|fences","").replace("|list","").replace("|html","").replace("|tag","").getRegex()},Hi=/^\\([!"#$%&'()*+,\-./:;<=>?@\[\]\\^_`{|}~])/,Ui=/^(`+)([^`]|[^`][\s\S]*?[^`])\1(?!`)/,lo=/^( {2,}|\\)\n(?!\s*$)/,Bi=/^(`+|[^`])(?:(?= {2,}\n)|[\s\S]*?(?:(?=[\\<!\[`*_]|\b_|$)|[^ ](?= {2,}\n)))/,Zt=/[\p{P}\p{S}]/u,zn=/[\s\p{P}\p{S}]/u,co=/[^\s\p{P}\p{S}]/u,Wi=j(/^((?![*_])punctSpace)/,"u").replace(/punctSpace/g,zn).getRegex(),uo=/(?!~)[\p{P}\p{S}]/u,Gi=/(?!~)[\s\p{P}\p{S}]/u,zi=/(?:[^\s\p{P}\p{S}]|~)/u,Vi=j(/link|precode-code|html/,"g").replace("link",/\[(?:[^\[\]`]|(?<a>`+)[^`]+\k<a>(?!`))*?\]\((?:\\[\s\S]|[^\\\(\)]|\((?:\\[\s\S]|[^\\\(\)])*\))*\)/).replace("precode-",wi?"(?<!`)()":"(^^|[^`])").replace("code",/(?<b>`+)[^`]+\k<b>(?!`)/).replace("html",/<(?! )[^<>]*?>/).getRegex(),_o=/^(?:\*+(?:((?!\*)punct)|[^\s*]))|^_+(?:((?!_)punct)|([^\s_]))/,ji=j(_o,"u").replace(/punct/g,Zt).getRegex(),Yi=j(_o,"u").replace(/punct/g,uo).getRegex(),mo="^[^_*]*?__[^_*]*?\\*[^_*]*?(?=__)|[^*]+(?=[^*])|(?!\\*)punct(\\*+)(?=[\\s]|$)|notPunctSpace(\\*+)(?!\\*)(?=punctSpace|$)|(?!\\*)punctSpace(\\*+)(?=notPunctSpace)|[\\s](\\*+)(?!\\*)(?=punct)|(?!\\*)punct(\\*+)(?!\\*)(?=punct)|notPunctSpace(\\*+)(?=notPunctSpace)",qi=j(mo,"gu").replace(/notPunctSpace/g,co).replace(/punctSpace/g,zn).replace(/punct/g,Zt).getRegex(),Xi=j(mo,"gu").replace(/notPunctSpace/g,zi).replace(/punctSpace/g,Gi).replace(/punct/g,uo).getRegex(),Ki=j("^[^_*]*?\\*\\*[^_*]*?_[^_*]*?(?=\\*\\*)|[^_]+(?=[^_])|(?!_)punct(_+)(?=[\\s]|$)|notPunctSpace(_+)(?!_)(?=punctSpace|$)|(?!_)punctSpace(_+)(?=notPunctSpace)|[\\s](_+)(?!_)(?=punct)|(?!_)punct(_+)(?!_)(?=punct)","gu").replace(/notPunctSpace/g,co).replace(/punctSpace/g,zn).replace(/punct/g,Zt).getRegex(),Zi=j(/\\(punct)/,"gu").replace(/punct/g,Zt).getRegex(),Ji=j(/^<(scheme:[^\s\x00-\x1f<>]*|email)>/).replace("scheme",/[a-zA-Z][a-zA-Z0-9+.-]{1,31}/).replace("email",/[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+(@)[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)+(?![-_])/).getRegex(),Qi=j(Wn).replace("(?:-->|$)","-->").getRegex(),es=j("^comment|^</[a-zA-Z][\\w:-]*\\s*>|^<[a-zA-Z][\\w-]*(?:attribute)*?\\s*/?>|^<\\?[\\s\\S]*?\\?>|^<![a-zA-Z]+\\s[\\s\\S]*?>|^<!\\[CDATA\\[[\\s\\S]*?\\]\\]>").replace("comment",Qi).replace("attribute",/\s+[a-zA-Z:_][\w.:-]*(?:\s*=\s*"[^"]*"|\s*=\s*'[^']*'|\s*=\s*[^\s"'=<>`]+)?/).getRegex(),Vt=/(?:\[(?:\\[\s\S]|[^\[\]\\])*\]|\\[\s\S]|`+[^`]*?`+(?!`)|[^\[\]\\`])*?/,ts=j(/^!?\[(label)\]\(\s*(href)(?:(?:[ \t]*(?:\n[ \t]*)?)(title))?\s*\)/).replace("label",Vt).replace("href",/<(?:\\.|[^\n<>\\])+>|[^ \t\n\x00-\x1f]*/).replace("title",/"(?:\\"?|[^"\\])*"|'(?:\\'?|[^'\\])*'|\((?:\\\)?|[^)\\])*\)/).getRegex(),ho=j(/^!?\[(label)\]\[(ref)\]/).replace("label",Vt).replace("ref",Bn).getRegex(),po=j(/^!?\[(ref)\](?:\[\])?/).replace("ref",Bn).getRegex(),ns=j("reflink|nolink(?!\\()","g").replace("reflink",ho).replace("nolink",po).getRegex(),Lr=/[hH][tT][tT][pP][sS]?|[fF][tT][pP]/,Vn={_backpedal:bt,anyPunctuation:Zi,autolink:Ji,blockSkip:Vi,br:lo,code:Ui,del:bt,emStrongLDelim:ji,emStrongRDelimAst:qi,emStrongRDelimUnd:Ki,escape:Hi,link:ts,nolink:po,punctuation:Wi,reflink:ho,reflinkSearch:ns,tag:es,text:Bi,url:bt},rs={...Vn,link:j(/^!?\[(label)\]\((.*?)\)/).replace("label",Vt).getRegex(),reflink:j(/^!?\[(label)\]\s*\[([^\]]*)\]/).replace("label",Vt).getRegex()},wn={...Vn,emStrongRDelimAst:Xi,emStrongLDelim:Yi,url:j(/^((?:protocol):\/\/|www\.)(?:[a-zA-Z0-9\-]+\.?)+[^\s<]*|^email/).replace("protocol",Lr).replace("email",/[A-Za-z0-9._+-]+(@)[a-zA-Z0-9-_]+(?:\.[a-zA-Z0-9-_]*[a-zA-Z0-9])+(?![-_])/).getRegex(),_backpedal:/(?:[^?!.,:;*_'"~()&]+|\([^)]*\)|&(?![a-zA-Z0-9]+;$)|[?!.,:;*_'"~)]+(?!$))+/,del:/^(~~?)(?=[^\s~])((?:\\[\s\S]|[^\\])*?(?:\\[\s\S]|[^\s~\\]))\1(?=[^~]|$)/,text:j(/^([`~]+|[^`~])(?:(?= {2,}\n)|(?=[a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-]+@)|[\s\S]*?(?:(?=[\\<!\[`*~_]|\b_|protocol:\/\/|www\.|$)|[^ ](?= {2,}\n)|[^a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-](?=[a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-]+@)))/).replace("protocol",Lr).getRegex()},os={...wn,br:j(lo).replace("{2,}","*").getRegex(),text:j(wn.text).replace("\\b_","\\b_| {2,}\\n").replace(/\{2,\}/g,"*").getRegex()},Bt={normal:Gn,gfm:Pi,pedantic:Fi},pt={normal:Vn,gfm:wn,breaks:os,pedantic:rs},is={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},Ir=o=>is[o];function Me(o,e){if(e){if(ge.escapeTest.test(o))return o.replace(ge.escapeReplace,Ir)}else if(ge.escapeTestNoEncode.test(o))return o.replace(ge.escapeReplaceNoEncode,Ir);return o}function br(o){try{o=encodeURI(o).replace(ge.percentDecode,"%")}catch{return null}return o}function wr(o,e){let t=o.replace(ge.findPipe,(i,s,l)=>{let a=!1,d=s;for(;--d>=0&&l[d]==="\\";)a=!a;return a?"|":" |"}),n=t.split(ge.splitPipe),r=0;if(n[0].trim()||n.shift(),n.length>0&&!n.at(-1)?.trim()&&n.pop(),e)if(n.length>e)n.splice(e);else for(;n.length<e;)n.push("");for(;r<n.length;r++)n[r]=n[r].trim().replace(ge.slashPipe,"|");return n}function ft(o,e,t){let n=o.length;if(n===0)return"";let r=0;for(;r<n&&o.charAt(n-r-1)===e;)r++;return o.slice(0,n-r)}function ss(o,e){if(o.indexOf(e[1])===-1)return-1;let t=0;for(let n=0;n<o.length;n++)if(o[n]==="\\")n++;else if(o[n]===e[0])t++;else if(o[n]===e[1]&&(t--,t<0))return n;return t>0?-2:-1}function Sr(o,e,t,n,r){let i=e.href,s=e.title||null,l=o[1].replace(r.other.outputLinkReplace,"$1");n.state.inLink=!0;let a={type:o[0].charAt(0)==="!"?"image":"link",raw:t,href:i,title:s,text:l,tokens:n.inlineTokens(l)};return n.state.inLink=!1,a}function as(o,e,t){let n=o.match(t.other.indentCodeCompensation);if(n===null)return e;let r=n[1];return e.split(`
`).map(i=>{let s=i.match(t.other.beginningSpace);if(s===null)return i;let[l]=s;return l.length>=r.length?i.slice(r.length):i}).join(`
`)}var jt=class{options;rules;lexer;constructor(o){this.options=o||Qe}space(o){let e=this.rules.block.newline.exec(o);if(e&&e[0].length>0)return{type:"space",raw:e[0]}}code(o){let e=this.rules.block.code.exec(o);if(e){let t=e[0].replace(this.rules.other.codeRemoveIndent,"");return{type:"code",raw:e[0],codeBlockStyle:"indented",text:this.options.pedantic?t:ft(t,`
`)}}}fences(o){let e=this.rules.block.fences.exec(o);if(e){let t=e[0],n=as(t,e[3]||"",this.rules);return{type:"code",raw:t,lang:e[2]?e[2].trim().replace(this.rules.inline.anyPunctuation,"$1"):e[2],text:n}}}heading(o){let e=this.rules.block.heading.exec(o);if(e){let t=e[2].trim();if(this.rules.other.endingHash.test(t)){let n=ft(t,"#");(this.options.pedantic||!n||this.rules.other.endingSpaceChar.test(n))&&(t=n.trim())}return{type:"heading",raw:e[0],depth:e[1].length,text:t,tokens:this.lexer.inline(t)}}}hr(o){let e=this.rules.block.hr.exec(o);if(e)return{type:"hr",raw:ft(e[0],`
`)}}blockquote(o){let e=this.rules.block.blockquote.exec(o);if(e){let t=ft(e[0],`
`).split(`
...
${d}`:d,r=r?`${r}
${_}`:_;let $=this.lexer.state.top;if(this.lexer.state.top=!0,this.lexer.blockTokens(_,i,!0),this.lexer.state.top=$,t.length===0)break;let g=i.at(-1);if(g?.type==="code")break;if(g?.type==="blockquote"){let E=g,A=E.raw+`
`+t.join(`
`),M=this.blockquote(A);i[i.length-1]=M,n=n.substring(0,n.length-E.raw.length)+M.raw,r=r.substring(0,r.length-E.text.length)+M.text;break}else if(g?.type==="list"){let E=g,A=E.raw+`
`+t.join(`
`),M=this.list(A);i[i.length-1]=M,n=n.substring(0,n.length-g.raw.length)+M.raw,r=r.substring(0,r.length-E.raw.length)+M.raw,t=A.substring(i.at(-1).raw.length).split(`
...
`}strong({tokens:o}){return`<strong>${this.parser.parseInline(o)}</strong>`}em({tokens:o}){return`<em>${this.parser.parseInline(o)}</em>`}codespan({text:o}){return`<code>${Me(o,!0)}</code>`}br(o){return"<br>"}del({tokens:o}){return`<del>${this.parser.parseInline(o)}</del>`}link({href:o,title:e,tokens:t}){let n=this.parser.parseInline(t),r=br(o);if(r===null)return n;o=r;let i='<a href="'+o+'"';return e&&(i+=' title="'+Me(e)+'"'),i+=">"+n+"</a>",i}image({href:o,title:e,text:t,tokens:n}){n&&(t=this.parser.parseInline(n,this.parser.textRenderer));let r=br(o);if(r===null)return Me(t);o=r;let i=`<img src="${o}" alt="${t}"`;return e&&(i+=` title="${Me(e)}"`),i+=">",i}text(o){return"tokens"in o&&o.tokens?this.parser.parseInline(o.tokens):"escaped"in o&&o.escaped?o.text:Me(o.text)}},jn=class{strong({text:o}){return o}em({text:o}){return o}codespan({text:o}){return o}del({text:o}){return o}html({text:o}){return o}text({text:o}){return o}link({text:o}){return""+o}image({text:o}){return""+o}br(){return""}checkbox({raw:o}){return o}},we=class Cn{options;renderer;textRenderer;constructor(e){this.options=e||Qe,this.options.renderer=this.options.renderer||new Yt,this.renderer=this.options.renderer,this.renderer.options=this.options,this.renderer.parser=this,this.textRenderer=new jn}static parse(e,t){return new Cn(t).parse(e)}static parseInline(e,t){return new Cn(t).parseInline(e)}parse(e){let t="";for(let n=0;n<e.length;n++){let r=e[n];if(this.options.extensions?.renderers?.[r.type]){let s=r,l=this.options.extensions.renderers[s.type].call({parser:this},s);if(l!==!1||!["space","hr","heading","code","table","blockquote","list","html","def","paragraph","text"].includes(s.type)){t+=l||"";continue}}let i=r;switch(i.type){case"space":{t+=this.renderer.space(i);break}case"hr":{t+=this.renderer.hr(i);break}case"heading":{t+=this.renderer.heading(i);break}case"code":{t+=this.renderer.code(i);break}case"table":{t+=this.renderer.table(i);break}case"blockquote":{t+=this.renderer.blockquote(i);break}case"list":{t+=this.renderer.list(i);break}case"checkbox":{t+=this.renderer.checkbox(i);break}case"html":{t+=this.renderer.html(i);break}case"def":{t+=this.renderer.def(i);break}case"paragraph":{t+=this.renderer.paragraph(i);break}case"text":{t+=this.renderer.text(i);break}default:{let s='Token with "'+i.type+'" type was not found.';if(this.options.silent)return console.error(s),"";throw new Error(s)}}}return t}parseInline(e,t=this.renderer){let n="";for(let r=0;r<e.length;r++){let i=e[r];if(this.options.extensions?.renderers?.[i.type]){let l=this.options.extensions.renderers[i.type].call({parser:this},i);if(l!==!1||!["escape","html","link","image","strong","em","codespan","br","del","text"].includes(i.type)){n+=l||"";continue}}let s=i;switch(s.type){case"escape":{n+=t.text(s);break}case"html":{n+=t.html(s);break}case"link":{n+=t.link(s);break}case"image":{n+=t.image(s);break}case"checkbox":{n+=t.checkbox(s);break}case"strong":{n+=t.strong(s);break}case"em":{n+=t.em(s);break}case"codespan":{n+=t.codespan(s);break}case"br":{n+=t.br(s);break}case"del":{n+=t.del(s);break}case"text":{n+=t.text(s);break}default:{let l='Token with "'+s.type+'" type was not found.';if(this.options.silent)return console.error(l),"";throw new Error(l)}}}return n}},yt=class{options;block;constructor(o){this.options=o||Qe}static passThroughHooks=new Set(["preprocess","postprocess","processAllTokens","emStrongMask"]);static passThroughHooksRespectAsync=new Set(["preprocess","postprocess","processAllTokens"]);preprocess(o){return o}postprocess(o){return o}processAllTokens(o){return o}emStrongMask(o){return o}provideLexer(){return this.block?be.lex:be.lexInline}provideParser(){return this.block?we.parse:we.parseInline}},ls=class{defaults=Fn();options=this.setOptions;parse=this.parseMarkdown(!0);parseInline=this.parseMarkdown(!1);Parser=we;Renderer=Yt;TextRenderer=jn;Lexer=be;Tokenizer=jt;Hooks=yt;constructor(...o){this.use(...o)}walkTokens(o,e){let t=[];for(let n of o)switch(t=t.concat(e.call(this,n)),n.type){case"table":{let r=n;for(let i of r.header)t=t.concat(this.walkTokens(i.tokens,e));for(let i of r.rows)for(let s of i)t=t.concat(this.walkTokens(s.tokens,e));break}case"list":{let r=n;t=t.concat(this.walkTokens(r.items,e));break}default:{let r=n;this.defaults.extensions?.childTokens?.[r.type]?this.defaults.extensions.childTokens[r.type].forEach(i=>{let s=r[i].flat(1/0);t=t.concat(this.walkTokens(s,e))}):r.tokens&&(t=t.concat(this.walkTokens(r.tokens,e)))}}return t}use(...o){let e=this.defaults.extensions||{renderers:{},childTokens:{}};return o.forEach(t=>{let n={...t};if(n.async=this.defaults.async||n.async||!1,t.extensions&&(t.extensions.forEach(r=>{if(!r.name)throw new Error("extension name required");if("renderer"in r){let i=e.renderers[r.name];i?e.renderers[r.name]=function(...s){let l=r.renderer.apply(this,s);return l===!1&&(l=i.apply(this,s)),l}:e.renderers[r.name]=r.renderer}if("tokenizer"in r){if(!r.level||r.level!=="block"&&r.level!=="inline")throw new Error("extension level must be 'block' or 'inline'");let i=e[r.level];i?i.unshift(r.tokenizer):e[r.level]=[r.tokenizer],r.start&&(r.level==="block"?e.startBlock?e.startBlock.push(r.start):e.startBlock=[r.start]:r.level==="inline"&&(e.startInline?e.startInline.push(r.start):e.startInline=[r.start]))}"childTokens"in r&&r.childTokens&&(e.childTokens[r.name]=r.childTokens)}),n.extensions=e),t.renderer){let r=this.defaults.renderer||new Yt(this.defaults);for(let i in t.renderer){if(!(i in r))throw new Error(`renderer '${i}' does not exist`);if(["options","parser"].includes(i))continue;let s=i,l=t.renderer[s],a=r[s];r[s]=(...d)=>{let _=l.apply(r,d);return _===!1&&(_=a.apply(r,d)),_||""}}n.renderer=r}if(t.tokenizer){let r=this.defaults.tokenizer||new jt(this.defaults);for(let i in t.tokenizer){if(!(i in r))throw new Error(`tokenizer '${i}' does not exist`);if(["options","rules","lexer"].includes(i))continue;let s=i,l=t.tokenizer[s],a=r[s];r[s]=(...d)=>{let _=l.apply(r,d);return _===!1&&(_=a.apply(r,d)),_}}n.tokenizer=r}if(t.hooks){let r=this.defaults.hooks||new yt;for(let i in t.hooks){if(!(i in r))throw new Error(`hook '${i}' does not exist`);if(["options","block"].includes(i))continue;let s=i,l=t.hooks[s],a=r[s];yt.passThroughHooks.has(i)?r[s]=d=>{if(this.defaults.async&&yt.passThroughHooksRespectAsync.has(i))return(async()=>{let $=await l.call(r,d);return a.call(r,$)})();let _=l.call(r,d);return a.call(r,_)}:r[s]=(...d)=>{if(this.defaults.async)return(async()=>{let $=await l.apply(r,d);return $===!1&&($=await a.apply(r,d)),$})();let _=l.apply(r,d);return _===!1&&(_=a.apply(r,d)),_}}n.hooks=r}if(t.walkTokens){let r=this.defaults.walkTokens,i=t.walkTokens;n.walkTokens=function(s){let l=[];return l.push(i.call(this,s)),r&&(l=l.concat(r.call(this,s))),l}}this.defaults={...this.defaults,...n}}),this}setOptions(o){return this.defaults={...this.defaults,...o},this}lexer(o,e){return be.lex(o,e??this.defaults)}parser(o,e){return we.parse(o,e??this.defaults)}parseMarkdown(o){return(e,t)=>{let n={...t},r={...this.defaults,...n},i=this.onError(!!r.silent,!!r.async);if(this.defaults.async===!0&&n.async===!1)return i(new Error("marked(): The async option was set to true by an extension. Remove async: false from the parse options object to return a Promise."));if(typeof e>"u"||e===null)return i(new Error("marked(): input parameter is undefined or null"));if(typeof e!="string")return i(new Error("marked(): input parameter is of type "+Object.prototype.toString.call(e)+", string expected"));if(r.hooks&&(r.hooks.options=r,r.hooks.block=o),r.async)return(async()=>{let s=r.hooks?await r.hooks.preprocess(e):e,l=await(r.hooks?await r.hooks.provideLexer():o?be.lex:be.lexInline)(s,r),a=r.hooks?await r.hooks.processAllTokens(l):l;r.walkTokens&&await Promise.all(this.walkTokens(a,r.walkTokens));let d=await(r.hooks?await r.hooks.provideParser():o?we.parse:we.parseInline)(a,r);return r.hooks?await r.hooks.postprocess(d):d})().catch(i);try{r.hooks&&(e=r.hooks.preprocess(e));let s=(r.hooks?r.hooks.provideLexer():o?be.lex:be.lexInline)(e,r);r.hooks&&(s=r.hooks.processAllTokens(s)),r.walkTokens&&this.walkTokens(s,r.walkTokens);let l=(r.hooks?r.hooks.provideParser():o?we.parse:we.parseInline)(s,r);return r.hooks&&(l=r.hooks.postprocess(l)),l}catch(s){return i(s)}}}onError(o,e){return t=>{if(t.message+=`
Please report this to https://github.com/markedjs/marked.`,o){let n="<p>An error occurred:</p><pre>"+Me(t.message+"",!0)+"</pre>";return e?Promise.resolve(n):n}if(e)return Promise.reject(t);throw t}}},Ze=new ls;function q(o,e){return Ze.parse(o,e)}q.options=q.setOptions=function(o){return Ze.setOptions(o),q.defaults=Ze.defaults,oo(q.defaults),q};q.getDefaults=Fn;q.defaults=Qe;q.use=function(...o){return Ze.use(...o),q.defaults=Ze.defaults,oo(q.defaults),q};q.walkTokens=function(o,e){return Ze.walkTokens(o,e)};q.parseInline=Ze.parseInline;q.Parser=we;q.parser=we.parse;q.Renderer=Yt;q.TextRenderer=jn;q.Lexer=be;q.lexer=be.lex;q.Tokenizer=jt;q.Hooks=yt;q.parse=q;q.options;q.setOptions;q.use;q.walkTokens;q.parseInline;we.parse;be.lex;class cs{static render(e,t=!1){let n=e,r="";if(t){const s=yr.parse(e);n=s.content,s.frontmatter&&(r=yr.renderFrontmatter(s.frontmatter))}const i=q.parse(n);return`<div class="markdown-output">${r}${i}</div>`}}class fe{static render(e,t=!1){return cs.render(e,t)}}function ds(o){return{name:"render",description:"Render markdown file with formatting",execute:(e,t)=>{if(new B(e).hasFlag("help"))return{output:`Usage: render <file>
Or: <command> | render
...
Try 'render --help' for more information`,error:!0};const i=r.trim().startsWith("---");return{output:fe.render(r,i),html:!0}}}}const us="hunter2",_s=300*1e3;function ms(o,e){let t=null,n=3,r=null,i=null;function s(){return t===null?!1:Date.now()-t<_s}function l(){n=3}function a(){o.setUsername("root"),e.execute("export HOME=/root"),e.execute("export USER=root"),o.executeCommand("cd /root")}function d(){const g=`[sudo] password for ${o.getUsername()}: `;o.getInput().setInputType("password"),o.getInput().setPrompt(g),o.setInputInterceptor($)}function _(){o.getInput().setInputType("text"),o.setUsername(o.getUsername())}function $(g){if(g===us){if(t=Date.now(),l(),_(),i&&r){const E=i,A=r;i=null,r=null,E==="su"||E==="su -"?(a(),A({output:""})):e.execute(E).then(M=>A(M))}}else n--,n<=0?(_(),r&&(r({output:"sudo: 3 incorrect password attempts",error:!0}),r=null,i=null),l()):(o.writeError("Sorry, try again."),d())}return{name:"sudo",description:"Execute a command as superuser",execute:(g,E)=>{if(new B(g).hasFlag("help"))return{output:`Usage: sudo <command>
...
Examples:
  ...
  sudo su -            # Switch to root user (login shell)`};if(g.length===0)return{output:"usage: sudo <command>",error:!0};const M=g.join(" ");if(M==="make me a sandwich")return{output:"Okay."};if(s()){const I=M.trim();return I==="su"||I==="su -"?(a(),{output:""}):e.execute(M)}return l(),new Promise(I=>{r=I,i=M,d()})}}}function hs(o){return{name:"unalias",description:"Remove command aliases",execute:(e,t)=>{if(new B(e).hasFlag("help"))return{output:`Usage: unalias <name>
...
Try 'unalias --help' for more information.`,error:!0};const r=e[0];return o.removeAlias(r)?{output:`Alias removed: ${r}`}:{output:`unalias: ${r}: not found`,error:!0}}}}const ps=new Set(["about","portfolio","blog","contact","settings"]);function fs(o,e){return{name:"which",description:"Locate a command and display its path",execute:(t,n)=>{const r=new B(t);if(r.hasFlag("help"))return{output:`Usage: which [-a] <command> [command ...]
...
Usage: which [-a] <command> [command ...]`,error:!0};const s=r.hasFlag("a"),l=[];let a=!1;for(const _ of i){const $=gs(_,o,e,s);$.error&&(a=!0),l.push($.output)}const d={output:l.join(`
`)};return a&&(d.error=!0),d}}}function gs(o,e,t,n){const r=[],i=t.getAlias(o);if(i&&(r.push(`${o}: aliased to ${i}`),!n))return{output:r.join(`
`)};if(e.getCommandNames().includes(o.toLowerCase())){const a=ps.has(o.toLowerCase())?`/usr/local/bin/${o}`:`/usr/bin/${o}`;r.push(a)}return r.length===0?{output:`which: ${o}: command not found`,error:!0}:{output:r.join(`
`)}}function $s(o){return{name:"whoami",description:"Display current username",execute:(e,t)=>new B(e).hasFlag("help")?{output:`Usage: whoami

Description:
  Display the current username

Examples:
  whoami               # Show current user`}:{output:o.getUsername()}}}function Ts(o){return{name:"cat",description:"Display file contents",execute:(e,t)=>{if(new B(e).hasFlag("help"))return{output:`Usage: cat <file>
...
Examples:
  ...
  cd -                 # Go to previous directory`};try{let s=n[0]||"~";if(s==="-"&&t){const l=t.getVariable("OLDPWD");if(!l)return{output:"cd: OLDPWD not set",error:!0};s=l}if(t){const l=t.getVariable("PWD")??o.getCurrentPath();t.setVariable("OLDPWD",l)}return o.changeDirectory(s),t&&t.setVariable("PWD",o.getCurrentPath()),e(o.getShortPath()),{output:""}}catch(s){return{output:s instanceof Error?s.message:String(s),error:!0}}}}}function ys(o,e){if(!e)return o.toString();const t=["B","K","M","G","T"];let n=o,r=0;for(;n>=1024&&r<t.length-1;)n/=1024,r++;return`${r===0?n.toString():n.toFixed(1)}${t[r]}`}function Es(o){const t=["Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"][o.getMonth()],n=o.getDate().toString().padStart(2," "),r=o.getHours().toString().padStart(2,"0"),i=o.getMinutes().toString().padStart(2,"0");return`${t} ${n} ${r}:${i}`}function Cr(o,e){const t=o.permissions??"-rw-r--r--",n="1",r=o.owner??"darin",i="staff",s=ys(o.size??0,e),l=Es(o.modifiedTime??new Date),a=o.name,d=s.padStart(6," ");return`${t}  ${n} ${r}  ${i}  ${d} ${l} ${a}`}function Ls(o){const e=o.reduce((t,n)=>t+(n.size??0),0);return Math.ceil(e/512)}function Is(o){return{name:"ls",description:"List directory contents",execute:(e,t)=>{try{const n=new B(e);if(n.hasFlag("help"))return{output:`Usage: ls [options] [path]
...
Try 'ls --help' for more information`,error:!0};if(a.type==="file")return s?{output:Cr(a,l)}:{output:a.name};if(!a.children)return{output:""};let d=Array.from(a.children.values());return i||(d=d.filter(_=>!_.isHidden)),d.length===0?{output:""}:(d.sort((_,$)=>_.name.localeCompare($.name)),s?{output:[`total ${Ls(d)}`,...d.map(g=>Cr(g,l))].join(`
`)}:{output:d.map($=>$.name).join("  ")})}catch(n){return{output:n instanceof Error?n.message:String(n),error:!0}}}}}const bs=`Usage: mkdir [OPTION]... DIRECTORY...
...
Examples:
  ...
  mkdir dir1 dir2      # Create multiple directories`;function ws(o){return{name:"mkdir",description:"Create directories",execute:(e,t)=>{const n=new B(e);if(n.hasFlag("help"))return{output:bs};const r=n.hasFlag("p"),i=n.getAllPositionals();if(i.length===0)return{output:`mkdir: missing operand
...
`),error:l}}}}function Ss(o){return{name:"pwd",description:"Print working directory",execute:(e,t)=>new B(e).hasFlag("help")?{output:`Usage: pwd

Description:
  Print current working directory path

Examples:
  pwd                  # Show current directory`}:{output:o.getCurrentPath()}}}const Cs=`Usage: rm [OPTION]... FILE...
...
Examples:
  ...
  rm -rf /             # Don't try this at home`;function vs(){return'<div data-melt class="melt-trigger"></div>'}function Rs(o,e){return{name:"rm",description:"Remove files or directories",execute:(t,n)=>{const r=new B(t);if(r.hasFlag("help"))return{output:Cs};const i=r.getFlag("recursive"),s=r.getFlag("force"),l=r.getFlag("f"),a=r.hasFlag("r")||r.hasFlag("R")||i!==void 0,d=r.hasFlag("f")||s!==void 0,_=[...r.getAllPositionals()];if(typeof i=="string"&&_.push(i),typeof s=="string"&&_.push(s),typeof l=="string"&&_.push(l),_.length===0)return{output:`rm: missing operand
Try 'rm --help' for more information`,error:!0};if(a&&d&&_.some(A=>A==="/"||A==="/*"))return{output:vs(),html:!0};const $=[];let g=!1;for(const E of _)try{if(!o.exists(E)){d||($.push(`rm: cannot remove '${E}': No such file or directory`),g=!0);continue}if(o.isDirectory(E)){if(!a){$.push(`rm: cannot remove '${E}': Is a directory`),g=!0;continue}o.deleteDirectory(E,!0)}else{const I=E.startsWith("/")?E:`${o.getCurrentPath()}/${E}`.replace(/\/+/g,"/");if(I.startsWith("/usr/bin/")||I.startsWith("/usr/local/bin/")){const T=I.split("/").pop();T&&e.unregisterCommand(T)}o.deleteFile(E)}}catch(A){d||($.push(A instanceof Error?A.message:String(A)),g=!0)}return d?{output:"",error:!1}:{output:$.join(`
`),error:g}}}}const xs=`Usage: rmdir DIRECTORY...
...
Examples:
  ...
  rmdir dir1 dir2      # Remove multiple empty directories`;function Ns(o){return{name:"rmdir",description:"Remove empty directories",execute:(e,t)=>{const n=new B(e);if(n.hasFlag("help"))return{output:xs};const r=n.getAllPositionals();if(r.length===0)return{output:`rmdir: missing operand
...
`),error:s}}}}function ks(o){return{name:"tree",description:"Display directory tree structure",execute:(e,t)=>{try{const n=new B(e);if(n.hasFlag("help"))return{output:`Usage: tree [options] [path]
...
<a href="/notes" data-command="notes">← Back to Notes</a>`}}function Os(o,e=[]){return{name:"about",description:"Display bio and expertise overview",execute:(t,n)=>{if(new B(t).hasFlag("help"))return{output:`Usage: about

Description:
  Display professional bio and expertise overview

Examples:
  about                # Show bio and background`};try{const i=o.readFile(Ee.CONTENT_ABOUT),s=fe.render(i);return{output:ze.makeCommandsClickable(s,e),html:!0,scrollBehavior:"top"}}catch(i){return{output:i instanceof Error?i.message:String(i),error:!0}}}}}function Yn(o){const e=o.split(`
...
`).trim()}}function Rr(o){return o.replace(/^["']|["']$/g,"")}function go(o){return o.startsWith("[")&&o.endsWith("]")?o.substring(1,o.length-1).split(",").map(e=>Rr(e.trim())).filter(e=>e.length>0):Rr(o)}function $o(o){const e={};for(const t of o){const n=t.indexOf(":");if(n===-1)continue;const r=t.substring(0,n).trim();e[r]=go(t.substring(n+1).trim())}return e}function Rn(o){return o.replace(/^\d{4}-\d{2}-\d{2}-(\d{2}-)?/,"").replace(/\.md$/,"")}function Ms(o){if(typeof o!="object"||o===null)return!1;const e=o;return typeof e.title=="string"&&typeof e.date=="string"&&typeof e.summary=="string"&&Array.isArray(e.tags)&&e.tags.every(t=>typeof t=="string")}class To{static parseFrontmatter(e){const{frontmatterLines:t,markdown:n}=Yn(e),r=$o(t);if(!Ms(r)){const i=[];throw r.title||i.push("title"),r.date||i.push("date"),r.summary||i.push("summary"),Array.isArray(r.tags)||i.push("tags"),new Error(`Invalid blog frontmatter: missing or invalid fields: ${i.join(", ")}`)}return{frontmatter:r,markdown:n}}static parseBlogPost(e,t){const{frontmatter:n,markdown:r}=this.parseFrontmatter(t);return{id:Rn(e),title:n.title,date:n.date,summary:n.summary,content:r,tags:n.tags}}static getIdFromFilename(e){return Rn(e)}}function gt(o){return{output:fe.render(o),html:!0,scrollBehavior:"top"}}function Ao(o,e){const{name:t,pluralNoun:n}=e;return{name:t,description:e.description,execute:(r,i)=>{const s=new B(r);if(s.hasFlag("help"))return{output:e.help};try{const l=o.list(e.dir).filter(A=>A.endsWith(".md")).sort().reverse(),a=s.getFlag("tags"),d=s.hasFlag("tags"),_=s.getPositional(0),$=l.map(A=>e.parse(A,o.readFile(`${e.dir}/${A}`)));if($.length===0&&!d&&!_)return gt(`# ${e.heading}

${e.emptyMessage}`);if(d&&(typeof a=="boolean"||!a)){const A=new Map;$.forEach(T=>T.tags?.forEach(F=>A.set(F,(A.get(F)??0)+1)));const M=Array.from(A.keys()).sort();if(M.length===0)return gt(`# ${e.tagsHeading}

${wt.NO_TAGS_AVAILABLE}`);const I=M.map(T=>{const F=A.get(T)??0;return`- <button data-command="${t} --tags ${T}" class="tag-link">${T}</button> (${F} ${e.countNoun}${F!==1?"s":""})`}).join(`
`);return gt(`# ${e.tagsHeading}

${I}

---

**Usage:** Type \`${t} --tags <tag>\` to filter ${n}`)}if(_){const A=parseInt(_,10),M=!isNaN(A)&&A>0&&A<=$.length?$[$.length-A]:$.find(I=>I.id===_);return M?gt(e.formatDetail(M)):{output:`${e.notFoundLabel} '${_}' not found.
Use '${t}' to list all ${n}.
Try '${t} --help' for more information`,error:!0}}let g=$;const E=typeof a=="string"?a:void 0;if(E&&(g=$.filter(A=>A.tags.some(M=>M.toLowerCase()===E.toLowerCase())),g.length===0)){const A=Array.from($.flatMap(I=>I.tags??[]).reduce((I,T)=>I.set(T,(I.get(T)??0)+1),new Map).entries()).sort((I,T)=>T[1]-I[1]).slice(0,5).map(([I])=>I),M=A.length>0?`
Try one of these tags: ${A.join(", ")}`:"";return{output:`No ${e.filterMissLabel} found with tag '${E}'.${M}
Use '${t}' to see all ${n}.`,error:!1}}return gt(e.formatList(g,E))}catch(l){return{output:l instanceof Error?l.message:String(l),error:!0}}}}}function Ds(o){return Ao(o,{name:"blog",description:"List and read blog posts",help:`Usage: blog [options] [post-id|number]
...
Examples:
  ...
  blog post-id                  # Read specific post by ID`,dir:Ee.CONTENT_BLOG,emptyMessage:wt.EMPTY_BLOG,heading:"Blog",tagsHeading:"Blog Tags",countNoun:"post",pluralNoun:"posts",notFoundLabel:"Blog post",filterMissLabel:"blog posts",parse:(e,t)=>To.parseBlogPost(e,t),formatList:(e,t)=>ze.formatBlogList(e,t),formatDetail:e=>ze.formatBlogPost(e)})}class qe{static parse(e){const t=[],n=e.split(`
...
`);return t+n}}function Ps(o){return{name:"changelog",description:"View project version history",execute:(e,t)=>{const n=new B(e);if(n.hasFlag("help"))return{output:`Usage: changelog [options] [version|number]
...
Try 'changelog --help' for more information.`,error:!0};const A=qe.formatEntry(E);return{output:fe.render(A),html:!0,scrollBehavior:"top"}}}const d=qe.getVersion(r,i);if(!d){const g=r.slice(0,5).map(E=>E.version).join(", ");return{output:`Version '${i}' not found.
Recent versions: ${g}
Try 'changelog --help' for more information.`,error:!0}}const _=qe.formatEntry(d);return{output:fe.render(_),html:!0,scrollBehavior:"top"}}const s=qe.formatEntries(r);return{output:fe.render(s),html:!0,scrollBehavior:"top"}}catch(r){return{output:r instanceof Error?r.message:String(r),error:!0}}}}}function Fs(o){return{name:"contact",description:"Display contact information",execute:(e,t)=>{if(new B(e).hasFlag("help"))return{output:`Usage: contact

Description:
  Display contact information and professional links

Examples:
  contact              # Show contact details`};try{const r=o.readFile(Ee.CONTENT_CONTACT);return{output:fe.render(r),html:!0}}catch(r){return{output:r instanceof Error?r.message:String(r),error:!0}}}}}function Hs(o){if(typeof o!="object"||o===null)return!1;const e=o;return typeof e.title=="string"&&typeof e.date=="string"&&Array.isArray(e.tags)&&e.tags.every(t=>typeof t=="string")}function Us(o){const e=[];let t=null;for(const n of o){const r=n.trim();if(r.startsWith("- ")){t?.platform&&t?.url&&e.push({platform:t.platform,url:t.url}),t={};const i=r.substring(2).trim(),s=i.indexOf(":");if(s!==-1){const l=i.substring(0,s).trim(),a=i.substring(s+1).trim().replace(/^["']|["']$/g,"");l==="platform"&&(t.platform=a),l==="url"&&(t.url=a)}}else if(t){const i=r.indexOf(":");if(i!==-1){const s=r.substring(0,i).trim(),l=r.substring(i+1).trim().replace(/^["']|["']$/g,"");s==="platform"&&(t.platform=l),s==="url"&&(t.url=l)}}}return t?.platform&&t?.url&&e.push({platform:t.platform,url:t.url}),e}class yo{static parseFrontmatter(e){const{frontmatterLines:t,markdown:n}=Yn(e),r={};let i=0;for(;i<t.length;){const s=t[i],l=s.indexOf(":");if(l===-1){i++;continue}const a=s.substring(0,l).trim(),d=s.substring(l+1).trim();if(a==="posted"&&d===""){const _=[];for(i++;i<t.length;){const $=t[i];if(/^\s+(- |[\w])/.exec($))_.push($),i++;else break}r[a]=Us(_);continue}r[a]=go(d),i++}if(!Hs(r)){const s=[];throw r.title||s.push("title"),r.date||s.push("date"),Array.isArray(r.tags)||s.push("tags"),new Error(`Invalid post frontmatter: missing or invalid fields: ${s.join(", ")}`)}return{frontmatter:r,markdown:n}}static parsePost(e,t){const{frontmatter:n,markdown:r}=this.parseFrontmatter(t);return{id:this.getIdFromFilename(e),title:n.title,date:n.date,content:r,tags:n.tags,...n.posted&&n.posted.length>0&&{posted:n.posted}}}static getIdFromFilename(e){return Rn(e)}}function Bs(o){return Ao(o,{name:"notes",description:"List and read short-form notes",help:`Usage: notes [options] [note-id|number]
...
Examples:
  ...
  notes note-id                 # Read specific note by ID`,dir:Ee.CONTENT_POSTS,emptyMessage:wt.EMPTY_POSTS,heading:"Notes",tagsHeading:"Note Tags",countNoun:"note",pluralNoun:"notes",notFoundLabel:"Note",filterMissLabel:"notes",parse:(e,t)=>yo.parsePost(e,t),formatList:(e,t)=>ze.formatPostList(e,t),formatDetail:e=>ze.formatPostDetail(e)})}function Ws(o){if(typeof o!="object"||o===null)return!1;const e=o;return typeof e.id=="string"&&typeof e.title=="string"&&typeof e.summary=="string"&&typeof e.year=="string"&&typeof e.order=="number"&&Array.isArray(e.technologies)&&e.technologies.every(t=>typeof t=="string")&&(e.impact===void 0||typeof e.impact=="string")&&(e.tags===void 0||Array.isArray(e.tags)&&e.tags.every(t=>typeof t=="string"))}class Gs{static parseFrontmatter(e){const{frontmatterLines:t,markdown:n}=Yn(e),r=$o(t);if(typeof r.order=="string"){const i=Number(r.order);isNaN(i)||(r.order=i)}if(!Ws(r)){const i=[];throw r.id||i.push("id"),r.title||i.push("title"),r.summary||i.push("summary"),r.year||i.push("year"),typeof r.order!="number"&&i.push("order"),Array.isArray(r.technologies)||i.push("technologies"),new Error(`Invalid portfolio frontmatter: missing or invalid fields: ${i.join(", ")}`)}return{frontmatter:r,markdown:n}}static parseProject(e,t){const{frontmatter:n,markdown:r}=this.parseFrontmatter(t);return{id:n.id||e.replace(/\.md$/,""),title:n.title,summary:n.summary,description:r,technologies:n.technologies,impact:n.impact,year:n.year,order:n.order,tags:n.tags}}static getIdFromFilename(e){return e.replace(/\.md$/,"")}}function zs(o){return{name:"portfolio",description:"Showcase projects and accomplishments",execute:(e,t)=>{const n=new B(e);if(n.hasFlag("help"))return{output:`Usage: portfolio [options] [project-id|number]
...
Examples:
  ...
  settings reset       # Reset all settings`};if(n.length===0)return{output:Eo(e,t),html:!0};const s=i.getPositional(0);switch(s){case"list":return Zs(e,t);case"set":return xr(i,e,t);case"reset":return Js(e,t);case"theme":case"font-size":case"font-family":case"fontSize":case"fontFamily":case"scan-lines":case"scanLines":case"glow":case"border":case"animation-speed":case"animationSpeed":case"sound":case"auto-scroll":case"autoScroll":case"prompt":case"screensaver-enabled":case"screensaverEnabled":case"screensaver-timeout":case"screensaverTimeout":case"screensaver-type":case"screensaverType":return xr(new B(["set",s,...n.slice(1)]),e,t);default:return{output:`Unknown subcommand: ${s}.
Try 'settings --help' for more information`,error:!0}}}}}function Zs(o,e){const t=Qs(o,e);return{output:fe.render(t),html:!0}}function xr(o,e,t){const n=o.getPositional(1),r=o.getPositional(2);if(!n)return{output:`Usage: settings set <setting> <value>
...
</div>`}function oa(o,e){const t=["0x0000007E","0xC0000005","0xBF8B4C62","0x00000000","0xBF8B4C62"];return`<div class="bsod-overlay bsod-classic" data-bsod="true" data-bsod-style="classic">
...
</div>`}const ia={name:"bsod",description:"Display a fake Windows Blue Screen of Death",execute:(o,e)=>{const t=new B(o);if(t.hasFlag("help")||t.hasFlag("h"))return{output:`Usage: bsod [options]
...
Note: Click anywhere or press any key to dismiss the BSOD.`};const n=t.hasFlag("classic"),r=t.getFlag("reason"),i=t.getFlag("error");let s=st[Math.floor(Math.random()*st.length)];if(i!==void 0&&i!==!0){const d=parseInt(String(i),10);!isNaN(d)&&d>=0&&d<st.length&&(s=st[d])}const l=typeof r=="string"?r:s.description;return{output:n?oa(s.code,l):ra(s.code,l),html:!0,clearBefore:!0,scrollBehavior:"top"}}},sa=["Chaos","Discord","Confusion","Bureaucracy","The Aftermath"],aa=["Sweetmorn","Boomtime","Pungenday","Prickle-Prickle","Setting Orange"],la=["Mungday","Mojoday","Syadday","Zaraday","Malbowday"],Nr=73,ca=1166;function Nn(o){return o%4===0&&o%100!==0||o%400===0}function da(o,e,t){const n=[31,28,31,30,31,30,31,31,30,31,30,31];Nn(o)&&(n[1]=29);let r=t;for(let i=0;i<e-1;i++)r+=n[i];return r}function ua(o){const e=o.getFullYear(),t=o.getMonth()+1,n=o.getDate(),r=e+ca,i=da(e,t,n);if(Nn(e)&&t===2&&n===29)return{weekday:"",season:"",dayOfSeason:0,yold:r,isStTibsDay:!0};let s=i;Nn(e)&&i>60&&(s=i-1);const l=Math.floor((s-1)/Nr),a=sa[l],d=(s-1)%Nr+1,_=(s-1)%5,$=aa[_],g=d===5?la[l]:void 0;return{weekday:$,season:a,dayOfSeason:d,yold:r,isStTibsDay:!1,apostleDay:g}}function _a(o){return o.isStTibsDay?`St. Tib's Day, ${o.yold} YOLD`:o.apostleDay?`${o.weekday}, ${o.apostleDay}, day ${o.dayOfSeason} of ${o.season}, ${o.yold} YOLD`:`${o.weekday}, ${o.season} ${o.dayOfSeason}, ${o.yold} YOLD`}function ma(o){if(/^\d{4}-\d{2}-\d{2}$/.test(o)){const e=new Date(o);if(!isNaN(e.getTime()))return e}if(/^\d{1,2}\/\d{1,2}\/\d{4}$/.test(o)){const e=new Date(o);if(!isNaN(e.getTime()))return e}return null}function ha(o,e,t){if(o<1||o>31||e<1||e>12||t<1)return null;const n=new Date(t,e-1,o);return isNaN(n.getTime())?null:n}const pa={name:"ddate",description:"Display date in Discordian calendar",execute:(o,e)=>{const t=new B(o);if(t.hasFlag("help"))return{output:`Usage: ddate [DATE]
...
Options:
  --help                   Display this help message`};let n;if(t.positionalCount===0)n=new Date;else if(t.positionalCount===1){const s=t.getPositional(0),l=ma(s);if(!l)return{output:`ddate: invalid date '${s}'`,error:!0};n=l}else if(t.positionalCount===3){const s=parseInt(t.getPositional(0),10),l=parseInt(t.getPositional(1),10),a=parseInt(t.getPositional(2),10);if(isNaN(l)||isNaN(s)||isNaN(a))return{output:"ddate: invalid numeric date arguments",error:!0};const d=ha(l,s,a);if(!d)return{output:`ddate: invalid date ${s}/${l}/${a}`,error:!0};n=d}else return{output:`ddate: invalid arguments
Try 'ddate --help' for more information.`,error:!0};const r=ua(n);return{output:_a(r)}}},fa={FULL_WIDTH:0,FITTING:1,SMUSHING:2,CONTROLLED_SMUSHING:3};class ga{constructor(){this.comment="",this.numChars=0,this.options={}}}const An=["1Row","3-D","3D Diagonal","3D-ASCII","3x5","4Max","5 Line Oblique","AMC 3 Line","AMC 3 Liv1","AMC AAA01","AMC Neko","AMC Razor","AMC Razor2","AMC Slash","AMC Slider","AMC Thin","AMC Tubes","AMC Untitled","ANSI Regular","ANSI Shadow","ANSI-Compact","ASCII 12","ASCII 9","ASCII New Roman","Acrobatic","Alligator","Alligator2","Alpha","Alphabet","Arrows","Avatar","B1FF","Babyface Lame","Babyface Leet","Banner","Banner3-D","Banner3","Banner4","Barbwire","Basic","Bear","Bell","Benjamin","Big ASCII 12","Big ASCII 9","Big Chief","Big Money-ne","Big Money-nw","Big Money-se","Big Money-sw","Big Mono 12","Big Mono 9","Big","Bigfig","Binary","Block","Blocks","Bloody","BlurVision ASCII","Bolger","Braced","Bright","Broadway KB","Broadway","Bubble","Bulbhead","Caligraphy","Caligraphy2","Calvin S","Cards","Catwalk","Chiseled","Chunky","Circle","Coinstak","Cola","Colossal","Computer","Contessa","Contrast","Cosmike","Cosmike2","Crawford","Crawford2","Crazy","Cricket","Cursive","Cyberlarge","Cybermedium","Cybersmall","Cygnet","DANC4","DOS Rebel","DWhistled","Dancing Font","Decimal","Def Leppard","Delta Corps Priest 1","DiamFont","Diamond","Diet Cola","Digital","Doh","Doom","Dot Matrix","Double Shorts","Double","Dr Pepper","Efti Chess","Efti Font","Efti Italic","Efti Piti","Efti Robot","Efti Wall","Efti Water","Electronic","Elite","Emboss 2","Emboss","Epic","Fender","Filter","Fire Font-k","Fire Font-s","Flipped","Flower Power","Four Tops","Fraktur","Fun Face","Fun Faces","Future","Fuzzy","Georgi16","Georgia11","Ghost","Ghoulish","Glenyn","Goofy","Gothic","Graceful","Gradient","Graffiti","Greek","Heart Left","Heart Right","Henry 3D","Hex","Hieroglyphs","Hollywood","Horizontal Left","Horizontal Right","ICL-1900","Impossible","Invita","Isometric1","Isometric2","Isometric3","Isometric4","Italic","Ivrit","JS Block Letters","JS Bracket Letters","JS Capital Curves","JS Cursive","JS Stick Letters","Jacky","Jazmine","Jerusalem","Katakana","Kban","Keyboard","Knob","Konto Slant","Konto","LCD","Larry 3D 2","Larry 3D","Lean","Letter","Letters","Lil Devil","Line Blocks","Linux","Lockergnome","Madrid","Marquee","Maxfour","Merlin1","Merlin2","Mike","Mini","Mirror","Mnemonic","Modular","Mono 12","Mono 9","Morse","Morse2","Moscow","Mshebrew210","Muzzle","NScript","NT Greek","NV Script","Nancyj-Fancy","Nancyj-Improved","Nancyj-Underlined","Nancyj","Nipples","O8","OS2","Octal","Ogre","Old Banner","Pagga","Patorjk's Cheese","Patorjk-HeX","Pawp","Peaks Slant","Peaks","Pebbles","Pepper","Poison","Puffy","Puzzle","Pyramid","Rammstein","Rebel","Rectangles","Red Phoenix","Relief","Relief2","Reverse","Roman","Rot13","Rotated","Rounded","Rowan Cap","Rozzo","RubiFont","Runic","Runyc","S Blood","SL Script","Santa Clara","Script","Serifcap","Shaded Blocky","Shadow","Shimrod","Short","Slant Relief","Slant","Slide","Small ASCII 12","Small ASCII 9","Small Block","Small Braille","Small Caps","Small Isometric1","Small Keyboard","Small Mono 12","Small Mono 9","Small Poison","Small Script","Small Shadow","Small Slant","Small Tengwar","Small","Soft","Speed","Spliff","Stacey","Stampate","Stampatello","Standard","Star Strips","Star Wars","Stellar","Stforek","Stick Letters","Stop","Straight","Stronger Than All","Sub-Zero","Swamp Land","Swan","Sweet","THIS","Tanja","Tengwar","Term","Terrace","Test1","The Edge","Thick","Thin","Thorned","Three Point","Ticks Slant","Ticks","Tiles","Tinker-Toy","Tmplr","Tombstone","Train","Trek","Tsalagi","Tubular","Twisted","Two Point","USA Flag","Univers","Upside Down Text","Varsity","Wavescape","Wavy","Weird","Wet Letter","Whimsy","WideTerm","Wow","miniwi"];function $a(o){return/[.*+?^${}()|[\]\\]/.test(o)?"\\"+o:o}const Ct=(()=>{const{FULL_WIDTH:o=0,FITTING:e,SMUSHING:t,CONTROLLED_SMUSHING:n}=fa,r={},i={font:"Standard",fontPath:"./fonts",fetchFontIfMissing:!0};function s(p,f,u){const h=$a(p.trim().slice(-1))||"@",y=f===u-1?new RegExp(h+h+"?\\s*$"):new RegExp(h+"\\s*$");return p.replace(y,"")}function l(p=-1,f=null){let u={},h,y=[[16384,"vLayout",t],[8192,"vLayout",e],[4096,"vRule5",!0],[2048,"vRule4",!0],[1024,"vRule3",!0],[512,"vRule2",!0],[256,"vRule1",!0],[128,"hLayout",t],[64,"hLayout",e],[32,"hRule6",!0],[16,"hRule5",!0],[8,"hRule4",!0],[4,"hRule3",!0],[2,"hRule2",!0],[1,"hRule1",!0]];h=f!==null?f:p;for(const[b,C,w]of y)h>=b?(h-=b,u[C]===void 0&&(u[C]=w)):C!=="vLayout"&&C!=="hLayout"&&(u[C]=!1);return typeof u.hLayout>"u"?p===0?u.hLayout=e:p===-1?u.hLayout=o:u.hRule1||u.hRule2||u.hRule3||u.hRule4||u.hRule5||u.hRule6?u.hLayout=n:u.hLayout=t:u.hLayout===t&&(u.hRule1||u.hRule2||u.hRule3||u.hRule4||u.hRule5||u.hRule6)&&(u.hLayout=n),typeof u.vLayout>"u"?u.vRule1||u.vRule2||u.vRule3||u.vRule4||u.vRule5?u.vLayout=n:u.vLayout=o:u.vLayout===t&&(u.vRule1||u.vRule2||u.vRule3||u.vRule4||u.vRule5)&&(u.vLayout=n),u}function a(p,f,u=""){return p===f&&p!==u?p:!1}function d(p,f){let u="|/\\[]{}()<>";if(p==="_"){if(u.indexOf(f)!==-1)return f}else if(f==="_"&&u.indexOf(p)!==-1)return p;return!1}function _(p,f){let u="| /\\ [] {} () <>",h=u.indexOf(p),y=u.indexOf(f);if(h!==-1&&y!==-1&&h!==y&&Math.abs(h-y)!==1){const b=Math.max(h,y),C=b+1;return u.substring(b,C)}return!1}function $(p,f){let u="[] {} ()",h=u.indexOf(p),y=u.indexOf(f);return h!==-1&&y!==-1&&Math.abs(h-y)<=1?"|":!1}function g(p,f){return{"/\\":"|","\\/":"Y","><":"X"}[p+f]||!1}function E(p,f,u=""){return p===u&&f===u?u:!1}function A(p,f){return p===f?p:!1}function M(p,f){return d(p,f)}function I(p,f){return _(p,f)}function T(p,f){return p==="-"&&f==="_"||p==="_"&&f==="-"?"=":!1}function F(p,f){return p==="|"&&f==="|"?"|":!1}function D(p,f,u){return f===" "||f===""||f===u&&p!==" "?p:f}function O(p,f,u){if(u.fittingRules&&u.fittingRules.vLayout===o)return"invalid";let h,y=Math.min(p.length,f.length),b,C,w=!1,R;if(y===0)return"invalid";for(h=0;h<y;h++)if(b=p.substring(h,h+1),C=f.substring(h,h+1),b!==" "&&C!==" "){if(u.fittingRules&&u.fittingRules.vLayout===e)return"invalid";if(u.fittingRules&&u.fittingRules.vLayout===t)return"end";if(F(b,C)){w=w||!1;continue}if(R=!1,R=u.fittingRules&&u.fittingRules.vRule1?A(b,C):R,R=!R&&u.fittingRules&&u.fittingRules.vRule2?M(b,C):R,R=!R&&u.fittingRules&&u.fittingRules.vRule3?I(b,C):R,R=!R&&u.fittingRules&&u.fittingRules.vRule4?T(b,C):R,w=!0,!R)return"invalid"}return w?"end":"valid"}function P(p,f,u){let h=p.length,y=p.length,b,C,w,R=1,v,H,x;for(;R<=h;){for(b=p.slice(Math.max(0,y-R),y),C=f.slice(0,Math.min(h,R)),w=C.length,x="",v=0;v<w;v++)if(H=O(b[v],C[v],u),H==="end")x=H;else if(H==="invalid"){x=H;break}else x===""&&(x="valid");if(x==="invalid"){R--;break}if(x==="end")break;x==="valid"&&R++}return Math.min(h,R)}function Y(p,f,u){let h,y=Math.min(p.length,f.length),b,C,w="",R;const v=u.fittingRules||{};for(h=0;h<y;h++)b=p.substring(h,h+1),C=f.substring(h,h+1),b!==" "&&C!==" "?v.vLayout===e||v.vLayout===t?w+=D(b,C):(R=!1,R=v.vRule5?F(b,C):R,R=!R&&v.vRule1?A(b,C):R,R=!R&&v.vRule2?M(b,C):R,R=!R&&v.vRule3?I(b,C):R,R=!R&&v.vRule4?T(b,C):R,w+=R):w+=D(b,C);return w}function K(p,f,u,h){let y=p.length,b=f.length,C=p.slice(0,Math.max(0,y-u)),w=p.slice(Math.max(0,y-u),y),R=f.slice(0,Math.min(u,b)),v,H,x,U=[],k;for(H=w.length,v=0;v<H;v++)v>=b?x=w[v]:x=Y(w[v],R[v],h),U.push(x);return k=f.slice(Math.min(u,b),b),[...C,...U,...k]}function Fe(p,f){const u=" ".repeat(f);return p.map(h=>h+u)}function Ve(p,f,u){let h=p[0].length,y=f[0].length,b;return h>y?f=Fe(f,h-y):y>h&&(p=Fe(p,y-h)),b=P(p,f,u),K(p,f,b,u)}function Ae(p,f,u){const h=u.fittingRules||{};if(h.hLayout===o)return 0;let y,b=p.length,C=f.length,w=b,R=1,v=!1,H,x,U,k;if(b===0)return 0;e:for(;R<=w;){const ne=b-R;for(H=p.substring(ne,ne+R),x=f.substring(0,Math.min(R,C)),y=0;y<Math.min(R,C);y++)if(U=H.substring(y,y+1),k=x.substring(y,y+1),U!==" "&&k!==" "){if(h.hLayout===e){R=R-1;break e}else if(h.hLayout===t){(U===u.hardBlank||k===u.hardBlank)&&(R=R-1);break e}else if(v=!0,!(h.hRule1&&a(U,k,u.hardBlank)||h.hRule2&&d(U,k)||h.hRule3&&_(U,k)||h.hRule4&&$(U,k)||h.hRule5&&g(U,k)||h.hRule6&&E(U,k,u.hardBlank))){R=R-1;break e}}if(v)break;R++}return Math.min(w,R)}function He(p,f,u,h){let y,b,C=[],w,R,v,H,x,U,k,ne;const re=h.fittingRules||{};if(typeof h.height!="number")throw new Error("height is not defined.");for(y=0;y<h.height;y++){k=p[y],ne=f[y],x=k.length,U=ne.length,w=x-u,R=k.slice(0,Math.max(0,w)),v="";const $e=Math.max(0,x-u);let Te=k.substring($e,$e+u),Le=ne.substring(0,Math.min(u,U));for(b=0;b<u;b++){let ue=b<x?Te.substring(b,b+1):" ",oe=b<U?Le.substring(b,b+1):" ";if(ue!==" "&&oe!==" ")if(re.hLayout===e||re.hLayout===t)v+=D(ue,oe,h.hardBlank);else{const ve=re.hRule1&&a(ue,oe,h.hardBlank)||re.hRule2&&d(ue,oe)||re.hRule3&&_(ue,oe)||re.hRule4&&$(ue,oe)||re.hRule5&&g(ue,oe)||re.hRule6&&E(ue,oe,h.hardBlank)||D(ue,oe,h.hardBlank);v+=ve}else v+=D(ue,oe,h.hardBlank)}u>=U?H="":H=ne.substring(u,u+Math.max(0,U-u)),C[y]=R+v+H}return C}function de(p){return new Array(p).fill("")}const Se=function(p){return Math.max(...p.map(f=>f.length))};function Ce(p,f,u){return p.reduce(function(h,y){return He(h,y.fig,y.overlap||0,u)},de(f))}function et(p,f,u){for(let h=p.length-1;h>0;h--){const y=Ce(p.slice(0,h),f,u);if(Se(y)<=u.width)return{outputFigText:y,chars:p.slice(h)}}return{outputFigText:de(f),chars:p}}function ut(p,f,u){let h,y,b=0,C,w,R,v=u.height,H=[],x,U={chars:[],overlap:b},k=[],ne,re,$e,Te,Le;if(typeof v!="number")throw new Error("height is not defined.");w=de(v);const ue=u.fittingRules||{};for(u.printDirection===1&&(p=p.split("").reverse().join("")),R=p.length,h=0;h<R;h++)if(ne=p.substring(h,h+1),re=ne.match(/\s/),y=f[ne.charCodeAt(0)],Te=null,y){if(ue.hLayout!==o){for(b=1e4,C=0;C<v;C++)b=Math.min(b,Ae(w[C],y[C],u));b=b===1e4?0:b}if(u.width>0&&(u.whitespaceBreak?($e=Ce(U.chars.concat([{fig:y,overlap:b}]),v,u),Te=Ce(k.concat([{fig:$e,overlap:U.overlap}]),v,u),x=Se(Te)):(Te=He(w,y,b,u),x=Se(Te)),x>=u.width&&h>0&&(u.whitespaceBreak?(w=Ce(k.slice(0,-1),v,u),k.length>1&&(H.push(w),w=de(v)),k=[]):(H.push(w),w=de(v)))),u.width>0&&u.whitespaceBreak&&((!re||h===R-1)&&U.chars.push({fig:y,overlap:b}),re||h===R-1)){for(Le=null;Te=Ce(U.chars,v,u),x=Se(Te),x>=u.width;)Le=et(U.chars,v,u),U={chars:Le.chars},H.push(Le.outputFigText);x>0&&(Le?k.push({fig:Te,overlap:1}):k.push({fig:Te,overlap:U.overlap})),re&&(k.push({fig:y,overlap:b}),w=de(v)),h===R-1&&(w=Ce(k,v,u)),U={chars:[],overlap:b};continue}w=He(w,y,b,u)}return Se(w)>0&&H.push(w),u.showHardBlanks||H.forEach(function(oe){for(R=oe.length,C=0;C<R;C++)oe[C]=oe[C].replace(new RegExp("\\"+u.hardBlank,"g")," ")}),p===""&&H.length===0&&H.push(new Array(v).fill("")),H}const xt=function(p,f){let u;const h=f.fittingRules||{};if(p==="default")u={hLayout:h.hLayout,hRule1:h.hRule1,hRule2:h.hRule2,hRule3:h.hRule3,hRule4:h.hRule4,hRule5:h.hRule5,hRule6:h.hRule6};else if(p==="full")u={hLayout:o,hRule1:!1,hRule2:!1,hRule3:!1,hRule4:!1,hRule5:!1,hRule6:!1};else if(p==="fitted")u={hLayout:e,hRule1:!1,hRule2:!1,hRule3:!1,hRule4:!1,hRule5:!1,hRule6:!1};else if(p==="controlled smushing")u={hLayout:n,hRule1:!0,hRule2:!0,hRule3:!0,hRule4:!0,hRule5:!0,hRule6:!0};else if(p==="universal smushing")u={hLayout:t,hRule1:!1,hRule2:!1,hRule3:!1,hRule4:!1,hRule5:!1,hRule6:!1};else return;return u},Qt=function(p,f){let u={};const h=f.fittingRules||{};if(p==="default")u={vLayout:h.vLayout,vRule1:h.vRule1,vRule2:h.vRule2,vRule3:h.vRule3,vRule4:h.vRule4,vRule5:h.vRule5};else if(p==="full")u={vLayout:o,vRule1:!1,vRule2:!1,vRule3:!1,vRule4:!1,vRule5:!1};else if(p==="fitted")u={vLayout:e,vRule1:!1,vRule2:!1,vRule3:!1,vRule4:!1,vRule5:!1};else if(p==="controlled smushing")u={vLayout:n,vRule1:!0,vRule2:!0,vRule3:!0,vRule4:!0,vRule5:!0};else if(p==="universal smushing")u={vLayout:t,vRule1:!1,vRule2:!1,vRule3:!1,vRule4:!1,vRule5:!1};else return;return u},Nt=function(p,f,u){u=u.replace(/\r\n/g,`
`).replace(/\r/g,`
`);let h=u.split(`
`),y=[],b,C,w;for(C=h.length,b=0;b<C;b++)y=y.concat(ut(h[b],r[p],f));for(C=y.length,w=y[0],b=1;b<C;b++)w=Ve(w,y[b],f);return w?w.join(`
`):""};function kt(p,f){let u;if(typeof structuredClone<"u"?u=structuredClone(p):u=JSON.parse(JSON.stringify(p)),u.showHardBlanks=f.showHardBlanks||!1,u.width=f.width||-1,u.whitespaceBreak=f.whitespaceBreak||!1,f.horizontalLayout){const h=xt(f.horizontalLayout,p);h&&Object.assign(u.fittingRules,h)}if(f.verticalLayout){const h=Qt(f.verticalLayout,p);h&&Object.assign(u.fittingRules,h)}return u.printDirection=f.printDirection!==null&&f.printDirection!==void 0?f.printDirection:p.printDirection,u}const W=async function(p,f,u){return W.text(p,f,u)};return W.text=async function(p,f,u){p=p+"";let h,y;typeof f=="function"?(y=f,h={font:i.font}):typeof f=="string"?(h={font:f},y=u):f?(h=f,y=u):(h={font:i.font},y=u);const b=h.font||i.font;try{const C=await W.loadFont(b),w=C?Nt(b,kt(C,h),p):"";return y&&y(null,w),w}catch(C){const w=C instanceof Error?C:new Error(String(C));if(y)return y(w),"";throw w}},W.textSync=function(p,f){p=p+"",typeof f=="string"?f={font:f}:f=f||{};const u=f.font||i.font;let h=kt(W.loadFontSync(u),f);return Nt(u,h,p)},W.metadata=async function(p,f){p=p+"";try{const u=await W.loadFont(p);if(!u)throw new Error("Error loading font.");const h=r[p]||{},y=[u,h.comment||""];return f&&f(null,u,h.comment),y}catch(u){const h=u instanceof Error?u:new Error(String(u));if(f)return f(h),null;throw h}},W.defaults=function(p){return p&&typeof p=="object"&&Object.assign(i,p),typeof structuredClone<"u"?structuredClone(i):JSON.parse(JSON.stringify(i))},W.parseFont=function(p,f,u=!0){if(r[p]&&!u)return r[p].options;f=f.replace(/\r\n/g,`
`).replace(/\r/g,`
`);const h=new ga,y=f.split(`
`),b=y.shift();if(!b)throw new Error("Invalid font file: missing header");const C=b.split(" "),w={hardBlank:C[0].substring(5,6),height:parseInt(C[1],10),baseline:parseInt(C[2],10),maxLength:parseInt(C[3],10),oldLayout:parseInt(C[4],10),numCommentLines:parseInt(C[5],10),printDirection:C[6]?parseInt(C[6],10):0,fullLayout:C[7]?parseInt(C[7],10):null,codeTagCount:C[8]?parseInt(C[8],10):null};if((w.hardBlank||"").length!==1||[w.height,w.baseline,w.maxLength,w.oldLayout,w.numCommentLines].some(H=>H==null||isNaN(H)))throw new Error("FIGlet header contains invalid values.");if(w.height==null||w.numCommentLines==null)throw new Error("FIGlet header contains invalid values.");w.fittingRules=l(w.oldLayout,w.fullLayout),h.options=w;const v=[];for(let H=32;H<=126;H++)v.push(H);if(v.push(196,214,220,228,246,252,223),y.length<w.numCommentLines+w.height*v.length)throw new Error(`FIGlet file is missing data. Line length: ${y.length}. Comment lines: ${w.numCommentLines}. Height: ${w.height}. Num chars: ${v.length}.`);for(h.comment=y.splice(0,w.numCommentLines).join(`
`),h.numChars=0;y.length>0&&h.numChars<v.length;){const H=v[h.numChars];h[H]=y.splice(0,w.height);for(let x=0;x<w.height;x++)typeof h[H][x]>"u"?h[H][x]="":h[H][x]=s(h[H][x],x,w.height);h.numChars++}for(;y.length>0;){const H=y.shift();if(!H||H.trim()==="")break;let x=H.split(" ")[0],U;if(/^-?0[xX][0-9a-fA-F]+$/.test(x))U=parseInt(x,16);else if(/^-?0[0-7]+$/.test(x))U=parseInt(x,8);else if(/^-?[0-9]+$/.test(x))U=parseInt(x,10);else throw new Error(`Error parsing data. Invalid data: ${x}`);if(U===-1||U<-2147483648||U>2147483647){const k=U===-1?"The char code -1 is not permitted.":`The char code cannot be ${U<-2147483648?"less than -2147483648":"greater than 2147483647"}.`;throw new Error(`Error parsing data. ${k}`)}h[U]=y.splice(0,w.height);for(let k=0;k<w.height;k++)typeof h[U][k]>"u"?h[U][k]="":h[U][k]=s(h[U][k],k,w.height);h.numChars++}return r[p]=h,w},W.loadedFonts=()=>Object.keys(r),W.clearLoadedFonts=()=>{Object.keys(r).forEach(p=>{delete r[p]})},W.loadFont=async function(p,f){if(r[p]){const u=r[p].options;return f&&f(null,u),Promise.resolve(u)}try{if(!i.fetchFontIfMissing)throw new Error(`Font is not loaded: ${p}`);const u=await fetch(`${i.fontPath}/${p}.flf`);if(!u.ok)throw new Error(`Network response was not ok: ${u.status}`);const h=await u.text(),y=W.parseFont(p,h);return f&&f(null,y),y}catch(u){const h=u instanceof Error?u:new Error(String(u));if(f)return f(h),null;throw h}},W.loadFontSync=function(p){if(r[p])return r[p].options;throw new Error("Synchronous font loading is not implemented for the browser, it will only work for fonts already loaded.")},W.preloadFonts=async function(p,f){try{for(const u of p){const h=await fetch(`${i.fontPath}/${u}.flf`);if(!h.ok)throw new Error(`Failed to preload fonts. Error fetching font: ${u}, status code: ${h.statusText}`);const y=await h.text();W.parseFont(u,y)}f&&f()}catch(u){const h=u instanceof Error?u:new Error(String(u));if(f){f(h);return}throw u}},W.fonts=function(p){return new Promise(function(f,u){f(An),p&&p(null,An)})},W.fontsSync=function(){return An},W.figFonts=r,W})(),Ta=`flf2a$ 8 7 54 0 12 0 64 185
...
255  LATIN SMALL LETTER Y WITH DIAERESIS
 ...
 | || |@
  \\_, |@
  |__/ @@
`,Ea=`flf2a$ 6 5 16 15 13 0 24463 229
...
0xCA0  KANNADA LETTER TTHA
 ...
 $\\___/$ @
         @@
         `;Ct.parseFont("Standard",Ea);Ct.parseFont("Slant",Aa);Ct.parseFont("Banner",Ta);Ct.parseFont("Small",ya);const La={name:"figlet",description:"Convert text to ASCII art",execute:(o,e)=>{const t=new B(o);if(t.hasFlag("help"))return{output:`Usage: figlet [options] <text>
...
Try 'figlet --help' for more information.`,error:!0};const r=t.getFlag("f"),i=typeof r=="string"?r:"Standard",s=i.charAt(0).toUpperCase()+i.slice(1).toLowerCase();let l="default";t.hasFlag("c")?l="full":t.hasFlag("r")&&(l="fitted");try{return{output:Ct.textSync(n,{font:s,horizontalLayout:l})}}catch(a){return a instanceof Error?a.message.includes("font")||a.message.includes("Font")||a.message.includes("FIGlet")?{output:`figlet: font '${s}' not found or invalid
Available fonts: standard, slant, banner, small`,error:!0}:{output:`figlet: ${a.message}`,error:!0}:{output:"figlet: unknown error occurred",error:!0}}}};function Ia(){const o=window.innerWidth,e=window.innerHeight,t=document.querySelector("header"),n=t?t.getBoundingClientRect().height:60,r=Math.max(400,Math.floor(o*.95)),i=Math.max(300,Math.floor(e-n));return{width:r,height:i}}function ba(o){return{name:"life",description:"Conway's Game of Life cellular automaton",execute:(e,t)=>{const n=new B(e);if(n.hasFlag("help"))return{output:`Usage: life [options]
...
Note: Animation continues until you scroll, type, or run 'clear'`};let r=2;const i=n.getFlag("speed");if(i!==void 0){const D=parseFloat(String(i));if(isNaN(D)||D<.5||D>10)return{output:`life: invalid speed '${i}'
Speed must be between 0.5 and 10.0`,error:!0};r=D}let s=.3;const l=n.getFlag("density");if(l!==void 0){const D=parseFloat(String(l));if(isNaN(D)||D<0||D>1)return{output:`life: invalid density '${l}'
Density must be between 0.0 and 1.0`,error:!0};s=D}const a=n.getFlag("pattern");let d="random";if(a!==void 0){const D=String(a),O=["random","acorn","glider","blinker"];if(!O.includes(D))return{output:`life: invalid pattern '${D}'
Valid patterns: ${O.join(", ")}`,error:!0};d=D}const _=n.getFlag("theme");let $=o.getCurrentColors();if(_!==void 0){const D=String(_),O=["green","yellow","white","light-blue","paper","dc","custom"];if(!O.includes(D))return{output:`life: invalid theme '${D}'
Valid themes: ${O.join(", ")}`,error:!0};if(D!=="custom"){const P=o.getPreset(D);P&&($=P.colors)}}const{width:g,height:E}=Ia(),A=Math.floor(E*.8),M=$["--terminal-accent"],I=$["--terminal-dim"];return{output:`
<div class="life-container" style="background-color: ${$["--terminal-bg"]}; min-height: ${A}px;">
  <canvas id="life-canvas" class="life-grid"
          ...
          data-accent-color="${M}"
          data-dim-color="${I}"
          style="width: 100%; height: ${A}px; display: block;">
  </canvas>
</div>
`,html:!0}}}}const kr=["#ff6b35","#ff8c42","#ffaa4f","#ffc85c","#e6e669","#c4e676","#9fe683","#7ae690","#5ad69d","#3ac6aa","#1bb6b7","#00a6c4","#0096d1","#0086de"];function kn(o,e,t,n){const r=o/t+e*n;return kr[Math.floor(Math.abs(r))%kr.length]}function wa(o){return/<(div|span|pre)\s+(class|style)=/i.test(o)}function Sa(o,e,t){return o.split(`
`).map((n,r)=>{let i=0;return[...n].map(s=>s===" "||s==="	"?s:`<span style="color: ${kn(i++,r,e,t)}">${De(s)}</span>`).join("")}).join(`
`)}function Ca(o,e,t){let n=0,r=0,i="",s=!1,l=!1,a="";for(const d of o)if(d==="<")s=!0,i+=d;else if(d===">")s=!1,i+=d;else if(s)i+=d;else if(d==="&")l=!0,a=d;else if(l){if(a+=d,d===";"){l=!1;const _=kn(r++,n,e,t);i+=`<span style="color: ${_}">${a}</span>`,a=""}}else if(d===`
`)i+=d,n++,r=0;else if(d===" "||d==="	")i+=d;else{const _=kn(r++,n,e,t);i+=`<span style="color: ${_}">${d}</span>`}return i}const va={name:"lolcat",description:"Rainbow-colorize text output",execute:(o,e)=>{const t=new B(o);if(t.hasFlag("help"))return{output:`Usage: lolcat [options] [text...]
...
Try 'lolcat --help' for more information.`,error:!0};return wa(l)?{output:Ca(l,r,s),html:!0}:{output:`<pre class="lolcat-output">${Sa(l,r,s)}</pre>`,html:!0}}},Ra=3600;function xa(o){return{name:"make",description:"Build targets from a Makefile",execute:(e,t)=>{if(new B(e).hasFlag("help"))return{output:`Usage: make [target...]
...
Note: Animation continues until you scroll, type, or run 'clear'`};let r=1;const i=n.getFlag("speed");if(i!==void 0){const P=parseFloat(String(i));if(isNaN(P)||P<.1||P>5)return{output:`matrix: invalid speed value '${i}'
Speed must be between 0.1 and 5.0`,error:!0};r=P}const s=n.getFlag("theme");let l=o.getCurrentColors();if(s!==void 0){const P=String(s),Y=["green","yellow","white","light-blue","paper","dc","custom"];if(!Y.includes(P))return{output:`matrix: invalid theme '${P}'
Valid themes: ${Y.join(", ")}`,error:!0};if(P!=="custom"){const K=o.getPreset(P);K&&(l=K.colors)}}const{cols:a,rows:d}=Na(),_=1.2,$=Math.floor(a/_)+5,g=Math.min(d,20),E=l["--terminal-accent"],A=l["--terminal-dim"],M=l["--terminal-bg"],I=d*1.5,T=-g*1.5,F=I,D=[];for(let P=0;P<$;P++){const Y=-Math.random()*5,K=(5+Math.random()*5)/r,Fe=P*_,Ve=[];for(let Ae=0;Ae<g;Ae++){const He=Ae/g,de=Math.pow(He,2),Se=Ae===g-1,Ce=ka();Ve.push(`<span class="matrix-char${Se?" matrix-char-bright":""}" data-char-index="${Ae}" style="color: ${Se?E:A}; opacity: ${de};">${Ce}</span>`)}D.push(`
  <div class="matrix-column" data-column-index="${P}" data-trail-length="${g}" style="
    left: ${Fe}em;
    animation: matrix-fall ${K}s linear ${Y}s infinite;
    --matrix-start: ${T}em;
    --matrix-end: ${F}em;
  ">${Ve.join("")}</div>`)}return{output:`
<div class="matrix-rain" data-matrix-chars="${On}" style="height: ${I}em; background-color: ${M};">
${D.join("")}
</div>
`,html:!0}}}}function Ma(){return[{type:"info",text:"Broadcast message from root@darinchambers.com:"},{type:"info",text:"The system is going down for poweroff NOW!"},{type:"ok",text:"Stopped Session c1 of user darin"},{type:"ok",text:"Stopped Target - Graphical Interface"},{type:"ok",text:"Stopped Code Editor Process"},{type:"ok",text:"Stopped Docker Container Runtime"},{type:"ok",text:"Stopped OpenSSH Server"},{type:"failed",text:"Stopped Bluetooth Service (timeout)"},{type:"ok",text:"Stopped Network Manager"},{type:"ok",text:"Stopped D-Bus System Message Bus"},{type:"ok",text:"Stopped Journal Service"},{type:"ok",text:"Stopped System Logging Service"},{type:"info",text:"Sending SIGTERM to remaining processes..."},{type:"info",text:"Sending SIGKILL to remaining processes..."},{type:"ok",text:"Unmounted /home"},{type:"ok",text:"Unmounted /var"},{type:"ok",text:"Unmounted /tmp"},{type:"info",text:"All filesystems unmounted."},{type:"ok",text:"Reached target - Power-Off"}]}function So(o){const e=Ma(),t=150,n=e.map((l,a)=>{const d=a*t,_=`boot-line boot-line-${l.type}`,$=l.text.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;");return`<div class="${_}" style="animation-delay: ${d}ms;">${$}</div>`}),r=e.length*t,i=o?"System halted.":"Power off.";n.push(`<div class="boot-line boot-line-info" style="animation-delay: ${r}ms;">${i}</div>`);const s=r+500;return n.push(`<div class="boot-overlay" style="animation-delay: ${s}ms;" data-boot-overlay="true"><span class="boot-overlay-text">Screen off</span></div>`),n.join(`
`)}const Da={name:"shutdown",description:"Display simulated Linux shutdown sequence",execute:(o,e)=>{const t=new B(o);if(t.hasFlag("help"))return{output:`Usage: shutdown [options]
...
${So(n)}
</div>`,html:!0,clearBefore:!0,fullscreen:!0,fullscreenExitCommand:"boot",scrollBehavior:"top"}}},Pa={name:"reboot",description:"Display simulated system reboot sequence",execute:(o,e)=>{const t=new B(o);if(t.hasFlag("help"))return{output:`Usage: reboot [options]
...
Note: The full sequence takes about 10 seconds. Scroll or type to stop.`};const n=t.hasFlag("fast"),i=So(!1).split(`
...
<div class="boot-line boot-line-info" style="animation-delay: ${d}ms;">Rebooting...</div>
</div>`,html:!0,clearBefore:!0,fullscreen:!0,scrollBehavior:"top",scheduledCommand:{command:n?"boot --fast":"boot",delayMs:_,clearBefore:!0}}}};class Or{static generateHeader(){return`
 ██████╗  █████╗ ██████╗ ██╗███╗   ██╗     ██████╗██╗  ██╗ █████╗ ███╗   ███╗██████╗ ███████╗██████╗ ███████╗
 ██╔══██╗██╔══██╗██╔══██╗██║████╗  ██║    ██╔════╝██║  ██║██╔══██╗████╗ ████║██╔══██╗██╔════╝██╔══██╗██╔════╝
 ██║  ██║███████║██████╔╝██║██╔██╗ ██║    ██║     ███████║███████║██╔████╔██║██████╔╝█████╗  ██████╔╝███████╗
 ██║  ██║██╔══██║██╔══██╗██║██║╚██╗██║    ██║     ██╔══██║██╔══██║██║╚██╔╝██║██╔══██╗██╔══╝  ██╔══██╗╚════██║
 ██████╔╝██║  ██║██║  ██║██║██║ ╚████║    ╚██████╗██║  ██║██║  ██║██║ ╚═╝ ██║██████╔╝███████╗██║  ██║███████║
 ╚═════╝ ╚═╝  ╚═╝╚═╝  ╚═╝╚═╝╚═╝  ╚═══╝     ╚═════╝╚═╝  ╚═╝╚═╝  ╚═╝╚═╝     ╚═╝╚═════╝ ╚══════╝╚═╝  ╚═╝╚══════╝
`}static getTagline(){return"Technologist, Inventor | Building What's Next on Rock-Solid Foundations"}}function Mr(o,e){(e==null||e>o.length)&&(e=o.length);for(var t=0,n=Array(e);t<e;t++)n[t]=o[t];return n}function Fa(o){if(Array.isArray(o))return o}function Ha(o,e){var t=o==null?null:typeof Symbol<"u"&&o[Symbol.iterator]||o["@@iterator"];if(t!=null){var n,r,i,s,l=[],a=!0,d=!1;try{if(i=(t=t.call(o)).next,e!==0)for(;!(a=(n=i.call(t)).done)&&(l.push(n.value),l.length!==e);a=!0);}catch(_){d=!0,r=_}finally{try{if(!a&&t.return!=null&&(s=t.return(),Object(s)!==s))return}finally{if(d)throw r}}return l}}function Ua(){throw new TypeError(`Invalid attempt to destructure non-iterable instance.
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`)}function Ba(o,e){return Fa(o)||Ha(o,e)||Wa(o,e)||Ua()}function Wa(o,e){if(o){if(typeof o=="string")return Mr(o,e);var t={}.toString.call(o).slice(8,-1);return t==="Object"&&o.constructor&&(t=o.constructor.name),t==="Map"||t==="Set"?Array.from(o):t==="Arguments"||/^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(t)?Mr(o,e):void 0}}const Co=Object.entries,Dr=Object.setPrototypeOf,Ga=Object.isFrozen,za=Object.getPrototypeOf,Va=Object.getOwnPropertyDescriptor;let ae=Object.freeze,le=Object.seal,lt=Object.create,vo=typeof Reflect<"u"&&Reflect,Mn=vo.apply,Dn=vo.construct;ae||(ae=function(e){return e});le||(le=function(e){return e});Mn||(Mn=function(e,t){for(var n=arguments.length,r=new Array(n>2?n-2:0),i=2;i<n;i++)r[i-2]=arguments[i];return e.apply(t,r)});Dn||(Dn=function(e){for(var t=arguments.length,n=new Array(t>1?t-1:0),r=1;r<t;r++)n[r-1]=arguments[r];return new e(...n)});const $t=Q(Array.prototype.forEach),ja=Q(Array.prototype.lastIndexOf),Pr=Q(Array.prototype.pop),at=Q(Array.prototype.push),Ya=Q(Array.prototype.splice),We=Array.isArray,Lt=Q(String.prototype.toLowerCase),yn=Q(String.prototype.toString),Fr=Q(String.prototype.match),Tt=Q(String.prototype.replace),Hr=Q(String.prototype.indexOf),qa=Q(String.prototype.trim),Xa=Q(Number.prototype.toString),Ka=Q(Boolean.prototype.toString),Ur=typeof BigInt>"u"?null:Q(BigInt.prototype.toString),Br=typeof Symbol>"u"?null:Q(Symbol.prototype.toString),pe=Q(Object.prototype.hasOwnProperty),At=Q(Object.prototype.toString),ie=Q(RegExp.prototype.test),Xe=Za(TypeError);function Q(o){return function(e){e instanceof RegExp&&(e.lastIndex=0);for(var t=arguments.length,n=new Array(t>1?t-1:0),r=1;r<t;r++)n[r-1]=arguments[r];return Mn(o,e,n)}}function Za(o){return function(){for(var e=arguments.length,t=new Array(e),n=0;n<e;n++)t[n]=arguments[n];return Dn(o,t)}}function z(o,e){let t=arguments.length>2&&arguments[2]!==void 0?arguments[2]:Lt;if(Dr&&Dr(o,null),!We(e))return o;let n=e.length;for(;n--;){let r=e[n];if(typeof r=="string"){const i=t(r);i!==r&&(Ga(e)||(e[n]=i),r=i)}o[r]=!0}return o}function Ja(o){for(let e=0;e<o.length;e++)pe(o,e)||(o[e]=null);return o}function he(o){const e=lt(null);for(const n of Co(o)){var t=Ba(n,2);const r=t[0],i=t[1];pe(o,r)&&(We(i)?e[r]=Ja(i):i&&typeof i=="object"&&i.constructor===Object?e[r]=he(i):e[r]=i)}return e}function Qa(o){switch(typeof o){case"string":return o;case"number":return Xa(o);case"boolean":return Ka(o);case"bigint":return Ur?Ur(o):"0";case"symbol":return Br?Br(o):"Symbol()";case"undefined":return At(o);case"function":case"object":{if(o===null)return At(o);const e=o,t=ke(e,"toString");if(typeof t=="function"){const n=t(e);return typeof n=="string"?n:At(n)}return At(o)}default:return At(o)}}function ke(o,e){for(;o!==null;){const n=Va(o,e);if(n){if(n.get)return Q(n.get);if(typeof n.value=="function")return Q(n.value)}o=za(o)}function t(){return null}return t}function el(o){try{return ie(o,""),!0}catch{return!1}}const Wr=ae(["a","abbr","acronym","address","area","article","aside","audio","b","bdi","bdo","big","blink","blockquote","body","br","button","canvas","caption","center","cite","code","col","colgroup","content","data","datalist","dd","decorator","del","details","dfn","dialog","dir","div","dl","dt","element","em","fieldset","figcaption","figure","font","footer","form","h1","h2","h3","h4","h5","h6","head","header","hgroup","hr","html","i","img","input","ins","kbd","label","legend","li","main","map","mark","marquee","menu","menuitem","meter","nav","nobr","ol","optgroup","option","output","p","picture","pre","progress","q","rp","rt","ruby","s","samp","search","section","select","shadow","slot","small","source","spacer","span","strike","strong","style","sub","summary","sup","table","tbody","td","template","textarea","tfoot","th","thead","time","tr","track","tt","u","ul","var","video","wbr"]),En=ae(["svg","a","altglyph","altglyphdef","altglyphitem","animatecolor","animatemotion","animatetransform","circle","clippath","defs","desc","ellipse","enterkeyhint","exportparts","filter","font","g","glyph","glyphref","hkern","image","inputmode","line","lineargradient","marker","mask","metadata","mpath","part","path","pattern","polygon","polyline","radialgradient","rect","stop","style","switch","symbol","text","textpath","title","tref","tspan","view","vkern"]),Ln=ae(["feBlend","feColorMatrix","feComponentTransfer","feComposite","feConvolveMatrix","feDiffuseLighting","feDisplacementMap","feDistantLight","feDropShadow","feFlood","feFuncA","feFuncB","feFuncG","feFuncR","feGaussianBlur","feImage","feMerge","feMergeNode","feMorphology","feOffset","fePointLight","feSpecularLighting","feSpotLight","feTile","feTurbulence"]),tl=ae(["animate","color-profile","cursor","discard","font-face","font-face-format","font-face-name","font-face-src","font-face-uri","foreignobject","hatch","hatchpath","mesh","meshgradient","meshpatch","meshrow","missing-glyph","script","set","solidcolor","unknown","use"]),In=ae(["math","menclose","merror","mfenced","mfrac","mglyph","mi","mlabeledtr","mmultiscripts","mn","mo","mover","mpadded","mphantom","mroot","mrow","ms","mspace","msqrt","mstyle","msub","msup","msubsup","mtable","mtd","mtext","mtr","munder","munderover","mprescripts"]),nl=ae(["maction","maligngroup","malignmark","mlongdiv","mscarries","mscarry","msgroup","mstack","msline","msrow","semantics","annotation","annotation-xml","mprescripts","none"]),Gr=ae(["#text"]),zr=ae(["accept","action","align","alt","autocapitalize","autocomplete","autopictureinpicture","autoplay","background","bgcolor","border","capture","cellpadding","cellspacing","checked","cite","class","clear","color","cols","colspan","command","commandfor","controls","controlslist","coords","crossorigin","datetime","decoding","default","dir","disabled","disablepictureinpicture","disableremoteplayback","download","draggable","enctype","enterkeyhint","exportparts","face","for","headers","height","hidden","high","href","hreflang","id","inert","inputmode","integrity","ismap","kind","label","lang","list","loading","loop","low","max","maxlength","media","method","min","minlength","multiple","muted","name","nonce","noshade","novalidate","nowrap","open","optimum","part","pattern","placeholder","playsinline","popover","popovertarget","popovertargetaction","poster","preload","pubdate","radiogroup","readonly","rel","required","rev","reversed","role","rows","rowspan","spellcheck","scope","selected","shape","size","sizes","slot","span","srclang","start","src","srcset","step","style","summary","tabindex","title","translate","type","usemap","valign","value","width","wrap","xmlns"]),bn=ae(["accent-height","accumulate","additive","alignment-baseline","amplitude","ascent","attributename","attributetype","azimuth","basefrequency","baseline-shift","begin","bias","by","class","clip","clippathunits","clip-path","clip-rule","color","color-interpolation","color-interpolation-filters","color-profile","color-rendering","cx","cy","d","dx","dy","diffuseconstant","direction","display","divisor","dur","edgemode","elevation","end","exponent","fill","fill-opacity","fill-rule","filter","filterunits","flood-color","flood-opacity","font-family","font-size","font-size-adjust","font-stretch","font-style","font-variant","font-weight","fx","fy","g1","g2","glyph-name","glyphref","gradientunits","gradienttransform","height","href","id","image-rendering","in","in2","intercept","k","k1","k2","k3","k4","kerning","keypoints","keysplines","keytimes","lang","lengthadjust","letter-spacing","kernelmatrix","kernelunitlength","lighting-color","local","marker-end","marker-mid","marker-start","markerheight","markerunits","markerwidth","maskcontentunits","maskunits","max","mask","mask-type","media","method","mode","min","name","numoctaves","offset","operator","opacity","order","orient","orientation","origin","overflow","paint-order","path","pathlength","patterncontentunits","patterntransform","patternunits","points","preservealpha","preserveaspectratio","primitiveunits","r","rx","ry","radius","refx","refy","repeatcount","repeatdur","restart","result","rotate","scale","seed","shape-rendering","slope","specularconstant","specularexponent","spreadmethod","startoffset","stddeviation","stitchtiles","stop-color","stop-opacity","stroke-dasharray","stroke-dashoffset","stroke-linecap","stroke-linejoin","stroke-miterlimit","stroke-opacity","stroke","stroke-width","style","surfacescale","systemlanguage","tabindex","tablevalues","targetx","targety","transform","transform-origin","text-anchor","text-decoration","text-rendering","textlength","type","u1","u2","unicode","values","viewbox","visibility","version","vert-adv-y","vert-origin-x","vert-origin-y","width","word-spacing","wrap","writing-mode","xchannelselector","ychannelselector","x","x1","x2","xmlns","y","y1","y2","z","zoomandpan"]),Vr=ae(["accent","accentunder","align","bevelled","close","columnalign","columnlines","columnspacing","columnspan","denomalign","depth","dir","display","displaystyle","encoding","fence","frame","height","href","id","largeop","length","linethickness","lquote","lspace","mathbackground","mathcolor","mathsize","mathvariant","maxsize","minsize","movablelimits","notation","numalign","open","rowalign","rowlines","rowspacing","rowspan","rspace","rquote","scriptlevel","scriptminsize","scriptsizemultiplier","selection","separator","separators","stretchy","subscriptshift","supscriptshift","symmetric","voffset","width","xmlns"]),Wt=ae(["xlink:href","xml:id","xlink:title","xml:space","xmlns:xlink"]),rl=le(/{{[\w\W]*|^[\w\W]*}}/g),ol=le(/<%[\w\W]*|^[\w\W]*%>/g),il=le(/\${[\w\W]*/g),sl=le(/^data-[\-\w.\u00B7-\uFFFF]+$/),al=le(/^aria-[\-\w]+$/),jr=le(/^(?:(?:(?:f|ht)tps?|mailto|tel|callto|sms|cid|xmpp|matrix):|[^a-z]|[a-z+.\-]+(?:[^a-z+.\-:]|$))/i),ll=le(/^(?:\w+script|data):/i),cl=le(/[\u0000-\u0020\u00A0\u1680\u180E\u2000-\u2029\u205F\u3000]/g),dl=le(/^html$/i),ul=le(/^[a-z][.\w]*(-[.\w]+)+$/i),Yr=le(/<[/\w!]/g),_l=le(/<[/\w]/g),ml=le(/<\/no(script|embed|frames)/i),hl=le(/\/>/i),Ne={element:1,attribute:2,text:3,cdataSection:4,entityReference:5,entityNode:6,processingInstruction:7,comment:8,document:9,documentType:10,documentFragment:11,notation:12},pl=function(){return typeof window>"u"?null:window},fl=function(e,t){if(typeof e!="object"||typeof e.createPolicy!="function")return null;let n=null;const r="data-tt-policy-suffix";t&&t.hasAttribute(r)&&(n=t.getAttribute(r));const i="dompurify"+(n?"#"+n:"");try{return e.createPolicy(i,{createHTML(s){return s},createScriptURL(s){return s}})}catch{return console.warn("TrustedTypes policy "+i+" could not be created."),null}},qr=function(){return{afterSanitizeAttributes:[],afterSanitizeElements:[],afterSanitizeShadowDOM:[],beforeSanitizeAttributes:[],beforeSanitizeElements:[],beforeSanitizeShadowDOM:[],uponSanitizeAttribute:[],uponSanitizeElement:[],uponSanitizeShadowNode:[]}},Be=function(e,t,n,r){return pe(e,t)&&We(e[t])?z(r.base?he(r.base):{},e[t],r.transform):n};function Ro(){let o=arguments.length>0&&arguments[0]!==void 0?arguments[0]:pl();const e=S=>Ro(S);if(e.version="3.4.10",e.removed=[],!o||!o.document||o.document.nodeType!==Ne.document||!o.Element)return e.isSupported=!1,e;let t=o.document;const n=t,r=n.currentScript;o.DocumentFragment;const i=o.HTMLTemplateElement,s=o.Node,l=o.Element,a=o.NodeFilter,d=o.NamedNodeMap;d===void 0&&(o.NamedNodeMap||o.MozNamedAttrMap),o.HTMLFormElement;const _=o.DOMParser,$=o.trustedTypes,g=l.prototype,E=ke(g,"cloneNode"),A=ke(g,"remove"),M=ke(g,"nextSibling"),I=ke(g,"childNodes"),T=ke(g,"parentNode"),F=ke(g,"shadowRoot"),D=ke(g,"attributes"),O=s&&s.prototype?ke(s.prototype,"nodeType"):null,P=s&&s.prototype?ke(s.prototype,"nodeName"):null;if(typeof i=="function"){const S=t.createElement("template");S.content&&S.content.ownerDocument&&(t=S.content.ownerDocument)}let Y,K="",Fe,Ve=!1,Ae=0;const He=function(){if(Ae>0)throw Xe('A configured TRUSTED_TYPES_POLICY callback (createHTML or createScriptURL) must not call DOMPurify.sanitize, as that causes infinite recursion. Do not pass a policy whose callbacks wrap DOMPurify as TRUSTED_TYPES_POLICY; see the "DOMPurify and Trusted Types" section of the README.')},de=function(c){He(),Ae++;try{return Y.createHTML(c)}finally{Ae--}},Se=function(c){He(),Ae++;try{return Y.createScriptURL(c)}finally{Ae--}},Ce=function(){return Ve||(Fe=fl($,r),Ve=!0),Fe},et=t,ut=et.implementation,xt=et.createNodeIterator,Qt=et.createDocumentFragment,Nt=et.getElementsByTagName,kt=n.importNode;let W=qr();e.isSupported=typeof Co=="function"&&typeof T=="function"&&ut&&ut.createHTMLDocument!==void 0;const p=rl,f=ol,u=il,h=sl,y=al,b=ll,C=cl,w=ul;let R=jr,v=null;const H=z({},[...Wr,...En,...Ln,...In,...Gr]);let x=null;const U=z({},[...zr,...bn,...Vr,...Wt]);let k=Object.seal(lt(null,{tagNameCheck:{writable:!0,configurable:!1,enumerable:!0,value:null},attributeNameCheck:{writable:!0,configurable:!1,enumerable:!0,value:null},allowCustomizedBuiltInElements:{writable:!0,configurable:!1,enumerable:!0,value:!1}})),ne=null,re=null;const $e=Object.seal(lt(null,{tagCheck:{writable:!0,configurable:!1,enumerable:!0,value:null},attributeCheck:{writable:!0,configurable:!1,enumerable:!0,value:null}}));let Te=!0,Le=!0,ue=!1,oe=!0,ve=!1,_t=!0,je=!1,en=!1,tn=!1,tt=!1,Ot=!1,Mt=!1,Kn=!0,Zn=!1;const Jn="user-content-";let nn=!0,rn=!1,nt={},Re=null;const on=z({},["annotation-xml","audio","colgroup","desc","foreignobject","head","iframe","math","mi","mn","mo","ms","mtext","noembed","noframes","noscript","plaintext","script","selectedcontent","style","svg","template","thead","title","video","xmp"]);let Qn=null;const er=z({},["audio","video","img","source","image","track"]);let sn=null;const tr=z({},["alt","class","for","id","label","name","pattern","placeholder","role","summary","title","value","style","xmlns"]),Dt="http://www.w3.org/1998/Math/MathML",Pt="http://www.w3.org/2000/svg",xe="http://www.w3.org/1999/xhtml";let rt=xe,an=!1,ln=null;const Mo=z({},[Dt,Pt,xe],yn),nr=ae(["mi","mo","mn","ms","mtext"]);let cn=z({},nr);const rr=ae(["annotation-xml"]);let dn=z({},rr);const Do=z({},["title","style","font","a","script"]);let mt=null;const Po=["application/xhtml+xml","text/html"],Fo="text/html";let Z=null,ot=null;const Ho=t.createElement("form"),or=function(c){return c instanceof RegExp||c instanceof Function},un=function(){let c=arguments.length>0&&arguments[0]!==void 0?arguments[0]:{};if(ot&&ot===c)return;(!c||typeof c!="object")&&(c={}),c=he(c),mt=Po.indexOf(c.PARSER_MEDIA_TYPE)===-1?Fo:c.PARSER_MEDIA_TYPE,Z=mt==="application/xhtml+xml"?yn:Lt,v=Be(c,"ALLOWED_TAGS",H,{transform:Z}),x=Be(c,"ALLOWED_ATTR",U,{transform:Z}),ln=Be(c,"ALLOWED_NAMESPACES",Mo,{transform:yn}),sn=Be(c,"ADD_URI_SAFE_ATTR",tr,{transform:Z,base:tr}),Qn=Be(c,"ADD_DATA_URI_TAGS",er,{transform:Z,base:er}),Re=Be(c,"FORBID_CONTENTS",on,{transform:Z}),ne=Be(c,"FORBID_TAGS",he({}),{transform:Z}),re=Be(c,"FORBID_ATTR",he({}),{transform:Z}),nt=pe(c,"USE_PROFILES")?c.USE_PROFILES&&typeof c.USE_PROFILES=="object"?he(c.USE_PROFILES):c.USE_PROFILES:!1,Te=c.ALLOW_ARIA_ATTR!==!1,Le=c.ALLOW_DATA_ATTR!==!1,ue=c.ALLOW_UNKNOWN_PROTOCOLS||!1,oe=c.ALLOW_SELF_CLOSE_IN_ATTR!==!1,ve=c.SAFE_FOR_TEMPLATES||!1,_t=c.SAFE_FOR_XML!==!1,je=c.WHOLE_DOCUMENT||!1,tt=c.RETURN_DOM||!1,Ot=c.RETURN_DOM_FRAGMENT||!1,Mt=c.RETURN_TRUSTED_TYPE||!1,tn=c.FORCE_BODY||!1,Kn=c.SANITIZE_DOM!==!1,Zn=c.SANITIZE_NAMED_PROPS||!1,nn=c.KEEP_CONTENT!==!1,rn=c.IN_PLACE||!1,R=el(c.ALLOWED_URI_REGEXP)?c.ALLOWED_URI_REGEXP:jr,rt=typeof c.NAMESPACE=="string"?c.NAMESPACE:xe,cn=pe(c,"MATHML_TEXT_INTEGRATION_POINTS")&&c.MATHML_TEXT_INTEGRATION_POINTS&&typeof c.MATHML_TEXT_INTEGRATION_POINTS=="object"?he(c.MATHML_TEXT_INTEGRATION_POINTS):z({},nr),dn=pe(c,"HTML_INTEGRATION_POINTS")&&c.HTML_INTEGRATION_POINTS&&typeof c.HTML_INTEGRATION_POINTS=="object"?he(c.HTML_INTEGRATION_POINTS):z({},rr);const m=pe(c,"CUSTOM_ELEMENT_HANDLING")&&c.CUSTOM_ELEMENT_HANDLING&&typeof c.CUSTOM_ELEMENT_HANDLING=="object"?he(c.CUSTOM_ELEMENT_HANDLING):lt(null);if(k=lt(null),pe(m,"tagNameCheck")&&or(m.tagNameCheck)&&(k.tagNameCheck=m.tagNameCheck),pe(m,"attributeNameCheck")&&or(m.attributeNameCheck)&&(k.attributeNameCheck=m.attributeNameCheck),pe(m,"allowCustomizedBuiltInElements")&&typeof m.allowCustomizedBuiltInElements=="boolean"&&(k.allowCustomizedBuiltInElements=m.allowCustomizedBuiltInElements),le(k),ve&&(Le=!1),Ot&&(tt=!0),nt&&(v=z({},Gr),x=lt(null),nt.html===!0&&(z(v,Wr),z(x,zr)),nt.svg===!0&&(z(v,En),z(x,bn),z(x,Wt)),nt.svgFilters===!0&&(z(v,Ln),z(x,bn),z(x,Wt)),nt.mathMl===!0&&(z(v,In),z(x,Vr),z(x,Wt))),$e.tagCheck=null,$e.attributeCheck=null,pe(c,"ADD_TAGS")&&(typeof c.ADD_TAGS=="function"?$e.tagCheck=c.ADD_TAGS:We(c.ADD_TAGS)&&(v===H&&(v=he(v)),z(v,c.ADD_TAGS,Z))),pe(c,"ADD_ATTR")&&(typeof c.ADD_ATTR=="function"?$e.attributeCheck=c.ADD_ATTR:We(c.ADD_ATTR)&&(x===U&&(x=he(x)),z(x,c.ADD_ATTR,Z))),pe(c,"ADD_URI_SAFE_ATTR")&&We(c.ADD_URI_SAFE_ATTR)&&z(sn,c.ADD_URI_SAFE_ATTR,Z),pe(c,"FORBID_CONTENTS")&&We(c.FORBID_CONTENTS)&&(Re===on&&(Re=he(Re)),z(Re,c.FORBID_CONTENTS,Z)),pe(c,"ADD_FORBID_CONTENTS")&&We(c.ADD_FORBID_CONTENTS)&&(Re===on&&(Re=he(Re)),z(Re,c.ADD_FORBID_CONTENTS,Z)),nn&&(v["#text"]=!0),je&&z(v,["html","head","body"]),v.table&&(z(v,["tbody"]),delete ne.tbody),c.TRUSTED_TYPES_POLICY){if(typeof c.TRUSTED_TYPES_POLICY.createHTML!="function")throw Xe('TRUSTED_TYPES_POLICY configuration option must provide a "createHTML" hook.');if(typeof c.TRUSTED_TYPES_POLICY.createScriptURL!="function")throw Xe('TRUSTED_TYPES_POLICY configuration option must provide a "createScriptURL" hook.');const L=Y;Y=c.TRUSTED_TYPES_POLICY;try{K=de("")}catch(N){throw Y=L,N}}else c.TRUSTED_TYPES_POLICY===null?(Y=void 0,K=""):(Y===void 0&&(Y=Ce()),Y&&typeof K=="string"&&(K=de("")));(W.uponSanitizeElement.length>0||W.uponSanitizeAttribute.length>0)&&v===H&&(v=he(v)),W.uponSanitizeAttribute.length>0&&x===U&&(x=he(x)),ae&&ae(c),ot=c},ir=z({},[...En,...Ln,...tl]),sr=z({},[...In,...nl]),Uo=function(c,m,L){return m.namespaceURI===xe?c==="svg":m.namespaceURI===Dt?c==="svg"&&(L==="annotation-xml"||cn[L]):!!ir[c]},Bo=function(c,m,L){return m.namespaceURI===xe?c==="math":m.namespaceURI===Pt?c==="math"&&dn[L]:!!sr[c]},Wo=function(c,m,L){return m.namespaceURI===Pt&&!dn[L]||m.namespaceURI===Dt&&!cn[L]?!1:!sr[c]&&(Do[c]||!ir[c])},Go=function(c){let m=T(c);(!m||!m.tagName)&&(m={namespaceURI:rt,tagName:"template"});const L=Lt(c.tagName),N=Lt(m.tagName);return ln[c.namespaceURI]?c.namespaceURI===Pt?Uo(L,m,N):c.namespaceURI===Dt?Bo(L,m,N):c.namespaceURI===xe?Wo(L,m,N):!!(mt==="application/xhtml+xml"&&ln[c.namespaceURI]):!1},Ue=function(c){at(e.removed,{element:c});try{T(c).removeChild(c)}catch{if(A(c),!T(c))throw Xe("a node selected for removal could not be detached from its tree and cannot be safely returned; refusing to sanitize in place")}},ar=function(c){const m=I(c);if(m){const N=[];$t(m,G=>{at(N,G)}),$t(N,G=>{try{A(G)}catch{}})}const L=D(c);if(L)for(let N=L.length-1;N>=0;--N){const G=L[N],V=G&&G.name;if(typeof V=="string")try{c.removeAttribute(V)}catch{}}},Ye=function(c,m){try{at(e.removed,{attribute:m.getAttributeNode(c),from:m})}catch{at(e.removed,{attribute:null,from:m})}if(m.removeAttribute(c),c==="is")if(tt||Ot)try{Ue(m)}catch{}else try{m.setAttribute(c,"")}catch{}},zo=function(c){const m=D(c);if(m)for(let L=m.length-1;L>=0;--L){const N=m[L],G=N&&N.name;if(!(typeof G!="string"||x[Z(G)]))try{c.removeAttribute(G)}catch{}}},Vo=function(c){const m=[c];for(;m.length>0;){const L=m.pop();(O?O(L):L.nodeType)===Ne.element&&zo(L);const G=I(L);if(G)for(let V=G.length-1;V>=0;--V)m.push(G[V])}},lr=function(c){let m=null,L=null;if(tn)c="<remove></remove>"+c;else{const V=Fr(c,/^[\r\n\t ]+/);L=V&&V[0]}mt==="application/xhtml+xml"&&rt===xe&&(c='<html xmlns="http://www.w3.org/1999/xhtml"><head></head><body>'+c+"</body></html>");const N=Y?de(c):c;if(rt===xe)try{m=new _().parseFromString(N,mt)}catch{}if(!m||!m.documentElement){m=ut.createDocument(rt,"template",null);try{m.documentElement.innerHTML=an?K:N}catch{}}const G=m.body||m.documentElement;return c&&L&&G.insertBefore(t.createTextNode(L),G.childNodes[0]||null),rt===xe?Nt.call(m,je?"html":"body")[0]:je?m.documentElement:G},cr=function(c){return xt.call(c.ownerDocument||c,c,a.SHOW_ELEMENT|a.SHOW_COMMENT|a.SHOW_TEXT|a.SHOW_PROCESSING_INSTRUCTION|a.SHOW_CDATA_SECTION,null)},Ft=function(c){return c=Tt(c,p," "),c=Tt(c,f," "),c=Tt(c,u," "),c},_n=function(c){var m;c.normalize();const L=xt.call(c.ownerDocument||c,c,a.SHOW_TEXT|a.SHOW_COMMENT|a.SHOW_CDATA_SECTION|a.SHOW_PROCESSING_INSTRUCTION,null);let N=L.nextNode();for(;N;)N.data=Ft(N.data),N=L.nextNode();const G=(m=c.querySelectorAll)===null||m===void 0?void 0:m.call(c,"template");G&&$t(G,V=>{it(V.content)&&_n(V.content)})},Ht=function(c){const m=P?P(c):null;return typeof m!="string"||Z(m)!=="form"?!1:typeof c.nodeName!="string"||typeof c.textContent!="string"||typeof c.removeChild!="function"||c.attributes!==D(c)||typeof c.removeAttribute!="function"||typeof c.setAttribute!="function"||typeof c.namespaceURI!="string"||typeof c.insertBefore!="function"||typeof c.hasChildNodes!="function"||c.nodeType!==O(c)||c.childNodes!==I(c)},it=function(c){if(!O||typeof c!="object"||c===null)return!1;try{return O(c)===Ne.documentFragment}catch{return!1}},ht=function(c){if(!O||typeof c!="object"||c===null)return!1;try{return typeof O(c)=="number"}catch{return!1}};function Oe(S,c,m){S.length!==0&&$t(S,L=>{L.call(e,c,m,ot)})}const jo=function(c,m){return!!(_t&&c.hasChildNodes()&&!ht(c.firstElementChild)&&ie(Yr,c.textContent)&&ie(Yr,c.innerHTML)||_t&&c.namespaceURI===xe&&m==="style"&&ht(c.firstElementChild)||c.nodeType===Ne.processingInstruction||_t&&c.nodeType===Ne.comment&&ie(_l,c.data))},Yo=function(c,m){if(!ne[m]&&_r(m)&&(k.tagNameCheck instanceof RegExp&&ie(k.tagNameCheck,m)||k.tagNameCheck instanceof Function&&k.tagNameCheck(m)))return!1;if(nn&&!Re[m]){const L=T(c),N=I(c);if(N&&L){const G=N.length;for(let V=G-1;V>=0;--V){const te=rn?N[V]:E(N[V],!0);L.insertBefore(te,M(c))}}}return Ue(c),!0},dr=function(c){if(Oe(W.beforeSanitizeElements,c,null),Ht(c))return Ue(c),!0;const m=Z(P?P(c):c.nodeName);if(Oe(W.uponSanitizeElement,c,{tagName:m,allowedTags:v}),jo(c,m))return Ue(c),!0;if(ne[m]||!($e.tagCheck instanceof Function&&$e.tagCheck(m))&&!v[m])return Yo(c,m);if((O?O(c):c.nodeType)===Ne.element&&!Go(c)||(m==="noscript"||m==="noembed"||m==="noframes")&&ie(ml,c.innerHTML))return Ue(c),!0;if(ve&&c.nodeType===Ne.text){const N=Ft(c.textContent);c.textContent!==N&&(at(e.removed,{element:c.cloneNode()}),c.textContent=N)}return Oe(W.afterSanitizeElements,c,null),!1},ur=function(c,m,L){if(re[m]||Kn&&(m==="id"||m==="name")&&(L in t||L in Ho))return!1;const N=x[m]||$e.attributeCheck instanceof Function&&$e.attributeCheck(m,c);if(!(Le&&ie(h,m))){if(!(Te&&ie(y,m))){if(N){if(!sn[m]){if(!ie(R,Tt(L,C,""))){if(!((m==="src"||m==="xlink:href"||m==="href")&&c!=="script"&&Hr(L,"data:")===0&&Qn[c])){if(!(ue&&!ie(b,Tt(L,C,"")))){if(L)return!1}}}}}else if(!(_r(c)&&(k.tagNameCheck instanceof RegExp&&ie(k.tagNameCheck,c)||k.tagNameCheck instanceof Function&&k.tagNameCheck(c))&&(k.attributeNameCheck instanceof RegExp&&ie(k.attributeNameCheck,m)||k.attributeNameCheck instanceof Function&&k.attributeNameCheck(m,c))||m==="is"&&k.allowCustomizedBuiltInElements&&(k.tagNameCheck instanceof RegExp&&ie(k.tagNameCheck,L)||k.tagNameCheck instanceof Function&&k.tagNameCheck(L))))return!1}}return!0},qo=z({},["annotation-xml","color-profile","font-face","font-face-format","font-face-name","font-face-src","font-face-uri","missing-glyph"]),_r=function(c){return!qo[Lt(c)]&&ie(w,c)},Xo=function(c,m,L,N){if(Y&&typeof $=="object"&&typeof $.getAttributeType=="function"&&!L)switch($.getAttributeType(c,m)){case"TrustedHTML":return de(N);case"TrustedScriptURL":return Se(N)}return N},Ko=function(c,m,L,N){try{L?c.setAttributeNS(L,m,N):c.setAttribute(m,N),Ht(c)?Ue(c):Pr(e.removed)}catch{Ye(m,c)}},mr=function(c){Oe(W.beforeSanitizeAttributes,c,null);const m=c.attributes;if(!m||Ht(c))return;const L={attrName:"",attrValue:"",keepAttr:!0,allowedAttributes:x,forceKeepAttr:void 0};let N=m.length;const G=Z(c.nodeName);for(;N--;){const V=m[N],te=V.name,J=V.namespaceURI,ye=V.value,Ie=Z(te),hn=ye;let _e=te==="value"?hn:qa(hn);if(L.attrName=Ie,L.attrValue=_e,L.keepAttr=!0,L.forceKeepAttr=void 0,Oe(W.uponSanitizeAttribute,c,L),_e=L.attrValue,Zn&&(Ie==="id"||Ie==="name")&&Hr(_e,Jn)!==0&&(Ye(te,c),_e=Jn+_e),_t&&ie(/((--!?|])>)|<\/(style|script|title|xmp|textarea|noscript|iframe|noembed|noframes)/i,_e)){Ye(te,c);continue}if(Ie==="attributename"&&Fr(_e,"href")){Ye(te,c);continue}if(!L.forceKeepAttr){if(!L.keepAttr){Ye(te,c);continue}if(!oe&&ie(hl,_e)){Ye(te,c);continue}if(ve&&(_e=Ft(_e)),!ur(G,Ie,_e)){Ye(te,c);continue}_e=Xo(G,Ie,J,_e),_e!==hn&&Ko(c,te,J,_e)}}Oe(W.afterSanitizeAttributes,c,null)},Ut=function(c){let m=null;const L=cr(c);for(Oe(W.beforeSanitizeShadowDOM,c,null);m=L.nextNode();)if(Oe(W.uponSanitizeShadowNode,m,null),dr(m),mr(m),it(m.content)&&Ut(m.content),(O?O(m):m.nodeType)===Ne.element){const G=F(m);it(G)&&(mn(G),Ut(G))}Oe(W.afterSanitizeShadowDOM,c,null)},mn=function(c){const m=[{node:c,shadow:null}];for(;m.length>0;){const L=m.pop();if(L.shadow){Ut(L.shadow);continue}const N=L.node,V=(O?O(N):N.nodeType)===Ne.element,te=I(N);if(te)for(let J=te.length-1;J>=0;--J)m.push({node:te[J],shadow:null});if(V){const J=P?P(N):null;if(typeof J=="string"&&Z(J)==="template"){const ye=N.content;it(ye)&&m.push({node:ye,shadow:null})}}if(V){const J=F(N);it(J)&&m.push({node:null,shadow:J},{node:J,shadow:null})}}};return e.sanitize=function(S){let c=arguments.length>1&&arguments[1]!==void 0?arguments[1]:{},m=null,L=null,N=null,G=null;if(an=!S,an&&(S="<!-->"),typeof S!="string"&&!ht(S)&&(S=Qa(S),typeof S!="string"))throw Xe("dirty is not a string, aborting");if(!e.isSupported)return S;en||un(c),e.removed=[];const V=rn&&typeof S!="string"&&ht(S);if(V){const ye=P?P(S):S.nodeName;if(typeof ye=="string"){const Ie=Z(ye);if(!v[Ie]||ne[Ie])throw Xe("root node is forbidden and cannot be sanitized in-place")}if(Ht(S))throw Xe("root node is clobbered and cannot be sanitized in-place");try{mn(S)}catch(Ie){throw ar(S),Ie}}else if(ht(S))m=lr("<!---->"),L=m.ownerDocument.importNode(S,!0),L.nodeType===Ne.element&&L.nodeName==="BODY"||L.nodeName==="HTML"?m=L:m.appendChild(L),mn(L);else{if(!tt&&!ve&&!je&&S.indexOf("<")===-1)return Y&&Mt?de(S):S;if(m=lr(S),!m)return tt?null:Mt?K:""}m&&tn&&Ue(m.firstChild);const te=cr(V?S:m);try{for(;N=te.nextNode();)dr(N),mr(N),it(N.content)&&Ut(N.content)}catch(ye){throw V&&ar(S),ye}if(V)return $t(e.removed,ye=>{ye.element&&Vo(ye.element)}),ve&&_n(S),S;if(tt){if(ve&&_n(m),Ot)for(G=Qt.call(m.ownerDocument);m.firstChild;)G.appendChild(m.firstChild);else G=m;return(x.shadowroot||x.shadowrootmode)&&(G=kt.call(n,G,!0)),G}let J=je?m.outerHTML:m.innerHTML;return je&&v["!doctype"]&&m.ownerDocument&&m.ownerDocument.doctype&&m.ownerDocument.doctype.name&&ie(dl,m.ownerDocument.doctype.name)&&(J="<!DOCTYPE "+m.ownerDocument.doctype.name+`>
`+J),ve&&(J=Ft(J)),Y&&Mt?de(J):J},e.setConfig=function(){let S=arguments.length>0&&arguments[0]!==void 0?arguments[0]:{};un(S),en=!0},e.clearConfig=function(){ot=null,en=!1,Y=Fe,K=""},e.isValidAttribute=function(S,c,m){ot||un({});const L=Z(S),N=Z(c);return ur(L,N,m)},e.addHook=function(S,c){typeof c=="function"&&at(W[S],c)},e.removeHook=function(S,c){if(c!==void 0){const m=ja(W[S],c);return m===-1?void 0:Ya(W[S],m,1)[0]}return Pr(W[S])},e.removeHooks=function(S){W[S]=[]},e.removeAllHooks=function(){W=qr()},e}var gl=Ro();function qn(o){return gl.sanitize(o,{ALLOWED_TAGS:["p","div","span","br","strong","b","em","i","u","s","a","code","pre","h1","h2","h3","h4","h5","h6","ul","ol","li","blockquote","table","thead","tbody","tr","th","td","img","canvas","button","input","select","option","label","aside","section","details","summary"],ALLOWED_ATTR:["class","id","href","target","rel","src","alt","title","width","height","type","value","checked","selected","disabled","min","max","step","placeholder","data-command","data-command-template","data-setting-type","data-color-var","data-theme","data-settings-panel","data-graph","data-graph-src","data-graph-theme","data-graph-initialized","data-graph-error","data-speed","data-density","data-pattern","data-accent-color","data-dim-color","style","open","role","aria-label","aria-labelledby","aria-describedby","aria-valuemin","aria-valuemax","aria-valuenow","aria-valuetext","aria-live","aria-atomic","aria-current"],RETURN_DOM:!1,RETURN_DOM_FRAGMENT:!1})}class $l{headerElement;constructor(e){this.headerElement=e,this.render(),this.setupClickHandler()}render(){const e=Or.generateHeader(),t=Or.getTagline();this.headerElement.innerHTML=qn(`
...
`,kl=Object.freeze(Object.defineProperty({__proto__:null,default:Nl},Symbol.toStringTag,{value:"Module"})),Ol=`---
...
`,Ml=Object.freeze(Object.defineProperty({__proto__:null,default:Ol},Symbol.toStringTag,{value:"Module"})),Dl=`---
...
`,Pl=Object.freeze(Object.defineProperty({__proto__:null,default:Dl},Symbol.toStringTag,{value:"Module"})),Fl=`---
...
`,Bl=Object.freeze(Object.defineProperty({__proto__:null,default:Ul},Symbol.toStringTag,{value:"Module"})),Wl=`# Darin Chambers
...
`,Gl=Object.freeze(Object.defineProperty({__proto__:null,default:Wl},Symbol.toStringTag,{value:"Module"})),zl=`# Contact Information
