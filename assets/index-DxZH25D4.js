...
`)}}const r=e.join(" "),i=/^(\S+)=(.+)$/.exec(r);if(!i)return{output:`Usage: alias name='command'
       alias (to list all aliases)`,error:!0};const[,o,l]=i;try{return s.setAlias(o,l),{output:`Alias created: ${o}='${l}'`}}catch(a){return{output:a instanceof Error?a.message:String(a),error:!0}}}}}const Dr={name:"date",description:"Display current date and time",execute:(s,e)=>new V(s).hasFlag("help")?{output:`Usage: date

Description:
  Display the current date and time in the system's default format

Examples:
  date                 # Show current date and time`}:{output:new Date().toString()}},Pr={name:"echo",description:"Display a line of text",execute:(s,e)=>{if(new V(s).hasFlag("help"))return{output:`Usage: echo [options] [text...]
...
`).replace(/\\t/g,"	").replace(/\\r/g,"\r").replace(/\\b/g,"\b").replace(/\\f/g,"\f").replace(/\\v/g,"\v").replace(/\\\\/g,"\\")),{output:i}}};function Mr(s){return{name:"env",description:"Display all environment variables",execute:(e,t)=>{if(new V(e).hasFlag("help"))return{output:`Usage: env
...
`)}}catch(r){return{output:r instanceof Error?r.message:String(r),error:!0}}}}}function Hr(s){return{name:"export",description:"Set or display environment variables",execute:(e,t)=>{if(new V(e).hasFlag("help"))return{output:`Usage: export [VAR=value] [VAR]
...
`)}}catch(r){return{output:r instanceof Error?r.message:String(r),error:!0}}}}}function Fr(s){return{name:"history",description:"Display command history",execute:(e,t)=>{if(new V(e).hasFlag("help"))return{output:`Usage: history
...
`)}}function rn(){return{async:!1,breaks:!1,extensions:null,gfm:!0,hooks:null,pedantic:!1,renderer:null,silent:!1,tokenizer:null,walkTokens:null}}var Oe=rn();function er(s){Oe=s}var Je={exec:()=>null};function W(s,e=""){let t=typeof s=="string"?s:s.source,n={replace:(r,i)=>{let o=typeof i=="string"?i:i.source;return o=o.replace(ae.caret,"$1"),t=t.replace(r,o),n},getRegex:()=>new RegExp(t,e)};return n}var Wr=(()=>{try{return!!new RegExp("(?<=1)(?<!1)")}catch{return!1}})(),ae={codeRemoveIndent:/^(?: {1,4}| {0,3}\t)/gm,outputLinkReplace:/\\([\[\]])/g,indentCodeCompensation:/^(\s+)(?:```)/,beginningSpace:/^\s+/,endingHash:/#$/,startingSpaceChar:/^ /,endingSpaceChar:/ $/,nonSpaceChar:/[^ ]/,newLineCharGlobal:/\n/g,tabCharGlobal:/\t/g,multipleSpaceGlobal:/\s+/g,blankLine:/^[ \t]*$/,doubleBlankLine:/\n[ \t]*\n[ \t]*$/,blockquoteStart:/^ {0,3}>/,blockquoteSetextReplace:/\n {0,3}((?:=+|-+) *)(?=\n|$)/g,blockquoteSetextReplace2:/^ {0,3}>[ \t]?/gm,listReplaceTabs:/^\t+/,listReplaceNesting:/^ {1,4}(?=( {4})*[^ ])/g,listIsTask:/^\[[ xX]\] +\S/,listReplaceTask:/^\[[ xX]\] +/,listTaskCheckbox:/\[[ xX]\]/,anyLine:/\n.*\n/,hrefBrackets:/^<(.*)>$/,tableDelimiter:/[:|]/,tableAlignChars:/^\||\| *$/g,tableRowBlankLine:/\n[ \t]*$/,tableAlignRight:/^ *-+: *$/,tableAlignCenter:/^ *:-+: *$/,tableAlignLeft:/^ *:-+ *$/,startATag:/^<a /i,endATag:/^<\/a>/i,startPreScriptTag:/^<(pre|code|kbd|script)(\s|>)/i,endPreScriptTag:/^<\/(pre|code|kbd|script)(\s|>)/i,startAngleBracket:/^</,endAngleBracket:/>$/,pedanticHrefTitle:/^([^'"]*[^\s])\s+(['"])(.*)\2/,unicodeAlphaNumeric:/[\p{L}\p{N}]/u,escapeTest:/[&<>"']/,escapeReplace:/[&<>"']/g,escapeTestNoEncode:/[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/,escapeReplaceNoEncode:/[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/g,unescapeTest:/&(#(?:\d+)|(?:#x[0-9A-Fa-f]+)|(?:\w+));?/ig,caret:/(^|[^\[])\^/g,percentDecode:/%25/g,findPipe:/\|/g,splitPipe:/ \|/,slashPipe:/\\\|/g,carriageReturn:/\r\n|\r/g,spaceLine:/^ +$/gm,notSpaceStart:/^\S*/,endingNewline:/\n$/,listItemRegex:s=>new RegExp(`^( {0,3}${s})((?:[	 ][^\\n]*)?(?:\\n|$))`),nextBulletRegex:s=>new RegExp(`^ {0,${Math.min(3,s-1)}}(?:[*+-]|\\d{1,9}[.)])((?:[ 	][^\\n]*)?(?:\\n|$))`),hrRegex:s=>new RegExp(`^ {0,${Math.min(3,s-1)}}((?:- *){3,}|(?:_ *){3,}|(?:\\* *){3,})(?:\\n+|$)`),fencesBeginRegex:s=>new RegExp(`^ {0,${Math.min(3,s-1)}}(?:\`\`\`|~~~)`),headingBeginRegex:s=>new RegExp(`^ {0,${Math.min(3,s-1)}}#`),htmlBeginRegex:s=>new RegExp(`^ {0,${Math.min(3,s-1)}}<(?:[a-z].*>|!--)`,"i")},Ur=/^(?:[ \t]*(?:\n|$))+/,Br=/^((?: {4}| {0,3}\t)[^\n]+(?:\n(?:[ \t]*(?:\n|$))*)?)+/,Gr=/^ {0,3}(`{3,}(?=[^`\n]*(?:\n|$))|~{3,})([^\n]*)(?:\n|$)(?:|([\s\S]*?)(?:\n|$))(?: {0,3}\1[~`]* *(?=\n|$)|$)/,et=/^ {0,3}((?:-[\t ]*){3,}|(?:_[ \t]*){3,}|(?:\*[ \t]*){3,})(?:\n+|$)/,Vr=/^ {0,3}(#{1,6})(?=\s|$)(.*)(?:\n+|$)/,sn=/(?:[*+-]|\d{1,9}[.)])/,tr=/^(?!bull |blockCode|fences|blockquote|heading|html|table)((?:.|\n(?!\s*?\n|bull |blockCode|fences|blockquote|heading|html|table))+?)\n {0,3}(=+|-+) *(?:\n+|$)/,nr=W(tr).replace(/bull/g,sn).replace(/blockCode/g,/(?: {4}| {0,3}\t)/).replace(/fences/g,/ {0,3}(?:`{3,}|~{3,})/).replace(/blockquote/g,/ {0,3}>/).replace(/heading/g,/ {0,3}#{1,6}/).replace(/html/g,/ {0,3}<[^\n>]+>\n/).replace(/\|table/g,"").getRegex(),zr=W(tr).replace(/bull/g,sn).replace(/blockCode/g,/(?: {4}| {0,3}\t)/).replace(/fences/g,/ {0,3}(?:`{3,}|~{3,})/).replace(/blockquote/g,/ {0,3}>/).replace(/heading/g,/ {0,3}#{1,6}/).replace(/html/g,/ {0,3}<[^\n>]+>\n/).replace(/table/g,/ {0,3}\|?(?:[:\- ]*\|)+[\:\- ]*\n/).getRegex(),on=/^([^\n]+(?:\n(?!hr|heading|lheading|blockquote|fences|list|html|table| +\n)[^\n]+)*)/,jr=/^[^\n]+/,an=/(?!\s*\])(?:\\[\s\S]|[^\[\]\\])+/,Yr=W(/^ {0,3}\[(label)\]: *(?:\n[ \t]*)?([^<\s][^\s]*|<.*?>)(?:(?: +(?:\n[ \t]*)?| *\n[ \t]*)(title))? *(?:\n+|$)/).replace("label",an).replace("title",/(?:"(?:\\"?|[^"\\])*"|'[^'\n]*(?:\n[^'\n]+)*\n?'|\([^()]*\))/).getRegex(),Xr=W(/^( {0,3}bull)([ \t][^\n]+?)?(?:\n|$)/).replace(/bull/g,sn).getRegex(),It="address|article|aside|base|basefont|blockquote|body|caption|center|col|colgroup|dd|details|dialog|dir|div|dl|dt|fieldset|figcaption|figure|footer|form|frame|frameset|h[1-6]|head|header|hr|html|iframe|legend|li|link|main|menu|menuitem|meta|nav|noframes|ol|optgroup|option|p|param|search|section|summary|table|tbody|td|tfoot|th|thead|title|tr|track|ul",ln=/<!--(?:-?>|[\s\S]*?(?:-->|$))/,qr=W("^ {0,3}(?:<(script|pre|style|textarea)[\\s>][\\s\\S]*?(?:</\\1>[^\\n]*\\n+|$)|comment[^\\n]*(\\n+|$)|<\\?[\\s\\S]*?(?:\\?>\\n*|$)|<![A-Z][\\s\\S]*?(?:>\\n*|$)|<!\\[CDATA\\[[\\s\\S]*?(?:\\]\\]>\\n*|$)|</?(tag)(?: +|\\n|/?>)[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$)|<(?!script|pre|style|textarea)([a-z][\\w-]*)(?:attribute)*? */?>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$)|</(?!script|pre|style|textarea)[a-z][\\w-]*\\s*>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$))","i").replace("comment",ln).replace("tag",It).replace("attribute",/ +[a-zA-Z:_][\w.:-]*(?: *= *"[^"\n]*"| *= *'[^'\n]*'| *= *[^\s"'=<>`]+)?/).getRegex(),rr=W(on).replace("hr",et).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("|lheading","").replace("|table","").replace("blockquote"," {0,3}>").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)]) ").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",It).getRegex(),Kr=W(/^( {0,3}> ?(paragraph|[^\n]*)(?:\n|$))+/).replace("paragraph",rr).getRegex(),_n={blockquote:Kr,code:Br,def:Yr,fences:Gr,heading:Vr,hr:et,html:qr,lheading:nr,list:Xr,newline:Ur,paragraph:rr,table:Je,text:jr},kn=W("^ *([^\\n ].*)\\n {0,3}((?:\\| *)?:?-+:? *(?:\\| *:?-+:? *)*(?:\\| *)?)(?:\\n((?:(?! *\\n|hr|heading|blockquote|code|fences|list|html).*(?:\\n|$))*)\\n*|$)").replace("hr",et).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("blockquote"," {0,3}>").replace("code","(?: {4}| {0,3}	)[^\\n]").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)]) ").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",It).getRegex(),Zr={..._n,lheading:zr,table:kn,paragraph:W(on).replace("hr",et).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("|lheading","").replace("table",kn).replace("blockquote"," {0,3}>").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)]) ").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",It).getRegex()},Qr={..._n,html:W(`^ *(?:comment *(?:\\n|\\s*$)|<(tag)[\\s\\S]+?</\\1> *(?:\\n{2,}|\\s*$)|<tag(?:"[^"]*"|'[^']*'|\\s[^'"/>\\s]*)*?/?> *(?:\\n{2,}|\\s*$))`).replace("comment",ln).replace(/tag/g,"(?!(?:a|em|strong|small|s|cite|q|dfn|abbr|data|time|code|var|samp|kbd|sub|sup|i|b|u|mark|ruby|rt|rp|bdi|bdo|span|br|wbr|ins|del|img)\\b)\\w+(?!:|[^\\w\\s@]*@)\\b").getRegex(),def:/^ *\[([^\]]+)\]: *<?([^\s>]+)>?(?: +(["(][^\n]+[")]))? *(?:\n+|$)/,heading:/^(#{1,6})(.*)(?:\n+|$)/,fences:Je,lheading:/^(.+?)\n {0,3}(=+|-+) *(?:\n+|$)/,paragraph:W(on).replace("hr",et).replace("heading",` *#{1,6} *[^
]`).replace("lheading",nr).replace("|table","").replace("blockquote"," {0,3}>").replace("|fences","").replace("|list","").replace("|html","").replace("|tag","").getRegex()},Jr=/^\\([!"#$%&'()*+,\-./:;<=>?@\[\]\\^_`{|}~])/,es=/^(`+)([^`]|[^`][\s\S]*?[^`])\1(?!`)/,sr=/^( {2,}|\\)\n(?!\s*$)/,ts=/^(`+|[^`])(?:(?= {2,}\n)|[\s\S]*?(?:(?=[\\<!\[`*_]|\b_|$)|[^ ](?= {2,}\n)))/,yt=/[\p{P}\p{S}]/u,cn=/[\s\p{P}\p{S}]/u,ir=/[^\s\p{P}\p{S}]/u,ns=W(/^((?![*_])punctSpace)/,"u").replace(/punctSpace/g,cn).getRegex(),or=/(?!~)[\p{P}\p{S}]/u,rs=/(?!~)[\s\p{P}\p{S}]/u,ss=/(?:[^\s\p{P}\p{S}]|~)/u,is=W(/link|precode-code|html/,"g").replace("link",/\[(?:[^\[\]`]|(?<a>`+)[^`]+\k<a>(?!`))*?\]\((?:\\[\s\S]|[^\\\(\)]|\((?:\\[\s\S]|[^\\\(\)])*\))*\)/).replace("precode-",Wr?"(?<!`)()":"(^^|[^`])").replace("code",/(?<b>`+)[^`]+\k<b>(?!`)/).replace("html",/<(?! )[^<>]*?>/).getRegex(),ar=/^(?:\*+(?:((?!\*)punct)|[^\s*]))|^_+(?:((?!_)punct)|([^\s_]))/,os=W(ar,"u").replace(/punct/g,yt).getRegex(),as=W(ar,"u").replace(/punct/g,or).getRegex(),lr="^[^_*]*?__[^_*]*?\\*[^_*]*?(?=__)|[^*]+(?=[^*])|(?!\\*)punct(\\*+)(?=[\\s]|$)|notPunctSpace(\\*+)(?!\\*)(?=punctSpace|$)|(?!\\*)punctSpace(\\*+)(?=notPunctSpace)|[\\s](\\*+)(?!\\*)(?=punct)|(?!\\*)punct(\\*+)(?!\\*)(?=punct)|notPunctSpace(\\*+)(?=notPunctSpace)",ls=W(lr,"gu").replace(/notPunctSpace/g,ir).replace(/punctSpace/g,cn).replace(/punct/g,yt).getRegex(),_s=W(lr,"gu").replace(/notPunctSpace/g,ss).replace(/punctSpace/g,rs).replace(/punct/g,or).getRegex(),cs=W("^[^_*]*?\\*\\*[^_*]*?_[^_*]*?(?=\\*\\*)|[^_]+(?=[^_])|(?!_)punct(_+)(?=[\\s]|$)|notPunctSpace(_+)(?!_)(?=punctSpace|$)|(?!_)punctSpace(_+)(?=notPunctSpace)|[\\s](_+)(?!_)(?=punct)|(?!_)punct(_+)(?!_)(?=punct)","gu").replace(/notPunctSpace/g,ir).replace(/punctSpace/g,cn).replace(/punct/g,yt).getRegex(),us=W(/\\(punct)/,"gu").replace(/punct/g,yt).getRegex(),hs=W(/^<(scheme:[^\s\x00-\x1f<>]*|email)>/).replace("scheme",/[a-zA-Z][a-zA-Z0-9+.-]{1,31}/).replace("email",/[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+(@)[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)+(?![-_])/).getRegex(),ds=W(ln).replace("(?:-->|$)","-->").getRegex(),ms=W("^comment|^</[a-zA-Z][\\w:-]*\\s*>|^<[a-zA-Z][\\w-]*(?:attribute)*?\\s*/?>|^<\\?[\\s\\S]*?\\?>|^<![a-zA-Z]+\\s[\\s\\S]*?>|^<!\\[CDATA\\[[\\s\\S]*?\\]\\]>").replace("comment",ds).replace("attribute",/\s+[a-zA-Z:_][\w.:-]*(?:\s*=\s*"[^"]*"|\s*=\s*'[^']*'|\s*=\s*[^\s"'=<>`]+)?/).getRegex(),$t=/(?:\[(?:\\[\s\S]|[^\[\]\\])*\]|\\[\s\S]|`+[^`]*?`+(?!`)|[^\[\]\\`])*?/,ps=W(/^!?\[(label)\]\(\s*(href)(?:(?:[ \t]*(?:\n[ \t]*)?)(title))?\s*\)/).replace("label",$t).replace("href",/<(?:\\.|[^\n<>\\])+>|[^ \t\n\x00-\x1f]*/).replace("title",/"(?:\\"?|[^"\\])*"|'(?:\\'?|[^'\\])*'|\((?:\\\)?|[^)\\])*\)/).getRegex(),_r=W(/^!?\[(label)\]\[(ref)\]/).replace("label",$t).replace("ref",an).getRegex(),cr=W(/^!?\[(ref)\](?:\[\])?/).replace("ref",an).getRegex(),fs=W("reflink|nolink(?!\\()","g").replace("reflink",_r).replace("nolink",cr).getRegex(),vn=/[hH][tT][tT][pP][sS]?|[fF][tT][pP]/,un={_backpedal:Je,anyPunctuation:us,autolink:hs,blockSkip:is,br:sr,code:es,del:Je,emStrongLDelim:os,emStrongRDelimAst:ls,emStrongRDelimUnd:cs,escape:Jr,link:ps,nolink:cr,punctuation:ns,reflink:_r,reflinkSearch:fs,tag:ms,text:ts,url:Je},$s={...un,link:W(/^!?\[(label)\]\((.*?)\)/).replace("label",$t).getRegex(),reflink:W(/^!?\[(label)\]\s*\[([^\]]*)\]/).replace("label",$t).getRegex()},Yt={...un,emStrongRDelimAst:_s,emStrongLDelim:as,url:W(/^((?:protocol):\/\/|www\.)(?:[a-zA-Z0-9\-]+\.?)+[^\s<]*|^email/).replace("protocol",vn).replace("email",/[A-Za-z0-9._+-]+(@)[a-zA-Z0-9-_]+(?:\.[a-zA-Z0-9-_]*[a-zA-Z0-9])+(?![-_])/).getRegex(),_backpedal:/(?:[^?!.,:;*_'"~()&]+|\([^)]*\)|&(?![a-zA-Z0-9]+;$)|[?!.,:;*_'"~)]+(?!$))+/,del:/^(~~?)(?=[^\s~])((?:\\[\s\S]|[^\\])*?(?:\\[\s\S]|[^\s~\\]))\1(?=[^~]|$)/,text:W(/^([`~]+|[^`~])(?:(?= {2,}\n)|(?=[a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-]+@)|[\s\S]*?(?:(?=[\\<!\[`*~_]|\b_|protocol:\/\/|www\.|$)|[^ ](?= {2,}\n)|[^a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-](?=[a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-]+@)))/).replace("protocol",vn).getRegex()},gs={...Yt,br:W(sr).replace("{2,}","*").getRegex(),text:W(Yt.text).replace("\\b_","\\b_| {2,}\\n").replace(/\{2,\}/g,"*").getRegex()},ht={normal:_n,gfm:Zr,pedantic:Qr},ze={normal:un,gfm:Yt,breaks:gs,pedantic:$s},Ts={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},On=s=>Ts[s];function we(s,e){if(e){if(ae.escapeTest.test(s))return s.replace(ae.escapeReplace,On)}else if(ae.escapeTestNoEncode.test(s))return s.replace(ae.escapeReplaceNoEncode,On);return s}function Dn(s){try{s=encodeURI(s).replace(ae.percentDecode,"%")}catch{return null}return s}function Pn(s,e){let t=s.replace(ae.findPipe,(i,o,l)=>{let a=!1,p=o;for(;--p>=0&&l[p]==="\\";)a=!a;return a?"|":" |"}),n=t.split(ae.splitPipe),r=0;if(n[0].trim()||n.shift(),n.length>0&&!n.at(-1)?.trim()&&n.pop(),e)if(n.length>e)n.splice(e);else for(;n.length<e;)n.push("");for(;r<n.length;r++)n[r]=n[r].trim().replace(ae.slashPipe,"|");return n}function je(s,e,t){let n=s.length;if(n===0)return"";let r=0;for(;r<n&&s.charAt(n-r-1)===e;)r++;return s.slice(0,n-r)}function Ls(s,e){if(s.indexOf(e[1])===-1)return-1;let t=0;for(let n=0;n<s.length;n++)if(s[n]==="\\")n++;else if(s[n]===e[0])t++;else if(s[n]===e[1]&&(t--,t<0))return n;return t>0?-2:-1}function Mn(s,e,t,n,r){let i=e.href,o=e.title||null,l=s[1].replace(r.other.outputLinkReplace,"$1");n.state.inLink=!0;let a={type:s[0].charAt(0)==="!"?"image":"link",raw:t,href:i,title:o,text:l,tokens:n.inlineTokens(l)};return n.state.inLink=!1,a}function Es(s,e,t){let n=s.match(t.other.indentCodeCompensation);if(n===null)return e;let r=n[1];return e.split(`
...
${p}`:p,r=r?`${r}
${h}`:h;let A=this.lexer.state.top;if(this.lexer.state.top=!0,this.lexer.blockTokens(h,i,!0),this.lexer.state.top=A,t.length===0)break;let E=i.at(-1);if(E?.type==="code")break;if(E?.type==="blockquote"){let C=E,M=C.raw+`
`+t.join(`
...
`,1)[0],C=!A.trim(),M=0;if(this.options.pedantic?(M=2,h=A.trimStart()):C?M=e[1].length+1:(M=e[2].search(this.rules.other.nonSpaceChar),M=M>4?1:M,h=A.slice(M),M+=e[1].length),C&&this.rules.other.blankLine.test(E)&&(p+=E+`
...
Try 'render --help' for more information`,error:!0};const i=r.trim().startsWith("---");return{output:oe.render(r,i),html:!0}}}}function Rs(s){return{name:"unalias",description:"Remove command aliases",execute:(e,t)=>{if(new V(e).hasFlag("help"))return{output:`Usage: unalias <name>
...
Try 'unalias --help' for more information.`,error:!0};const r=e[0];return s.removeAlias(r)?{output:`Alias removed: ${r}`}:{output:`unalias: ${r}: not found`,error:!0}}}}const Ss=new Set(["about","portfolio","blog","contact","settings"]);function bs(s,e){return{name:"which",description:"Locate a command and display its path",execute:(t,n)=>{const r=new V(t);if(r.hasFlag("help"))return{output:`Usage: which [-a] <command> [command ...]
...
Usage: which [-a] <command> [command ...]`,error:!0};const o=r.hasFlag("a"),l=[];let a=!1;for(const h of i){const A=Cs(h,s,e,o);A.error&&(a=!0),l.push(A.output)}const p={output:l.join(`
`)};return a&&(p.error=!0),p}}}function Cs(s,e,t,n){const r=[],i=t.getAlias(s);if(i&&(r.push(`${s}: aliased to ${i}`),!n))return{output:r.join(`
`)};if(e.getCommandNames().includes(s.toLowerCase())){const a=Ss.has(s.toLowerCase())?`/usr/local/bin/${s}`:`/usr/bin/${s}`;r.push(a)}return r.length===0?{output:`which: ${s}: command not found`,error:!0}:{output:r.join(`
`)}}function ws(s){return{name:"whoami",description:"Display current username",execute:(e,t)=>new V(e).hasFlag("help")?{output:`Usage: whoami

Description:
  Display the current username

Examples:
  whoami               # Show current user`}:{output:s.getUsername()}}}function Ns(s){return{name:"cat",description:"Display file contents",execute:(e,t)=>{if(new V(e).hasFlag("help"))return{output:`Usage: cat <file>
...
Try 'cat --help' for more information`,error:!0};try{return{output:s.readFile(e[0])}}catch(r){return{output:r instanceof Error?r.message:String(r),error:!0}}}}}function xs(s,e,t){return{name:"cd",description:"Change directory (supports - for previous directory)",execute:(n,r)=>{if(new V(n).hasFlag("help"))return{output:`Usage: cd [directory]
...
Examples:
  ...
  cd -                 # Go to previous directory`};try{let o=n[0]||"~";if(o==="-"&&t){const l=t.getVariable("OLDPWD");if(!l)return{output:"cd: OLDPWD not set",error:!0};o=l}if(t){const l=t.getVariable("PWD")??s.getCurrentPath();t.setVariable("OLDPWD",l)}return s.changeDirectory(o),t&&t.setVariable("PWD",s.getCurrentPath()),e(s.getShortPath()),{output:""}}catch(o){return{output:o instanceof Error?o.message:String(o),error:!0}}}}}function ks(s,e){if(!e)return s.toString();const t=["B","K","M","G","T"];let n=s,r=0;for(;n>=1024&&r<t.length-1;)n/=1024,r++;return`${r===0?n.toString():n.toFixed(1)}${t[r]}`}function vs(s){const t=["Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"][s.getMonth()],n=s.getDate().toString().padStart(2," "),r=s.getHours().toString().padStart(2,"0"),i=s.getMinutes().toString().padStart(2,"0");return`${t} ${n} ${r}:${i}`}function Hn(s,e){const t=s.permissions??"-rw-r--r--",n="1",r=s.owner??"darin",i="staff",o=ks(s.size??0,e),l=vs(s.modifiedTime??new Date),a=s.name,p=o.padStart(6," ");return`${t}  ${n} ${r}  ${i}  ${p} ${l} ${a}`}function Os(s){const e=s.reduce((t,n)=>t+(n.size??0),0);return Math.ceil(e/512)}function Ds(s){return{name:"ls",description:"List directory contents",execute:(e,t)=>{try{const n=new V(e);if(n.hasFlag("help"))return{output:`Usage: ls [options] [path]
...
Try 'ls --help' for more information`,error:!0};if(a.type==="file")return o?{output:Hn(a,l)}:{output:a.name};if(!a.children)return{output:""};let p=Array.from(a.children.values());return i||(p=p.filter(h=>!h.isHidden)),p.length===0?{output:""}:(p.sort((h,A)=>h.name.localeCompare(A.name)),o?{output:[`total ${Os(p)}`,...p.map(E=>Hn(E,l))].join(`
`)}:{output:p.map(A=>A.name).join("  ")})}catch(n){return{output:n instanceof Error?n.message:String(n),error:!0}}}}}function Ps(s){return{name:"pwd",description:"Print working directory",execute:(e,t)=>new V(e).hasFlag("help")?{output:`Usage: pwd

Description:
  Print current working directory path

Examples:
  pwd                  # Show current directory`}:{output:s.getCurrentPath()}}}function Ms(s){return{name:"tree",description:"Display directory tree structure",execute:(e,t)=>{try{const n=new V(e);if(n.hasFlag("help"))return{output:`Usage: tree [options] [path]
...
`),scrollBehavior:"top"}}catch(n){return{output:n instanceof Error?n.message:String(n),error:!0}}}}}const Ie={HOME_DARIN:"/home/darin",HOME_GUEST:"/home/guest",CONTENT_BLOG:"/home/darin/blog",CONTENT_PORTFOLIO:"/home/darin/portfolio",CONTENT_HELP:"/home/darin/content/help.md",CONTENT_ABOUT:"/home/darin/content/about.md",CONTENT_CONTACT:"/home/darin/content/contact.md",CONFIG_ALIASES:"/home/guest/.alias",CONFIG_SETTINGS:"/home/darin/.settings",CONFIG_ENV:"/home/darin/.env"},ur={CLEAR_SCREEN:"__CLEAR__"},Kt={SETTINGS:"terminal_settings",ENVIRONMENT:"terminal_env_vars"},Lt={EMPTY_PORTFOLIO:"No portfolio projects yet. Check back soon!",EMPTY_BLOG:"No blog posts yet. Check back soon!",NO_TAGS_AVAILABLE:"No tags available yet."},Hs={theme:{preset:"dc",customColors:void 0},font:{size:16,family:"Fira Code"},effects:{scanLines:!1,glow:!1,border:!0,animationSpeed:1,soundEffects:!1,autoScrollBehavior:!0},prompt:{format:"\\W \\$ "}};function Fs(s){return{name:"about",description:"Display bio and expertise overview",execute:(e,t)=>{if(new V(e).hasFlag("help"))return{output:`Usage: about

Description:
  Display professional bio and expertise overview

Examples:
  about                # Show bio and background`};try{const r=s.readFile(Ie.CONTENT_ABOUT);return{output:oe.render(r),html:!0,scrollBehavior:"top"}}catch(r){return{output:r instanceof Error?r.message:String(r),error:!0}}}}}function Ws(s){if(typeof s!="object"||s===null)return!1;const e=s;return typeof e.title=="string"&&typeof e.date=="string"&&typeof e.summary=="string"&&Array.isArray(e.tags)&&e.tags.every(t=>typeof t=="string")}class hr{static parseFrontmatter(e){const t=e.split(`
`);if(t[0]?.trim()!=="---")throw new Error("Invalid frontmatter: must start with ---");let n=-1;for(let l=1;l<t.length;l++)if(t[l].trim()==="---"){n=l;break}if(n===-1)throw new Error("Invalid frontmatter: no closing ---");const r=t.slice(1,n),i=t.slice(n+1),o={};for(const l of r){const a=l.indexOf(":");if(a===-1)continue;const p=l.substring(0,a).trim(),h=l.substring(a+1).trim();if(h.startsWith("[")&&h.endsWith("]")){const A=h.substring(1,h.length-1);o[p]=A.split(",").map(E=>E.trim().replace(/^["']|["']$/g,"")).filter(E=>E.length>0)}else o[p]=h.replace(/^["']|["']$/g,"")}if(!Ws(o)){const l=[];throw o.title||l.push("title"),o.date||l.push("date"),o.summary||l.push("summary"),Array.isArray(o.tags)||l.push("tags"),new Error(`Invalid blog frontmatter: missing or invalid fields: ${l.join(", ")}`)}return{frontmatter:o,markdown:i.join(`
`).trim()}}static parseBlogPost(e,t){const{frontmatter:n,markdown:r}=this.parseFrontmatter(t);return{id:e.replace(/^\d{4}-\d{2}-\d{2}-/,"").replace(/\.md$/,""),title:n.title,date:n.date,summary:n.summary,content:r,tags:n.tags}}static getIdFromFilename(e){return e.replace(/^\d{4}-\d{2}-\d{2}-/,"").replace(/\.md$/,"")}}class Et{static formatClickableTag(e,t){return`<button data-command="${t==="portfolio"?`portfolio --tags ${e}`:`blog --tags ${e}`}" class="tag-link">${e}</button>`}static formatPortfolioList(e,t){const n=t?`# Portfolio - Tag: ${t}`:"# Portfolio",r=e.map((o,l)=>{const a=o.tags?.map(h=>this.formatClickableTag(h,"portfolio")).join(" ")??"",p=a?`
...
<a href="/portfolio" data-command="portfolio">← Back to Portfolio</a>`}static formatBlogList(e,t){const n=t?`# Blog Posts - Tag: ${t}`:"# Blog Posts",r=e.map((o,l)=>{const a=o.tags.map(h=>this.formatClickableTag(h,"blog")).join(" "),p=e.length-l;return`### <a href="/blog/${o.id}" data-command="blog ${o.id}">${p}. ${o.title}</a>
...
<a href="/blog" data-command="blog">← Back to Blog</a>`}}function Us(s){return{name:"blog",description:"List and read blog posts",execute:(e,t)=>{const n=new V(e);if(n.hasFlag("help"))return{output:`Usage: blog [options] [post-id|number]
...
Examples:
  ...
  blog post-id                  # Read specific post by ID`};const r=Ie.CONTENT_BLOG;try{const o=s.list(r).filter(N=>N.endsWith(".md")).sort().reverse(),l=n.getFlag("tags"),a=n.hasFlag("tags"),p=n.getPositional(0),h=[];for(const N of o){const R=s.readFile(`${r}/${N}`),x=hr.parseBlogPost(N,R);h.push(x)}if(h.length===0&&!a&&!p){const N=`# Blog

${Lt.EMPTY_BLOG}`;return{output:oe.render(N),html:!0,scrollBehavior:"top"}}if(a&&(typeof l=="boolean"||!l)){const N=new Set,R=new Map;h.forEach(D=>{D.tags?.forEach(z=>{N.add(z),R.set(z,(R.get(z)??0)+1)})});const x=Array.from(N).sort();if(x.length===0){const D=`# Blog Tags

${Lt.NO_TAGS_AVAILABLE}`;return{output:oe.render(D),html:!0,scrollBehavior:"top"}}const U=`# Blog Tags

${x.map(D=>{const z=R.get(D)??0;return`- <button data-command="blog --tags ${D}" class="tag-link">${D}</button> (${z} post${z!==1?"s":""})`}).join(`
`)}

---

**Usage:** Type \`blog --tags <tag>\` to filter posts`;return{output:oe.render(U),html:!0,scrollBehavior:"top"}}if(p){let N;const R=parseInt(p,10);if(!isNaN(R)&&R>0&&R<=h.length){const U=h.length-R;N=h[U]}else N=h.find(U=>U.id===p);if(!N)return{output:`Blog post '${p}' not found.
Use 'blog' to list all posts.
Try 'blog --help' for more information`,error:!0};const x=Et.formatBlogPost(N);return{output:oe.render(x),html:!0,scrollBehavior:"top"}}let A=h;const E=typeof l=="string"?l:void 0;if(E&&(A=h.filter(N=>N.tags.some(R=>R.toLowerCase()===E.toLowerCase())),A.length===0)){const N=new Map;h.forEach(B=>{B.tags?.forEach(U=>{N.set(U,(N.get(U)??0)+1)})});const R=Array.from(N.entries()).sort((B,U)=>U[1]-B[1]).slice(0,5).map(([B])=>B),x=R.length>0?`
Try one of these tags: ${R.join(", ")}`:"";return{output:`No blog posts found with tag '${E}'.${x}
Use 'blog' to see all posts.`,error:!1}}const C=Et.formatBlogList(A,E);return{output:oe.render(C),html:!0,scrollBehavior:"top"}}catch(i){return{output:i instanceof Error?i.message:String(i),error:!0}}}}}function Bs(s){return{name:"contact",description:"Display contact information",execute:(e,t)=>{if(new V(e).hasFlag("help"))return{output:`Usage: contact

Description:
  Display contact information and professional links

Examples:
  contact              # Show contact details`};try{const r=s.readFile(Ie.CONTENT_CONTACT);return{output:oe.render(r),html:!0}}catch(r){return{output:r instanceof Error?r.message:String(r),error:!0}}}}}function Gs(s){if(typeof s!="object"||s===null)return!1;const e=s;return typeof e.id=="string"&&typeof e.title=="string"&&typeof e.summary=="string"&&typeof e.year=="string"&&typeof e.order=="number"&&Array.isArray(e.technologies)&&e.technologies.every(t=>typeof t=="string")&&(e.impact===void 0||typeof e.impact=="string")&&(e.tags===void 0||Array.isArray(e.tags)&&e.tags.every(t=>typeof t=="string"))}class Vs{static parseFrontmatter(e){const t=e.split(`
`);if(t[0]?.trim()!=="---")throw new Error("Invalid frontmatter: must start with ---");let n=-1;for(let l=1;l<t.length;l++)if(t[l].trim()==="---"){n=l;break}if(n===-1)throw new Error("Invalid frontmatter: no closing ---");const r=t.slice(1,n),i=t.slice(n+1),o={};for(const l of r){const a=l.indexOf(":");if(a===-1)continue;const p=l.substring(0,a).trim(),h=l.substring(a+1).trim();if(h.startsWith("[")&&h.endsWith("]")){const A=h.substring(1,h.length-1);o[p]=A.split(",").map(E=>E.trim().replace(/^["']|["']$/g,"")).filter(E=>E.length>0)}else{const A=h.replace(/^["']|["']$/g,"");if(p==="order"){const E=Number(A);o[p]=isNaN(E)?A:E}else o[p]=A}}if(!Gs(o)){const l=[];throw o.id||l.push("id"),o.title||l.push("title"),o.summary||l.push("summary"),o.year||l.push("year"),typeof o.order!="number"&&l.push("order"),Array.isArray(o.technologies)||l.push("technologies"),new Error(`Invalid portfolio frontmatter: missing or invalid fields: ${l.join(", ")}`)}return{frontmatter:o,markdown:i.join(`
`).trim()}}static parseProject(e,t){const{frontmatter:n,markdown:r}=this.parseFrontmatter(t);return{id:n.id||e.replace(/\.md$/,""),title:n.title,summary:n.summary,description:r,technologies:n.technologies,impact:n.impact,year:n.year,order:n.order,tags:n.tags}}static getIdFromFilename(e){return e.replace(/\.md$/,"")}}function zs(s){return{name:"portfolio",description:"Showcase projects and accomplishments",execute:(e,t)=>{const n=new V(e);if(n.hasFlag("help"))return{output:`Usage: portfolio [options] [project-id|number]
...
Examples:
  ...
  portfolio proj-id             # View specific project by ID`};const r=Ie.CONTENT_PORTFOLIO;try{const o=s.list(r).filter(R=>R.endsWith(".md")),l=n.getFlag("tags"),a=n.hasFlag("tags"),p=n.getPositional(0),h=[];for(const R of o){const x=s.readFile(`${r}/${R}`);if(x)try{const B=Vs.parseProject(R,x);h.push(B)}catch(B){console.error(`Error parsing ${R}:`,B)}}if(h.sort((R,x)=>R.order!==x.order?R.order-x.order:R.title.localeCompare(x.title)),h.length===0&&!a&&!p){const R=`# Portfolio

${Lt.EMPTY_PORTFOLIO}`;return{output:oe.render(R),html:!0,scrollBehavior:"top"}}if(a&&(typeof l=="boolean"||!l)){const R=new Set,x=new Map;h.forEach(z=>{z.tags?.forEach(ee=>{R.add(ee),x.set(ee,(x.get(ee)??0)+1)})});const B=Array.from(R).sort();if(B.length===0){const z=`# Portfolio Tags

${Lt.NO_TAGS_AVAILABLE}`;return{output:oe.render(z),html:!0,scrollBehavior:"top"}}const H=`# Portfolio Tags
...
Examples:
  ...
  settings reset       # Reset all settings`};if(n.length===0)return{output:dr(e,t),html:!0};const o=i.getPositional(0);switch(o){case"list":return Zs(e,t);case"set":return Fn(i,e,t);case"reset":return Qs(e,t);case"theme":case"font-size":case"font-family":case"fontSize":case"fontFamily":case"scan-lines":case"scanLines":case"glow":case"border":case"animation-speed":case"animationSpeed":case"sound":case"auto-scroll":case"autoScroll":case"prompt":return Fn(new V(["set",o,...n.slice(1)]),e,t);default:return{output:`Unknown subcommand: ${o}.
Try 'settings --help' for more information`,error:!0}}}}}function Zs(s,e){const t=Js(s,e);return{output:oe.render(t),html:!0}}function Fn(s,e,t){const n=s.getPositional(1),r=s.getPositional(2);if(!n)return{output:`Usage: settings set <setting> <value>
...
- \\\\d = current date
`}function Zt(s){const e=s.getSetting("font");typeof document<"u"&&(document.documentElement.style.setProperty("--terminal-font-size",`${e.size}px`),document.documentElement.style.setProperty("--terminal-font-family",e.family))}function mr(s){typeof document<"u"&&(s?document.body.classList.remove("no-scan-lines"):document.body.classList.add("no-scan-lines"))}function pr(s){typeof document<"u"&&(s?document.body.classList.remove("no-glow"):document.body.classList.add("no-glow"))}function fr(s){typeof document<"u"&&(s?document.body.classList.add("border-enabled"):document.body.classList.remove("border-enabled"))}function $r(s){typeof document<"u"&&document.documentElement.style.setProperty("--terminal-animation-speed",s.toString())}function fe(){if(typeof document<"u"){const s=new CustomEvent("settings-changed");document.dispatchEvent(s)}}const ei=["Chaos","Discord","Confusion","Bureaucracy","The Aftermath"],ti=["Sweetmorn","Boomtime","Pungenday","Prickle-Prickle","Setting Orange"],ni=["Mungday","Mojoday","Syadday","Zaraday","Malbowday"],Wn=73,ri=1166;function Qt(s){return s%4===0&&s%100!==0||s%400===0}function si(s,e,t){const n=[31,28,31,30,31,30,31,31,30,31,30,31];Qt(s)&&(n[1]=29);let r=t;for(let i=0;i<e-1;i++)r+=n[i];return r}function ii(s){const e=s.getFullYear(),t=s.getMonth()+1,n=s.getDate(),r=e+ri,i=si(e,t,n);if(Qt(e)&&t===2&&n===29)return{weekday:"",season:"",dayOfSeason:0,yold:r,isStTibsDay:!0};let o=i;Qt(e)&&i>60&&(o=i-1);const l=Math.floor((o-1)/Wn),a=ei[l],p=(o-1)%Wn+1,h=(o-1)%5,A=ti[h],E=p===5?ni[l]:void 0;return{weekday:A,season:a,dayOfSeason:p,yold:r,isStTibsDay:!1,apostleDay:E}}function oi(s){return s.isStTibsDay?`St. Tib's Day, ${s.yold} YOLD`:s.apostleDay?`${s.weekday}, ${s.apostleDay}, day ${s.dayOfSeason} of ${s.season}, ${s.yold} YOLD`:`${s.weekday}, ${s.season} ${s.dayOfSeason}, ${s.yold} YOLD`}function ai(s){if(/^\d{4}-\d{2}-\d{2}$/.test(s)){const e=new Date(s);if(!isNaN(e.getTime()))return e}if(/^\d{1,2}\/\d{1,2}\/\d{4}$/.test(s)){const e=new Date(s);if(!isNaN(e.getTime()))return e}return null}function li(s,e,t){if(s<1||s>31||e<1||e>12||t<1)return null;const n=new Date(t,e-1,s);return isNaN(n.getTime())?null:n}const _i={name:"ddate",description:"Display date in Discordian calendar",execute:(s,e)=>{const t=new V(s);if(t.hasFlag("help"))return{output:`Usage: ddate [DATE]
...
Options:
  --help                   Display this help message`};let n;if(t.positionalCount===0)n=new Date;else if(t.positionalCount===1){const o=t.getPositional(0),l=ai(o);if(!l)return{output:`ddate: invalid date '${o}'`,error:!0};n=l}else if(t.positionalCount===3){const o=parseInt(t.getPositional(0),10),l=parseInt(t.getPositional(1),10),a=parseInt(t.getPositional(2),10);if(isNaN(l)||isNaN(o)||isNaN(a))return{output:"ddate: invalid numeric date arguments",error:!0};const p=li(l,o,a);if(!p)return{output:`ddate: invalid date ${o}/${l}/${a}`,error:!0};n=p}else return{output:`ddate: invalid arguments
Try 'ddate --help' for more information.`,error:!0};const r=ii(n);return{output:oi(r)}}},ci={FULL_WIDTH:0,FITTING:1,SMUSHING:2,CONTROLLED_SMUSHING:3};class ui{constructor(){this.comment="",this.numChars=0,this.options={}}}const Wt=["1Row","3-D","3D Diagonal","3D-ASCII","3x5","4Max","5 Line Oblique","AMC 3 Line","AMC 3 Liv1","AMC AAA01","AMC Neko","AMC Razor","AMC Razor2","AMC Slash","AMC Slider","AMC Thin","AMC Tubes","AMC Untitled","ANSI Regular","ANSI Shadow","ANSI-Compact","ASCII 12","ASCII 9","ASCII New Roman","Acrobatic","Alligator","Alligator2","Alpha","Alphabet","Arrows","Avatar","B1FF","Babyface Lame","Babyface Leet","Banner","Banner3-D","Banner3","Banner4","Barbwire","Basic","Bear","Bell","Benjamin","Big ASCII 12","Big ASCII 9","Big Chief","Big Money-ne","Big Money-nw","Big Money-se","Big Money-sw","Big Mono 12","Big Mono 9","Big","Bigfig","Binary","Block","Blocks","Bloody","BlurVision ASCII","Bolger","Braced","Bright","Broadway KB","Broadway","Bubble","Bulbhead","Caligraphy","Caligraphy2","Calvin S","Cards","Catwalk","Chiseled","Chunky","Circle","Coinstak","Cola","Colossal","Computer","Contessa","Contrast","Cosmike","Cosmike2","Crawford","Crawford2","Crazy","Cricket","Cursive","Cyberlarge","Cybermedium","Cybersmall","Cygnet","DANC4","DOS Rebel","DWhistled","Dancing Font","Decimal","Def Leppard","Delta Corps Priest 1","DiamFont","Diamond","Diet Cola","Digital","Doh","Doom","Dot Matrix","Double Shorts","Double","Dr Pepper","Efti Chess","Efti Font","Efti Italic","Efti Piti","Efti Robot","Efti Wall","Efti Water","Electronic","Elite","Emboss 2","Emboss","Epic","Fender","Filter","Fire Font-k","Fire Font-s","Flipped","Flower Power","Four Tops","Fraktur","Fun Face","Fun Faces","Future","Fuzzy","Georgi16","Georgia11","Ghost","Ghoulish","Glenyn","Goofy","Gothic","Graceful","Gradient","Graffiti","Greek","Heart Left","Heart Right","Henry 3D","Hex","Hieroglyphs","Hollywood","Horizontal Left","Horizontal Right","ICL-1900","Impossible","Invita","Isometric1","Isometric2","Isometric3","Isometric4","Italic","Ivrit","JS Block Letters","JS Bracket Letters","JS Capital Curves","JS Cursive","JS Stick Letters","Jacky","Jazmine","Jerusalem","Katakana","Kban","Keyboard","Knob","Konto Slant","Konto","LCD","Larry 3D 2","Larry 3D","Lean","Letter","Letters","Lil Devil","Line Blocks","Linux","Lockergnome","Madrid","Marquee","Maxfour","Merlin1","Merlin2","Mike","Mini","Mirror","Mnemonic","Modular","Mono 12","Mono 9","Morse","Morse2","Moscow","Mshebrew210","Muzzle","NScript","NT Greek","NV Script","Nancyj-Fancy","Nancyj-Improved","Nancyj-Underlined","Nancyj","Nipples","O8","OS2","Octal","Ogre","Old Banner","Pagga","Patorjk's Cheese","Patorjk-HeX","Pawp","Peaks Slant","Peaks","Pebbles","Pepper","Poison","Puffy","Puzzle","Pyramid","Rammstein","Rebel","Rectangles","Red Phoenix","Relief","Relief2","Reverse","Roman","Rot13","Rotated","Rounded","Rowan Cap","Rozzo","RubiFont","Runic","Runyc","S Blood","SL Script","Santa Clara","Script","Serifcap","Shaded Blocky","Shadow","Shimrod","Short","Slant Relief","Slant","Slide","Small ASCII 12","Small ASCII 9","Small Block","Small Braille","Small Caps","Small Isometric1","Small Keyboard","Small Mono 12","Small Mono 9","Small Poison","Small Script","Small Shadow","Small Slant","Small Tengwar","Small","Soft","Speed","Spliff","Stacey","Stampate","Stampatello","Standard","Star Strips","Star Wars","Stellar","Stforek","Stick Letters","Stop","Straight","Stronger Than All","Sub-Zero","Swamp Land","Swan","Sweet","THIS","Tanja","Tengwar","Term","Terrace","Test1","The Edge","Thick","Thin","Thorned","Three Point","Ticks Slant","Ticks","Tiles","Tinker-Toy","Tmplr","Tombstone","Train","Trek","Tsalagi","Tubular","Twisted","Two Point","USA Flag","Univers","Upside Down Text","Varsity","Wavescape","Wavy","Weird","Wet Letter","Whimsy","WideTerm","Wow","miniwi"];function hi(s){return/[.*+?^${}()|[\]\\]/.test(s)?"\\"+s:s}const tt=(()=>{const{FULL_WIDTH:s=0,FITTING:e,SMUSHING:t,CONTROLLED_SMUSHING:n}=ci,r={},i={font:"Standard",fontPath:"./fonts",fetchFontIfMissing:!0};function o(d,m,_){const u=hi(d.trim().slice(-1))||"@",f=m===_-1?new RegExp(u+u+"?\\s*$"):new RegExp(u+"\\s*$");return d.replace(f,"")}function l(d=-1,m=null){let _={},u,f=[[16384,"vLayout",t],[8192,"vLayout",e],[4096,"vRule5",!0],[2048,"vRule4",!0],[1024,"vRule3",!0],[512,"vRule2",!0],[256,"vRule1",!0],[128,"hLayout",t],[64,"hLayout",e],[32,"hRule6",!0],[16,"hRule5",!0],[8,"hRule4",!0],[4,"hRule3",!0],[2,"hRule2",!0],[1,"hRule1",!0]];u=m!==null?m:d;for(const[g,T,L]of f)u>=g?(u-=g,_[T]===void 0&&(_[T]=L)):T!=="vLayout"&&T!=="hLayout"&&(_[T]=!1);return typeof _.hLayout>"u"?d===0?_.hLayout=e:d===-1?_.hLayout=s:_.hRule1||_.hRule2||_.hRule3||_.hRule4||_.hRule5||_.hRule6?_.hLayout=n:_.hLayout=t:_.hLayout===t&&(_.hRule1||_.hRule2||_.hRule3||_.hRule4||_.hRule5||_.hRule6)&&(_.hLayout=n),typeof _.vLayout>"u"?_.vRule1||_.vRule2||_.vRule3||_.vRule4||_.vRule5?_.vLayout=n:_.vLayout=s:_.vLayout===t&&(_.vRule1||_.vRule2||_.vRule3||_.vRule4||_.vRule5)&&(_.vLayout=n),_}function a(d,m,_=""){return d===m&&d!==_?d:!1}function p(d,m){let _="|/\\[]{}()<>";if(d==="_"){if(_.indexOf(m)!==-1)return m}else if(m==="_"&&_.indexOf(d)!==-1)return d;return!1}function h(d,m){let _="| /\\ [] {} () <>",u=_.indexOf(d),f=_.indexOf(m);if(u!==-1&&f!==-1&&u!==f&&Math.abs(u-f)!==1){const g=Math.max(u,f),T=g+1;return _.substring(g,T)}return!1}function A(d,m){let _="[] {} ()",u=_.indexOf(d),f=_.indexOf(m);return u!==-1&&f!==-1&&Math.abs(u-f)<=1?"|":!1}function E(d,m){return{"/\\":"|","\\/":"Y","><":"X"}[d+m]||!1}function C(d,m,_=""){return d===_&&m===_?_:!1}function M(d,m){return d===m?d:!1}function N(d,m){return p(d,m)}function R(d,m){return h(d,m)}function x(d,m){return d==="-"&&m==="_"||d==="_"&&m==="-"?"=":!1}function B(d,m){return d==="|"&&m==="|"?"|":!1}function U(d,m,_){return m===" "||m===""||m===_&&d!==" "?d:m}function H(d,m,_){if(_.fittingRules&&_.fittingRules.vLayout===s)return"invalid";let u,f=Math.min(d.length,m.length),g,T,L=!1,I;if(f===0)return"invalid";for(u=0;u<f;u++)if(g=d.substring(u,u+1),T=m.substring(u,u+1),g!==" "&&T!==" "){if(_.fittingRules&&_.fittingRules.vLayout===e)return"invalid";if(_.fittingRules&&_.fittingRules.vLayout===t)return"end";if(B(g,T)){L=L||!1;continue}if(I=!1,I=_.fittingRules&&_.fittingRules.vRule1?M(g,T):I,I=!I&&_.fittingRules&&_.fittingRules.vRule2?N(g,T):I,I=!I&&_.fittingRules&&_.fittingRules.vRule3?R(g,T):I,I=!I&&_.fittingRules&&_.fittingRules.vRule4?x(g,T):I,L=!0,!I)return"invalid"}return L?"end":"valid"}function D(d,m,_){let u=d.length,f=d.length,g,T,L,I=1,b,v,w;for(;I<=u;){for(g=d.slice(Math.max(0,f-I),f),T=m.slice(0,Math.min(u,I)),L=T.length,w="",b=0;b<L;b++)if(v=H(g[b],T[b],_),v==="end")w=v;else if(v==="invalid"){w=v;break}else w===""&&(w="valid");if(w==="invalid"){I--;break}if(w==="end")break;w==="valid"&&I++}return Math.min(u,I)}function z(d,m,_){let u,f=Math.min(d.length,m.length),g,T,L="",I;const b=_.fittingRules||{};for(u=0;u<f;u++)g=d.substring(u,u+1),T=m.substring(u,u+1),g!==" "&&T!==" "?b.vLayout===e||b.vLayout===t?L+=U(g,T):(I=!1,I=b.vRule5?B(g,T):I,I=!I&&b.vRule1?M(g,T):I,I=!I&&b.vRule2?N(g,T):I,I=!I&&b.vRule3?R(g,T):I,I=!I&&b.vRule4?x(g,T):I,L+=I):L+=U(g,T);return L}function ee(d,m,_,u){let f=d.length,g=m.length,T=d.slice(0,Math.max(0,f-_)),L=d.slice(Math.max(0,f-_),f),I=m.slice(0,Math.min(_,g)),b,v,w,k=[],O;for(v=L.length,b=0;b<v;b++)b>=g?w=L[b]:w=z(L[b],I[b],u),k.push(w);return O=m.slice(Math.min(_,g),g),[...T,...k,...O]}function De(d,m){const _=" ".repeat(m);return d.map(u=>u+_)}function Pe(d,m,_){let u=d[0].length,f=m[0].length,g;return u>f?m=De(m,u-f):f>u&&(d=De(d,f-u)),g=D(d,m,_),ee(d,m,g,_)}function Re(d,m,_){const u=_.fittingRules||{};if(u.hLayout===s)return 0;let f,g=d.length,T=m.length,L=g,I=1,b=!1,v,w,k,O;if(g===0)return 0;e:for(;I<=L;){const re=g-I;for(v=d.substring(re,re+I),w=m.substring(0,Math.min(I,T)),f=0;f<Math.min(I,T);f++)if(k=v.substring(f,f+1),O=w.substring(f,f+1),k!==" "&&O!==" "){if(u.hLayout===e){I=I-1;break e}else if(u.hLayout===t){(k===_.hardBlank||O===_.hardBlank)&&(I=I-1);break e}else if(b=!0,!(u.hRule1&&a(k,O,_.hardBlank)||u.hRule2&&p(k,O)||u.hRule3&&h(k,O)||u.hRule4&&A(k,O)||u.hRule5&&E(k,O)||u.hRule6&&C(k,O,_.hardBlank))){I=I-1;break e}}if(b)break;I++}return Math.min(L,I)}function Y(d,m,_,u){let f,g,T=[],L,I,b,v,w,k,O,re;const q=u.fittingRules||{};if(typeof u.height!="number")throw new Error("height is not defined.");for(f=0;f<u.height;f++){O=d[f],re=m[f],w=O.length,k=re.length,L=w-_,I=O.slice(0,Math.max(0,L)),b="";const me=Math.max(0,w-_);let te=O.substring(me,me+_),pe=re.substring(0,Math.min(_,k));for(g=0;g<_;g++){let se=g<w?te.substring(g,g+1):" ",Q=g<k?pe.substring(g,g+1):" ";if(se!==" "&&Q!==" ")if(q.hLayout===e||q.hLayout===t)b+=U(se,Q,u.hardBlank);else{const xt=q.hRule1&&a(se,Q,u.hardBlank)||q.hRule2&&p(se,Q)||q.hRule3&&h(se,Q)||q.hRule4&&A(se,Q)||q.hRule5&&E(se,Q)||q.hRule6&&C(se,Q,u.hardBlank)||U(se,Q,u.hardBlank);b+=xt}else b+=U(se,Q,u.hardBlank)}_>=k?v="":v=re.substring(_,_+Math.max(0,k-_)),T[f]=I+b+v}return T}function ue(d){return new Array(d).fill("")}const he=function(d){return Math.max(...d.map(m=>m.length))};function de(d,m,_){return d.reduce(function(u,f){return Y(u,f.fig,f.overlap||0,_)},ue(m))}function Ct(d,m,_){for(let u=d.length-1;u>0;u--){const f=de(d.slice(0,u),m,_);if(he(f)<=_.width)return{outputFigText:f,chars:d.slice(u)}}return{outputFigText:ue(m),chars:d}}function wt(d,m,_){let u,f,g=0,T,L,I,b=_.height,v=[],w,k={chars:[],overlap:g},O=[],re,q,me,te,pe;if(typeof b!="number")throw new Error("height is not defined.");L=ue(b);const se=_.fittingRules||{};for(_.printDirection===1&&(d=d.split("").reverse().join("")),I=d.length,u=0;u<I;u++)if(re=d.substring(u,u+1),q=re.match(/\s/),f=m[re.charCodeAt(0)],te=null,f){if(se.hLayout!==s){for(g=1e4,T=0;T<b;T++)g=Math.min(g,Re(L[T],f[T],_));g=g===1e4?0:g}if(_.width>0&&(_.whitespaceBreak?(me=de(k.chars.concat([{fig:f,overlap:g}]),b,_),te=de(O.concat([{fig:me,overlap:k.overlap}]),b,_),w=he(te)):(te=Y(L,f,g,_),w=he(te)),w>=_.width&&u>0&&(_.whitespaceBreak?(L=de(O.slice(0,-1),b,_),O.length>1&&(v.push(L),L=ue(b)),O=[]):(v.push(L),L=ue(b)))),_.width>0&&_.whitespaceBreak&&((!q||u===I-1)&&k.chars.push({fig:f,overlap:g}),q||u===I-1)){for(pe=null;te=de(k.chars,b,_),w=he(te),w>=_.width;)pe=Ct(k.chars,b,_),k={chars:pe.chars},v.push(pe.outputFigText);w>0&&(pe?O.push({fig:te,overlap:1}):O.push({fig:te,overlap:k.overlap})),q&&(O.push({fig:f,overlap:g}),L=ue(b)),u===I-1&&(L=de(O,b,_)),k={chars:[],overlap:g};continue}L=Y(L,f,g,_)}return he(L)>0&&v.push(L),_.showHardBlanks||v.forEach(function(Q){for(I=Q.length,T=0;T<I;T++)Q[T]=Q[T].replace(new RegExp("\\"+_.hardBlank,"g")," ")}),d===""&&v.length===0&&v.push(new Array(b).fill("")),v}const Nt=function(d,m){let _;const u=m.fittingRules||{};if(d==="default")_={hLayout:u.hLayout,hRule1:u.hRule1,hRule2:u.hRule2,hRule3:u.hRule3,hRule4:u.hRule4,hRule5:u.hRule5,hRule6:u.hRule6};else if(d==="full")_={hLayout:s,hRule1:!1,hRule2:!1,hRule3:!1,hRule4:!1,hRule5:!1,hRule6:!1};else if(d==="fitted")_={hLayout:e,hRule1:!1,hRule2:!1,hRule3:!1,hRule4:!1,hRule5:!1,hRule6:!1};else if(d==="controlled smushing")_={hLayout:n,hRule1:!0,hRule2:!0,hRule3:!0,hRule4:!0,hRule5:!0,hRule6:!0};else if(d==="universal smushing")_={hLayout:t,hRule1:!1,hRule2:!1,hRule3:!1,hRule4:!1,hRule5:!1,hRule6:!1};else return;return _},st=function(d,m){let _={};const u=m.fittingRules||{};if(d==="default")_={vLayout:u.vLayout,vRule1:u.vRule1,vRule2:u.vRule2,vRule3:u.vRule3,vRule4:u.vRule4,vRule5:u.vRule5};else if(d==="full")_={vLayout:s,vRule1:!1,vRule2:!1,vRule3:!1,vRule4:!1,vRule5:!1};else if(d==="fitted")_={vLayout:e,vRule1:!1,vRule2:!1,vRule3:!1,vRule4:!1,vRule5:!1};else if(d==="controlled smushing")_={vLayout:n,vRule1:!0,vRule2:!0,vRule3:!0,vRule4:!0,vRule5:!0};else if(d==="universal smushing")_={vLayout:t,vRule1:!1,vRule2:!1,vRule3:!1,vRule4:!1,vRule5:!1};else return;return _},it=function(d,m,_){_=_.replace(/\r\n/g,`
`).replace(/\r/g,`
`);let u=_.split(`
`),f=[],g,T,L;for(T=u.length,g=0;g<T;g++)f=f.concat(wt(u[g],r[d],m));for(T=f.length,L=f[0],g=1;g<T;g++)L=Pe(L,f[g],m);return L?L.join(`
`):""};function Be(d,m){let _;if(typeof structuredClone<"u"?_=structuredClone(d):_=JSON.parse(JSON.stringify(d)),_.showHardBlanks=m.showHardBlanks||!1,_.width=m.width||-1,_.whitespaceBreak=m.whitespaceBreak||!1,m.horizontalLayout){const u=Nt(m.horizontalLayout,d);u&&Object.assign(_.fittingRules,u)}if(m.verticalLayout){const u=st(m.verticalLayout,d);u&&Object.assign(_.fittingRules,u)}return _.printDirection=m.printDirection!==null&&m.printDirection!==void 0?m.printDirection:d.printDirection,_}const P=async function(d,m,_){return P.text(d,m,_)};return P.text=async function(d,m,_){d=d+"";let u,f;typeof m=="function"?(f=m,u={font:i.font}):typeof m=="string"?(u={font:m},f=_):m?(u=m,f=_):(u={font:i.font},f=_);const g=u.font||i.font;try{const T=await P.loadFont(g),L=T?it(g,Be(T,u),d):"";return f&&f(null,L),L}catch(T){const L=T instanceof Error?T:new Error(String(T));if(f)return f(L),"";throw L}},P.textSync=function(d,m){d=d+"",typeof m=="string"?m={font:m}:m=m||{};const _=m.font||i.font;let u=Be(P.loadFontSync(_),m);return it(_,u,d)},P.metadata=async function(d,m){d=d+"";try{const _=await P.loadFont(d);if(!_)throw new Error("Error loading font.");const u=r[d]||{},f=[_,u.comment||""];return m&&m(null,_,u.comment),f}catch(_){const u=_ instanceof Error?_:new Error(String(_));if(m)return m(u),null;throw u}},P.defaults=function(d){return d&&typeof d=="object"&&Object.assign(i,d),typeof structuredClone<"u"?structuredClone(i):JSON.parse(JSON.stringify(i))},P.parseFont=function(d,m,_=!0){if(r[d]&&!_)return r[d].options;m=m.replace(/\r\n/g,`
`).replace(/\r/g,`
`);const u=new ui,f=m.split(`
...
`),u.numChars=0;f.length>0&&u.numChars<b.length;){const v=b[u.numChars];u[v]=f.splice(0,L.height);for(let w=0;w<L.height;w++)typeof u[v][w]>"u"?u[v][w]="":u[v][w]=o(u[v][w],w,L.height);u.numChars++}for(;f.length>0;){const v=f.shift();if(!v||v.trim()==="")break;let w=v.split(" ")[0],k;if(/^-?0[xX][0-9a-fA-F]+$/.test(w))k=parseInt(w,16);else if(/^-?0[0-7]+$/.test(w))k=parseInt(w,8);else if(/^-?[0-9]+$/.test(w))k=parseInt(w,10);else throw new Error(`Error parsing data. Invalid data: ${w}`);if(k===-1||k<-2147483648||k>2147483647){const O=k===-1?"The char code -1 is not permitted.":`The char code cannot be ${k<-2147483648?"less than -2147483648":"greater than 2147483647"}.`;throw new Error(`Error parsing data. ${O}`)}u[k]=f.splice(0,L.height);for(let O=0;O<L.height;O++)typeof u[k][O]>"u"?u[k][O]="":u[k][O]=o(u[k][O],O,L.height);u.numChars++}return r[d]=u,L},P.loadedFonts=()=>Object.keys(r),P.clearLoadedFonts=()=>{Object.keys(r).forEach(d=>{delete r[d]})},P.loadFont=async function(d,m){if(r[d]){const _=r[d].options;return m&&m(null,_),Promise.resolve(_)}try{if(!i.fetchFontIfMissing)throw new Error(`Font is not loaded: ${d}`);const _=await fetch(`${i.fontPath}/${d}.flf`);if(!_.ok)throw new Error(`Network response was not ok: ${_.status}`);const u=await _.text(),f=P.parseFont(d,u);return m&&m(null,f),f}catch(_){const u=_ instanceof Error?_:new Error(String(_));if(m)return m(u),null;throw u}},P.loadFontSync=function(d){if(r[d])return r[d].options;throw new Error("Synchronous font loading is not implemented for the browser, it will only work for fonts already loaded.")},P.preloadFonts=async function(d,m){try{for(const _ of d){const u=await fetch(`${i.fontPath}/${_}.flf`);if(!u.ok)throw new Error(`Failed to preload fonts. Error fetching font: ${_}, status code: ${u.statusText}`);const f=await u.text();P.parseFont(_,f)}m&&m()}catch(_){const u=_ instanceof Error?_:new Error(String(_));if(m){m(u);return}throw _}},P.fonts=function(d){return new Promise(function(m,_){m(Wt),d&&d(null,Wt)})},P.fontsSync=function(){return Wt},P.figFonts=r,P})(),di=`flf2a$ 8 7 54 0 12 0 64 185
...
255  LATIN SMALL LETTER Y WITH DIAERESIS
 ...
 | || |@
  \\_, |@
  |__/ @@
`,fi=`flf2a$ 6 5 16 15 13 0 24463 229
...
0xCA0  KANNADA LETTER TTHA
 ...
 $\\___/$ @
         @@
         `;tt.parseFont("Standard",fi);tt.parseFont("Slant",mi);tt.parseFont("Banner",di);tt.parseFont("Small",pi);const $i={name:"figlet",description:"Convert text to ASCII art",execute:(s,e)=>{const t=new V(s);if(t.hasFlag("help"))return{output:`Usage: figlet [options] <text>
...
Try 'figlet --help' for more information.`,error:!0};const r=t.getFlag("f"),i=typeof r=="string"?r:"Standard",o=i.charAt(0).toUpperCase()+i.slice(1).toLowerCase();let l="default";t.hasFlag("c")?l="full":t.hasFlag("r")&&(l="fitted");try{return{output:tt.textSync(n,{font:o,horizontalLayout:l})}}catch(a){return a instanceof Error?a.message.includes("font")||a.message.includes("Font")||a.message.includes("FIGlet")?{output:`figlet: font '${o}' not found or invalid
Available fonts: standard, slant, banner, small`,error:!0}:{output:`figlet: ${a.message}`,error:!0}:{output:"figlet: unknown error occurred",error:!0}}}},Jt="0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZｱｲｳｴｵｶｷｸｹｺｻｼｽｾｿﾀﾁﾂﾃﾄﾅﾆﾇﾈﾉﾊﾋﾌﾍﾎﾏﾐﾑﾒﾓﾔﾕﾖﾗﾘﾙﾚﾛﾜﾝ";function gi(){const s=document.getElementById("terminal-output");if(!s)return{cols:80,rows:24};const e=s.getBoundingClientRect(),t=parseFloat(getComputedStyle(document.documentElement).getPropertyValue("--terminal-font-size")||"16"),n=t*.6,r=t*1.5,i=Math.floor(e.width/n),o=Math.floor(e.height/r);return{cols:Math.max(i,20),rows:Math.max(o,10)}}function Ti(){return Jt[Math.floor(Math.random()*Jt.length)]}function Li(s){return{name:"matrix",description:"Display Matrix digital rain animation",execute:(e,t)=>{const n=new V(e);if(n.hasFlag("help"))return{output:`Usage: matrix [options]
...
Speed must be between 0.1 and 5.0`,error:!0};r=D}const o=n.getFlag("theme");let l=s.getCurrentColors();if(o!==void 0){const D=String(o),z=["green","yellow","white","light-blue","paper","dc","custom"];if(!z.includes(D))return{output:`matrix: invalid theme '${D}'
Valid themes: ${z.join(", ")}`,error:!0};if(D!=="custom"){const ee=s.getPreset(D);ee&&(l=ee.colors)}}const{cols:a,rows:p}=gi(),h=1.2,A=Math.floor(a/h)+5,E=Math.min(p,20),C=l["--terminal-accent"],M=l["--terminal-dim"],N=l["--terminal-bg"],R=p*1.5,x=-E*1.5,B=R,U=[];for(let D=0;D<A;D++){const z=-Math.random()*5,ee=(5+Math.random()*5)/r,De=D*h,Pe=[];for(let Re=0;Re<E;Re++){const Y=Re/E,ue=Math.pow(Y,2),he=Re===E-1,de=Ti();Pe.push(`<span class="matrix-char${he?" matrix-char-bright":""}" data-char-index="${Re}" style="color: ${he?C:M}; opacity: ${ue};">${de}</span>`)}U.push(`
...
<div class="matrix-rain" data-matrix-chars="${Jt}" style="height: ${R}em; background-color: ${N};">
${U.join("")}
</div>
`,html:!0}}}}class Un{static generateHeader(){return`
 ...
 ██████╔╝██║  ██║██║  ██║██║██║ ╚████║    ╚██████╗██║  ██║██║  ██║██║ ╚═╝ ██║██████╔╝███████╗██║  ██║███████║
 ╚═════╝ ╚═╝  ╚═╝╚═╝  ╚═╝╚═╝╚═╝  ╚═══╝     ╚═════╝╚═╝  ╚═╝╚═╝  ╚═╝╚═╝     ╚═╝╚═════╝ ╚══════╝╚═╝  ╚═╝╚══════╝
`}static getTagline(){return"Technologist, Inventor | Building What's Next on Rock-Solid Foundations"}}const{entries:gr,setPrototypeOf:Bn,isFrozen:Ei,getPrototypeOf:Ai,getOwnPropertyDescriptor:Ii}=Object;let{freeze:le,seal:$e,create:en}=Object,{apply:tn,construct:nn}=typeof Reflect<"u"&&Reflect;le||(le=function(e){return e});$e||($e=function(e){return e});tn||(tn=function(e,t){for(var n=arguments.length,r=new Array(n>2?n-2:0),i=2;i<n;i++)r[i-2]=arguments[i];return e.apply(t,r)});nn||(nn=function(e){for(var t=arguments.length,n=new Array(t>1?t-1:0),r=1;r<t;r++)n[r-1]=arguments[r];return new e(...n)});const dt=_e(Array.prototype.forEach),yi=_e(Array.prototype.lastIndexOf),Gn=_e(Array.prototype.pop),Ye=_e(Array.prototype.push),Ri=_e(Array.prototype.splice),pt=_e(String.prototype.toLowerCase),Ut=_e(String.prototype.toString),Bt=_e(String.prototype.match),Xe=_e(String.prototype.replace),Si=_e(String.prototype.indexOf),bi=_e(String.prototype.trim),Te=_e(Object.prototype.hasOwnProperty),ie=_e(RegExp.prototype.test),qe=Ci(TypeError);function _e(s){return function(e){e instanceof RegExp&&(e.lastIndex=0);for(var t=arguments.length,n=new Array(t>1?t-1:0),r=1;r<t;r++)n[r-1]=arguments[r];return tn(s,e,n)}}function Ci(s){return function(){for(var e=arguments.length,t=new Array(e),n=0;n<e;n++)t[n]=arguments[n];return nn(s,t)}}function F(s,e){let t=arguments.length>2&&arguments[2]!==void 0?arguments[2]:pt;Bn&&Bn(s,null);let n=e.length;for(;n--;){let r=e[n];if(typeof r=="string"){const i=t(r);i!==r&&(Ei(e)||(e[n]=i),r=i)}s[r]=!0}return s}function wi(s){for(let e=0;e<s.length;e++)Te(s,e)||(s[e]=null);return s}function Ne(s){const e=en(null);for(const[t,n]of gr(s))Te(s,t)&&(Array.isArray(n)?e[t]=wi(n):n&&typeof n=="object"&&n.constructor===Object?e[t]=Ne(n):e[t]=n);return e}function Ke(s,e){for(;s!==null;){const n=Ii(s,e);if(n){if(n.get)return _e(n.get);if(typeof n.value=="function")return _e(n.value)}s=Ai(s)}function t(){return null}return t}const Vn=le(["a","abbr","acronym","address","area","article","aside","audio","b","bdi","bdo","big","blink","blockquote","body","br","button","canvas","caption","center","cite","code","col","colgroup","content","data","datalist","dd","decorator","del","details","dfn","dialog","dir","div","dl","dt","element","em","fieldset","figcaption","figure","font","footer","form","h1","h2","h3","h4","h5","h6","head","header","hgroup","hr","html","i","img","input","ins","kbd","label","legend","li","main","map","mark","marquee","menu","menuitem","meter","nav","nobr","ol","optgroup","option","output","p","picture","pre","progress","q","rp","rt","ruby","s","samp","search","section","select","shadow","slot","small","source","spacer","span","strike","strong","style","sub","summary","sup","table","tbody","td","template","textarea","tfoot","th","thead","time","tr","track","tt","u","ul","var","video","wbr"]),Gt=le(["svg","a","altglyph","altglyphdef","altglyphitem","animatecolor","animatemotion","animatetransform","circle","clippath","defs","desc","ellipse","enterkeyhint","exportparts","filter","font","g","glyph","glyphref","hkern","image","inputmode","line","lineargradient","marker","mask","metadata","mpath","part","path","pattern","polygon","polyline","radialgradient","rect","stop","style","switch","symbol","text","textpath","title","tref","tspan","view","vkern"]),Vt=le(["feBlend","feColorMatrix","feComponentTransfer","feComposite","feConvolveMatrix","feDiffuseLighting","feDisplacementMap","feDistantLight","feDropShadow","feFlood","feFuncA","feFuncB","feFuncG","feFuncR","feGaussianBlur","feImage","feMerge","feMergeNode","feMorphology","feOffset","fePointLight","feSpecularLighting","feSpotLight","feTile","feTurbulence"]),Ni=le(["animate","color-profile","cursor","discard","font-face","font-face-format","font-face-name","font-face-src","font-face-uri","foreignobject","hatch","hatchpath","mesh","meshgradient","meshpatch","meshrow","missing-glyph","script","set","solidcolor","unknown","use"]),zt=le(["math","menclose","merror","mfenced","mfrac","mglyph","mi","mlabeledtr","mmultiscripts","mn","mo","mover","mpadded","mphantom","mroot","mrow","ms","mspace","msqrt","mstyle","msub","msup","msubsup","mtable","mtd","mtext","mtr","munder","munderover","mprescripts"]),xi=le(["maction","maligngroup","malignmark","mlongdiv","mscarries","mscarry","msgroup","mstack","msline","msrow","semantics","annotation","annotation-xml","mprescripts","none"]),zn=le(["#text"]),jn=le(["accept","action","align","alt","autocapitalize","autocomplete","autopictureinpicture","autoplay","background","bgcolor","border","capture","cellpadding","cellspacing","checked","cite","class","clear","color","cols","colspan","controls","controlslist","coords","crossorigin","datetime","decoding","default","dir","disabled","disablepictureinpicture","disableremoteplayback","download","draggable","enctype","enterkeyhint","exportparts","face","for","headers","height","hidden","high","href","hreflang","id","inert","inputmode","integrity","ismap","kind","label","lang","list","loading","loop","low","max","maxlength","media","method","min","minlength","multiple","muted","name","nonce","noshade","novalidate","nowrap","open","optimum","part","pattern","placeholder","playsinline","popover","popovertarget","popovertargetaction","poster","preload","pubdate","radiogroup","readonly","rel","required","rev","reversed","role","rows","rowspan","spellcheck","scope","selected","shape","size","sizes","slot","span","srclang","start","src","srcset","step","style","summary","tabindex","title","translate","type","usemap","valign","value","width","wrap","xmlns","slot"]),jt=le(["accent-height","accumulate","additive","alignment-baseline","amplitude","ascent","attributename","attributetype","azimuth","basefrequency","baseline-shift","begin","bias","by","class","clip","clippathunits","clip-path","clip-rule","color","color-interpolation","color-interpolation-filters","color-profile","color-rendering","cx","cy","d","dx","dy","diffuseconstant","direction","display","divisor","dur","edgemode","elevation","end","exponent","fill","fill-opacity","fill-rule","filter","filterunits","flood-color","flood-opacity","font-family","font-size","font-size-adjust","font-stretch","font-style","font-variant","font-weight","fx","fy","g1","g2","glyph-name","glyphref","gradientunits","gradienttransform","height","href","id","image-rendering","in","in2","intercept","k","k1","k2","k3","k4","kerning","keypoints","keysplines","keytimes","lang","lengthadjust","letter-spacing","kernelmatrix","kernelunitlength","lighting-color","local","marker-end","marker-mid","marker-start","markerheight","markerunits","markerwidth","maskcontentunits","maskunits","max","mask","mask-type","media","method","mode","min","name","numoctaves","offset","operator","opacity","order","orient","orientation","origin","overflow","paint-order","path","pathlength","patterncontentunits","patterntransform","patternunits","points","preservealpha","preserveaspectratio","primitiveunits","r","rx","ry","radius","refx","refy","repeatcount","repeatdur","restart","result","rotate","scale","seed","shape-rendering","slope","specularconstant","specularexponent","spreadmethod","startoffset","stddeviation","stitchtiles","stop-color","stop-opacity","stroke-dasharray","stroke-dashoffset","stroke-linecap","stroke-linejoin","stroke-miterlimit","stroke-opacity","stroke","stroke-width","style","surfacescale","systemlanguage","tabindex","tablevalues","targetx","targety","transform","transform-origin","text-anchor","text-decoration","text-rendering","textlength","type","u1","u2","unicode","values","viewbox","visibility","version","vert-adv-y","vert-origin-x","vert-origin-y","width","word-spacing","wrap","writing-mode","xchannelselector","ychannelselector","x","x1","x2","xmlns","y","y1","y2","z","zoomandpan"]),Yn=le(["accent","accentunder","align","bevelled","close","columnsalign","columnlines","columnspan","denomalign","depth","dir","display","displaystyle","encoding","fence","frame","height","href","id","largeop","length","linethickness","lspace","lquote","mathbackground","mathcolor","mathsize","mathvariant","maxsize","minsize","movablelimits","notation","numalign","open","rowalign","rowlines","rowspacing","rowspan","rspace","rquote","scriptlevel","scriptminsize","scriptsizemultiplier","selection","separator","separators","stretchy","subscriptshift","supscriptshift","symmetric","voffset","width","xmlns"]),mt=le(["xlink:href","xml:id","xlink:title","xml:space","xmlns:xlink"]),ki=$e(/\{\{[\w\W]*|[\w\W]*\}\}/gm),vi=$e(/<%[\w\W]*|[\w\W]*%>/gm),Oi=$e(/\$\{[\w\W]*/gm),Di=$e(/^data-[\-\w.\u00B7-\uFFFF]+$/),Pi=$e(/^aria-[\-\w]+$/),Tr=$e(/^(?:(?:(?:f|ht)tps?|mailto|tel|callto|sms|cid|xmpp|matrix):|[^a-z]|[a-z+.\-]+(?:[^a-z+.\-:]|$))/i),Mi=$e(/^(?:\w+script|data):/i),Hi=$e(/[\u0000-\u0020\u00A0\u1680\u180E\u2000-\u2029\u205F\u3000]/g),Lr=$e(/^html$/i),Fi=$e(/^[a-z][.\w]*(-[.\w]+)+$/i);var Xn=Object.freeze({__proto__:null,ARIA_ATTR:Pi,ATTR_WHITESPACE:Hi,CUSTOM_ELEMENT:Fi,DATA_ATTR:Di,DOCTYPE_NAME:Lr,ERB_EXPR:vi,IS_ALLOWED_URI:Tr,IS_SCRIPT_OR_DATA:Mi,MUSTACHE_EXPR:ki,TMPLIT_EXPR:Oi});const Ze={element:1,text:3,progressingInstruction:7,comment:8,document:9},Wi=function(){return typeof window>"u"?null:window},Ui=function(e,t){if(typeof e!="object"||typeof e.createPolicy!="function")return null;let n=null;const r="data-tt-policy-suffix";t&&t.hasAttribute(r)&&(n=t.getAttribute(r));const i="dompurify"+(n?"#"+n:"");try{return e.createPolicy(i,{createHTML(o){return o},createScriptURL(o){return o}})}catch{return console.warn("TrustedTypes policy "+i+" could not be created."),null}},qn=function(){return{afterSanitizeAttributes:[],afterSanitizeElements:[],afterSanitizeShadowDOM:[],beforeSanitizeAttributes:[],beforeSanitizeElements:[],beforeSanitizeShadowDOM:[],uponSanitizeAttribute:[],uponSanitizeElement:[],uponSanitizeShadowNode:[]}};function Er(){let s=arguments.length>0&&arguments[0]!==void 0?arguments[0]:Wi();const e=S=>Er(S);if(e.version="3.3.0",e.removed=[],!s||!s.document||s.document.nodeType!==Ze.document||!s.Element)return e.isSupported=!1,e;let{document:t}=s;const n=t,r=n.currentScript,{DocumentFragment:i,HTMLTemplateElement:o,Node:l,Element:a,NodeFilter:p,NamedNodeMap:h=s.NamedNodeMap||s.MozNamedAttrMap,HTMLFormElement:A,DOMParser:E,trustedTypes:C}=s,M=a.prototype,N=Ke(M,"cloneNode"),R=Ke(M,"remove"),x=Ke(M,"nextSibling"),B=Ke(M,"childNodes"),U=Ke(M,"parentNode");if(typeof o=="function"){const S=t.createElement("template");S.content&&S.content.ownerDocument&&(t=S.content.ownerDocument)}let H,D="";const{implementation:z,createNodeIterator:ee,createDocumentFragment:De,getElementsByTagName:Pe}=t,{importNode:Re}=n;let Y=qn();e.isSupported=typeof gr=="function"&&typeof U=="function"&&z&&z.createHTMLDocument!==void 0;const{MUSTACHE_EXPR:ue,ERB_EXPR:he,TMPLIT_EXPR:de,DATA_ATTR:Ct,ARIA_ATTR:wt,IS_SCRIPT_OR_DATA:Nt,ATTR_WHITESPACE:st,CUSTOM_ELEMENT:it}=Xn;let{IS_ALLOWED_URI:Be}=Xn,P=null;const d=F({},[...Vn,...Gt,...Vt,...zt,...zn]);let m=null;const _=F({},[...jn,...jt,...Yn,...mt]);let u=Object.seal(en(null,{tagNameCheck:{writable:!0,configurable:!1,enumerable:!0,value:null},attributeNameCheck:{writable:!0,configurable:!1,enumerable:!0,value:null},allowCustomizedBuiltInElements:{writable:!0,configurable:!1,enumerable:!0,value:!1}})),f=null,g=null;const T=Object.seal(en(null,{tagCheck:{writable:!0,configurable:!1,enumerable:!0,value:null},attributeCheck:{writable:!0,configurable:!1,enumerable:!0,value:null}}));let L=!0,I=!0,b=!1,v=!0,w=!1,k=!0,O=!1,re=!1,q=!1,me=!1,te=!1,pe=!1,se=!0,Q=!1;const xt="user-content-";let kt=!0,Ge=!1,Me={},He=null;const pn=F({},["annotation-xml","audio","colgroup","desc","foreignobject","head","iframe","math","mi","mn","mo","ms","mtext","noembed","noframes","noscript","plaintext","script","style","svg","template","thead","title","video","xmp"]);let fn=null;const $n=F({},["audio","video","img","source","image","track"]);let vt=null;const gn=F({},["alt","class","for","id","label","name","pattern","placeholder","role","summary","title","value","style","xmlns"]),ot="http://www.w3.org/1998/Math/MathML",at="http://www.w3.org/2000/svg",Se="http://www.w3.org/1999/xhtml";let Fe=Se,Ot=!1,Dt=null;const Rr=F({},[ot,at,Se],Ut);let lt=F({},["mi","mo","mn","ms","mtext"]),_t=F({},["annotation-xml"]);const Sr=F({},["title","style","font","a","script"]);let Ve=null;const br=["application/xhtml+xml","text/html"],Cr="text/html";let K=null,We=null;const wr=t.createElement("form"),Tn=function(c){return c instanceof RegExp||c instanceof Function},Pt=function(){let c=arguments.length>0&&arguments[0]!==void 0?arguments[0]:{};if(!(We&&We===c)){if((!c||typeof c!="object")&&(c={}),c=Ne(c),Ve=br.indexOf(c.PARSER_MEDIA_TYPE)===-1?Cr:c.PARSER_MEDIA_TYPE,K=Ve==="application/xhtml+xml"?Ut:pt,P=Te(c,"ALLOWED_TAGS")?F({},c.ALLOWED_TAGS,K):d,m=Te(c,"ALLOWED_ATTR")?F({},c.ALLOWED_ATTR,K):_,Dt=Te(c,"ALLOWED_NAMESPACES")?F({},c.ALLOWED_NAMESPACES,Ut):Rr,vt=Te(c,"ADD_URI_SAFE_ATTR")?F(Ne(gn),c.ADD_URI_SAFE_ATTR,K):gn,fn=Te(c,"ADD_DATA_URI_TAGS")?F(Ne($n),c.ADD_DATA_URI_TAGS,K):$n,He=Te(c,"FORBID_CONTENTS")?F({},c.FORBID_CONTENTS,K):pn,f=Te(c,"FORBID_TAGS")?F({},c.FORBID_TAGS,K):Ne({}),g=Te(c,"FORBID_ATTR")?F({},c.FORBID_ATTR,K):Ne({}),Me=Te(c,"USE_PROFILES")?c.USE_PROFILES:!1,L=c.ALLOW_ARIA_ATTR!==!1,I=c.ALLOW_DATA_ATTR!==!1,b=c.ALLOW_UNKNOWN_PROTOCOLS||!1,v=c.ALLOW_SELF_CLOSE_IN_ATTR!==!1,w=c.SAFE_FOR_TEMPLATES||!1,k=c.SAFE_FOR_XML!==!1,O=c.WHOLE_DOCUMENT||!1,me=c.RETURN_DOM||!1,te=c.RETURN_DOM_FRAGMENT||!1,pe=c.RETURN_TRUSTED_TYPE||!1,q=c.FORCE_BODY||!1,se=c.SANITIZE_DOM!==!1,Q=c.SANITIZE_NAMED_PROPS||!1,kt=c.KEEP_CONTENT!==!1,Ge=c.IN_PLACE||!1,Be=c.ALLOWED_URI_REGEXP||Tr,Fe=c.NAMESPACE||Se,lt=c.MATHML_TEXT_INTEGRATION_POINTS||lt,_t=c.HTML_INTEGRATION_POINTS||_t,u=c.CUSTOM_ELEMENT_HANDLING||{},c.CUSTOM_ELEMENT_HANDLING&&Tn(c.CUSTOM_ELEMENT_HANDLING.tagNameCheck)&&(u.tagNameCheck=c.CUSTOM_ELEMENT_HANDLING.tagNameCheck),c.CUSTOM_ELEMENT_HANDLING&&Tn(c.CUSTOM_ELEMENT_HANDLING.attributeNameCheck)&&(u.attributeNameCheck=c.CUSTOM_ELEMENT_HANDLING.attributeNameCheck),c.CUSTOM_ELEMENT_HANDLING&&typeof c.CUSTOM_ELEMENT_HANDLING.allowCustomizedBuiltInElements=="boolean"&&(u.allowCustomizedBuiltInElements=c.CUSTOM_ELEMENT_HANDLING.allowCustomizedBuiltInElements),w&&(I=!1),te&&(me=!0),Me&&(P=F({},zn),m=[],Me.html===!0&&(F(P,Vn),F(m,jn)),Me.svg===!0&&(F(P,Gt),F(m,jt),F(m,mt)),Me.svgFilters===!0&&(F(P,Vt),F(m,jt),F(m,mt)),Me.mathMl===!0&&(F(P,zt),F(m,Yn),F(m,mt))),c.ADD_TAGS&&(typeof c.ADD_TAGS=="function"?T.tagCheck=c.ADD_TAGS:(P===d&&(P=Ne(P)),F(P,c.ADD_TAGS,K))),c.ADD_ATTR&&(typeof c.ADD_ATTR=="function"?T.attributeCheck=c.ADD_ATTR:(m===_&&(m=Ne(m)),F(m,c.ADD_ATTR,K))),c.ADD_URI_SAFE_ATTR&&F(vt,c.ADD_URI_SAFE_ATTR,K),c.FORBID_CONTENTS&&(He===pn&&(He=Ne(He)),F(He,c.FORBID_CONTENTS,K)),kt&&(P["#text"]=!0),O&&F(P,["html","head","body"]),P.table&&(F(P,["tbody"]),delete f.tbody),c.TRUSTED_TYPES_POLICY){if(typeof c.TRUSTED_TYPES_POLICY.createHTML!="function")throw qe('TRUSTED_TYPES_POLICY configuration option must provide a "createHTML" hook.');if(typeof c.TRUSTED_TYPES_POLICY.createScriptURL!="function")throw qe('TRUSTED_TYPES_POLICY configuration option must provide a "createScriptURL" hook.');H=c.TRUSTED_TYPES_POLICY,D=H.createHTML("")}else H===void 0&&(H=Ui(C,r)),H!==null&&typeof D=="string"&&(D=H.createHTML(""));le&&le(c),We=c}},Ln=F({},[...Gt,...Vt,...Ni]),En=F({},[...zt,...xi]),Nr=function(c){let $=U(c);(!$||!$.tagName)&&($={namespaceURI:Fe,tagName:"template"});const y=pt(c.tagName),j=pt($.tagName);return Dt[c.namespaceURI]?c.namespaceURI===at?$.namespaceURI===Se?y==="svg":$.namespaceURI===ot?y==="svg"&&(j==="annotation-xml"||lt[j]):!!Ln[y]:c.namespaceURI===ot?$.namespaceURI===Se?y==="math":$.namespaceURI===at?y==="math"&&_t[j]:!!En[y]:c.namespaceURI===Se?$.namespaceURI===at&&!_t[j]||$.namespaceURI===ot&&!lt[j]?!1:!En[y]&&(Sr[y]||!Ln[y]):!!(Ve==="application/xhtml+xml"&&Dt[c.namespaceURI]):!1},Ae=function(c){Ye(e.removed,{element:c});try{U(c).removeChild(c)}catch{R(c)}},ke=function(c,$){try{Ye(e.removed,{attribute:$.getAttributeNode(c),from:$})}catch{Ye(e.removed,{attribute:null,from:$})}if($.removeAttribute(c),c==="is")if(me||te)try{Ae($)}catch{}else try{$.setAttribute(c,"")}catch{}},An=function(c){let $=null,y=null;if(q)c="<remove></remove>"+c;else{const X=Bt(c,/^[\r\n\t ]+/);y=X&&X[0]}Ve==="application/xhtml+xml"&&Fe===Se&&(c='<html xmlns="http://www.w3.org/1999/xhtml"><head></head><body>'+c+"</body></html>");const j=H?H.createHTML(c):c;if(Fe===Se)try{$=new E().parseFromString(j,Ve)}catch{}if(!$||!$.documentElement){$=z.createDocument(Fe,"template",null);try{$.documentElement.innerHTML=Ot?D:j}catch{}}const ne=$.body||$.documentElement;return c&&y&&ne.insertBefore(t.createTextNode(y),ne.childNodes[0]||null),Fe===Se?Pe.call($,O?"html":"body")[0]:O?$.documentElement:ne},In=function(c){return ee.call(c.ownerDocument||c,c,p.SHOW_ELEMENT|p.SHOW_COMMENT|p.SHOW_TEXT|p.SHOW_PROCESSING_INSTRUCTION|p.SHOW_CDATA_SECTION,null)},Mt=function(c){return c instanceof A&&(typeof c.nodeName!="string"||typeof c.textContent!="string"||typeof c.removeChild!="function"||!(c.attributes instanceof h)||typeof c.removeAttribute!="function"||typeof c.setAttribute!="function"||typeof c.namespaceURI!="string"||typeof c.insertBefore!="function"||typeof c.hasChildNodes!="function")},yn=function(c){return typeof l=="function"&&c instanceof l};function be(S,c,$){dt(S,y=>{y.call(e,c,$,We)})}const Rn=function(c){let $=null;if(be(Y.beforeSanitizeElements,c,null),Mt(c))return Ae(c),!0;const y=K(c.nodeName);if(be(Y.uponSanitizeElement,c,{tagName:y,allowedTags:P}),k&&c.hasChildNodes()&&!yn(c.firstElementChild)&&ie(/<[/\w!]/g,c.innerHTML)&&ie(/<[/\w!]/g,c.textContent)||c.nodeType===Ze.progressingInstruction||k&&c.nodeType===Ze.comment&&ie(/<[/\w]/g,c.data))return Ae(c),!0;if(!(T.tagCheck instanceof Function&&T.tagCheck(y))&&(!P[y]||f[y])){if(!f[y]&&bn(y)&&(u.tagNameCheck instanceof RegExp&&ie(u.tagNameCheck,y)||u.tagNameCheck instanceof Function&&u.tagNameCheck(y)))return!1;if(kt&&!He[y]){const j=U(c)||c.parentNode,ne=B(c)||c.childNodes;if(ne&&j){const X=ne.length;for(let ce=X-1;ce>=0;--ce){const Ce=N(ne[ce],!0);Ce.__removalCount=(c.__removalCount||0)+1,j.insertBefore(Ce,x(c))}}}return Ae(c),!0}return c instanceof a&&!Nr(c)||(y==="noscript"||y==="noembed"||y==="noframes")&&ie(/<\/no(script|embed|frames)/i,c.innerHTML)?(Ae(c),!0):(w&&c.nodeType===Ze.text&&($=c.textContent,dt([ue,he,de],j=>{$=Xe($,j," ")}),c.textContent!==$&&(Ye(e.removed,{element:c.cloneNode()}),c.textContent=$)),be(Y.afterSanitizeElements,c,null),!1)},Sn=function(c,$,y){if(se&&($==="id"||$==="name")&&(y in t||y in wr))return!1;if(!(I&&!g[$]&&ie(Ct,$))){if(!(L&&ie(wt,$))){if(!(T.attributeCheck instanceof Function&&T.attributeCheck($,c))){if(!m[$]||g[$]){if(!(bn(c)&&(u.tagNameCheck instanceof RegExp&&ie(u.tagNameCheck,c)||u.tagNameCheck instanceof Function&&u.tagNameCheck(c))&&(u.attributeNameCheck instanceof RegExp&&ie(u.attributeNameCheck,$)||u.attributeNameCheck instanceof Function&&u.attributeNameCheck($,c))||$==="is"&&u.allowCustomizedBuiltInElements&&(u.tagNameCheck instanceof RegExp&&ie(u.tagNameCheck,y)||u.tagNameCheck instanceof Function&&u.tagNameCheck(y))))return!1}else if(!vt[$]){if(!ie(Be,Xe(y,st,""))){if(!(($==="src"||$==="xlink:href"||$==="href")&&c!=="script"&&Si(y,"data:")===0&&fn[c])){if(!(b&&!ie(Nt,Xe(y,st,"")))){if(y)return!1}}}}}}}return!0},bn=function(c){return c!=="annotation-xml"&&Bt(c,it)},Cn=function(c){be(Y.beforeSanitizeAttributes,c,null);const{attributes:$}=c;if(!$||Mt(c))return;const y={attrName:"",attrValue:"",keepAttr:!0,allowedAttributes:m,forceKeepAttr:void 0};let j=$.length;for(;j--;){const ne=$[j],{name:X,namespaceURI:ce,value:Ce}=ne,Ue=K(X),Ht=Ce;let J=X==="value"?Ht:bi(Ht);if(y.attrName=Ue,y.attrValue=J,y.keepAttr=!0,y.forceKeepAttr=void 0,be(Y.uponSanitizeAttribute,c,y),J=y.attrValue,Q&&(Ue==="id"||Ue==="name")&&(ke(X,c),J=xt+J),k&&ie(/((--!?|])>)|<\/(style|title|textarea)/i,J)){ke(X,c);continue}if(Ue==="attributename"&&Bt(J,"href")){ke(X,c);continue}if(y.forceKeepAttr)continue;if(!y.keepAttr){ke(X,c);continue}if(!v&&ie(/\/>/i,J)){ke(X,c);continue}w&&dt([ue,he,de],Nn=>{J=Xe(J,Nn," ")});const wn=K(c.nodeName);if(!Sn(wn,Ue,J)){ke(X,c);continue}if(H&&typeof C=="object"&&typeof C.getAttributeType=="function"&&!ce)switch(C.getAttributeType(wn,Ue)){case"TrustedHTML":{J=H.createHTML(J);break}case"TrustedScriptURL":{J=H.createScriptURL(J);break}}if(J!==Ht)try{ce?c.setAttributeNS(ce,X,J):c.setAttribute(X,J),Mt(c)?Ae(c):Gn(e.removed)}catch{ke(X,c)}}be(Y.afterSanitizeAttributes,c,null)},xr=function S(c){let $=null;const y=In(c);for(be(Y.beforeSanitizeShadowDOM,c,null);$=y.nextNode();)be(Y.uponSanitizeShadowNode,$,null),Rn($),Cn($),$.content instanceof i&&S($.content);be(Y.afterSanitizeShadowDOM,c,null)};return e.sanitize=function(S){let c=arguments.length>1&&arguments[1]!==void 0?arguments[1]:{},$=null,y=null,j=null,ne=null;if(Ot=!S,Ot&&(S="<!-->"),typeof S!="string"&&!yn(S))if(typeof S.toString=="function"){if(S=S.toString(),typeof S!="string")throw qe("dirty is not a string, aborting")}else throw qe("toString is not a function");if(!e.isSupported)return S;if(re||Pt(c),e.removed=[],typeof S=="string"&&(Ge=!1),Ge){if(S.nodeName){const Ce=K(S.nodeName);if(!P[Ce]||f[Ce])throw qe("root node is forbidden and cannot be sanitized in-place")}}else if(S instanceof l)$=An("<!---->"),y=$.ownerDocument.importNode(S,!0),y.nodeType===Ze.element&&y.nodeName==="BODY"||y.nodeName==="HTML"?$=y:$.appendChild(y);else{if(!me&&!w&&!O&&S.indexOf("<")===-1)return H&&pe?H.createHTML(S):S;if($=An(S),!$)return me?null:pe?D:""}$&&q&&Ae($.firstChild);const X=In(Ge?S:$);for(;j=X.nextNode();)Rn(j),Cn(j),j.content instanceof i&&xr(j.content);if(Ge)return S;if(me){if(te)for(ne=De.call($.ownerDocument);$.firstChild;)ne.appendChild($.firstChild);else ne=$;return(m.shadowroot||m.shadowrootmode)&&(ne=Re.call(n,ne,!0)),ne}let ce=O?$.outerHTML:$.innerHTML;return O&&P["!doctype"]&&$.ownerDocument&&$.ownerDocument.doctype&&$.ownerDocument.doctype.name&&ie(Lr,$.ownerDocument.doctype.name)&&(ce="<!DOCTYPE "+$.ownerDocument.doctype.name+`>
`+ce),w&&dt([ue,he,de],Ce=>{ce=Xe(ce,Ce," ")}),H&&pe?H.createHTML(ce):ce},e.setConfig=function(){let S=arguments.length>0&&arguments[0]!==void 0?arguments[0]:{};Pt(S),re=!0},e.clearConfig=function(){We=null,re=!1},e.isValidAttribute=function(S,c,$){We||Pt({});const y=K(S),j=K(c);return Sn(y,j,$)},e.addHook=function(S,c){typeof c=="function"&&Ye(Y[S],c)},e.removeHook=function(S,c){if(c!==void 0){const $=yi(Y[S],c);return $===-1?void 0:Ri(Y[S],$,1)[0]}return Gn(Y[S])},e.removeHooks=function(S){Y[S]=[]},e.removeAllHooks=function(){Y=qn()},e}var Bi=Er();function dn(s){return Bi.sanitize(s,{ALLOWED_TAGS:["p","div","span","br","strong","b","em","i","u","s","a","code","pre","h1","h2","h3","h4","h5","h6","ul","ol","li","blockquote","table","thead","tbody","tr","th","td","img","button","input","select","option","label","aside","section","details","summary"],ALLOWED_ATTR:["class","id","href","target","rel","src","alt","title","width","height","type","value","checked","selected","disabled","min","max","step","placeholder","data-command","data-command-template","data-setting-type","data-color-var","data-theme","data-settings-panel","data-graph","data-graph-src","data-graph-theme","data-graph-initialized","data-graph-error","style","open","role","aria-label","aria-labelledby","aria-describedby","aria-valuemin","aria-valuemax","aria-valuenow","aria-valuetext","aria-live","aria-atomic","aria-current"],RETURN_DOM:!1,RETURN_DOM_FRAGMENT:!1})}class Gi{headerElement;constructor(e){this.headerElement=e,this.render(),this.setupClickHandler()}render(){const e=Un.generateHeader(),t=Un.getTagline();this.headerElement.innerHTML=dn(`
...
`,to=Object.freeze(Object.defineProperty({__proto__:null,default:eo},Symbol.toStringTag,{value:"Module"})),no=`---
...
`,ro=Object.freeze(Object.defineProperty({__proto__:null,default:no},Symbol.toStringTag,{value:"Module"})),so=`---
...
`,io=Object.freeze(Object.defineProperty({__proto__:null,default:so},Symbol.toStringTag,{value:"Module"})),oo=`---
...
`,ao=Object.freeze(Object.defineProperty({__proto__:null,default:oo},Symbol.toStringTag,{value:"Module"})),lo=`---
...
`,_o=Object.freeze(Object.defineProperty({__proto__:null,default:lo},Symbol.toStringTag,{value:"Module"})),co=`# Darin Chambers
...
`,uo=Object.freeze(Object.defineProperty({__proto__:null,default:co},Symbol.toStringTag,{value:"Module"})),ho=`# Contact Information
...
`,mo=Object.freeze(Object.defineProperty({__proto__:null,default:ho},Symbol.toStringTag,{value:"Module"})),po=`# Terminal Help
