(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))n(r);new MutationObserver(r=>{for(const s of r)if(s.type==="childList")for(const i of s.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&n(i)}).observe(document,{childList:!0,subtree:!0});function t(r){const s={};return r.integrity&&(s.integrity=r.integrity),r.referrerPolicy&&(s.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?s.credentials="include":r.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function n(r){if(r.ep)return;r.ep=!0;const s=t(r);fetch(r.href,s)}})();const Ke=new Map;function Wo(){Ke.forEach(e=>{e.stopAnimation()}),Ke.clear(),document.querySelectorAll(".boot-overlay").forEach(e=>{e.remove()})}function ur(o){o.style.animation="boot-overlay-fade 0.3s ease forwards",o.addEventListener("animationend",()=>{o.remove()},{once:!0}),setTimeout(()=>{o.parentNode&&o.remove()},500)}function hn(o){Wo();const e=o.dataset.bootType??"boot";e==="boot"&&document.querySelectorAll(".boot-overlay").forEach(r=>{ur(r)});const t={element:o,bootType:e,overlay:null,cleanupFns:[],stopAnimation:()=>{t.cleanupFns.forEach(n=>n()),t.cleanupFns=[],t.overlay?.parentNode&&(ur(t.overlay),t.overlay=null),Ke.delete(o)}};if(Ke.set(o,t),e==="shutdown"||e==="reboot"){const n=o.querySelector("[data-boot-overlay]");if(n){t.overlay=n;const s=getComputedStyle(n).animationDelay,i=parseFloat(s)*(s.includes("ms")?1:1e3);setTimeout(()=>{Ke.has(o)&&n.parentNode&&document.body.appendChild(n)},i)}}Go(o,t)}function Go(o,e){const t=document.getElementById("terminal-output");if(t){const a=()=>{e.stopAnimation()};t.addEventListener("scroll",a,{once:!0}),e.cleanupFns.push(()=>{t.removeEventListener("scroll",a)})}const n=a=>{a.key==="Shift"||a.key==="Control"||a.key==="Alt"||a.key==="Meta"||e.stopAnimation()};setTimeout(()=>{Ke.has(o)&&(document.addEventListener("keydown",n,{once:!0}),e.cleanupFns.push(()=>{document.removeEventListener("keydown",n)}))},100);const r=()=>{e.stopAnimation()};setTimeout(()=>{Ke.has(o)&&(document.addEventListener("click",r,{once:!0}),e.cleanupFns.push(()=>{document.removeEventListener("click",r)}))},100);const s=new MutationObserver(()=>{o.nextElementSibling&&(e.stopAnimation(),s.disconnect())});t&&(s.observe(t,{childList:!0,subtree:!0}),e.cleanupFns.push(()=>{s.disconnect()}));const i=new MutationObserver(()=>{document.body.contains(o)||(e.stopAnimation(),i.disconnect())});i.observe(document.body,{childList:!0,subtree:!0}),e.cleanupFns.push(()=>{i.disconnect()})}function zo(){const o=new MutationObserver(n=>{n.forEach(r=>{r.addedNodes.forEach(s=>{if(s.nodeType===Node.ELEMENT_NODE){const i=s;i.classList.contains("boot-sequence")&&hn(i),i.querySelectorAll(".boot-sequence").forEach(l=>{hn(l)})}})})}),e=document.getElementById("terminal-output");e&&o.observe(e,{childList:!0,subtree:!0}),document.querySelectorAll(".boot-sequence").forEach(n=>{hn(n)})}const Ge=new Map;function Vo(){Ge.forEach(e=>{e.stopAnimation()}),Ge.clear(),document.querySelectorAll(".bsod-overlay").forEach(e=>{e.remove()})}function jo(o){o.style.animation="bsod-fade-out 0.3s ease forwards",o.addEventListener("animationend",()=>{o.remove()},{once:!0}),setTimeout(()=>{o.parentNode&&o.remove()},500)}function Yo(o,e){const t=o.querySelector("[data-bsod-progress]");if(!t)return;let n=0;const r=setInterval(()=>{if(!Ge.has(o)){clearInterval(r);return}n=(n+1)%101,t.textContent=String(n)},100);e.cleanupFns.push(()=>{clearInterval(r)})}function qo(o,e){const t=o.querySelector("[data-bsod-cursor]");if(!t)return;let n=!0;const r=setInterval(()=>{if(!Ge.has(o)){clearInterval(r);return}n=!n,t.style.visibility=n?"visible":"hidden"},530);e.cleanupFns.push(()=>{clearInterval(r)})}function pn(o){Vo();const e=o.dataset.bsodStyle??"modern",t={element:o,style:e,cleanupFns:[],stopAnimation:()=>{t.cleanupFns.forEach(n=>n()),t.cleanupFns=[],o.parentNode&&jo(o),Ge.delete(o)}};Ge.set(o,t),document.body.appendChild(o),e==="modern"?Yo(o,t):qo(o,t),Xo(o,t)}function Xo(o,e){const t=document.getElementById("terminal-output"),n=a=>{a.key==="Shift"||a.key==="Control"||a.key==="Alt"||a.key==="Meta"||e.stopAnimation()};setTimeout(()=>{Ge.has(o)&&(document.addEventListener("keydown",n,{once:!0}),e.cleanupFns.push(()=>{document.removeEventListener("keydown",n)}))},100);const r=()=>{e.stopAnimation()};setTimeout(()=>{Ge.has(o)&&(document.addEventListener("click",r,{once:!0}),e.cleanupFns.push(()=>{document.removeEventListener("click",r)}))},100);const s=new MutationObserver(a=>{for(const l of a)for(const d of l.addedNodes)if(d!==o&&d.nodeType===Node.ELEMENT_NODE){e.stopAnimation(),s.disconnect();return}});t&&(s.observe(t,{childList:!0,subtree:!0}),e.cleanupFns.push(()=>{s.disconnect()}));const i=new MutationObserver(()=>{document.body.contains(o)||(e.stopAnimation(),i.disconnect())});i.observe(document.body,{childList:!0,subtree:!0}),e.cleanupFns.push(()=>{i.disconnect()})}function Ko(){const o=new MutationObserver(n=>{n.forEach(r=>{r.addedNodes.forEach(s=>{if(s.nodeType===Node.ELEMENT_NODE){const i=s;i.hasAttribute("data-bsod")&&pn(i),i.querySelectorAll("[data-bsod]").forEach(l=>{pn(l)})}})})}),e=document.getElementById("terminal-output");e&&o.observe(e,{childList:!0,subtree:!0}),document.querySelectorAll("[data-bsod]").forEach(n=>{pn(n)})}const Gt=new Map;function Xr(o,e){return{width:o,height:e,cells:new Uint8Array(o*e),generation:0}}function Dn(o,e,t){return o.cells[t*o.width+e]}function ae(o,e,t,n){o.cells[t*o.width+e]=n}function _r(o,e){return(o%e+e)%e}function Zo(o,e,t){let n=0;for(let r=-1;r<=1;r++)for(let s=-1;s<=1;s++){if(s===0&&r===0)continue;const i=_r(e+s,o.width),a=_r(t+r,o.height);Dn(o,i,a)>0&&n++}return n}function Jo(o){const e=Xr(o.width,o.height);e.generation=o.generation+1;for(let t=0;t<o.height;t++)for(let n=0;n<o.width;n++){const r=Zo(o,n,t);Dn(o,n,t)>0?ae(e,n,t,r===2||r===3?1:0):ae(e,n,t,r===3?2:0)}return e}function Kr(o,e){for(let t=0;t<o.cells.length;t++)o.cells[t]=Math.random()<e?1:0}function Qo(o,e){const t=Math.floor(o.width/2),n=Math.floor(o.height/2);switch(e){case"acorn":ae(o,t+1,n-1,1),ae(o,t+3,n,1),ae(o,t,n+1,1),ae(o,t+1,n+1,1),ae(o,t+4,n+1,1),ae(o,t+5,n+1,1),ae(o,t+6,n+1,1);break;case"glider":ae(o,t+1,n-1,1),ae(o,t-1,n,1),ae(o,t+1,n,1),ae(o,t,n+1,1),ae(o,t+1,n+1,1);break;case"blinker":ae(o,t-1,n,1),ae(o,t,n,1),ae(o,t+1,n,1);break;default:Kr(o,.3)}}function mr(){const o=getComputedStyle(document.documentElement);return{accent:o.getPropertyValue("--terminal-accent").trim(),dim:o.getPropertyValue("--terminal-dim").trim(),bg:o.getPropertyValue("--terminal-bg").trim()}}function hr(o,e,t,n,r){o.fillStyle=t.bg,o.fillRect(0,0,o.canvas.width,o.canvas.height);for(let s=0;s<e.height;s++)for(let i=0;i<e.width;i++){const a=Dn(e,i,s);a!==0&&(o.fillStyle=a===2?t.accent:t.dim,o.globalAlpha=a===2?1:.7,o.fillRect(i*n,s*r,n,r))}o.globalAlpha=1}function Zr(){Gt.forEach(o=>{o.stopAnimation()}),Gt.clear()}function es(o,e){const t=()=>{e.stopAnimation()};window.addEventListener("scroll",t,{once:!0});const n=new MutationObserver(a=>{for(const l of a)if(l.type==="childList"&&l.addedNodes.length>0){for(const d of l.addedNodes)if(d instanceof HTMLElement&&d.classList.contains("output-line")){e.stopAnimation(),n.disconnect();return}}}),r=document.querySelector(".terminal-output");r&&n.observe(r,{childList:!0});const s=new MutationObserver(()=>{document.body.contains(o)||(e.stopAnimation(),s.disconnect())});s.observe(document.body,{childList:!0,subtree:!0});const i=e.stopAnimation;e.stopAnimation=()=>{window.removeEventListener("scroll",t),n.disconnect(),s.disconnect(),i()}}function pr(o,e,t,n){Zr();const r=o.getContext("2d");if(!r)return;const s=o.dataset.speed,i=o.dataset.density,a=o.dataset.pattern,l=s?parseFloat(s):e,d=i?parseFloat(i):t,u=a??n,$=10,f=Math.floor(o.width/$),E=Math.floor(o.height/$),R=o.width/f,L=o.height/E,y=Xr(f,E);u&&u!=="random"?Qo(y,u):Kr(y,d);const T={animationId:null,grid:y,canvas:o,speed:l,lastUpdate:performance.now(),cellWidth:R,cellHeight:L,stopAnimation:()=>{T.animationId!==null&&(cancelAnimationFrame(T.animationId),T.animationId=null),Gt.delete(o)}};Gt.set(o,T);const P=mr();hr(r,T.grid,P,T.cellWidth,T.cellHeight);function C(F){if(!T.animationId)return;const k=1e3/T.speed;if(F-T.lastUpdate>=k){T.grid=Jo(T.grid);const H=mr();r&&hr(r,T.grid,H,T.cellWidth,T.cellHeight),T.lastUpdate=F}T.animationId=requestAnimationFrame(C)}T.animationId=requestAnimationFrame(C),es(o,T)}function ts(){new MutationObserver(e=>{for(const t of e)if(t.type==="childList"){for(const n of t.addedNodes)if(n instanceof HTMLElement){n.classList.contains("life-grid")&&n instanceof HTMLCanvasElement&&pr(n,2,.3);const r=n.querySelectorAll(".life-grid");r.length>0&&requestAnimationFrame(()=>{r.forEach(s=>{pr(s,2,.3)})})}}}).observe(document.body,{childList:!0,subtree:!0})}const ct=new Map;function ns(){ct.forEach(e=>{e.stopAnimation()}),ct.clear(),document.querySelectorAll(".matrix-rain").forEach(e=>{e.querySelectorAll(".matrix-column").forEach(n=>{n.style.animationPlayState="paused"})})}function fn(o){ct.forEach((s,i)=>{s.stopAnimation(),i.querySelectorAll(".matrix-column").forEach(l=>{l.style.animationPlayState="paused"})}),ct.clear();const e=o.dataset.matrixChars??"";if(!e){console.warn("[Matrix] No character set found in data-matrix-chars");return}const t={animationId:null,frameCount:0,matrixChars:e,rainElement:o,stopAnimation:()=>{t.animationId&&(cancelAnimationFrame(t.animationId),t.animationId=null),ct.delete(o)}};ct.set(o,t);function n(){return e[Math.floor(Math.random()*e.length)]}function r(){t.frameCount++,o.querySelectorAll(".matrix-column").forEach(i=>{const a=i.querySelectorAll(".matrix-char"),l=parseInt(i.dataset.trailLength??"20");a.forEach((d,u)=>{if(d.classList.contains("matrix-char-bright"))(t.frameCount%45===0||t.frameCount%60===0&&Math.random()<.5)&&(d.textContent=n());else{const f=l-u-1,E=Math.max(8,Math.floor(f/2));t.frameCount%E===0&&Math.random()<.3&&(d.textContent=n())}})}),t.animationId=requestAnimationFrame(r)}t.animationId=requestAnimationFrame(r),rs(o,t)}function rs(o,e){const t=document.getElementById("terminal-output");if(t){const s=()=>{e.stopAnimation()};t.addEventListener("scroll",s,{once:!0})}const n=new MutationObserver(()=>{o.nextElementSibling&&(e.stopAnimation(),n.disconnect())});t&&n.observe(t,{childList:!0,subtree:!0});const r=new MutationObserver(()=>{document.body.contains(o)||(e.stopAnimation(),r.disconnect())});r.observe(document.body,{childList:!0,subtree:!0})}function os(){const o=new MutationObserver(n=>{n.forEach(r=>{r.addedNodes.forEach(s=>{if(s.nodeType===Node.ELEMENT_NODE){const i=s;i.classList.contains("matrix-rain")&&fn(i),i.querySelectorAll(".matrix-rain").forEach(l=>{fn(l)})}})})}),e=document.getElementById("terminal-output");e&&o.observe(e,{childList:!0,subtree:!0}),document.querySelectorAll(".matrix-rain").forEach(n=>{fn(n)})}const It=new Map;function ss(o){return()=>(o=o*1103515245+12345&2147483647,o/2147483647)}function gn(){It.forEach(t=>{t.cleanupFns.forEach(n=>n()),t.styleElement.remove(),t.container.remove()}),It.clear(),document.querySelectorAll(".melt-container").forEach(t=>t.remove()),document.querySelectorAll("style[data-melt-styles]").forEach(t=>t.remove())}function is(o,e,t){const n=/linear-gradient\(\s*(\d+)deg\s*,\s*(.+)\)/.exec(e);if(!n)return null;const r=parseInt(n[1]),s=n[2];let i,a,l,d;i=t.left,a=t.top,l=t.right,d=t.top;const u=o.createLinearGradient(i,a,l,d),$=s.matchAll(/(#[0-9a-fA-F]{6}|rgb[a]?\([^)]+\))\s*(\d+)?%?/g);for(const f of $){const E=f[1],R=f[2]?parseInt(f[2])/100:0;try{u.addColorStop(R,E)}catch{}}return u}function $n(o,e,t,n){try{const r=document.createTreeWalker(e,NodeFilter.SHOW_TEXT,null);let s;for(;s=r.nextNode();){const i=s.textContent||"";if(!i.trim())continue;const a=s.parentElement;if(!a)continue;const l=getComputedStyle(a),d=l.fontSize,u=l.fontFamily,$=l.fontWeight,f=document.createRange();if(f.selectNodeContents(s),typeof f.getClientRects!="function")continue;const E=f.getClientRects();if(E.length===0)continue;const L=(l.getPropertyValue("-webkit-background-clip")||l.backgroundClip)==="text";let y=l.color||n;if(L){const P=a.getBoundingClientRect(),C=l.backgroundImage;if(C?.includes("linear-gradient")){const F=is(o,C,P);F&&(y=F)}}o.fillStyle=y;const T=parseInt($)>=600?"bold ":"";o.font=`${T}${d} ${u||t}`;for(const P of E)P.width>0&&P.height>0&&o.fillText(i,P.left,P.top+P.height*.85)}}catch{}}function as(){const o=window.innerWidth,e=window.innerHeight,t=document.createElement("canvas");t.width=o,t.height=e;const n=t.getContext("2d"),r=getComputedStyle(document.documentElement),s=r.getPropertyValue("--terminal-bg").trim()||"#0a0a0a",i=r.getPropertyValue("--terminal-fg").trim()||"#00ff00",a=r.getPropertyValue("--terminal-font-family")||"monospace";n.fillStyle=s,n.fillRect(0,0,o,e);const l=document.querySelector("header");l&&$n(n,l,a,i);const d=document.getElementById("terminal-output");d&&$n(n,d,a,i);const u=document.querySelector(".terminal-input-container");return u&&$n(n,u,a,i),t}function fr(o){gn();const e=window.innerWidth,t=window.innerHeight,n=document.createElement("style");n.setAttribute("data-melt-styles",""),n.textContent=`
    @keyframes melt-drop {
      0% {
  ...
  `,document.head.appendChild(n);const r=document.createElement("div");r.className="melt-container";const i=as().toDataURL("image/png"),a=12,l=Math.ceil(e/a),d=ss(Date.now());for(let E=0;E<l;E++){const R=document.createElement("div");R.className="melt-column",R.style.left=`${E*a}px`,R.style.width=`${a}px`,R.style.height=`${t}px`,R.style.backgroundImage=`url(${i})`,R.style.backgroundPosition=`-${E*a}px 0`,R.style.backgroundSize=`${e}px ${t}px`;const y=Math.abs(E-l/2)/(l/2)*.4+d()*.3,T=2.5+d()*1.5;R.style.animation=`melt-drop ${T}s ease-in ${y}s forwards`,r.appendChild(R)}const u=document.createElement("div");u.className="melt-message",u.textContent="yeah, you probably shouldn't do that",u.style.animation="melt-message-fade 0.5s ease-out 2s forwards",r.appendChild(u),document.body.appendChild(r);const $={container:r,styleElement:n,cleanupFns:[]};It.set(o,$);const f=setTimeout(()=>{It.has(o)&&gn()},6500);$.cleanupFns.push(()=>clearTimeout(f)),setTimeout(()=>{if(!It.has(o))return;const E=()=>gn(),R=y=>{["Shift","Control","Alt","Meta"].includes(y.key)||E()},L=()=>E();document.addEventListener("keydown",R,{once:!0}),document.addEventListener("click",L,{once:!0}),$.cleanupFns.push(()=>{document.removeEventListener("keydown",R),document.removeEventListener("click",L)})},500)}function ls(){const o=new MutationObserver(t=>{t.forEach(n=>{n.addedNodes.forEach(r=>{if(r.nodeType===Node.ELEMENT_NODE){const s=r;s.hasAttribute("data-melt")&&fr(s),s.querySelectorAll("[data-melt]").forEach(a=>{fr(a)})}})})}),e=document.getElementById("terminal-output");e&&o.observe(e,{childList:!0,subtree:!0}),o.observe(document.body,{childList:!0,subtree:!0})}class W{flags=new Map;positionals=[];static VALUE_FLAGS=new Set(["f","L","w"]);constructor(e){const t=[];for(const n of e)if(n.startsWith("-")&&!n.startsWith("--")&&n.length>2)for(let r=1;r<n.length;r++)t.push(`-${n[r]}`);else t.push(n);for(let n=0;n<t.length;n++){const r=t[n];if(r.startsWith("--")){const s=r.substring(2),i=t[n+1];i!==void 0&&!i.startsWith("--")&&!i.startsWith("-")?(this.flags.set(s,i),n++):this.flags.set(s,!0)}else if(r.startsWith("-")&&r.length===2){const s=r.substring(1),i=t[n+1];i!==void 0&&!i.startsWith("-")&&(W.VALUE_FLAGS.has(s)||/^\d+$/.test(i))?(this.flags.set(s,i),n++):this.flags.set(s,!0)}else this.positionals.push(r)}}getFlag(e){return this.flags.get(e)}hasFlag(e){return this.flags.has(e)}getPositional(e){return this.positionals[e]}getAllFlags(){return new Map(this.flags)}getAllPositionals(){return[...this.positionals]}get positionalCount(){return this.positionals.length}}function cs(o){return{name:"alias",description:"Create or display command aliases",execute:(e,t)=>{if(new W(e).hasFlag("help"))return{output:`Usage: alias [name='command']
...
`)}}const r=e.join(" "),s=/^(\S+)=(.+)$/.exec(r);if(!s)return{output:`Usage: alias name='command'
       alias (to list all aliases)`,error:!0};const[,i,a]=s;try{return o.setAlias(i,a),{output:`Alias created: ${i}='${a}'`}}catch(l){return{output:l instanceof Error?l.message:String(l),error:!0}}}}}const ds={name:"date",description:"Display current date and time",execute:(o,e)=>new W(o).hasFlag("help")?{output:`Usage: date

Description:
  Display the current date and time in the system's default format

Examples:
  date                 # Show current date and time`}:{output:new Date().toString()}},us={name:"echo",description:"Display a line of text",execute:(o,e)=>{if(new W(o).hasFlag("help"))return{output:`Usage: echo [options] [text...]
...
Examples:
  ...
  cat file.txt | echo  # Pass through stdin`};let n=!1;const r=[];for(const i of o)i==="-e"?n=!0:r.push(i);let s;return r.length===0&&e?(s=e,s.endsWith(`
`)&&(s=s.slice(0,-1))):s=r.join(" "),n&&(s=s.replace(/\\n/g,`
`).replace(/\\t/g,"	").replace(/\\r/g,"\r").replace(/\\b/g,"\b").replace(/\\f/g,"\f").replace(/\\v/g,"\v").replace(/\\\\/g,"\\")),{output:s}}};function _s(o){return{name:"env",description:"Display all environment variables",execute:(e,t)=>{if(new W(e).hasFlag("help"))return{output:`Usage: env
...
...just kidding. Welcome back.`];function ms(o,e,t,n){return{name:"exit",description:"Exit the current session",aliases:["logout"],execute:(r,s)=>{if(new W(r).hasFlag("help"))return{output:`Usage: exit
...
Examples:
  ...
  logout               # Same as exit`};if(o.getUsername()==="root")return o.setUsername("darin"),e.setVariable("HOME","/home/darin"),e.setVariable("USER","darin"),e.setVariable("PWD","/home/darin"),t.changeDirectory("/home/darin"),n(t.getShortPath()),{output:""};const a=Math.floor(Math.random()*gr.length);return{output:gr[a]}}}}function hs(o){return{name:"export",description:"Set or display environment variables",execute:(e,t)=>{if(new W(e).hasFlag("help"))return{output:`Usage: export [VAR=value] [VAR]
...
Examples:
  ...
  export USER          # Display single variable`};try{if(e.length===0){const s=o.getAllVariables();return s.size===0?{output:""}:{output:Array.from(s.entries()).sort((l,d)=>l[0].localeCompare(d[0])).map(([l,d])=>`${l}=${d}`).join(`
`)}}const r=[];for(const s of e){const i=/^([A-Za-z_][A-Za-z0-9_]*)=(.*)$/.exec(s);if(i){const[,a,l]=i;o.setVariable(a,l)}else{const a=o.getVariable(s);a!==void 0?r.push(`${s}=${a}`):r.push(`export: ${s}: not found`)}}return{output:r.join(`
`)}}catch(r){return{output:r instanceof Error?r.message:String(r),error:!0}}}}}function ps(o){return{name:"history",description:"Display command history",execute:(e,t)=>{if(new W(e).hasFlag("help"))return{output:`Usage: history

Description:
  Display command history with line numbers

Examples:
  history              # Show all commands`};const r=o.getHistory();return r.length===0?{output:"No commands in history."}:{output:r.map((i,a)=>`${(a+1).toString().padStart(5," ")}  ${i}`).join(`
`)}}}}function fs(o){return{name:"man",description:"Display manual pages for commands",execute:async(e,t)=>{const n=new W(e);if(n.hasFlag("help"))return{output:`Usage: man <command>
...
For example, try 'man help'.`,error:!0};const s=r[0].toLowerCase();if(!o.getCommandNames().includes(s))return{output:`No manual entry for ${r[0]}`,error:!0};const l=o.getCommands().find(P=>P.name===s),d=l?l.description:s,$=(await o.dispatch(`${s} --help`)).output,f=`${s}(1)`,E="User Commands",R=Math.max(0,60-f.length*2-E.length),L=`${f}${" ".repeat(Math.floor(R/2))}${E}${" ".repeat(Math.ceil(R/2))}${f}`,y=["help","which"].filter(P=>P!==s).map(P=>`${P}(1)`).join(", ");return{output:[L,"","NAME",`    ${s} - ${d}`,"",$,"","SEE ALSO",`    ${y}`].join(`
...
`),n=this.findFrontmatterEnd(t);if(n===-1)return{frontmatter:null,content:e};const r=t.slice(1,n),s=t.slice(n+1);return{frontmatter:this.parseFrontmatterLines(r),content:s.join(`
`)}}static findFrontmatterEnd(e){for(let t=1;t<e.length;t++)if(e[t].trim()==="---")return t;return-1}static parseFrontmatterLines(e){const t={};for(const n of e){const r=n.indexOf(":");if(r===-1)continue;const s=n.substring(0,r).trim(),i=n.substring(r+1).trim();if(i.startsWith("[")&&i.endsWith("]")){const a=i.substring(1,i.length-1);t[s]=a.split(",").map(l=>l.trim().replace(/^["']|["']$/g,"")).filter(l=>l.length>0)}else t[s]=i.replace(/^["']|["']$/g,"")}return t}static renderFrontmatter(e){const t=[];e.title&&typeof e.title=="string"&&t.push(`<h1 class="fm-title">${Me(e.title)}</h1>`);const n=[];if(e.date&&typeof e.date=="string"&&n.push(`<span class="fm-date">${Me(e.date)}</span>`),e.tags&&Array.isArray(e.tags)){const r=e.tags.map(s=>`<span class="fm-tag">${Me(s)}</span>`).join(" ");n.push(`<span class="fm-tags">${r}</span>`)}return n.length>0&&t.push(`<div class="fm-meta">${n.join(" • ")}</div>`),e.summary&&typeof e.summary=="string"&&t.push(`<p class="fm-summary">${Me(e.summary)}</p>`),t.length>0&&t.push('<hr class="fm-divider">'),t.join(`
`)}}function Mn(){return{async:!1,breaks:!1,extensions:null,gfm:!0,hooks:null,pedantic:!1,renderer:null,silent:!1,tokenizer:null,walkTokens:null}}var Qe=Mn();function Jr(o){Qe=o}var bt={exec:()=>null};function Y(o,e=""){let t=typeof o=="string"?o:o.source,n={replace:(r,s)=>{let i=typeof s=="string"?s:s.source;return i=i.replace(ge.caret,"$1"),t=t.replace(r,i),n},getRegex:()=>new RegExp(t,e)};return n}var gs=(()=>{try{return!!new RegExp("(?<=1)(?<!1)")}catch{return!1}})(),ge={codeRemoveIndent:/^(?: {1,4}| {0,3}\t)/gm,outputLinkReplace:/\\([\[\]])/g,indentCodeCompensation:/^(\s+)(?:```)/,beginningSpace:/^\s+/,endingHash:/#$/,startingSpaceChar:/^ /,endingSpaceChar:/ $/,nonSpaceChar:/[^ ]/,newLineCharGlobal:/\n/g,tabCharGlobal:/\t/g,multipleSpaceGlobal:/\s+/g,blankLine:/^[ \t]*$/,doubleBlankLine:/\n[ \t]*\n[ \t]*$/,blockquoteStart:/^ {0,3}>/,blockquoteSetextReplace:/\n {0,3}((?:=+|-+) *)(?=\n|$)/g,blockquoteSetextReplace2:/^ {0,3}>[ \t]?/gm,listReplaceTabs:/^\t+/,listReplaceNesting:/^ {1,4}(?=( {4})*[^ ])/g,listIsTask:/^\[[ xX]\] +\S/,listReplaceTask:/^\[[ xX]\] +/,listTaskCheckbox:/\[[ xX]\]/,anyLine:/\n.*\n/,hrefBrackets:/^<(.*)>$/,tableDelimiter:/[:|]/,tableAlignChars:/^\||\| *$/g,tableRowBlankLine:/\n[ \t]*$/,tableAlignRight:/^ *-+: *$/,tableAlignCenter:/^ *:-+: *$/,tableAlignLeft:/^ *:-+ *$/,startATag:/^<a /i,endATag:/^<\/a>/i,startPreScriptTag:/^<(pre|code|kbd|script)(\s|>)/i,endPreScriptTag:/^<\/(pre|code|kbd|script)(\s|>)/i,startAngleBracket:/^</,endAngleBracket:/>$/,pedanticHrefTitle:/^([^'"]*[^\s])\s+(['"])(.*)\2/,unicodeAlphaNumeric:/[\p{L}\p{N}]/u,escapeTest:/[&<>"']/,escapeReplace:/[&<>"']/g,escapeTestNoEncode:/[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/,escapeReplaceNoEncode:/[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/g,unescapeTest:/&(#(?:\d+)|(?:#x[0-9A-Fa-f]+)|(?:\w+));?/ig,caret:/(^|[^\[])\^/g,percentDecode:/%25/g,findPipe:/\|/g,splitPipe:/ \|/,slashPipe:/\\\|/g,carriageReturn:/\r\n|\r/g,spaceLine:/^ +$/gm,notSpaceStart:/^\S*/,endingNewline:/\n$/,listItemRegex:o=>new RegExp(`^( {0,3}${o})((?:[	 ][^\\n]*)?(?:\\n|$))`),nextBulletRegex:o=>new RegExp(`^ {0,${Math.min(3,o-1)}}(?:[*+-]|\\d{1,9}[.)])((?:[ 	][^\\n]*)?(?:\\n|$))`),hrRegex:o=>new RegExp(`^ {0,${Math.min(3,o-1)}}((?:- *){3,}|(?:_ *){3,}|(?:\\* *){3,})(?:\\n+|$)`),fencesBeginRegex:o=>new RegExp(`^ {0,${Math.min(3,o-1)}}(?:\`\`\`|~~~)`),headingBeginRegex:o=>new RegExp(`^ {0,${Math.min(3,o-1)}}#`),htmlBeginRegex:o=>new RegExp(`^ {0,${Math.min(3,o-1)}}<(?:[a-z].*>|!--)`,"i")},$s=/^(?:[ \t]*(?:\n|$))+/,Ts=/^((?: {4}| {0,3}\t)[^\n]+(?:\n(?:[ \t]*(?:\n|$))*)?)+/,ys=/^ {0,3}(`{3,}(?=[^`\n]*(?:\n|$))|~{3,})([^\n]*)(?:\n|$)(?:|([\s\S]*?)(?:\n|$))(?: {0,3}\1[~`]* *(?=\n|$)|$)/,wt=/^ {0,3}((?:-[\t ]*){3,}|(?:_[ \t]*){3,}|(?:\*[ \t]*){3,})(?:\n+|$)/,As=/^ {0,3}(#{1,6})(?=\s|$)(.*)(?:\n+|$)/,Pn=/(?:[*+-]|\d{1,9}[.)])/,Qr=/^(?!bull |blockCode|fences|blockquote|heading|html|table)((?:.|\n(?!\s*?\n|bull |blockCode|fences|blockquote|heading|html|table))+?)\n {0,3}(=+|-+) *(?:\n+|$)/,eo=Y(Qr).replace(/bull/g,Pn).replace(/blockCode/g,/(?: {4}| {0,3}\t)/).replace(/fences/g,/ {0,3}(?:`{3,}|~{3,})/).replace(/blockquote/g,/ {0,3}>/).replace(/heading/g,/ {0,3}#{1,6}/).replace(/html/g,/ {0,3}<[^\n>]+>\n/).replace(/\|table/g,"").getRegex(),Es=Y(Qr).replace(/bull/g,Pn).replace(/blockCode/g,/(?: {4}| {0,3}\t)/).replace(/fences/g,/ {0,3}(?:`{3,}|~{3,})/).replace(/blockquote/g,/ {0,3}>/).replace(/heading/g,/ {0,3}#{1,6}/).replace(/html/g,/ {0,3}<[^\n>]+>\n/).replace(/table/g,/ {0,3}\|?(?:[:\- ]*\|)+[\:\- ]*\n/).getRegex(),Fn=/^([^\n]+(?:\n(?!hr|heading|lheading|blockquote|fences|list|html|table| +\n)[^\n]+)*)/,Ls=/^[^\n]+/,Hn=/(?!\s*\])(?:\\[\s\S]|[^\[\]\\])+/,Is=Y(/^ {0,3}\[(label)\]: *(?:\n[ \t]*)?([^<\s][^\s]*|<.*?>)(?:(?: +(?:\n[ \t]*)?| *\n[ \t]*)(title))? *(?:\n+|$)/).replace("label",Hn).replace("title",/(?:"(?:\\"?|[^"\\])*"|'[^'\n]*(?:\n[^'\n]+)*\n?'|\([^()]*\))/).getRegex(),bs=Y(/^( {0,3}bull)([ \t][^\n]+?)?(?:\n|$)/).replace(/bull/g,Pn).getRegex(),Xt="address|article|aside|base|basefont|blockquote|body|caption|center|col|colgroup|dd|details|dialog|dir|div|dl|dt|fieldset|figcaption|figure|footer|form|frame|frameset|h[1-6]|head|header|hr|html|iframe|legend|li|link|main|menu|menuitem|meta|nav|noframes|ol|optgroup|option|p|param|search|section|summary|table|tbody|td|tfoot|th|thead|title|tr|track|ul",Un=/<!--(?:-?>|[\s\S]*?(?:-->|$))/,ws=Y("^ {0,3}(?:<(script|pre|style|textarea)[\\s>][\\s\\S]*?(?:</\\1>[^\\n]*\\n+|$)|comment[^\\n]*(\\n+|$)|<\\?[\\s\\S]*?(?:\\?>\\n*|$)|<![A-Z][\\s\\S]*?(?:>\\n*|$)|<!\\[CDATA\\[[\\s\\S]*?(?:\\]\\]>\\n*|$)|</?(tag)(?: +|\\n|/?>)[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$)|<(?!script|pre|style|textarea)([a-z][\\w-]*)(?:attribute)*? */?>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$)|</(?!script|pre|style|textarea)[a-z][\\w-]*\\s*>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$))","i").replace("comment",Un).replace("tag",Xt).replace("attribute",/ +[a-zA-Z:_][\w.:-]*(?: *= *"[^"\n]*"| *= *'[^'\n]*'| *= *[^\s"'=<>`]+)?/).getRegex(),to=Y(Fn).replace("hr",wt).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("|lheading","").replace("|table","").replace("blockquote"," {0,3}>").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)]) ").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",Xt).getRegex(),Ss=Y(/^( {0,3}> ?(paragraph|[^\n]*)(?:\n|$))+/).replace("paragraph",to).getRegex(),Bn={blockquote:Ss,code:Ts,def:Is,fences:ys,heading:As,hr:wt,html:ws,lheading:eo,list:bs,newline:$s,paragraph:to,table:bt,text:Ls},Tr=Y("^ *([^\\n ].*)\\n {0,3}((?:\\| *)?:?-+:? *(?:\\| *:?-+:? *)*(?:\\| *)?)(?:\\n((?:(?! *\\n|hr|heading|blockquote|code|fences|list|html).*(?:\\n|$))*)\\n*|$)").replace("hr",wt).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("blockquote"," {0,3}>").replace("code","(?: {4}| {0,3}	)[^\\n]").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)]) ").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",Xt).getRegex(),vs={...Bn,lheading:Es,table:Tr,paragraph:Y(Fn).replace("hr",wt).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("|lheading","").replace("table",Tr).replace("blockquote"," {0,3}>").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)]) ").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",Xt).getRegex()},Cs={...Bn,html:Y(`^ *(?:comment *(?:\\n|\\s*$)|<(tag)[\\s\\S]+?</\\1> *(?:\\n{2,}|\\s*$)|<tag(?:"[^"]*"|'[^']*'|\\s[^'"/>\\s]*)*?/?> *(?:\\n{2,}|\\s*$))`).replace("comment",Un).replace(/tag/g,"(?!(?:a|em|strong|small|s|cite|q|dfn|abbr|data|time|code|var|samp|kbd|sub|sup|i|b|u|mark|ruby|rt|rp|bdi|bdo|span|br|wbr|ins|del|img)\\b)\\w+(?!:|[^\\w\\s@]*@)\\b").getRegex(),def:/^ *\[([^\]]+)\]: *<?([^\s>]+)>?(?: +(["(][^\n]+[")]))? *(?:\n+|$)/,heading:/^(#{1,6})(.*)(?:\n+|$)/,fences:bt,lheading:/^(.+?)\n {0,3}(=+|-+) *(?:\n+|$)/,paragraph:Y(Fn).replace("hr",wt).replace("heading",` *#{1,6} *[^
]`).replace("lheading",eo).replace("|table","").replace("blockquote"," {0,3}>").replace("|fences","").replace("|list","").replace("|html","").replace("|tag","").getRegex()},Rs=/^\\([!"#$%&'()*+,\-./:;<=>?@\[\]\\^_`{|}~])/,xs=/^(`+)([^`]|[^`][\s\S]*?[^`])\1(?!`)/,no=/^( {2,}|\\)\n(?!\s*$)/,Ns=/^(`+|[^`])(?:(?= {2,}\n)|[\s\S]*?(?:(?=[\\<!\[`*_]|\b_|$)|[^ ](?= {2,}\n)))/,Kt=/[\p{P}\p{S}]/u,Wn=/[\s\p{P}\p{S}]/u,ro=/[^\s\p{P}\p{S}]/u,ks=Y(/^((?![*_])punctSpace)/,"u").replace(/punctSpace/g,Wn).getRegex(),oo=/(?!~)[\p{P}\p{S}]/u,Os=/(?!~)[\s\p{P}\p{S}]/u,Ds=/(?:[^\s\p{P}\p{S}]|~)/u,Ms=Y(/link|precode-code|html/,"g").replace("link",/\[(?:[^\[\]`]|(?<a>`+)[^`]+\k<a>(?!`))*?\]\((?:\\[\s\S]|[^\\\(\)]|\((?:\\[\s\S]|[^\\\(\)])*\))*\)/).replace("precode-",gs?"(?<!`)()":"(^^|[^`])").replace("code",/(?<b>`+)[^`]+\k<b>(?!`)/).replace("html",/<(?! )[^<>]*?>/).getRegex(),so=/^(?:\*+(?:((?!\*)punct)|[^\s*]))|^_+(?:((?!_)punct)|([^\s_]))/,Ps=Y(so,"u").replace(/punct/g,Kt).getRegex(),Fs=Y(so,"u").replace(/punct/g,oo).getRegex(),io="^[^_*]*?__[^_*]*?\\*[^_*]*?(?=__)|[^*]+(?=[^*])|(?!\\*)punct(\\*+)(?=[\\s]|$)|notPunctSpace(\\*+)(?!\\*)(?=punctSpace|$)|(?!\\*)punctSpace(\\*+)(?=notPunctSpace)|[\\s](\\*+)(?!\\*)(?=punct)|(?!\\*)punct(\\*+)(?!\\*)(?=punct)|notPunctSpace(\\*+)(?=notPunctSpace)",Hs=Y(io,"gu").replace(/notPunctSpace/g,ro).replace(/punctSpace/g,Wn).replace(/punct/g,Kt).getRegex(),Us=Y(io,"gu").replace(/notPunctSpace/g,Ds).replace(/punctSpace/g,Os).replace(/punct/g,oo).getRegex(),Bs=Y("^[^_*]*?\\*\\*[^_*]*?_[^_*]*?(?=\\*\\*)|[^_]+(?=[^_])|(?!_)punct(_+)(?=[\\s]|$)|notPunctSpace(_+)(?!_)(?=punctSpace|$)|(?!_)punctSpace(_+)(?=notPunctSpace)|[\\s](_+)(?!_)(?=punct)|(?!_)punct(_+)(?!_)(?=punct)","gu").replace(/notPunctSpace/g,ro).replace(/punctSpace/g,Wn).replace(/punct/g,Kt).getRegex(),Ws=Y(/\\(punct)/,"gu").replace(/punct/g,Kt).getRegex(),Gs=Y(/^<(scheme:[^\s\x00-\x1f<>]*|email)>/).replace("scheme",/[a-zA-Z][a-zA-Z0-9+.-]{1,31}/).replace("email",/[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+(@)[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)+(?![-_])/).getRegex(),zs=Y(Un).replace("(?:-->|$)","-->").getRegex(),Vs=Y("^comment|^</[a-zA-Z][\\w:-]*\\s*>|^<[a-zA-Z][\\w-]*(?:attribute)*?\\s*/?>|^<\\?[\\s\\S]*?\\?>|^<![a-zA-Z]+\\s[\\s\\S]*?>|^<!\\[CDATA\\[[\\s\\S]*?\\]\\]>").replace("comment",zs).replace("attribute",/\s+[a-zA-Z:_][\w.:-]*(?:\s*=\s*"[^"]*"|\s*=\s*'[^']*'|\s*=\s*[^\s"'=<>`]+)?/).getRegex(),zt=/(?:\[(?:\\[\s\S]|[^\[\]\\])*\]|\\[\s\S]|`+[^`]*?`+(?!`)|[^\[\]\\`])*?/,js=Y(/^!?\[(label)\]\(\s*(href)(?:(?:[ \t]*(?:\n[ \t]*)?)(title))?\s*\)/).replace("label",zt).replace("href",/<(?:\\.|[^\n<>\\])+>|[^ \t\n\x00-\x1f]*/).replace("title",/"(?:\\"?|[^"\\])*"|'(?:\\'?|[^'\\])*'|\((?:\\\)?|[^)\\])*\)/).getRegex(),ao=Y(/^!?\[(label)\]\[(ref)\]/).replace("label",zt).replace("ref",Hn).getRegex(),lo=Y(/^!?\[(ref)\](?:\[\])?/).replace("ref",Hn).getRegex(),Ys=Y("reflink|nolink(?!\\()","g").replace("reflink",ao).replace("nolink",lo).getRegex(),yr=/[hH][tT][tT][pP][sS]?|[fF][tT][pP]/,Gn={_backpedal:bt,anyPunctuation:Ws,autolink:Gs,blockSkip:Ms,br:no,code:xs,del:bt,emStrongLDelim:Ps,emStrongRDelimAst:Hs,emStrongRDelimUnd:Bs,escape:Rs,link:js,nolink:lo,punctuation:ks,reflink:ao,reflinkSearch:Ys,tag:Vs,text:Ns,url:bt},qs={...Gn,link:Y(/^!?\[(label)\]\((.*?)\)/).replace("label",zt).getRegex(),reflink:Y(/^!?\[(label)\]\s*\[([^\]]*)\]/).replace("label",zt).getRegex()},bn={...Gn,emStrongRDelimAst:Us,emStrongLDelim:Fs,url:Y(/^((?:protocol):\/\/|www\.)(?:[a-zA-Z0-9\-]+\.?)+[^\s<]*|^email/).replace("protocol",yr).replace("email",/[A-Za-z0-9._+-]+(@)[a-zA-Z0-9-_]+(?:\.[a-zA-Z0-9-_]*[a-zA-Z0-9])+(?![-_])/).getRegex(),_backpedal:/(?:[^?!.,:;*_'"~()&]+|\([^)]*\)|&(?![a-zA-Z0-9]+;$)|[?!.,:;*_'"~)]+(?!$))+/,del:/^(~~?)(?=[^\s~])((?:\\[\s\S]|[^\\])*?(?:\\[\s\S]|[^\s~\\]))\1(?=[^~]|$)/,text:Y(/^([`~]+|[^`~])(?:(?= {2,}\n)|(?=[a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-]+@)|[\s\S]*?(?:(?=[\\<!\[`*~_]|\b_|protocol:\/\/|www\.|$)|[^ ](?= {2,}\n)|[^a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-](?=[a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-]+@)))/).replace("protocol",yr).getRegex()},Xs={...bn,br:Y(no).replace("{2,}","*").getRegex(),text:Y(bn.text).replace("\\b_","\\b_| {2,}\\n").replace(/\{2,\}/g,"*").getRegex()},Ut={normal:Bn,gfm:vs,pedantic:Cs},ft={normal:Gn,gfm:bn,breaks:Xs,pedantic:qs},Ks={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},Ar=o=>Ks[o];function De(o,e){if(e){if(ge.escapeTest.test(o))return o.replace(ge.escapeReplace,Ar)}else if(ge.escapeTestNoEncode.test(o))return o.replace(ge.escapeReplaceNoEncode,Ar);return o}function Er(o){try{o=encodeURI(o).replace(ge.percentDecode,"%")}catch{return null}return o}function Lr(o,e){let t=o.replace(ge.findPipe,(s,i,a)=>{let l=!1,d=i;for(;--d>=0&&a[d]==="\\";)l=!l;return l?"|":" |"}),n=t.split(ge.splitPipe),r=0;if(n[0].trim()||n.shift(),n.length>0&&!n.at(-1)?.trim()&&n.pop(),e)if(n.length>e)n.splice(e);else for(;n.length<e;)n.push("");for(;r<n.length;r++)n[r]=n[r].trim().replace(ge.slashPipe,"|");return n}function gt(o,e,t){let n=o.length;if(n===0)return"";let r=0;for(;r<n&&o.charAt(n-r-1)===e;)r++;return o.slice(0,n-r)}function Zs(o,e){if(o.indexOf(e[1])===-1)return-1;let t=0;for(let n=0;n<o.length;n++)if(o[n]==="\\")n++;else if(o[n]===e[0])t++;else if(o[n]===e[1]&&(t--,t<0))return n;return t>0?-2:-1}function Ir(o,e,t,n,r){let s=e.href,i=e.title||null,a=o[1].replace(r.other.outputLinkReplace,"$1");n.state.inLink=!0;let l={type:o[0].charAt(0)==="!"?"image":"link",raw:t,href:s,title:i,text:a,tokens:n.inlineTokens(a)};return n.state.inLink=!1,l}function Js(o,e,t){let n=o.match(t.other.indentCodeCompensation);if(n===null)return e;let r=n[1];return e.split(`
`).map(s=>{let i=s.match(t.other.beginningSpace);if(i===null)return s;let[a]=i;return a.length>=r.length?s.slice(r.length):s}).join(`
...
`)}}}fences(o){let e=this.rules.block.fences.exec(o);if(e){let t=e[0],n=Js(t,e[3]||"",this.rules);return{type:"code",raw:t,lang:e[2]?e[2].trim().replace(this.rules.inline.anyPunctuation,"$1"):e[2],text:n}}}heading(o){let e=this.rules.block.heading.exec(o);if(e){let t=e[2].trim();if(this.rules.other.endingHash.test(t)){let n=gt(t,"#");(this.options.pedantic||!n||this.rules.other.endingSpaceChar.test(n))&&(t=n.trim())}return{type:"heading",raw:e[0],depth:e[1].length,text:t,tokens:this.lexer.inline(t)}}}hr(o){let e=this.rules.block.hr.exec(o);if(e)return{type:"hr",raw:gt(e[0],`
`)}}blockquote(o){let e=this.rules.block.blockquote.exec(o);if(e){let t=gt(e[0],`
`).split(`
`),n="",r="",s=[];for(;t.length>0;){let i=!1,a=[],l;for(l=0;l<t.length;l++)if(this.rules.other.blockquoteStart.test(t[l]))a.push(t[l]),i=!0;else if(!i)a.push(t[l]);else break;t=t.slice(l);let d=a.join(`
`),u=d.replace(this.rules.other.blockquoteSetextReplace,`
    $1`).replace(this.rules.other.blockquoteSetextReplace2,"");n=n?`${n}
${d}`:d,r=r?`${r}
${u}`:u;let $=this.lexer.state.top;if(this.lexer.state.top=!0,this.lexer.blockTokens(u,s,!0),this.lexer.state.top=$,t.length===0)break;let f=s.at(-1);if(f?.type==="code")break;if(f?.type==="blockquote"){let E=f,R=E.raw+`
`+t.join(`
`),L=this.blockquote(R);s[s.length-1]=L,n=n.substring(0,n.length-E.raw.length)+L.raw,r=r.substring(0,r.length-E.text.length)+L.text;break}else if(f?.type==="list"){let E=f,R=E.raw+`
`+t.join(`
`),L=this.list(R);s[s.length-1]=L,n=n.substring(0,n.length-f.raw.length)+L.raw,r=r.substring(0,r.length-E.raw.length)+L.raw,t=R.substring(s.at(-1).raw.length).split(`
`);continue}}return{type:"blockquote",raw:n,tokens:s,text:r}}}list(o){let e=this.rules.block.list.exec(o);if(e){let t=e[1].trim(),n=t.length>1,r={type:"list",raw:"",ordered:n,start:n?+t.slice(0,-1):"",loose:!1,items:[]};t=n?`\\d{1,9}\\${t.slice(-1)}`:`\\${t}`,this.options.pedantic&&(t=n?t:"[*+-]");let s=this.rules.other.listItemRegex(t),i=!1;for(;o;){let l=!1,d="",u="";if(!(e=s.exec(o))||this.rules.block.hr.test(o))break;d=e[0],o=o.substring(d.length);let $=e[2].split(`
...
`}hr(o){return`<hr>
`}list(o){let e=o.ordered,t=o.start,n="";for(let i=0;i<o.items.length;i++){let a=o.items[i];n+=this.listitem(a)}let r=e?"ol":"ul",s=e&&t!==1?' start="'+t+'"':"";return"<"+r+s+`>
`+n+"</"+r+`>
...
`}table(o){let e="",t="";for(let r=0;r<o.header.length;r++)t+=this.tablecell(o.header[r]);e+=this.tablerow({text:t});let n="";for(let r=0;r<o.rows.length;r++){let s=o.rows[r];t="";for(let i=0;i<s.length;i++)t+=this.tablecell(s[i]);n+=this.tablerow({text:t})}return n&&(n=`<tbody>${n}</tbody>`),`<table>
<thead>
`+e+`</thead>
`+n+`</table>
...
`}strong({tokens:o}){return`<strong>${this.parser.parseInline(o)}</strong>`}em({tokens:o}){return`<em>${this.parser.parseInline(o)}</em>`}codespan({text:o}){return`<code>${De(o,!0)}</code>`}br(o){return"<br>"}del({tokens:o}){return`<del>${this.parser.parseInline(o)}</del>`}link({href:o,title:e,tokens:t}){let n=this.parser.parseInline(t),r=Er(o);if(r===null)return n;o=r;let s='<a href="'+o+'"';return e&&(s+=' title="'+De(e)+'"'),s+=">"+n+"</a>",s}image({href:o,title:e,text:t,tokens:n}){n&&(t=this.parser.parseInline(n,this.parser.textRenderer));let r=Er(o);if(r===null)return De(t);o=r;let s=`<img src="${o}" alt="${t}"`;return e&&(s+=` title="${De(e)}"`),s+=">",s}text(o){return"tokens"in o&&o.tokens?this.parser.parseInline(o.tokens):"escaped"in o&&o.escaped?o.text:De(o.text)}},zn=class{strong({text:o}){return o}em({text:o}){return o}codespan({text:o}){return o}del({text:o}){return o}html({text:o}){return o}text({text:o}){return o}link({text:o}){return""+o}image({text:o}){return""+o}br(){return""}checkbox({raw:o}){return o}},we=class Sn{options;renderer;textRenderer;constructor(e){this.options=e||Qe,this.options.renderer=this.options.renderer||new jt,this.renderer=this.options.renderer,this.renderer.options=this.options,this.renderer.parser=this,this.textRenderer=new zn}static parse(e,t){return new Sn(t).parse(e)}static parseInline(e,t){return new Sn(t).parseInline(e)}parse(e){let t="";for(let n=0;n<e.length;n++){let r=e[n];if(this.options.extensions?.renderers?.[r.type]){let i=r,a=this.options.extensions.renderers[i.type].call({parser:this},i);if(a!==!1||!["space","hr","heading","code","table","blockquote","list","html","def","paragraph","text"].includes(i.type)){t+=a||"";continue}}let s=r;switch(s.type){case"space":{t+=this.renderer.space(s);break}case"hr":{t+=this.renderer.hr(s);break}case"heading":{t+=this.renderer.heading(s);break}case"code":{t+=this.renderer.code(s);break}case"table":{t+=this.renderer.table(s);break}case"blockquote":{t+=this.renderer.blockquote(s);break}case"list":{t+=this.renderer.list(s);break}case"checkbox":{t+=this.renderer.checkbox(s);break}case"html":{t+=this.renderer.html(s);break}case"def":{t+=this.renderer.def(s);break}case"paragraph":{t+=this.renderer.paragraph(s);break}case"text":{t+=this.renderer.text(s);break}default:{let i='Token with "'+s.type+'" type was not found.';if(this.options.silent)return console.error(i),"";throw new Error(i)}}}return t}parseInline(e,t=this.renderer){let n="";for(let r=0;r<e.length;r++){let s=e[r];if(this.options.extensions?.renderers?.[s.type]){let a=this.options.extensions.renderers[s.type].call({parser:this},s);if(a!==!1||!["escape","html","link","image","strong","em","codespan","br","del","text"].includes(s.type)){n+=a||"";continue}}let i=s;switch(i.type){case"escape":{n+=t.text(i);break}case"html":{n+=t.html(i);break}case"link":{n+=t.link(i);break}case"image":{n+=t.image(i);break}case"checkbox":{n+=t.checkbox(i);break}case"strong":{n+=t.strong(i);break}case"em":{n+=t.em(i);break}case"codespan":{n+=t.codespan(i);break}case"br":{n+=t.br(i);break}case"del":{n+=t.del(i);break}case"text":{n+=t.text(i);break}default:{let a='Token with "'+i.type+'" type was not found.';if(this.options.silent)return console.error(a),"";throw new Error(a)}}}return n}},At=class{options;block;constructor(o){this.options=o||Qe}static passThroughHooks=new Set(["preprocess","postprocess","processAllTokens","emStrongMask"]);static passThroughHooksRespectAsync=new Set(["preprocess","postprocess","processAllTokens"]);preprocess(o){return o}postprocess(o){return o}processAllTokens(o){return o}emStrongMask(o){return o}provideLexer(){return this.block?be.lex:be.lexInline}provideParser(){return this.block?we.parse:we.parseInline}},Qs=class{defaults=Mn();options=this.setOptions;parse=this.parseMarkdown(!0);parseInline=this.parseMarkdown(!1);Parser=we;Renderer=jt;TextRenderer=zn;Lexer=be;Tokenizer=Vt;Hooks=At;constructor(...o){this.use(...o)}walkTokens(o,e){let t=[];for(let n of o)switch(t=t.concat(e.call(this,n)),n.type){case"table":{let r=n;for(let s of r.header)t=t.concat(this.walkTokens(s.tokens,e));for(let s of r.rows)for(let i of s)t=t.concat(this.walkTokens(i.tokens,e));break}case"list":{let r=n;t=t.concat(this.walkTokens(r.items,e));break}default:{let r=n;this.defaults.extensions?.childTokens?.[r.type]?this.defaults.extensions.childTokens[r.type].forEach(s=>{let i=r[s].flat(1/0);t=t.concat(this.walkTokens(i,e))}):r.tokens&&(t=t.concat(this.walkTokens(r.tokens,e)))}}return t}use(...o){let e=this.defaults.extensions||{renderers:{},childTokens:{}};return o.forEach(t=>{let n={...t};if(n.async=this.defaults.async||n.async||!1,t.extensions&&(t.extensions.forEach(r=>{if(!r.name)throw new Error("extension name required");if("renderer"in r){let s=e.renderers[r.name];s?e.renderers[r.name]=function(...i){let a=r.renderer.apply(this,i);return a===!1&&(a=s.apply(this,i)),a}:e.renderers[r.name]=r.renderer}if("tokenizer"in r){if(!r.level||r.level!=="block"&&r.level!=="inline")throw new Error("extension level must be 'block' or 'inline'");let s=e[r.level];s?s.unshift(r.tokenizer):e[r.level]=[r.tokenizer],r.start&&(r.level==="block"?e.startBlock?e.startBlock.push(r.start):e.startBlock=[r.start]:r.level==="inline"&&(e.startInline?e.startInline.push(r.start):e.startInline=[r.start]))}"childTokens"in r&&r.childTokens&&(e.childTokens[r.name]=r.childTokens)}),n.extensions=e),t.renderer){let r=this.defaults.renderer||new jt(this.defaults);for(let s in t.renderer){if(!(s in r))throw new Error(`renderer '${s}' does not exist`);if(["options","parser"].includes(s))continue;let i=s,a=t.renderer[i],l=r[i];r[i]=(...d)=>{let u=a.apply(r,d);return u===!1&&(u=l.apply(r,d)),u||""}}n.renderer=r}if(t.tokenizer){let r=this.defaults.tokenizer||new Vt(this.defaults);for(let s in t.tokenizer){if(!(s in r))throw new Error(`tokenizer '${s}' does not exist`);if(["options","rules","lexer"].includes(s))continue;let i=s,a=t.tokenizer[i],l=r[i];r[i]=(...d)=>{let u=a.apply(r,d);return u===!1&&(u=l.apply(r,d)),u}}n.tokenizer=r}if(t.hooks){let r=this.defaults.hooks||new At;for(let s in t.hooks){if(!(s in r))throw new Error(`hook '${s}' does not exist`);if(["options","block"].includes(s))continue;let i=s,a=t.hooks[i],l=r[i];At.passThroughHooks.has(s)?r[i]=d=>{if(this.defaults.async&&At.passThroughHooksRespectAsync.has(s))return(async()=>{let $=await a.call(r,d);return l.call(r,$)})();let u=a.call(r,d);return l.call(r,u)}:r[i]=(...d)=>{if(this.defaults.async)return(async()=>{let $=await a.apply(r,d);return $===!1&&($=await l.apply(r,d)),$})();let u=a.apply(r,d);return u===!1&&(u=l.apply(r,d)),u}}n.hooks=r}if(t.walkTokens){let r=this.defaults.walkTokens,s=t.walkTokens;n.walkTokens=function(i){let a=[];return a.push(s.call(this,i)),r&&(a=a.concat(r.call(this,i))),a}}this.defaults={...this.defaults,...n}}),this}setOptions(o){return this.defaults={...this.defaults,...o},this}lexer(o,e){return be.lex(o,e??this.defaults)}parser(o,e){return we.parse(o,e??this.defaults)}parseMarkdown(o){return(e,t)=>{let n={...t},r={...this.defaults,...n},s=this.onError(!!r.silent,!!r.async);if(this.defaults.async===!0&&n.async===!1)return s(new Error("marked(): The async option was set to true by an extension. Remove async: false from the parse options object to return a Promise."));if(typeof e>"u"||e===null)return s(new Error("marked(): input parameter is undefined or null"));if(typeof e!="string")return s(new Error("marked(): input parameter is of type "+Object.prototype.toString.call(e)+", string expected"));if(r.hooks&&(r.hooks.options=r,r.hooks.block=o),r.async)return(async()=>{let i=r.hooks?await r.hooks.preprocess(e):e,a=await(r.hooks?await r.hooks.provideLexer():o?be.lex:be.lexInline)(i,r),l=r.hooks?await r.hooks.processAllTokens(a):a;r.walkTokens&&await Promise.all(this.walkTokens(l,r.walkTokens));let d=await(r.hooks?await r.hooks.provideParser():o?we.parse:we.parseInline)(l,r);return r.hooks?await r.hooks.postprocess(d):d})().catch(s);try{r.hooks&&(e=r.hooks.preprocess(e));let i=(r.hooks?r.hooks.provideLexer():o?be.lex:be.lexInline)(e,r);r.hooks&&(i=r.hooks.processAllTokens(i)),r.walkTokens&&this.walkTokens(i,r.walkTokens);let a=(r.hooks?r.hooks.provideParser():o?we.parse:we.parseInline)(i,r);return r.hooks&&(a=r.hooks.postprocess(a)),a}catch(i){return s(i)}}}onError(o,e){return t=>{if(t.message+=`
Please report this to https://github.com/markedjs/marked.`,o){let n="<p>An error occurred:</p><pre>"+De(t.message+"",!0)+"</pre>";return e?Promise.resolve(n):n}if(e)return Promise.reject(t);throw t}}},Ze=new Qs;function q(o,e){return Ze.parse(o,e)}q.options=q.setOptions=function(o){return Ze.setOptions(o),q.defaults=Ze.defaults,Jr(q.defaults),q};q.getDefaults=Mn;q.defaults=Qe;q.use=function(...o){return Ze.use(...o),q.defaults=Ze.defaults,Jr(q.defaults),q};q.walkTokens=function(o,e){return Ze.walkTokens(o,e)};q.parseInline=Ze.parseInline;q.Parser=we;q.parser=we.parse;q.Renderer=jt;q.TextRenderer=zn;q.Lexer=be;q.lexer=be.lex;q.Tokenizer=Vt;q.Hooks=At;q.parse=q;q.options;q.setOptions;q.use;q.walkTokens;q.parseInline;we.parse;be.lex;class ei{static render(e,t=!1){let n=e,r="";if(t){const i=$r.parse(e);n=i.content,i.frontmatter&&(r=$r.renderFrontmatter(i.frontmatter))}const s=q.parse(n);return`<div class="markdown-output">${r}${s}</div>`}}class K{static render(e,t=!1){return ei.render(e,t)}}function ti(o){return{name:"render",description:"Render markdown file with formatting",execute:(e,t)=>{if(new W(e).hasFlag("help"))return{output:`Usage: render <file>
Or: <command> | render
...
Try 'render --help' for more information`,error:!0};const s=r.trim().startsWith("---");return{output:K.render(r,s),html:!0}}}}const ni="hunter2",ri=300*1e3;function oi(o,e){let t=null,n=3,r=null,s=null;function i(){return t===null?!1:Date.now()-t<ri}function a(){n=3}function l(){o.setUsername("root"),e.execute("export HOME=/root"),e.execute("export USER=root"),o.executeCommand("cd /root")}function d(){const f=`[sudo] password for ${o.getUsername()}: `;o.getInput().setInputType("password"),o.getInput().setPrompt(f),o.setInputInterceptor($)}function u(){o.getInput().setInputType("text"),o.setUsername(o.getUsername())}function $(f){if(f===ni){if(t=Date.now(),a(),u(),s&&r){const E=s,R=r;s=null,r=null,E==="su"||E==="su -"?(l(),R({output:""})):e.execute(E).then(L=>R(L))}}else n--,n<=0?(u(),r&&(r({output:"sudo: 3 incorrect password attempts",error:!0}),r=null,s=null),a()):(o.writeError("Sorry, try again."),d())}return{name:"sudo",description:"Execute a command as superuser",execute:(f,E)=>{if(new W(f).hasFlag("help"))return{output:`Usage: sudo <command>
...
Examples:
  ...
  sudo su -            # Switch to root user (login shell)`};if(f.length===0)return{output:"usage: sudo <command>",error:!0};const L=f.join(" ");if(L==="make me a sandwich")return{output:"Okay."};if(i()){const y=L.trim();return y==="su"||y==="su -"?(l(),{output:""}):e.execute(L)}return a(),new Promise(y=>{r=y,s=L,d()})}}}function si(o){return{name:"unalias",description:"Remove command aliases",execute:(e,t)=>{if(new W(e).hasFlag("help"))return{output:`Usage: unalias <name>
...
Try 'unalias --help' for more information.`,error:!0};const r=e[0];return o.removeAlias(r)?{output:`Alias removed: ${r}`}:{output:`unalias: ${r}: not found`,error:!0}}}}const ii=new Set(["about","portfolio","blog","contact","settings"]);function ai(o,e){return{name:"which",description:"Locate a command and display its path",execute:(t,n)=>{const r=new W(t);if(r.hasFlag("help"))return{output:`Usage: which [-a] <command> [command ...]
...
Examples:
  ...
  which ls cat     # Check multiple commands`};const s=r.getAllPositionals();if(s.length===0)return{output:`which: missing command argument
Usage: which [-a] <command> [command ...]`,error:!0};const i=r.hasFlag("a"),a=[];let l=!1;for(const u of s){const $=li(u,o,e,i);$.error&&(l=!0),a.push($.output)}const d={output:a.join(`
`)};return l&&(d.error=!0),d}}}function li(o,e,t,n){const r=[],s=t.getAlias(o);if(s&&(r.push(`${o}: aliased to ${s}`),!n))return{output:r.join(`
`)};if(e.getCommandNames().includes(o.toLowerCase())){const l=ii.has(o.toLowerCase())?`/usr/local/bin/${o}`:`/usr/bin/${o}`;r.push(l)}return r.length===0?{output:`which: ${o}: command not found`,error:!0}:{output:r.join(`
`)}}function ci(o){return{name:"whoami",description:"Display current username",execute:(e,t)=>new W(e).hasFlag("help")?{output:`Usage: whoami

Description:
  Display the current username

Examples:
  whoami               # Show current user`}:{output:o.getUsername()}}}function di(o){return{name:"cat",description:"Display file contents",execute:(e,t)=>{if(new W(e).hasFlag("help"))return{output:`Usage: cat <file>
...
Examples:
  ...
  cd -                 # Go to previous directory`};try{let i=n[0]||"~";if(i==="-"&&t){const a=t.getVariable("OLDPWD");if(!a)return{output:"cd: OLDPWD not set",error:!0};i=a}if(t){const a=t.getVariable("PWD")??o.getCurrentPath();t.setVariable("OLDPWD",a)}return o.changeDirectory(i),t&&t.setVariable("PWD",o.getCurrentPath()),e(o.getShortPath()),{output:""}}catch(i){return{output:i instanceof Error?i.message:String(i),error:!0}}}}}function _i(o,e){if(!e)return o.toString();const t=["B","K","M","G","T"];let n=o,r=0;for(;n>=1024&&r<t.length-1;)n/=1024,r++;return`${r===0?n.toString():n.toFixed(1)}${t[r]}`}function mi(o){const t=["Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"][o.getMonth()],n=o.getDate().toString().padStart(2," "),r=o.getHours().toString().padStart(2,"0"),s=o.getMinutes().toString().padStart(2,"0");return`${t} ${n} ${r}:${s}`}function br(o,e){const t=o.permissions??"-rw-r--r--",n="1",r=o.owner??"darin",s="staff",i=_i(o.size??0,e),a=mi(o.modifiedTime??new Date),l=o.name,d=i.padStart(6," ");return`${t}  ${n} ${r}  ${s}  ${d} ${a} ${l}`}function hi(o){const e=o.reduce((t,n)=>t+(n.size??0),0);return Math.ceil(e/512)}function pi(o){return{name:"ls",description:"List directory contents",execute:(e,t)=>{try{const n=new W(e);if(n.hasFlag("help"))return{output:`Usage: ls [options] [path]
...
Examples:
  ...
  ls ~/blog            # List specific directory`};const r=n.getPositional(0)??".",s=n.hasFlag("a"),i=n.hasFlag("l"),a=n.hasFlag("h"),l=o.getNode(r);if(!l)return{output:`ls: cannot access '${r}': No such file or directory
Try 'ls --help' for more information`,error:!0};if(l.type==="file")return i?{output:br(l,a)}:{output:l.name};if(!l.children)return{output:""};let d=Array.from(l.children.values());return s||(d=d.filter(u=>!u.isHidden)),d.length===0?{output:""}:(d.sort((u,$)=>u.name.localeCompare($.name)),i?{output:[`total ${hi(d)}`,...d.map(f=>br(f,a))].join(`
`)}:{output:d.map($=>$.name).join("  ")})}catch(n){return{output:n instanceof Error?n.message:String(n),error:!0}}}}}const fi=`Usage: mkdir [OPTION]... DIRECTORY...
...
Examples:
  ...
  mkdir dir1 dir2      # Create multiple directories`;function gi(o){return{name:"mkdir",description:"Create directories",execute:(e,t)=>{const n=new W(e);if(n.hasFlag("help"))return{output:fi};const r=n.hasFlag("p"),s=n.getAllPositionals();if(s.length===0)return{output:`mkdir: missing operand
Try 'mkdir --help' for more information`,error:!0};const i=[];let a=!1;for(const l of s)try{if(o.exists(l)&&o.isDirectory(l)){if(r)continue;i.push(`mkdir: cannot create directory '${l}': File exists`),a=!0;continue}if(!r){const d=l.replace(/\/+$/,"").split("/");if(d.length>1){const u=d.slice(0,-1).join("/")||"/";if(!o.exists(u)||!o.isDirectory(u)){i.push(`mkdir: cannot create directory '${l}': No such file or directory`),a=!0;continue}}}o.createDirectory(l)}catch(d){i.push(d instanceof Error?d.message:String(d)),a=!0}return{output:i.join(`
`),error:a}}}}function $i(o){return{name:"pwd",description:"Print working directory",execute:(e,t)=>new W(e).hasFlag("help")?{output:`Usage: pwd

Description:
  Print current working directory path

Examples:
  pwd                  # Show current directory`}:{output:o.getCurrentPath()}}}const Ti=`Usage: rm [OPTION]... FILE...
...
Examples:
  ...
  rm -rf /             # Don't try this at home`;function yi(){return'<div data-melt class="melt-trigger"></div>'}function Ai(o,e){return{name:"rm",description:"Remove files or directories",execute:(t,n)=>{const r=new W(t);if(r.hasFlag("help"))return{output:Ti};const s=r.getFlag("recursive"),i=r.getFlag("force"),a=r.getFlag("f"),l=r.hasFlag("r")||r.hasFlag("R")||s!==void 0,d=r.hasFlag("f")||i!==void 0,u=[...r.getAllPositionals()];if(typeof s=="string"&&u.push(s),typeof i=="string"&&u.push(i),typeof a=="string"&&u.push(a),u.length===0)return{output:`rm: missing operand
Try 'rm --help' for more information`,error:!0};if(l&&d&&u.some(R=>R==="/"||R==="/*"))return{output:yi(),html:!0};const $=[];let f=!1;for(const E of u)try{if(!o.exists(E)){d||($.push(`rm: cannot remove '${E}': No such file or directory`),f=!0);continue}if(o.isDirectory(E)){if(!l){$.push(`rm: cannot remove '${E}': Is a directory`),f=!0;continue}o.deleteDirectory(E,!0)}else{const y=E.startsWith("/")?E:`${o.getCurrentPath()}/${E}`.replace(/\/+/g,"/");if(y.startsWith("/usr/bin/")||y.startsWith("/usr/local/bin/")){const T=y.split("/").pop();T&&e.unregisterCommand(T)}o.deleteFile(E)}}catch(R){d||($.push(R instanceof Error?R.message:String(R)),f=!0)}return d?{output:"",error:!1}:{output:$.join(`
`),error:f}}}}const Ei=`Usage: rmdir DIRECTORY...
...
Examples:
  ...
  rmdir dir1 dir2      # Remove multiple empty directories`;function Li(o){return{name:"rmdir",description:"Remove empty directories",execute:(e,t)=>{const n=new W(e);if(n.hasFlag("help"))return{output:Ei};const r=n.getAllPositionals();if(r.length===0)return{output:`rmdir: missing operand
Try 'rmdir --help' for more information`,error:!0};const s=[];let i=!1;for(const a of r)try{if(!o.exists(a)){s.push(`rmdir: failed to remove '${a}': No such file or directory`),i=!0;continue}if(!o.isDirectory(a)){s.push(`rmdir: failed to remove '${a}': Not a directory`),i=!0;continue}o.deleteDirectory(a)}catch(l){const d=l instanceof Error?l.message:String(l);s.push(d.replace(/^rm:/,"rmdir:")),i=!0}return{output:s.join(`
`),error:i}}}}function Ii(o){return{name:"tree",description:"Display directory tree structure",execute:(e,t)=>{try{const n=new W(e);if(n.hasFlag("help"))return{output:`Usage: tree [options] [path]
...
`:"",r=e.tags?.map(i=>this.formatClickableTag(i,"portfolio")).join(" ")??"",s=r?`**Tags:** ${r}
...
<a href="/portfolio" data-command="portfolio">← Back to Portfolio</a>`}static formatBlogList(e,t){const n=t?`# Blog Posts - Tag: ${t}`:"# Blog Posts",r=e.map((i,a)=>{const l=i.tags.map(u=>this.formatClickableTag(u,"blog")).join(" "),d=e.length-a;return`### <a href="/blog/${i.id}" data-command="blog ${i.id}">${d}. ${i.title}</a>
...
**Posted on:** ${n}`}}static formatPostList(e,t){const n=t?`# Notes - Tag: ${t}`:"# Notes",r=e.map((i,a)=>{const l=i.tags.map(f=>this.formatClickableTag(f,"notes")).join(" "),d=e.length-a,{badges:u,links:$}=this.formatPostedLinks(i.posted);return`### <a href="/notes/${i.id}" data-command="notes ${i.id}">${d}. ${i.title}</a>
...
<a href="/notes" data-command="notes">← Back to All Notes</a>`:"\n\n---\n\n**Filter by tag:** Type `notes --tags <tag>` or `notes --tags` to list all tags"}`}static formatPostDetail(e){const t=e.tags.map(s=>this.formatClickableTag(s,"notes")).join(" "),{badges:n,links:r}=this.formatPostedLinks(e.posted);return`# ${e.title}
...
<a href="/notes" data-command="notes">← Back to Notes</a>`}}function bi(o,e=[]){return{name:"about",description:"Display bio and expertise overview",execute:(t,n)=>{if(new W(t).hasFlag("help"))return{output:`Usage: about

Description:
  Display professional bio and expertise overview

Examples:
  about                # Show bio and background`};try{const s=o.readFile(Ee.CONTENT_ABOUT),i=K.render(s);return{output:ze.makeCommandsClickable(i,e),html:!0,scrollBehavior:"top"}}catch(s){return{output:s instanceof Error?s.message:String(s),error:!0}}}}}function wi(o){if(typeof o!="object"||o===null)return!1;const e=o;return typeof e.title=="string"&&typeof e.date=="string"&&typeof e.summary=="string"&&Array.isArray(e.tags)&&e.tags.every(t=>typeof t=="string")}class uo{static parseFrontmatter(e){const t=e.split(`
`);if(t[0]?.trim()!=="---")throw new Error("Invalid frontmatter: must start with ---");let n=-1;for(let a=1;a<t.length;a++)if(t[a].trim()==="---"){n=a;break}if(n===-1)throw new Error("Invalid frontmatter: no closing ---");const r=t.slice(1,n),s=t.slice(n+1),i={};for(const a of r){const l=a.indexOf(":");if(l===-1)continue;const d=a.substring(0,l).trim(),u=a.substring(l+1).trim();if(u.startsWith("[")&&u.endsWith("]")){const $=u.substring(1,u.length-1);i[d]=$.split(",").map(f=>f.trim().replace(/^["']|["']$/g,"")).filter(f=>f.length>0)}else i[d]=u.replace(/^["']|["']$/g,"")}if(!wi(i)){const a=[];throw i.title||a.push("title"),i.date||a.push("date"),i.summary||a.push("summary"),Array.isArray(i.tags)||a.push("tags"),new Error(`Invalid blog frontmatter: missing or invalid fields: ${a.join(", ")}`)}return{frontmatter:i,markdown:s.join(`
`).trim()}}static parseBlogPost(e,t){const{frontmatter:n,markdown:r}=this.parseFrontmatter(t);return{id:e.replace(/^\d{4}-\d{2}-\d{2}-/,"").replace(/\.md$/,""),title:n.title,date:n.date,summary:n.summary,content:r,tags:n.tags}}static getIdFromFilename(e){return e.replace(/^\d{4}-\d{2}-\d{2}-/,"").replace(/\.md$/,"")}}function Si(o){return{name:"blog",description:"List and read blog posts",execute:(e,t)=>{const n=new W(e);if(n.hasFlag("help"))return{output:`Usage: blog [options] [post-id|number]
...
Examples:
  ...
  blog post-id                  # Read specific post by ID`};const r=Ee.CONTENT_BLOG;try{const i=o.list(r).filter(L=>L.endsWith(".md")).sort().reverse(),a=n.getFlag("tags"),l=n.hasFlag("tags"),d=n.getPositional(0),u=[];for(const L of i){const y=o.readFile(`${r}/${L}`),T=uo.parseBlogPost(L,y);u.push(T)}if(u.length===0&&!l&&!d){const L=`# Blog
...
Use 'blog' to see all posts.`,error:!1}}const E=ze.formatBlogList($,f);return{output:K.render(E),html:!0,scrollBehavior:"top"}}catch(s){return{output:s instanceof Error?s.message:String(s),error:!0}}}}}class qe{static parse(e){const t=[],n=e.split(`
`);let r=null,s=null,i=[];const a=/^## \[([^\]]+)\] - (\d{4}-\d{2}-\d{2})/,l=/^### (\w+)/,d=/^- (.+)/;for(const u of n){const $=a.exec(u);if($){r&&(r.rawContent=i.join(`
`).trim(),t.push(r)),r={version:$[1],date:$[2],sections:{},rawContent:""},s=null,i=[u];continue}r&&i.push(u);const f=l.exec(u);if(f&&r){s=f[1],r.sections[s]=[];continue}const E=d.exec(u);E&&r&&s&&r.sections[s].push(E[1])}return r&&(r.rawContent=i.join(`
`).trim(),t.push(r)),t}static getVersion(e,t){return e.find(n=>n.version===t)}static getByIndex(e,t){if(!(t<1||t>e.length))return e[t-1]}static formatEntry(e){const t=[];t.push(`## Version ${e.version}`),t.push(`*Released: ${e.date}*`),t.push("");for(const[n,r]of Object.entries(e.sections)){t.push(`### ${n}`);for(const s of r)t.push(`- ${s}`);t.push("")}return t.join(`
...
`);return t+n}}function vi(o){return{name:"changelog",description:"View project version history",execute:(e,t)=>{const n=new W(e);if(n.hasFlag("help"))return{output:`Usage: changelog [options] [version|number]
...
Examples:
  ...
  changelog 0.22.0           # Show specific version`};try{const r=qe.parse(o);if(r.length===0)return{output:"No changelog entries found.",error:!0};const s=n.getPositional(0);if(s){if(s.toLowerCase()==="latest"){const f=r[0],E=qe.formatEntry(f);return{output:K.render(E),html:!0,scrollBehavior:"top"}}if(/^\d+$/.test(s)){const f=parseInt(s,10);if(f>0){const E=qe.getByIndex(r,f);if(!E)return{output:`Version at position ${f} not found. There are ${r.length} versions available.
Try 'changelog --help' for more information.`,error:!0};const R=qe.formatEntry(E);return{output:K.render(R),html:!0,scrollBehavior:"top"}}}const d=qe.getVersion(r,s);if(!d){const f=r.slice(0,5).map(E=>E.version).join(", ");return{output:`Version '${s}' not found.
Recent versions: ${f}
Try 'changelog --help' for more information.`,error:!0}}const u=qe.formatEntry(d);return{output:K.render(u),html:!0,scrollBehavior:"top"}}const i=qe.formatEntries(r);return{output:K.render(i),html:!0,scrollBehavior:"top"}}catch(r){return{output:r instanceof Error?r.message:String(r),error:!0}}}}}function Ci(o){return{name:"contact",description:"Display contact information",execute:(e,t)=>{if(new W(e).hasFlag("help"))return{output:`Usage: contact

Description:
  Display contact information and professional links

Examples:
  contact              # Show contact details`};try{const r=o.readFile(Ee.CONTENT_CONTACT);return{output:K.render(r),html:!0}}catch(r){return{output:r instanceof Error?r.message:String(r),error:!0}}}}}function Ri(o){if(typeof o!="object"||o===null)return!1;const e=o;return typeof e.title=="string"&&typeof e.date=="string"&&Array.isArray(e.tags)&&e.tags.every(t=>typeof t=="string")}function xi(o){const e=[];let t=null;for(const n of o){const r=n.trim();if(r.startsWith("- ")){t?.platform&&t?.url&&e.push({platform:t.platform,url:t.url}),t={};const s=r.substring(2).trim(),i=s.indexOf(":");if(i!==-1){const a=s.substring(0,i).trim(),l=s.substring(i+1).trim().replace(/^["']|["']$/g,"");a==="platform"&&(t.platform=l),a==="url"&&(t.url=l)}}else if(t){const s=r.indexOf(":");if(s!==-1){const i=r.substring(0,s).trim(),a=r.substring(s+1).trim().replace(/^["']|["']$/g,"");i==="platform"&&(t.platform=a),i==="url"&&(t.url=a)}}}return t?.platform&&t?.url&&e.push({platform:t.platform,url:t.url}),e}class _o{static parseFrontmatter(e){const t=e.split(`
`);if(t[0]?.trim()!=="---")throw new Error("Invalid frontmatter: must start with ---");let n=-1;for(let l=1;l<t.length;l++)if(t[l].trim()==="---"){n=l;break}if(n===-1)throw new Error("Invalid frontmatter: no closing ---");const r=t.slice(1,n),s=t.slice(n+1),i={};let a=0;for(;a<r.length;){const l=r[a],d=l.indexOf(":");if(d===-1){a++;continue}const u=l.substring(0,d).trim(),$=l.substring(d+1).trim();if(u==="posted"&&$===""){const f=[];for(a++;a<r.length;){const E=r[a];if(/^\s+(- |[\w])/.exec(E))f.push(E),a++;else break}i[u]=xi(f);continue}if($.startsWith("[")&&$.endsWith("]")){const f=$.substring(1,$.length-1);i[u]=f.split(",").map(E=>E.trim().replace(/^["']|["']$/g,"")).filter(E=>E.length>0)}else i[u]=$.replace(/^["']|["']$/g,"");a++}if(!Ri(i)){const l=[];throw i.title||l.push("title"),i.date||l.push("date"),Array.isArray(i.tags)||l.push("tags"),new Error(`Invalid post frontmatter: missing or invalid fields: ${l.join(", ")}`)}return{frontmatter:i,markdown:s.join(`
`).trim()}}static parsePost(e,t){const{frontmatter:n,markdown:r}=this.parseFrontmatter(t);return{id:this.getIdFromFilename(e),title:n.title,date:n.date,content:r,tags:n.tags,...n.posted&&n.posted.length>0&&{posted:n.posted}}}static getIdFromFilename(e){return e.replace(/^\d{4}-\d{2}-\d{2}-/,"").replace(/\.md$/,"")}}function Ni(o){return{name:"notes",description:"List and read short-form notes",execute:(e,t)=>{const n=new W(e);if(n.hasFlag("help"))return{output:`Usage: notes [options] [note-id|number]
...
Examples:
  ...
  notes note-id                 # Read specific note by ID`};const r=Ee.CONTENT_POSTS;try{const i=o.list(r).filter(L=>L.endsWith(".md")).sort().reverse(),a=n.getFlag("tags"),l=n.hasFlag("tags"),d=n.getPositional(0),u=[];for(const L of i){const y=o.readFile(`${r}/${L}`),T=_o.parsePost(L,y);u.push(T)}if(u.length===0&&!l&&!d){const L=`# Notes
...
Use 'notes' to see all notes.`,error:!1}}const E=ze.formatPostList($,f);return{output:K.render(E),html:!0,scrollBehavior:"top"}}catch(s){return{output:s instanceof Error?s.message:String(s),error:!0}}}}}function ki(o){if(typeof o!="object"||o===null)return!1;const e=o;return typeof e.id=="string"&&typeof e.title=="string"&&typeof e.summary=="string"&&typeof e.year=="string"&&typeof e.order=="number"&&Array.isArray(e.technologies)&&e.technologies.every(t=>typeof t=="string")&&(e.impact===void 0||typeof e.impact=="string")&&(e.tags===void 0||Array.isArray(e.tags)&&e.tags.every(t=>typeof t=="string"))}class Oi{static parseFrontmatter(e){const t=e.split(`
`);if(t[0]?.trim()!=="---")throw new Error("Invalid frontmatter: must start with ---");let n=-1;for(let a=1;a<t.length;a++)if(t[a].trim()==="---"){n=a;break}if(n===-1)throw new Error("Invalid frontmatter: no closing ---");const r=t.slice(1,n),s=t.slice(n+1),i={};for(const a of r){const l=a.indexOf(":");if(l===-1)continue;const d=a.substring(0,l).trim(),u=a.substring(l+1).trim();if(u.startsWith("[")&&u.endsWith("]")){const $=u.substring(1,u.length-1);i[d]=$.split(",").map(f=>f.trim().replace(/^["']|["']$/g,"")).filter(f=>f.length>0)}else{const $=u.replace(/^["']|["']$/g,"");if(d==="order"){const f=Number($);i[d]=isNaN(f)?$:f}else i[d]=$}}if(!ki(i)){const a=[];throw i.id||a.push("id"),i.title||a.push("title"),i.summary||a.push("summary"),i.year||a.push("year"),typeof i.order!="number"&&a.push("order"),Array.isArray(i.technologies)||a.push("technologies"),new Error(`Invalid portfolio frontmatter: missing or invalid fields: ${a.join(", ")}`)}return{frontmatter:i,markdown:s.join(`
`).trim()}}static parseProject(e,t){const{frontmatter:n,markdown:r}=this.parseFrontmatter(t);return{id:n.id||e.replace(/\.md$/,""),title:n.title,summary:n.summary,description:r,technologies:n.technologies,impact:n.impact,year:n.year,order:n.order,tags:n.tags}}static getIdFromFilename(e){return e.replace(/\.md$/,"")}}function Di(o){return{name:"portfolio",description:"Showcase projects and accomplishments",execute:(e,t)=>{const n=new W(e);if(n.hasFlag("help"))return{output:`Usage: portfolio [options] [project-id|number]
...
Examples:
  ...
  portfolio proj-id             # View specific project by ID`};const r=Ee.CONTENT_PORTFOLIO;try{const i=o.list(r).filter(y=>y.endsWith(".md")),a=n.getFlag("tags"),l=n.hasFlag("tags"),d=n.getPositional(0),u=[];for(const y of i){const T=o.readFile(`${r}/${y}`);if(T)try{const P=Oi.parseProject(y,T);u.push(P)}catch(P){console.error(`Error parsing ${y}:`,P)}}if(u.sort((y,T)=>y.order!==T.order?y.order-T.order:y.title.localeCompare(T.title)),u.length===0&&!l&&!d){const y=`# Portfolio
...
Examples:
  ...
  settings reset       # Reset all settings`};if(n.length===0)return{output:mo(e,t),html:!0};const i=s.getPositional(0);switch(i){case"list":return Wi(e,t);case"set":return Sr(s,e,t);case"reset":return Gi(e,t);case"theme":case"font-size":case"font-family":case"fontSize":case"fontFamily":case"scan-lines":case"scanLines":case"glow":case"border":case"animation-speed":case"animationSpeed":case"sound":case"auto-scroll":case"autoScroll":case"prompt":case"screensaver-enabled":case"screensaverEnabled":case"screensaver-timeout":case"screensaverTimeout":case"screensaver-type":case"screensaverType":return Sr(new W(["set",i,...n.slice(1)]),e,t);default:return{output:`Unknown subcommand: ${i}.
Try 'settings --help' for more information`,error:!0}}}}}function Wi(o,e){const t=zi(o,e);return{output:K.render(t),html:!0}}function Sr(o,e,t){const n=o.getPositional(1),r=o.getPositional(2);if(!n)return{output:`Usage: settings set <setting> <value>
Try 'settings --help' for more information`,error:!0};if(n!=="color"&&!r)return{output:`Usage: settings set <setting> <value>
Try 'settings --help' for more information`,error:!0};try{switch(n){case"theme":{const s=["green","yellow","white","light-blue","paper","dc"];return s.includes(r)?(e.setSetting("theme",{preset:r}),t.applyTheme(r),he(),{output:`Theme changed to: ${r}`}):{output:`Invalid theme: ${r}. Available: ${s.join(", ")}`,error:!0}}case"color":{const s=["terminal-bg","terminal-fg","terminal-accent","terminal-dim","terminal-error","terminal-cursor","terminal-bg-secondary"];let i,a;for(const d of s){const u=o.getFlag(d);if(u&&typeof u=="string"){i="--"+d,a=u;break}}if(!i||!a)return{output:`Usage: settings set color <variable> <value>
Example: settings set color --terminal-accent #ff0000`,error:!0};const l={[i]:a};return t.applyCustomColors(l),he(),{output:`Color ${i} set to ${a}`}}case"font-size":case"fontSize":{if(!r)return{output:"Font size value required",error:!0};const s=parseInt(r,10);return isNaN(s)?{output:"Font size must be a number (8-24)",error:!0}:(e.setFontSize(s),Cn(e),he(),{output:`Font size set to: ${s}px`})}case"font-family":case"fontFamily":{if(!r)return{output:"Font family value required",error:!0};const s=["Fira Code","JetBrains Mono","Cascadia Code","Menlo","Monaco","Courier New","monospace"];return s.includes(r)?(e.setFontFamily(r),Cn(e),he(),{output:`Font family set to: ${r}`}):{output:`Invalid font family: ${r}. Available: ${s.join(", ")}`,error:!0}}case"scan-lines":case"scanLines":{if(!r)return{output:"Scan lines value required (on/off)",error:!0};if(r!=="on"&&r!=="off")return{output:'Scan lines must be "on" or "off"',error:!0};const s=r==="on";return e.setScanLines(s),ho(s),he(),{output:`Scan lines: ${r}`}}case"glow":{if(!r)return{output:"Glow value required (on/off)",error:!0};if(r!=="on"&&r!=="off")return{output:'Glow must be "on" or "off"',error:!0};const s=r==="on";return e.setGlow(s),po(s),he(),{output:`Glow: ${r}`}}case"border":{if(!r)return{output:"Border value required (on/off)",error:!0};if(r!=="on"&&r!=="off")return{output:'Border must be "on" or "off"',error:!0};const s=r==="on";return e.setBorder(s),fo(s),he(),{output:`Border: ${r}`}}case"animation-speed":case"animationSpeed":{if(!r)return{output:"Animation speed value required",error:!0};const s=parseFloat(r);return isNaN(s)?{output:"Animation speed must be a number (0.5-2.0)",error:!0}:(e.setAnimationSpeed(s),go(s),he(),{output:`Animation speed set to: ${s}x`})}case"sound-effects":case"sound":{if(!r)return{output:"Sound effects value required (on/off)",error:!0};if(r!=="on"&&r!=="off")return{output:'Sound effects must be "on" or "off"',error:!0};const s=r==="on";return e.setSoundEffects(s),he(),{output:`Sound effects: ${r}`}}case"autoscroll":case"auto-scroll":case"autoScroll":{if(!r)return{output:"Autoscroll value required (on/off)",error:!0};if(r!=="on"&&r!=="off")return{output:'Autoscroll must be "on" or "off"',error:!0};const s=r==="on";return e.setAutoScrollBehavior(s),he(),{output:`Autoscroll: ${r} - ${s?"Long content (>50 lines) scrolls to command line":"All content scrolls to bottom"}`}}case"prompt":return r?(e.setPromptFormat(r),he(),{output:`Prompt format set to: ${r}`}):{output:"Prompt format value required",error:!0};case"screensaver-enabled":case"screensaverEnabled":{if(!r)return{output:"Screensaver enabled value required (on/off)",error:!0};if(r!=="on"&&r!=="off")return{output:'Screensaver enabled must be "on" or "off"',error:!0};const s=r==="on";return e.setScreensaverEnabled(s),he(),{output:`Screensaver: ${r}`}}case"screensaver-timeout":case"screensaverTimeout":{if(!r)return{output:"Screensaver timeout value required (1-60 minutes)",error:!0};const s=parseInt(r,10);return isNaN(s)||s<1||s>60?{output:"Screensaver timeout must be between 1 and 60 minutes",error:!0}:(e.setScreensaverTimeout(s),he(),{output:`Screensaver timeout set to: ${s} minutes`})}case"screensaver-type":case"screensaverType":{if(!r)return{output:"Screensaver type value required",error:!0};const s=["matrix","life"];return s.includes(r)?(e.setActiveScreensaver(r),he(),{output:`Screensaver type set to: ${r}`}):{output:`Invalid screensaver type: ${r}. Available: ${s.join(", ")}`,error:!0}}default:return{output:`Unknown setting: ${n}. Available: theme, color, font-size, font-family, scan-lines, glow, border, animation-speed, sound-effects, autoscroll, prompt, screensaver-enabled, screensaver-timeout, screensaver-type`,error:!0}}}catch(s){return{output:s instanceof Error?s.message:String(s),error:!0}}}function Gi(o,e){return o.reset(),e.applyCurrentTheme(),Cn(o),ho(o.getScanLines()),po(o.getGlow()),fo(o.getBorder()),go(o.getAnimationSpeed()),he(),{output:"Settings reset to defaults."}}function zi(o,e){const t=o.loadSettings(),n=e.getPresets();return`# Terminal Settings

## Current Configuration

### Theme
**${t.theme.preset==="custom"?"Custom":n.find(s=>s.name===t.theme.preset)?.displayName??t.theme.preset}**
...
${n.map(s=>`- **${s.name}**: ${s.displayName}`).join(`
`)}
...
- \\\\d = current date
`}function Cn(o){const e=o.getSetting("font");typeof document<"u"&&(document.documentElement.style.setProperty("--terminal-font-size",`${e.size}px`),document.documentElement.style.setProperty("--terminal-font-family",e.family))}function ho(o){typeof document<"u"&&(o?document.body.classList.remove("no-scan-lines"):document.body.classList.add("no-scan-lines"))}function po(o){typeof document<"u"&&(o?document.body.classList.remove("no-glow"):document.body.classList.add("no-glow"))}function fo(o){typeof document<"u"&&(o?document.body.classList.add("border-enabled"):document.body.classList.remove("border-enabled"))}function go(o){typeof document<"u"&&document.documentElement.style.setProperty("--terminal-animation-speed",o.toString())}function he(){if(typeof document<"u"){const o=new CustomEvent("settings-changed");document.dispatchEvent(o)}}function Vi(o){const e=[{type:"bios",text:"PHOENIX BIOS v4.0 Release 6.0"},{type:"bios",text:"Copyright 1985-2025 Phoenix Technologies Ltd."},{type:"bios",text:"CPU: JavaScript V8 Engine @ ∞ GHz"},{type:"bios",text:"Memory Test: 16384 MB OK"},{type:"bios",text:"Detecting IDE drives..."},{type:"bios",text:"  Primary Master: Virtual SSD 256GB"},{type:"kernel",text:"Loading kernel..."},{type:"kernel",text:"[    0.000000] Linux version 6.8.0-darin (darin@darinchambers.com)"},{type:"kernel",text:"[    0.000001] Command line: BOOT_IMAGE=/vmlinuz-6.8.0-darin root=/dev/sda1"},{type:"kernel",text:"[    0.123456] Calibrating delay loop... 7999.99 BogoMIPS (lpj=15999984)"},{type:"kernel",text:"[    0.234567] Memory: 16384MB available"},{type:"kernel",text:"[    0.345678] CPU: JavaScript Virtual CPU"},{type:"kernel",text:"[    0.456789] Mounting root filesystem..."},{type:"ok",text:"Started System Logging Service"},{type:"ok",text:"Started Journal Service"},{type:"ok",text:"Started D-Bus System Message Bus"},{type:"ok",text:"Reached target Local File Systems"},{type:"ok",text:"Started Network Manager"},{type:"failed",text:"Started Bluetooth Service (no adapter found)"},{type:"ok",text:"Started Login Service"},{type:"ok",text:"Started OpenSSH Server"},{type:"ok",text:"Started Docker Container Runtime"},{type:"ok",text:"Started Code Editor Process"},{type:"ok",text:"Started Terminal Emulator"},{type:"ok",text:"Reached target Multi-User System"},{type:"info",text:"darinchambers.com login: darin"},{type:"info",text:"Password: ********"},{type:"welcome",text:"Welcome to darinchambers.com!"},{type:"info",text:"Type 'help' for available commands."}];return o?[{type:"bios",text:"PHOENIX BIOS v4.0"},{type:"bios",text:"Memory Test: 16384 MB OK"},{type:"kernel",text:"Loading kernel..."},{type:"kernel",text:"[    0.000000] Linux version 6.8.0-darin"},{type:"ok",text:"Started System Logging Service"},{type:"ok",text:"Started Network Manager"},{type:"ok",text:"Started Terminal Emulator"},{type:"ok",text:"Reached target Multi-User System"},{type:"welcome",text:"Welcome to darinchambers.com!"}]:e}function ji(o,e=0){const t=Vi(o),n=o?80:120;let r=0;return{html:t.map((i,a)=>{const l=e+a*n,d=`boot-line boot-line-${i.type}`,u=i.text.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;");return i.type==="welcome"&&(r=l),`<div class="${d}" style="animation-delay: ${l}ms;">${u}</div>`}).join(`
`),welcomeDelay:r}}const Yi={name:"boot",description:"Display simulated Linux boot sequence",execute:(o,e)=>{const t=new W(o);if(t.hasFlag("help"))return{output:`Usage: boot [options]
...
Note: Messages appear with timed animation. Scroll or type to stop.`};const n=t.hasFlag("fast"),{html:r,welcomeDelay:s}=ji(n);return{output:`<div class="boot-sequence boot-startup" data-boot-type="boot">
${r}
</div>`,html:!0,clearBefore:!0,fullscreen:!0,fullscreenDuration:s,scrollBehavior:"top"}}},it=[{code:"SYSTEM_THREAD_EXCEPTION_NOT_HANDLED",description:"A system thread generated an exception that was not handled."},{code:"DRIVER_IRQL_NOT_LESS_OR_EQUAL",description:"A driver attempted to access a pageable memory at an inappropriate IRQL."},{code:"KERNEL_DATA_INPAGE_ERROR",description:"The requested page of kernel data from the paging file could not be read."},{code:"PAGE_FAULT_IN_NONPAGED_AREA",description:"Invalid system memory has been referenced."},{code:"CRITICAL_PROCESS_DIED",description:"A critical system process died unexpectedly."}];function qi(o,e){return`<div class="bsod-overlay bsod-modern" data-bsod="true" data-bsod-style="modern">
...
</div>`}function Xi(o,e){const t=["0x0000007E","0xC0000005","0xBF8B4C62","0x00000000","0xBF8B4C62"];return`<div class="bsod-overlay bsod-classic" data-bsod="true" data-bsod-style="classic">
...
</div>`}const Ki={name:"bsod",description:"Display a fake Windows Blue Screen of Death",execute:(o,e)=>{const t=new W(o);if(t.hasFlag("help")||t.hasFlag("h"))return{output:`Usage: bsod [options]
...
Options:
  ...
  --error <index>   Select specific error code (0-${it.length-1})
  --help, -h        Display this help message

Error codes:
${it.map((d,u)=>`  ${u}: ${d.code}`).join(`
`)}
...
Note: Click anywhere or press any key to dismiss the BSOD.`};const n=t.hasFlag("classic"),r=t.getFlag("reason"),s=t.getFlag("error");let i=it[Math.floor(Math.random()*it.length)];if(s!==void 0&&s!==!0){const d=parseInt(String(s),10);!isNaN(d)&&d>=0&&d<it.length&&(i=it[d])}const a=typeof r=="string"?r:i.description;return{output:n?Xi(i.code,a):qi(i.code,a),html:!0,clearBefore:!0,scrollBehavior:"top"}}},Zi=["Chaos","Discord","Confusion","Bureaucracy","The Aftermath"],Ji=["Sweetmorn","Boomtime","Pungenday","Prickle-Prickle","Setting Orange"],Qi=["Mungday","Mojoday","Syadday","Zaraday","Malbowday"],vr=73,ea=1166;function Rn(o){return o%4===0&&o%100!==0||o%400===0}function ta(o,e,t){const n=[31,28,31,30,31,30,31,31,30,31,30,31];Rn(o)&&(n[1]=29);let r=t;for(let s=0;s<e-1;s++)r+=n[s];return r}function na(o){const e=o.getFullYear(),t=o.getMonth()+1,n=o.getDate(),r=e+ea,s=ta(e,t,n);if(Rn(e)&&t===2&&n===29)return{weekday:"",season:"",dayOfSeason:0,yold:r,isStTibsDay:!0};let i=s;Rn(e)&&s>60&&(i=s-1);const a=Math.floor((i-1)/vr),l=Zi[a],d=(i-1)%vr+1,u=(i-1)%5,$=Ji[u],f=d===5?Qi[a]:void 0;return{weekday:$,season:l,dayOfSeason:d,yold:r,isStTibsDay:!1,apostleDay:f}}function ra(o){return o.isStTibsDay?`St. Tib's Day, ${o.yold} YOLD`:o.apostleDay?`${o.weekday}, ${o.apostleDay}, day ${o.dayOfSeason} of ${o.season}, ${o.yold} YOLD`:`${o.weekday}, ${o.season} ${o.dayOfSeason}, ${o.yold} YOLD`}function oa(o){if(/^\d{4}-\d{2}-\d{2}$/.test(o)){const e=new Date(o);if(!isNaN(e.getTime()))return e}if(/^\d{1,2}\/\d{1,2}\/\d{4}$/.test(o)){const e=new Date(o);if(!isNaN(e.getTime()))return e}return null}function sa(o,e,t){if(o<1||o>31||e<1||e>12||t<1)return null;const n=new Date(t,e-1,o);return isNaN(n.getTime())?null:n}const ia={name:"ddate",description:"Display date in Discordian calendar",execute:(o,e)=>{const t=new W(o);if(t.hasFlag("help"))return{output:`Usage: ddate [DATE]
...
`),h.numChars=0;A.length>0&&h.numChars<x.length;){const U=x[h.numChars];h[U]=A.splice(0,w.height);for(let O=0;O<w.height;O++)typeof h[U][O]>"u"?h[U][O]="":h[U][O]=i(h[U][O],O,w.height);h.numChars++}for(;A.length>0;){const U=A.shift();if(!U||U.trim()==="")break;let O=U.split(" ")[0],B;if(/^-?0[xX][0-9a-fA-F]+$/.test(O))B=parseInt(O,16);else if(/^-?0[0-7]+$/.test(O))B=parseInt(O,8);else if(/^-?[0-9]+$/.test(O))B=parseInt(O,10);else throw new Error(`Error parsing data. Invalid data: ${O}`);if(B===-1||B<-2147483648||B>2147483647){const M=B===-1?"The char code -1 is not permitted.":`The char code cannot be ${B<-2147483648?"less than -2147483648":"greater than 2147483647"}.`;throw new Error(`Error parsing data. ${M}`)}h[B]=A.splice(0,w.height);for(let M=0;M<w.height;M++)typeof h[B][M]>"u"?h[B][M]="":h[B][M]=i(h[B][M],M,w.height);h.numChars++}return r[p]=h,w},G.loadedFonts=()=>Object.keys(r),G.clearLoadedFonts=()=>{Object.keys(r).forEach(p=>{delete r[p]})},G.loadFont=async function(p,g){if(r[p]){const _=r[p].options;return g&&g(null,_),Promise.resolve(_)}try{if(!s.fetchFontIfMissing)throw new Error(`Font is not loaded: ${p}`);const _=await fetch(`${s.fontPath}/${p}.flf`);if(!_.ok)throw new Error(`Network response was not ok: ${_.status}`);const h=await _.text(),A=G.parseFont(p,h);return g&&g(null,A),A}catch(_){const h=_ instanceof Error?_:new Error(String(_));if(g)return g(h),null;throw h}},G.loadFontSync=function(p){if(r[p])return r[p].options;throw new Error("Synchronous font loading is not implemented for the browser, it will only work for fonts already loaded.")},G.preloadFonts=async function(p,g){try{for(const _ of p){const h=await fetch(`${s.fontPath}/${_}.flf`);if(!h.ok)throw new Error(`Failed to preload fonts. Error fetching font: ${_}, status code: ${h.statusText}`);const A=await h.text();G.parseFont(_,A)}g&&g()}catch(_){const h=_ instanceof Error?_:new Error(String(_));if(g){g(h);return}throw _}},G.fonts=function(p){return new Promise(function(g,_){g(Tn),p&&p(null,Tn)})},G.fontsSync=function(){return Tn},G.figFonts=r,G})(),da=`flf2a$ 8 7 54 0 12 0 64 185
...
255  LATIN SMALL LETTER Y WITH DIAERESIS
 ...
 | || |@
  \\_, |@
  |__/ @@
`,ma=`flf2a$ 6 5 16 15 13 0 24463 229
...
0xCA0  KANNADA LETTER TTHA
 ...
 $\\___/$ @
         @@
         `;St.parseFont("Standard",ma);St.parseFont("Slant",ua);St.parseFont("Banner",da);St.parseFont("Small",_a);const ha={name:"figlet",description:"Convert text to ASCII art",execute:(o,e)=>{const t=new W(o);if(t.hasFlag("help"))return{output:`Usage: figlet [options] <text>
...
Try 'figlet --help' for more information.`,error:!0};const r=t.getFlag("f"),s=typeof r=="string"?r:"Standard",i=s.charAt(0).toUpperCase()+s.slice(1).toLowerCase();let a="default";t.hasFlag("c")?a="full":t.hasFlag("r")&&(a="fitted");try{return{output:St.textSync(n,{font:i,horizontalLayout:a})}}catch(l){return l instanceof Error?l.message.includes("font")||l.message.includes("Font")||l.message.includes("FIGlet")?{output:`figlet: font '${i}' not found or invalid
Available fonts: standard, slant, banner, small`,error:!0}:{output:`figlet: ${l.message}`,error:!0}:{output:"figlet: unknown error occurred",error:!0}}}};function pa(){const o=window.innerWidth,e=window.innerHeight,t=document.querySelector("header"),n=t?t.getBoundingClientRect().height:60,r=Math.max(400,Math.floor(o*.95)),s=Math.max(300,Math.floor(e-n));return{width:r,height:s}}function fa(o){return{name:"life",description:"Conway's Game of Life cellular automaton",execute:(e,t)=>{const n=new W(e);if(n.hasFlag("help"))return{output:`Usage: life [options]
...
Note: Animation continues until you scroll, type, or run 'clear'`};let r=2;const s=n.getFlag("speed");if(s!==void 0){const C=parseFloat(String(s));if(isNaN(C)||C<.5||C>10)return{output:`life: invalid speed '${s}'
Speed must be between 0.5 and 10.0`,error:!0};r=C}let i=.3;const a=n.getFlag("density");if(a!==void 0){const C=parseFloat(String(a));if(isNaN(C)||C<0||C>1)return{output:`life: invalid density '${a}'
Density must be between 0.0 and 1.0`,error:!0};i=C}const l=n.getFlag("pattern");let d="random";if(l!==void 0){const C=String(l),F=["random","acorn","glider","blinker"];if(!F.includes(C))return{output:`life: invalid pattern '${C}'
...
Valid themes: ${F.join(", ")}`,error:!0};if(C!=="custom"){const k=o.getPreset(C);k&&($=k.colors)}}const{width:f,height:E}=pa(),R=Math.floor(E*.8),L=$["--terminal-accent"],y=$["--terminal-dim"];return{output:`
...
`,html:!0}}}}const Cr=["#ff6b35","#ff8c42","#ffaa4f","#ffc85c","#e6e669","#c4e676","#9fe683","#7ae690","#5ad69d","#3ac6aa","#1bb6b7","#00a6c4","#0096d1","#0086de"];function xn(o,e,t,n){const r=o/t+e*n;return Cr[Math.floor(Math.abs(r))%Cr.length]}function ga(o){return/<(div|span|pre)\s+(class|style)=/i.test(o)}function $a(o,e,t){return o.split(`
`).map((n,r)=>{let s=0;return[...n].map(i=>i===" "||i==="	"?i:`<span style="color: ${xn(s++,r,e,t)}">${Me(i)}</span>`).join("")}).join(`
`)}function Ta(o,e,t){let n=0,r=0,s="",i=!1,a=!1,l="";for(const d of o)if(d==="<")i=!0,s+=d;else if(d===">")i=!1,s+=d;else if(i)s+=d;else if(d==="&")a=!0,l=d;else if(a){if(l+=d,d===";"){a=!1;const u=xn(r++,n,e,t);s+=`<span style="color: ${u}">${l}</span>`,l=""}}else if(d===`
`)s+=d,n++,r=0;else if(d===" "||d==="	")s+=d;else{const u=xn(r++,n,e,t);s+=`<span style="color: ${u}">${d}</span>`}return s}const ya={name:"lolcat",description:"Rainbow-colorize text output",execute:(o,e)=>{const t=new W(o);if(t.hasFlag("help"))return{output:`Usage: lolcat [options] [text...]
...
Spread must be between 1 and 10.`,error:!0};r=l}const s=t.getFlag("freq");let i=.3;if(typeof s=="string"){const l=parseFloat(s);if(isNaN(l)||l<.1||l>2)return{output:`lolcat: invalid freq '${s}'
...
Try 'lolcat --help' for more information.`,error:!0};return ga(a)?{output:Ta(a,r,i),html:!0}:{output:`<pre class="lolcat-output">${$a(a,r,i)}</pre>`,html:!0}}},Aa=3600;function Ea(o){return{name:"make",description:"Build targets from a Makefile",execute:(e,t)=>{if(new W(e).hasFlag("help"))return{output:`Usage: make [target...]
...
Examples:
  ...
  make me a sandwich   # Try it and see`};const r=e.join(" ");if(r==="me a sandwich")return{output:"What? Make it yourself."};if(r==="coffee"){const s=[{text:"Grinding beans...",delay:0},{text:"Compiling bean.c...",delay:400},{text:"Linking libcaffeine.so...",delay:800}],i=1200,a=i+2200,l='<div class="make-container">'+s.map(d=>`<div class="make-line" style="animation-delay: ${d.delay}ms;">${d.text}</div>`).join("")+`<div class="make-line" style="animation-delay: ${i}ms;">Brewing dark roast <span class="make-progress-track"><span class="make-progress-bar" style="animation-delay: ${i}ms;"></span></span> 100%</div><div class="make-line" style="animation-delay: ${a}ms;">make: Ready. Careful, it's hot.</div></div>`;return o.setInputLineVisible(!1),setTimeout(()=>{o.setInputLineVisible(!0),o.focus(!0)},Aa),{output:l,html:!0}}return e.length===0?{output:"make: *** No targets specified. Stop.",error:!0}:{output:`make: *** No rule to make target '${e[0]}'. Stop.`,error:!0}}}}const Nn="0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZｱｲｳｴｵｶｷｸｹｺｻｼｽｾｿﾀﾁﾂﾃﾄﾅﾆﾇﾈﾉﾊﾋﾌﾍﾎﾏﾐﾑﾒﾓﾔﾕﾖﾗﾘﾙﾚﾛﾜﾝ";function La(){const o=document.getElementById("terminal-output");if(!o)return{cols:80,rows:24};const e=o.getBoundingClientRect(),t=parseFloat(getComputedStyle(document.documentElement).getPropertyValue("--terminal-font-size")||"16"),n=t*.6,r=t*1.5,s=Math.floor(e.width/n),i=Math.floor(e.height/r);return{cols:Math.max(s,20),rows:Math.max(i,10)}}function Ia(){return Nn[Math.floor(Math.random()*Nn.length)]}function ba(o){return{name:"matrix",description:"Display Matrix digital rain animation",execute:(e,t)=>{const n=new W(e);if(n.hasFlag("help"))return{output:`Usage: matrix [options]
...
Note: Animation continues until you scroll, type, or run 'clear'`};let r=1;const s=n.getFlag("speed");if(s!==void 0){const k=parseFloat(String(s));if(isNaN(k)||k<.1||k>5)return{output:`matrix: invalid speed value '${s}'
Speed must be between 0.1 and 5.0`,error:!0};r=k}const i=n.getFlag("theme");let a=o.getCurrentColors();if(i!==void 0){const k=String(i),H=["green","yellow","white","light-blue","paper","dc","custom"];if(!H.includes(k))return{output:`matrix: invalid theme '${k}'
Valid themes: ${H.join(", ")}`,error:!0};if(k!=="custom"){const Z=o.getPreset(k);Z&&(a=Z.colors)}}const{cols:l,rows:d}=La(),u=1.2,$=Math.floor(l/u)+5,f=Math.min(d,20),E=a["--terminal-accent"],R=a["--terminal-dim"],L=a["--terminal-bg"],y=d*1.5,T=-f*1.5,P=y,C=[];for(let k=0;k<$;k++){const H=-Math.random()*5,Z=(5+Math.random()*5)/r,Fe=k*u,Ve=[];for(let ye=0;ye<f;ye++){const He=ye/f,ue=Math.pow(He,2),Se=ye===f-1,ve=Ia();Ve.push(`<span class="matrix-char${Se?" matrix-char-bright":""}" data-char-index="${ye}" style="color: ${Se?E:R}; opacity: ${ue};">${ve}</span>`)}C.push(`
...
`,html:!0}}}}function wa(){return[{type:"info",text:"Broadcast message from root@darinchambers.com:"},{type:"info",text:"The system is going down for poweroff NOW!"},{type:"ok",text:"Stopped Session c1 of user darin"},{type:"ok",text:"Stopped Target - Graphical Interface"},{type:"ok",text:"Stopped Code Editor Process"},{type:"ok",text:"Stopped Docker Container Runtime"},{type:"ok",text:"Stopped OpenSSH Server"},{type:"failed",text:"Stopped Bluetooth Service (timeout)"},{type:"ok",text:"Stopped Network Manager"},{type:"ok",text:"Stopped D-Bus System Message Bus"},{type:"ok",text:"Stopped Journal Service"},{type:"ok",text:"Stopped System Logging Service"},{type:"info",text:"Sending SIGTERM to remaining processes..."},{type:"info",text:"Sending SIGKILL to remaining processes..."},{type:"ok",text:"Unmounted /home"},{type:"ok",text:"Unmounted /var"},{type:"ok",text:"Unmounted /tmp"},{type:"info",text:"All filesystems unmounted."},{type:"ok",text:"Reached target - Power-Off"}]}function $o(o){const e=wa(),t=150,n=e.map((a,l)=>{const d=l*t,u=`boot-line boot-line-${a.type}`,$=a.text.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;");return`<div class="${u}" style="animation-delay: ${d}ms;">${$}</div>`}),r=e.length*t,s=o?"System halted.":"Power off.";n.push(`<div class="boot-line boot-line-info" style="animation-delay: ${r}ms;">${s}</div>`);const i=r+500;return n.push(`<div class="boot-overlay" style="animation-delay: ${i}ms;" data-boot-overlay="true"><span class="boot-overlay-text">Screen off</span></div>`),n.join(`
`)}const Sa={name:"shutdown",description:"Display simulated Linux shutdown sequence",execute:(o,e)=>{const t=new W(o);if(t.hasFlag("help"))return{output:`Usage: shutdown [options]
...
${$o(n)}
</div>`,html:!0,clearBefore:!0,fullscreen:!0,fullscreenExitCommand:"boot",scrollBehavior:"top"}}},va={name:"reboot",description:"Display simulated system reboot sequence",execute:(o,e)=>{const t=new W(o);if(t.hasFlag("help"))return{output:`Usage: reboot [options]
...
Note: The full sequence takes about 10 seconds. Scroll or type to stop.`};const n=t.hasFlag("fast"),s=$o(!1).split(`
...
<div class="boot-line boot-line-info" style="animation-delay: ${d}ms;">Rebooting...</div>
 ...
 ██████╔╝██║  ██║██║  ██║██║██║ ╚████║    ╚██████╗██║  ██║██║  ██║██║ ╚═╝ ██║██████╔╝███████╗██║  ██║███████║
 ╚═════╝ ╚═╝  ╚═╝╚═╝  ╚═╝╚═╝╚═╝  ╚═══╝     ╚═════╝╚═╝  ╚═╝╚═╝  ╚═╝╚═╝     ╚═╝╚═════╝ ╚══════╝╚═╝  ╚═╝╚══════╝
`}static getTagline(){return"Technologist, Inventor | Building What's Next on Rock-Solid Foundations"}}function xr(o,e){(e==null||e>o.length)&&(e=o.length);for(var t=0,n=Array(e);t<e;t++)n[t]=o[t];return n}function Ca(o){if(Array.isArray(o))return o}function Ra(o,e){var t=o==null?null:typeof Symbol<"u"&&o[Symbol.iterator]||o["@@iterator"];if(t!=null){var n,r,s,i,a=[],l=!0,d=!1;try{if(s=(t=t.call(o)).next,e!==0)for(;!(l=(n=s.call(t)).done)&&(a.push(n.value),a.length!==e);l=!0);}catch(u){d=!0,r=u}finally{try{if(!l&&t.return!=null&&(i=t.return(),Object(i)!==i))return}finally{if(d)throw r}}return a}}function xa(){throw new TypeError(`Invalid attempt to destructure non-iterable instance.
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`)}function Na(o,e){return Ca(o)||Ra(o,e)||ka(o,e)||xa()}function ka(o,e){if(o){if(typeof o=="string")return xr(o,e);var t={}.toString.call(o).slice(8,-1);return t==="Object"&&o.constructor&&(t=o.constructor.name),t==="Map"||t==="Set"?Array.from(o):t==="Arguments"||/^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(t)?xr(o,e):void 0}}const To=Object.entries,Nr=Object.setPrototypeOf,Oa=Object.isFrozen,Da=Object.getPrototypeOf,Ma=Object.getOwnPropertyDescriptor;let le=Object.freeze,ce=Object.seal,lt=Object.create,yo=typeof Reflect<"u"&&Reflect,kn=yo.apply,On=yo.construct;le||(le=function(e){return e});ce||(ce=function(e){return e});kn||(kn=function(e,t){for(var n=arguments.length,r=new Array(n>2?n-2:0),s=2;s<n;s++)r[s-2]=arguments[s];return e.apply(t,r)});On||(On=function(e){for(var t=arguments.length,n=new Array(t>1?t-1:0),r=1;r<t;r++)n[r-1]=arguments[r];return new e(...n)});const $t=ee(Array.prototype.forEach),Pa=ee(Array.prototype.lastIndexOf),kr=ee(Array.prototype.pop),at=ee(Array.prototype.push),Fa=ee(Array.prototype.splice),We=Array.isArray,Lt=ee(String.prototype.toLowerCase),yn=ee(String.prototype.toString),Or=ee(String.prototype.match),Tt=ee(String.prototype.replace),Dr=ee(String.prototype.indexOf),Ha=ee(String.prototype.trim),Ua=ee(Number.prototype.toString),Ba=ee(Boolean.prototype.toString),Mr=typeof BigInt>"u"?null:ee(BigInt.prototype.toString),Pr=typeof Symbol>"u"?null:ee(Symbol.prototype.toString),fe=ee(Object.prototype.hasOwnProperty),yt=ee(Object.prototype.toString),ie=ee(RegExp.prototype.test),Xe=Wa(TypeError);function ee(o){return function(e){e instanceof RegExp&&(e.lastIndex=0);for(var t=arguments.length,n=new Array(t>1?t-1:0),r=1;r<t;r++)n[r-1]=arguments[r];return kn(o,e,n)}}function Wa(o){return function(){for(var e=arguments.length,t=new Array(e),n=0;n<e;n++)t[n]=arguments[n];return On(o,t)}}function V(o,e){let t=arguments.length>2&&arguments[2]!==void 0?arguments[2]:Lt;if(Nr&&Nr(o,null),!We(e))return o;let n=e.length;for(;n--;){let r=e[n];if(typeof r=="string"){const s=t(r);s!==r&&(Oa(e)||(e[n]=s),r=s)}o[r]=!0}return o}function Ga(o){for(let e=0;e<o.length;e++)fe(o,e)||(o[e]=null);return o}function pe(o){const e=lt(null);for(const n of To(o)){var t=Na(n,2);const r=t[0],s=t[1];fe(o,r)&&(We(s)?e[r]=Ga(s):s&&typeof s=="object"&&s.constructor===Object?e[r]=pe(s):e[r]=s)}return e}function za(o){switch(typeof o){case"string":return o;case"number":return Ua(o);case"boolean":return Ba(o);case"bigint":return Mr?Mr(o):"0";case"symbol":return Pr?Pr(o):"Symbol()";case"undefined":return yt(o);case"function":case"object":{if(o===null)return yt(o);const e=o,t=ke(e,"toString");if(typeof t=="function"){const n=t(e);return typeof n=="string"?n:yt(n)}return yt(o)}default:return yt(o)}}function ke(o,e){for(;o!==null;){const n=Ma(o,e);if(n){if(n.get)return ee(n.get);if(typeof n.value=="function")return ee(n.value)}o=Da(o)}function t(){return null}return t}function Va(o){try{return ie(o,""),!0}catch{return!1}}const Fr=le(["a","abbr","acronym","address","area","article","aside","audio","b","bdi","bdo","big","blink","blockquote","body","br","button","canvas","caption","center","cite","code","col","colgroup","content","data","datalist","dd","decorator","del","details","dfn","dialog","dir","div","dl","dt","element","em","fieldset","figcaption","figure","font","footer","form","h1","h2","h3","h4","h5","h6","head","header","hgroup","hr","html","i","img","input","ins","kbd","label","legend","li","main","map","mark","marquee","menu","menuitem","meter","nav","nobr","ol","optgroup","option","output","p","picture","pre","progress","q","rp","rt","ruby","s","samp","search","section","select","shadow","slot","small","source","spacer","span","strike","strong","style","sub","summary","sup","table","tbody","td","template","textarea","tfoot","th","thead","time","tr","track","tt","u","ul","var","video","wbr"]),An=le(["svg","a","altglyph","altglyphdef","altglyphitem","animatecolor","animatemotion","animatetransform","circle","clippath","defs","desc","ellipse","enterkeyhint","exportparts","filter","font","g","glyph","glyphref","hkern","image","inputmode","line","lineargradient","marker","mask","metadata","mpath","part","path","pattern","polygon","polyline","radialgradient","rect","stop","style","switch","symbol","text","textpath","title","tref","tspan","view","vkern"]),En=le(["feBlend","feColorMatrix","feComponentTransfer","feComposite","feConvolveMatrix","feDiffuseLighting","feDisplacementMap","feDistantLight","feDropShadow","feFlood","feFuncA","feFuncB","feFuncG","feFuncR","feGaussianBlur","feImage","feMerge","feMergeNode","feMorphology","feOffset","fePointLight","feSpecularLighting","feSpotLight","feTile","feTurbulence"]),ja=le(["animate","color-profile","cursor","discard","font-face","font-face-format","font-face-name","font-face-src","font-face-uri","foreignobject","hatch","hatchpath","mesh","meshgradient","meshpatch","meshrow","missing-glyph","script","set","solidcolor","unknown","use"]),Ln=le(["math","menclose","merror","mfenced","mfrac","mglyph","mi","mlabeledtr","mmultiscripts","mn","mo","mover","mpadded","mphantom","mroot","mrow","ms","mspace","msqrt","mstyle","msub","msup","msubsup","mtable","mtd","mtext","mtr","munder","munderover","mprescripts"]),Ya=le(["maction","maligngroup","malignmark","mlongdiv","mscarries","mscarry","msgroup","mstack","msline","msrow","semantics","annotation","annotation-xml","mprescripts","none"]),Hr=le(["#text"]),Ur=le(["accept","action","align","alt","autocapitalize","autocomplete","autopictureinpicture","autoplay","background","bgcolor","border","capture","cellpadding","cellspacing","checked","cite","class","clear","color","cols","colspan","command","commandfor","controls","controlslist","coords","crossorigin","datetime","decoding","default","dir","disabled","disablepictureinpicture","disableremoteplayback","download","draggable","enctype","enterkeyhint","exportparts","face","for","headers","height","hidden","high","href","hreflang","id","inert","inputmode","integrity","ismap","kind","label","lang","list","loading","loop","low","max","maxlength","media","method","min","minlength","multiple","muted","name","nonce","noshade","novalidate","nowrap","open","optimum","part","pattern","placeholder","playsinline","popover","popovertarget","popovertargetaction","poster","preload","pubdate","radiogroup","readonly","rel","required","rev","reversed","role","rows","rowspan","spellcheck","scope","selected","shape","size","sizes","slot","span","srclang","start","src","srcset","step","style","summary","tabindex","title","translate","type","usemap","valign","value","width","wrap","xmlns"]),In=le(["accent-height","accumulate","additive","alignment-baseline","amplitude","ascent","attributename","attributetype","azimuth","basefrequency","baseline-shift","begin","bias","by","class","clip","clippathunits","clip-path","clip-rule","color","color-interpolation","color-interpolation-filters","color-profile","color-rendering","cx","cy","d","dx","dy","diffuseconstant","direction","display","divisor","dur","edgemode","elevation","end","exponent","fill","fill-opacity","fill-rule","filter","filterunits","flood-color","flood-opacity","font-family","font-size","font-size-adjust","font-stretch","font-style","font-variant","font-weight","fx","fy","g1","g2","glyph-name","glyphref","gradientunits","gradienttransform","height","href","id","image-rendering","in","in2","intercept","k","k1","k2","k3","k4","kerning","keypoints","keysplines","keytimes","lang","lengthadjust","letter-spacing","kernelmatrix","kernelunitlength","lighting-color","local","marker-end","marker-mid","marker-start","markerheight","markerunits","markerwidth","maskcontentunits","maskunits","max","mask","mask-type","media","method","mode","min","name","numoctaves","offset","operator","opacity","order","orient","orientation","origin","overflow","paint-order","path","pathlength","patterncontentunits","patterntransform","patternunits","points","preservealpha","preserveaspectratio","primitiveunits","r","rx","ry","radius","refx","refy","repeatcount","repeatdur","restart","result","rotate","scale","seed","shape-rendering","slope","specularconstant","specularexponent","spreadmethod","startoffset","stddeviation","stitchtiles","stop-color","stop-opacity","stroke-dasharray","stroke-dashoffset","stroke-linecap","stroke-linejoin","stroke-miterlimit","stroke-opacity","stroke","stroke-width","style","surfacescale","systemlanguage","tabindex","tablevalues","targetx","targety","transform","transform-origin","text-anchor","text-decoration","text-rendering","textlength","type","u1","u2","unicode","values","viewbox","visibility","version","vert-adv-y","vert-origin-x","vert-origin-y","width","word-spacing","wrap","writing-mode","xchannelselector","ychannelselector","x","x1","x2","xmlns","y","y1","y2","z","zoomandpan"]),Br=le(["accent","accentunder","align","bevelled","close","columnalign","columnlines","columnspacing","columnspan","denomalign","depth","dir","display","displaystyle","encoding","fence","frame","height","href","id","largeop","length","linethickness","lquote","lspace","mathbackground","mathcolor","mathsize","mathvariant","maxsize","minsize","movablelimits","notation","numalign","open","rowalign","rowlines","rowspacing","rowspan","rspace","rquote","scriptlevel","scriptminsize","scriptsizemultiplier","selection","separator","separators","stretchy","subscriptshift","supscriptshift","symmetric","voffset","width","xmlns"]),Bt=le(["xlink:href","xml:id","xlink:title","xml:space","xmlns:xlink"]),qa=ce(/{{[\w\W]*|^[\w\W]*}}/g),Xa=ce(/<%[\w\W]*|^[\w\W]*%>/g),Ka=ce(/\${[\w\W]*/g),Za=ce(/^data-[\-\w.\u00B7-\uFFFF]+$/),Ja=ce(/^aria-[\-\w]+$/),Wr=ce(/^(?:(?:(?:f|ht)tps?|mailto|tel|callto|sms|cid|xmpp|matrix):|[^a-z]|[a-z+.\-]+(?:[^a-z+.\-:]|$))/i),Qa=ce(/^(?:\w+script|data):/i),el=ce(/[\u0000-\u0020\u00A0\u1680\u180E\u2000-\u2029\u205F\u3000]/g),tl=ce(/^html$/i),nl=ce(/^[a-z][.\w]*(-[.\w]+)+$/i),Gr=ce(/<[/\w!]/g),rl=ce(/<[/\w]/g),ol=ce(/<\/no(script|embed|frames)/i),sl=ce(/\/>/i),Ne={element:1,attribute:2,text:3,cdataSection:4,entityReference:5,entityNode:6,processingInstruction:7,comment:8,document:9,documentType:10,documentFragment:11,notation:12},il=function(){return typeof window>"u"?null:window},al=function(e,t){if(typeof e!="object"||typeof e.createPolicy!="function")return null;let n=null;const r="data-tt-policy-suffix";t&&t.hasAttribute(r)&&(n=t.getAttribute(r));const s="dompurify"+(n?"#"+n:"");try{return e.createPolicy(s,{createHTML(i){return i},createScriptURL(i){return i}})}catch{return console.warn("TrustedTypes policy "+s+" could not be created."),null}},zr=function(){return{afterSanitizeAttributes:[],afterSanitizeElements:[],afterSanitizeShadowDOM:[],beforeSanitizeAttributes:[],beforeSanitizeElements:[],beforeSanitizeShadowDOM:[],uponSanitizeAttribute:[],uponSanitizeElement:[],uponSanitizeShadowNode:[]}},Be=function(e,t,n,r){return fe(e,t)&&We(e[t])?V(r.base?pe(r.base):{},e[t],r.transform):n};function Ao(){let o=arguments.length>0&&arguments[0]!==void 0?arguments[0]:il();const e=S=>Ao(S);if(e.version="3.4.10",e.removed=[],!o||!o.document||o.document.nodeType!==Ne.document||!o.Element)return e.isSupported=!1,e;let t=o.document;const n=t,r=n.currentScript;o.DocumentFragment;const s=o.HTMLTemplateElement,i=o.Node,a=o.Element,l=o.NodeFilter,d=o.NamedNodeMap;d===void 0&&(o.NamedNodeMap||o.MozNamedAttrMap),o.HTMLFormElement;const u=o.DOMParser,$=o.trustedTypes,f=a.prototype,E=ke(f,"cloneNode"),R=ke(f,"remove"),L=ke(f,"nextSibling"),y=ke(f,"childNodes"),T=ke(f,"parentNode"),P=ke(f,"shadowRoot"),C=ke(f,"attributes"),F=i&&i.prototype?ke(i.prototype,"nodeType"):null,k=i&&i.prototype?ke(i.prototype,"nodeName"):null;if(typeof s=="function"){const S=t.createElement("template");S.content&&S.content.ownerDocument&&(t=S.content.ownerDocument)}let H,Z="",Fe,Ve=!1,ye=0;const He=function(){if(ye>0)throw Xe('A configured TRUSTED_TYPES_POLICY callback (createHTML or createScriptURL) must not call DOMPurify.sanitize, as that causes infinite recursion. Do not pass a policy whose callbacks wrap DOMPurify as TRUSTED_TYPES_POLICY; see the "DOMPurify and Trusted Types" section of the README.')},ue=function(c){He(),ye++;try{return H.createHTML(c)}finally{ye--}},Se=function(c){He(),ye++;try{return H.createScriptURL(c)}finally{ye--}},ve=function(){return Ve||(Fe=al($,r),Ve=!0),Fe},et=t,_t=et.implementation,Rt=et.createNodeIterator,Jt=et.createDocumentFragment,xt=et.getElementsByTagName,Nt=n.importNode;let G=zr();e.isSupported=typeof To=="function"&&typeof T=="function"&&_t&&_t.createHTMLDocument!==void 0;const p=qa,g=Xa,_=Ka,h=Za,A=Ja,b=Qa,v=el,w=nl;let N=Wr,x=null;const U=V({},[...Fr,...An,...En,...Ln,...Hr]);let O=null;const B=V({},[...Ur,...In,...Br,...Bt]);let M=Object.seal(lt(null,{tagNameCheck:{writable:!0,configurable:!1,enumerable:!0,value:null},attributeNameCheck:{writable:!0,configurable:!1,enumerable:!0,value:null},allowCustomizedBuiltInElements:{writable:!0,configurable:!1,enumerable:!0,value:!1}})),re=null,oe=null;const $e=Object.seal(lt(null,{tagCheck:{writable:!0,configurable:!1,enumerable:!0,value:null},attributeCheck:{writable:!0,configurable:!1,enumerable:!0,value:null}}));let Te=!0,Le=!0,_e=!1,se=!0,Ce=!1,mt=!0,je=!1,Qt=!1,en=!1,tt=!1,kt=!1,Ot=!1,Yn=!0,qn=!1;const Xn="user-content-";let tn=!0,nn=!1,nt={},Re=null;const rn=V({},["annotation-xml","audio","colgroup","desc","foreignobject","head","iframe","math","mi","mn","mo","ms","mtext","noembed","noframes","noscript","plaintext","script","selectedcontent","style","svg","template","thead","title","video","xmp"]);let Kn=null;const Zn=V({},["audio","video","img","source","image","track"]);let on=null;const Jn=V({},["alt","class","for","id","label","name","pattern","placeholder","role","summary","title","value","style","xmlns"]),Dt="http://www.w3.org/1998/Math/MathML",Mt="http://www.w3.org/2000/svg",xe="http://www.w3.org/1999/xhtml";let rt=xe,sn=!1,an=null;const wo=V({},[Dt,Mt,xe],yn),Qn=le(["mi","mo","mn","ms","mtext"]);let ln=V({},Qn);const er=le(["annotation-xml"]);let cn=V({},er);const So=V({},["title","style","font","a","script"]);let ht=null;const vo=["application/xhtml+xml","text/html"],Co="text/html";let J=null,ot=null;const Ro=t.createElement("form"),tr=function(c){return c instanceof RegExp||c instanceof Function},dn=function(){let c=arguments.length>0&&arguments[0]!==void 0?arguments[0]:{};if(ot&&ot===c)return;(!c||typeof c!="object")&&(c={}),c=pe(c),ht=vo.indexOf(c.PARSER_MEDIA_TYPE)===-1?Co:c.PARSER_MEDIA_TYPE,J=ht==="application/xhtml+xml"?yn:Lt,x=Be(c,"ALLOWED_TAGS",U,{transform:J}),O=Be(c,"ALLOWED_ATTR",B,{transform:J}),an=Be(c,"ALLOWED_NAMESPACES",wo,{transform:yn}),on=Be(c,"ADD_URI_SAFE_ATTR",Jn,{transform:J,base:Jn}),Kn=Be(c,"ADD_DATA_URI_TAGS",Zn,{transform:J,base:Zn}),Re=Be(c,"FORBID_CONTENTS",rn,{transform:J}),re=Be(c,"FORBID_TAGS",pe({}),{transform:J}),oe=Be(c,"FORBID_ATTR",pe({}),{transform:J}),nt=fe(c,"USE_PROFILES")?c.USE_PROFILES&&typeof c.USE_PROFILES=="object"?pe(c.USE_PROFILES):c.USE_PROFILES:!1,Te=c.ALLOW_ARIA_ATTR!==!1,Le=c.ALLOW_DATA_ATTR!==!1,_e=c.ALLOW_UNKNOWN_PROTOCOLS||!1,se=c.ALLOW_SELF_CLOSE_IN_ATTR!==!1,Ce=c.SAFE_FOR_TEMPLATES||!1,mt=c.SAFE_FOR_XML!==!1,je=c.WHOLE_DOCUMENT||!1,tt=c.RETURN_DOM||!1,kt=c.RETURN_DOM_FRAGMENT||!1,Ot=c.RETURN_TRUSTED_TYPE||!1,en=c.FORCE_BODY||!1,Yn=c.SANITIZE_DOM!==!1,qn=c.SANITIZE_NAMED_PROPS||!1,tn=c.KEEP_CONTENT!==!1,nn=c.IN_PLACE||!1,N=Va(c.ALLOWED_URI_REGEXP)?c.ALLOWED_URI_REGEXP:Wr,rt=typeof c.NAMESPACE=="string"?c.NAMESPACE:xe,ln=fe(c,"MATHML_TEXT_INTEGRATION_POINTS")&&c.MATHML_TEXT_INTEGRATION_POINTS&&typeof c.MATHML_TEXT_INTEGRATION_POINTS=="object"?pe(c.MATHML_TEXT_INTEGRATION_POINTS):V({},Qn),cn=fe(c,"HTML_INTEGRATION_POINTS")&&c.HTML_INTEGRATION_POINTS&&typeof c.HTML_INTEGRATION_POINTS=="object"?pe(c.HTML_INTEGRATION_POINTS):V({},er);const m=fe(c,"CUSTOM_ELEMENT_HANDLING")&&c.CUSTOM_ELEMENT_HANDLING&&typeof c.CUSTOM_ELEMENT_HANDLING=="object"?pe(c.CUSTOM_ELEMENT_HANDLING):lt(null);if(M=lt(null),fe(m,"tagNameCheck")&&tr(m.tagNameCheck)&&(M.tagNameCheck=m.tagNameCheck),fe(m,"attributeNameCheck")&&tr(m.attributeNameCheck)&&(M.attributeNameCheck=m.attributeNameCheck),fe(m,"allowCustomizedBuiltInElements")&&typeof m.allowCustomizedBuiltInElements=="boolean"&&(M.allowCustomizedBuiltInElements=m.allowCustomizedBuiltInElements),ce(M),Ce&&(Le=!1),kt&&(tt=!0),nt&&(x=V({},Hr),O=lt(null),nt.html===!0&&(V(x,Fr),V(O,Ur)),nt.svg===!0&&(V(x,An),V(O,In),V(O,Bt)),nt.svgFilters===!0&&(V(x,En),V(O,In),V(O,Bt)),nt.mathMl===!0&&(V(x,Ln),V(O,Br),V(O,Bt))),$e.tagCheck=null,$e.attributeCheck=null,fe(c,"ADD_TAGS")&&(typeof c.ADD_TAGS=="function"?$e.tagCheck=c.ADD_TAGS:We(c.ADD_TAGS)&&(x===U&&(x=pe(x)),V(x,c.ADD_TAGS,J))),fe(c,"ADD_ATTR")&&(typeof c.ADD_ATTR=="function"?$e.attributeCheck=c.ADD_ATTR:We(c.ADD_ATTR)&&(O===B&&(O=pe(O)),V(O,c.ADD_ATTR,J))),fe(c,"ADD_URI_SAFE_ATTR")&&We(c.ADD_URI_SAFE_ATTR)&&V(on,c.ADD_URI_SAFE_ATTR,J),fe(c,"FORBID_CONTENTS")&&We(c.FORBID_CONTENTS)&&(Re===rn&&(Re=pe(Re)),V(Re,c.FORBID_CONTENTS,J)),fe(c,"ADD_FORBID_CONTENTS")&&We(c.ADD_FORBID_CONTENTS)&&(Re===rn&&(Re=pe(Re)),V(Re,c.ADD_FORBID_CONTENTS,J)),tn&&(x["#text"]=!0),je&&V(x,["html","head","body"]),x.table&&(V(x,["tbody"]),delete re.tbody),c.TRUSTED_TYPES_POLICY){if(typeof c.TRUSTED_TYPES_POLICY.createHTML!="function")throw Xe('TRUSTED_TYPES_POLICY configuration option must provide a "createHTML" hook.');if(typeof c.TRUSTED_TYPES_POLICY.createScriptURL!="function")throw Xe('TRUSTED_TYPES_POLICY configuration option must provide a "createScriptURL" hook.');const I=H;H=c.TRUSTED_TYPES_POLICY;try{Z=ue("")}catch(D){throw H=I,D}}else c.TRUSTED_TYPES_POLICY===null?(H=void 0,Z=""):(H===void 0&&(H=ve()),H&&typeof Z=="string"&&(Z=ue("")));(G.uponSanitizeElement.length>0||G.uponSanitizeAttribute.length>0)&&x===U&&(x=pe(x)),G.uponSanitizeAttribute.length>0&&O===B&&(O=pe(O)),le&&le(c),ot=c},nr=V({},[...An,...En,...ja]),rr=V({},[...Ln,...Ya]),xo=function(c,m,I){return m.namespaceURI===xe?c==="svg":m.namespaceURI===Dt?c==="svg"&&(I==="annotation-xml"||ln[I]):!!nr[c]},No=function(c,m,I){return m.namespaceURI===xe?c==="math":m.namespaceURI===Mt?c==="math"&&cn[I]:!!rr[c]},ko=function(c,m,I){return m.namespaceURI===Mt&&!cn[I]||m.namespaceURI===Dt&&!ln[I]?!1:!rr[c]&&(So[c]||!nr[c])},Oo=function(c){let m=T(c);(!m||!m.tagName)&&(m={namespaceURI:rt,tagName:"template"});const I=Lt(c.tagName),D=Lt(m.tagName);return an[c.namespaceURI]?c.namespaceURI===Mt?xo(I,m,D):c.namespaceURI===Dt?No(I,m,D):c.namespaceURI===xe?ko(I,m,D):!!(ht==="application/xhtml+xml"&&an[c.namespaceURI]):!1},Ue=function(c){at(e.removed,{element:c});try{T(c).removeChild(c)}catch{if(R(c),!T(c))throw Xe("a node selected for removal could not be detached from its tree and cannot be safely returned; refusing to sanitize in place")}},or=function(c){const m=y(c);if(m){const D=[];$t(m,z=>{at(D,z)}),$t(D,z=>{try{R(z)}catch{}})}const I=C(c);if(I)for(let D=I.length-1;D>=0;--D){const z=I[D],j=z&&z.name;if(typeof j=="string")try{c.removeAttribute(j)}catch{}}},Ye=function(c,m){try{at(e.removed,{attribute:m.getAttributeNode(c),from:m})}catch{at(e.removed,{attribute:null,from:m})}if(m.removeAttribute(c),c==="is")if(tt||kt)try{Ue(m)}catch{}else try{m.setAttribute(c,"")}catch{}},Do=function(c){const m=C(c);if(m)for(let I=m.length-1;I>=0;--I){const D=m[I],z=D&&D.name;if(!(typeof z!="string"||O[J(z)]))try{c.removeAttribute(z)}catch{}}},Mo=function(c){const m=[c];for(;m.length>0;){const I=m.pop();(F?F(I):I.nodeType)===Ne.element&&Do(I);const z=y(I);if(z)for(let j=z.length-1;j>=0;--j)m.push(z[j])}},sr=function(c){let m=null,I=null;if(en)c="<remove></remove>"+c;else{const j=Or(c,/^[\r\n\t ]+/);I=j&&j[0]}ht==="application/xhtml+xml"&&rt===xe&&(c='<html xmlns="http://www.w3.org/1999/xhtml"><head></head><body>'+c+"</body></html>");const D=H?ue(c):c;if(rt===xe)try{m=new u().parseFromString(D,ht)}catch{}if(!m||!m.documentElement){m=_t.createDocument(rt,"template",null);try{m.documentElement.innerHTML=sn?Z:D}catch{}}const z=m.body||m.documentElement;return c&&I&&z.insertBefore(t.createTextNode(I),z.childNodes[0]||null),rt===xe?xt.call(m,je?"html":"body")[0]:je?m.documentElement:z},ir=function(c){return Rt.call(c.ownerDocument||c,c,l.SHOW_ELEMENT|l.SHOW_COMMENT|l.SHOW_TEXT|l.SHOW_PROCESSING_INSTRUCTION|l.SHOW_CDATA_SECTION,null)},Pt=function(c){return c=Tt(c,p," "),c=Tt(c,g," "),c=Tt(c,_," "),c},un=function(c){var m;c.normalize();const I=Rt.call(c.ownerDocument||c,c,l.SHOW_TEXT|l.SHOW_COMMENT|l.SHOW_CDATA_SECTION|l.SHOW_PROCESSING_INSTRUCTION,null);let D=I.nextNode();for(;D;)D.data=Pt(D.data),D=I.nextNode();const z=(m=c.querySelectorAll)===null||m===void 0?void 0:m.call(c,"template");z&&$t(z,j=>{st(j.content)&&un(j.content)})},Ft=function(c){const m=k?k(c):null;return typeof m!="string"||J(m)!=="form"?!1:typeof c.nodeName!="string"||typeof c.textContent!="string"||typeof c.removeChild!="function"||c.attributes!==C(c)||typeof c.removeAttribute!="function"||typeof c.setAttribute!="function"||typeof c.namespaceURI!="string"||typeof c.insertBefore!="function"||typeof c.hasChildNodes!="function"||c.nodeType!==F(c)||c.childNodes!==y(c)},st=function(c){if(!F||typeof c!="object"||c===null)return!1;try{return F(c)===Ne.documentFragment}catch{return!1}},pt=function(c){if(!F||typeof c!="object"||c===null)return!1;try{return typeof F(c)=="number"}catch{return!1}};function Oe(S,c,m){S.length!==0&&$t(S,I=>{I.call(e,c,m,ot)})}const Po=function(c,m){return!!(mt&&c.hasChildNodes()&&!pt(c.firstElementChild)&&ie(Gr,c.textContent)&&ie(Gr,c.innerHTML)||mt&&c.namespaceURI===xe&&m==="style"&&pt(c.firstElementChild)||c.nodeType===Ne.processingInstruction||mt&&c.nodeType===Ne.comment&&ie(rl,c.data))},Fo=function(c,m){if(!re[m]&&cr(m)&&(M.tagNameCheck instanceof RegExp&&ie(M.tagNameCheck,m)||M.tagNameCheck instanceof Function&&M.tagNameCheck(m)))return!1;if(tn&&!Re[m]){const I=T(c),D=y(c);if(D&&I){const z=D.length;for(let j=z-1;j>=0;--j){const ne=nn?D[j]:E(D[j],!0);I.insertBefore(ne,L(c))}}}return Ue(c),!0},ar=function(c){if(Oe(G.beforeSanitizeElements,c,null),Ft(c))return Ue(c),!0;const m=J(k?k(c):c.nodeName);if(Oe(G.uponSanitizeElement,c,{tagName:m,allowedTags:x}),Po(c,m))return Ue(c),!0;if(re[m]||!($e.tagCheck instanceof Function&&$e.tagCheck(m))&&!x[m])return Fo(c,m);if((F?F(c):c.nodeType)===Ne.element&&!Oo(c)||(m==="noscript"||m==="noembed"||m==="noframes")&&ie(ol,c.innerHTML))return Ue(c),!0;if(Ce&&c.nodeType===Ne.text){const D=Pt(c.textContent);c.textContent!==D&&(at(e.removed,{element:c.cloneNode()}),c.textContent=D)}return Oe(G.afterSanitizeElements,c,null),!1},lr=function(c,m,I){if(oe[m]||Yn&&(m==="id"||m==="name")&&(I in t||I in Ro))return!1;const D=O[m]||$e.attributeCheck instanceof Function&&$e.attributeCheck(m,c);if(!(Le&&ie(h,m))){if(!(Te&&ie(A,m))){if(D){if(!on[m]){if(!ie(N,Tt(I,v,""))){if(!((m==="src"||m==="xlink:href"||m==="href")&&c!=="script"&&Dr(I,"data:")===0&&Kn[c])){if(!(_e&&!ie(b,Tt(I,v,"")))){if(I)return!1}}}}}else if(!(cr(c)&&(M.tagNameCheck instanceof RegExp&&ie(M.tagNameCheck,c)||M.tagNameCheck instanceof Function&&M.tagNameCheck(c))&&(M.attributeNameCheck instanceof RegExp&&ie(M.attributeNameCheck,m)||M.attributeNameCheck instanceof Function&&M.attributeNameCheck(m,c))||m==="is"&&M.allowCustomizedBuiltInElements&&(M.tagNameCheck instanceof RegExp&&ie(M.tagNameCheck,I)||M.tagNameCheck instanceof Function&&M.tagNameCheck(I))))return!1}}return!0},Ho=V({},["annotation-xml","color-profile","font-face","font-face-format","font-face-name","font-face-src","font-face-uri","missing-glyph"]),cr=function(c){return!Ho[Lt(c)]&&ie(w,c)},Uo=function(c,m,I,D){if(H&&typeof $=="object"&&typeof $.getAttributeType=="function"&&!I)switch($.getAttributeType(c,m)){case"TrustedHTML":return ue(D);case"TrustedScriptURL":return Se(D)}return D},Bo=function(c,m,I,D){try{I?c.setAttributeNS(I,m,D):c.setAttribute(m,D),Ft(c)?Ue(c):kr(e.removed)}catch{Ye(m,c)}},dr=function(c){Oe(G.beforeSanitizeAttributes,c,null);const m=c.attributes;if(!m||Ft(c))return;const I={attrName:"",attrValue:"",keepAttr:!0,allowedAttributes:O,forceKeepAttr:void 0};let D=m.length;const z=J(c.nodeName);for(;D--;){const j=m[D],ne=j.name,Q=j.namespaceURI,Ae=j.value,Ie=J(ne),mn=Ae;let me=ne==="value"?mn:Ha(mn);if(I.attrName=Ie,I.attrValue=me,I.keepAttr=!0,I.forceKeepAttr=void 0,Oe(G.uponSanitizeAttribute,c,I),me=I.attrValue,qn&&(Ie==="id"||Ie==="name")&&Dr(me,Xn)!==0&&(Ye(ne,c),me=Xn+me),mt&&ie(/((--!?|])>)|<\/(style|script|title|xmp|textarea|noscript|iframe|noembed|noframes)/i,me)){Ye(ne,c);continue}if(Ie==="attributename"&&Or(me,"href")){Ye(ne,c);continue}if(!I.forceKeepAttr){if(!I.keepAttr){Ye(ne,c);continue}if(!se&&ie(sl,me)){Ye(ne,c);continue}if(Ce&&(me=Pt(me)),!lr(z,Ie,me)){Ye(ne,c);continue}me=Uo(z,Ie,Q,me),me!==mn&&Bo(c,ne,Q,me)}}Oe(G.afterSanitizeAttributes,c,null)},Ht=function(c){let m=null;const I=ir(c);for(Oe(G.beforeSanitizeShadowDOM,c,null);m=I.nextNode();)if(Oe(G.uponSanitizeShadowNode,m,null),ar(m),dr(m),st(m.content)&&Ht(m.content),(F?F(m):m.nodeType)===Ne.element){const z=P(m);st(z)&&(_n(z),Ht(z))}Oe(G.afterSanitizeShadowDOM,c,null)},_n=function(c){const m=[{node:c,shadow:null}];for(;m.length>0;){const I=m.pop();if(I.shadow){Ht(I.shadow);continue}const D=I.node,j=(F?F(D):D.nodeType)===Ne.element,ne=y(D);if(ne)for(let Q=ne.length-1;Q>=0;--Q)m.push({node:ne[Q],shadow:null});if(j){const Q=k?k(D):null;if(typeof Q=="string"&&J(Q)==="template"){const Ae=D.content;st(Ae)&&m.push({node:Ae,shadow:null})}}if(j){const Q=P(D);st(Q)&&m.push({node:null,shadow:Q},{node:Q,shadow:null})}}};return e.sanitize=function(S){let c=arguments.length>1&&arguments[1]!==void 0?arguments[1]:{},m=null,I=null,D=null,z=null;if(sn=!S,sn&&(S="<!-->"),typeof S!="string"&&!pt(S)&&(S=za(S),typeof S!="string"))throw Xe("dirty is not a string, aborting");if(!e.isSupported)return S;Qt||dn(c),e.removed=[];const j=nn&&typeof S!="string"&&pt(S);if(j){const Ae=k?k(S):S.nodeName;if(typeof Ae=="string"){const Ie=J(Ae);if(!x[Ie]||re[Ie])throw Xe("root node is forbidden and cannot be sanitized in-place")}if(Ft(S))throw Xe("root node is clobbered and cannot be sanitized in-place");try{_n(S)}catch(Ie){throw or(S),Ie}}else if(pt(S))m=sr("<!---->"),I=m.ownerDocument.importNode(S,!0),I.nodeType===Ne.element&&I.nodeName==="BODY"||I.nodeName==="HTML"?m=I:m.appendChild(I),_n(I);else{if(!tt&&!Ce&&!je&&S.indexOf("<")===-1)return H&&Ot?ue(S):S;if(m=sr(S),!m)return tt?null:Ot?Z:""}m&&en&&Ue(m.firstChild);const ne=ir(j?S:m);try{for(;D=ne.nextNode();)ar(D),dr(D),st(D.content)&&Ht(D.content)}catch(Ae){throw j&&or(S),Ae}if(j)return $t(e.removed,Ae=>{Ae.element&&Mo(Ae.element)}),Ce&&un(S),S;if(tt){if(Ce&&un(m),kt)for(z=Jt.call(m.ownerDocument);m.firstChild;)z.appendChild(m.firstChild);else z=m;return(O.shadowroot||O.shadowrootmode)&&(z=Nt.call(n,z,!0)),z}let Q=je?m.outerHTML:m.innerHTML;return je&&x["!doctype"]&&m.ownerDocument&&m.ownerDocument.doctype&&m.ownerDocument.doctype.name&&ie(tl,m.ownerDocument.doctype.name)&&(Q="<!DOCTYPE "+m.ownerDocument.doctype.name+`>
`+Q),Ce&&(Q=Pt(Q)),H&&Ot?ue(Q):Q},e.setConfig=function(){let S=arguments.length>0&&arguments[0]!==void 0?arguments[0]:{};dn(S),Qt=!0},e.clearConfig=function(){ot=null,Qt=!1,H=Fe,Z=""},e.isValidAttribute=function(S,c,m){ot||dn({});const I=J(S),D=J(c);return lr(I,D,m)},e.addHook=function(S,c){typeof c=="function"&&at(G[S],c)},e.removeHook=function(S,c){if(c!==void 0){const m=Pa(G[S],c);return m===-1?void 0:Fa(G[S],m,1)[0]}return kr(G[S])},e.removeHooks=function(S){G[S]=[]},e.removeAllHooks=function(){G=zr()},e}var ll=Ao();function Vn(o){return ll.sanitize(o,{ALLOWED_TAGS:["p","div","span","br","strong","b","em","i","u","s","a","code","pre","h1","h2","h3","h4","h5","h6","ul","ol","li","blockquote","table","thead","tbody","tr","th","td","img","canvas","button","input","select","option","label","aside","section","details","summary"],ALLOWED_ATTR:["class","id","href","target","rel","src","alt","title","width","height","type","value","checked","selected","disabled","min","max","step","placeholder","data-command","data-command-template","data-setting-type","data-color-var","data-theme","data-settings-panel","data-graph","data-graph-src","data-graph-theme","data-graph-initialized","data-graph-error","data-speed","data-density","data-pattern","data-accent-color","data-dim-color","style","open","role","aria-label","aria-labelledby","aria-describedby","aria-valuemin","aria-valuemax","aria-valuenow","aria-valuetext","aria-live","aria-atomic","aria-current"],RETURN_DOM:!1,RETURN_DOM_FRAGMENT:!1})}class cl{headerElement;constructor(e){this.headerElement=e,this.render(),this.setupClickHandler()}render(){const e=Rr.generateHeader(),t=Rr.getTagline();this.headerElement.innerHTML=Vn(`
...
`,Al=Object.freeze(Object.defineProperty({__proto__:null,default:yl},Symbol.toStringTag,{value:"Module"})),El=`---
...
`,Ll=Object.freeze(Object.defineProperty({__proto__:null,default:El},Symbol.toStringTag,{value:"Module"})),Il=`---
...
`,bl=Object.freeze(Object.defineProperty({__proto__:null,default:Il},Symbol.toStringTag,{value:"Module"})),wl=`---
...
`,Sl=Object.freeze(Object.defineProperty({__proto__:null,default:wl},Symbol.toStringTag,{value:"Module"})),vl=`---
...
`,Cl=Object.freeze(Object.defineProperty({__proto__:null,default:vl},Symbol.toStringTag,{value:"Module"})),Rl=`# Darin Chambers
...
`,xl=Object.freeze(Object.defineProperty({__proto__:null,default:Rl},Symbol.toStringTag,{value:"Module"})),Nl=`# Contact Information
...
`,Pl=Object.freeze(Object.defineProperty({__proto__:null,default:Ml},Symbol.toStringTag,{value:"Module"}));class Fl{static createDirectoryNode(e){const t=e.startsWith(".");return{name:e,type:"directory",children:new Map,permissions:"drwxr-xr-x",owner:"darin",size:4096,modifiedTime:new Date,isHidden:t}}static createFileNode(e,t){const n=e.startsWith(".");return{name:e,type:"file",content:t,permissions:"-rw-r--r--",owner:"darin",size:t.length,modifiedTime:new Date,isHidden:n}}static loadBlogFiles(){const e=Object.assign({"../../content/blog/2025-09-20-01-building-a-minimal-production-graph-library.md":Al,"../../content/blog/2025-11-14-a-love-letter-to-developers-and-the-terminal.md":Ll,"../../content/blog/2025-11-15-we-trick-rocks-into-thinking.md":bl,"../../content/blog/2025-11-23-leet-status-unlocked.md":Sl}),t=new Map;for(const[n,r]of Object.entries(e)){const s=n.split("/").pop(),i=r.default;t.set(s,this.createFileNode(s,i))}return t}static loadPortfolioFiles(){const e=Object.assign({"../../content/portfolio/hypergrowing-a-unicorn.md":Cl}),t=new Map;for(const[n,r]of Object.entries(e)){const s=n.split("/").pop(),i=r.default;t.set(s,this.createFileNode(s,i))}return t}static loadPostFiles(){const e=Object.assign({}),t=new Map;for(const[n,r]of Object.entries(e)){const s=n.split("/").pop(),i=r.default;t.set(s,this.createFileNode(s,i))}return t}static loadContentFiles(){const e=Object.assign({"../../content/about.md":xl,"../../content/contact.md":kl,"../../content/help.md":Dl}),t=new Map;for(const[n,r]of Object.entries(e)){const s=n.split("/").pop(),i=r.default;t.set(s,this.createFileNode(s,i))}return t}static loadChangelogFile(){const t=Object.values(Object.assign({"../../../CHANGELOG.md":Pl}));return t.length>0?t[0].default:""}static createDefaultStructure(){const e=this.createDirectoryNode(""),t=e.children,n=this.createDirectoryNode("root");n.permissions="drwx------",n.owner="root",t.set("root",n),n.children.set(".bashrc",this.createFileNode(".bashrc",`# /root/.bashrc
# TODO: fix the thing
...
- Darin
`));for(const F of n.children.values())F.owner="root";const r=this.createDirectoryNode("home");t.set("home",r);const s=this.createDirectoryNode("guest");r.children.set("guest",s),s.children.set("README.txt",this.createFileNode("README.txt",`Welcome to darinchambers.com!
...
`));const i=this.createDirectoryNode("darin");r.children.set("darin",i),i.children.set(".post-it",this.createFileNode(".post-it",`=============================
...
`)),i.children.set(".secret",this.createFileNode(".secret",`You found a secret! 🎉
