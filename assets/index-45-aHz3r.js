(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))n(r);new MutationObserver(r=>{for(const i of r)if(i.type==="childList")for(const s of i.addedNodes)s.tagName==="LINK"&&s.rel==="modulepreload"&&n(s)}).observe(document,{childList:!0,subtree:!0});function t(r){const i={};return r.integrity&&(i.integrity=r.integrity),r.referrerPolicy&&(i.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?i.credentials="include":r.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function n(r){if(r.ep)return;r.ep=!0;const i=t(r);fetch(r.href,i)}})();const Fe=new Map;function lo(){Fe.forEach(e=>{e.stopAnimation()}),Fe.clear(),document.querySelectorAll(".boot-overlay").forEach(e=>{e.remove()})}function jn(o){o.style.animation="boot-overlay-fade 0.3s ease forwards",o.addEventListener("animationend",()=>{o.remove()},{once:!0}),setTimeout(()=>{o.parentNode&&o.remove()},500)}function qt(o){lo();const e=o.dataset.bootType??"boot";e==="boot"&&document.querySelectorAll(".boot-overlay").forEach(r=>{jn(r)});const t={element:o,bootType:e,overlay:null,cleanupFns:[],stopAnimation:()=>{t.cleanupFns.forEach(n=>n()),t.cleanupFns=[],t.overlay?.parentNode&&(jn(t.overlay),t.overlay=null),Fe.delete(o)}};if(Fe.set(o,t),e==="shutdown"||e==="reboot"){const n=o.querySelector("[data-boot-overlay]");if(n){t.overlay=n;const i=getComputedStyle(n).animationDelay,s=parseFloat(i)*(i.includes("ms")?1:1e3);setTimeout(()=>{Fe.has(o)&&n.parentNode&&document.body.appendChild(n)},s)}}co(o,t)}function co(o,e){const t=document.getElementById("terminal-output");if(t){const a=()=>{e.stopAnimation()};t.addEventListener("scroll",a,{once:!0}),e.cleanupFns.push(()=>{t.removeEventListener("scroll",a)})}const n=a=>{a.key==="Shift"||a.key==="Control"||a.key==="Alt"||a.key==="Meta"||e.stopAnimation()};setTimeout(()=>{Fe.has(o)&&(document.addEventListener("keydown",n,{once:!0}),e.cleanupFns.push(()=>{document.removeEventListener("keydown",n)}))},100);const r=()=>{e.stopAnimation()};setTimeout(()=>{Fe.has(o)&&(document.addEventListener("click",r,{once:!0}),e.cleanupFns.push(()=>{document.removeEventListener("click",r)}))},100);const i=new MutationObserver(()=>{o.nextElementSibling&&(e.stopAnimation(),i.disconnect())});t&&(i.observe(t,{childList:!0,subtree:!0}),e.cleanupFns.push(()=>{i.disconnect()}));const s=new MutationObserver(()=>{document.body.contains(o)||(e.stopAnimation(),s.disconnect())});s.observe(document.body,{childList:!0,subtree:!0}),e.cleanupFns.push(()=>{s.disconnect()})}function uo(){const o=new MutationObserver(n=>{n.forEach(r=>{r.addedNodes.forEach(i=>{if(i.nodeType===Node.ELEMENT_NODE){const s=i;s.classList.contains("boot-sequence")&&qt(s),s.querySelectorAll(".boot-sequence").forEach(l=>{qt(l)})}})})}),e=document.getElementById("terminal-output");e&&o.observe(e,{childList:!0,subtree:!0}),document.querySelectorAll(".boot-sequence").forEach(n=>{qt(n)})}const Oe=new Map;function _o(){Oe.forEach(e=>{e.stopAnimation()}),Oe.clear(),document.querySelectorAll(".bsod-overlay").forEach(e=>{e.remove()})}function mo(o){o.style.animation="bsod-fade-out 0.3s ease forwards",o.addEventListener("animationend",()=>{o.remove()},{once:!0}),setTimeout(()=>{o.parentNode&&o.remove()},500)}function ho(o,e){const t=o.querySelector("[data-bsod-progress]");if(!t)return;let n=0;const r=setInterval(()=>{if(!Oe.has(o)){clearInterval(r);return}n=(n+1)%101,t.textContent=String(n)},100);e.cleanupFns.push(()=>{clearInterval(r)})}function po(o,e){const t=o.querySelector("[data-bsod-cursor]");if(!t)return;let n=!0;const r=setInterval(()=>{if(!Oe.has(o)){clearInterval(r);return}n=!n,t.style.visibility=n?"visible":"hidden"},530);e.cleanupFns.push(()=>{clearInterval(r)})}function Xt(o){_o();const e=o.dataset.bsodStyle??"modern",t={element:o,style:e,cleanupFns:[],stopAnimation:()=>{t.cleanupFns.forEach(n=>n()),t.cleanupFns=[],o.parentNode&&mo(o),Oe.delete(o)}};Oe.set(o,t),document.body.appendChild(o),e==="modern"?ho(o,t):po(o,t),fo(o,t)}function fo(o,e){const t=document.getElementById("terminal-output"),n=a=>{a.key==="Shift"||a.key==="Control"||a.key==="Alt"||a.key==="Meta"||e.stopAnimation()};setTimeout(()=>{Oe.has(o)&&(document.addEventListener("keydown",n,{once:!0}),e.cleanupFns.push(()=>{document.removeEventListener("keydown",n)}))},100);const r=()=>{e.stopAnimation()};setTimeout(()=>{Oe.has(o)&&(document.addEventListener("click",r,{once:!0}),e.cleanupFns.push(()=>{document.removeEventListener("click",r)}))},100);const i=new MutationObserver(a=>{for(const l of a)for(const c of l.addedNodes)if(c!==o&&c.nodeType===Node.ELEMENT_NODE){e.stopAnimation(),i.disconnect();return}});t&&(i.observe(t,{childList:!0,subtree:!0}),e.cleanupFns.push(()=>{i.disconnect()}));const s=new MutationObserver(()=>{document.body.contains(o)||(e.stopAnimation(),s.disconnect())});s.observe(document.body,{childList:!0,subtree:!0}),e.cleanupFns.push(()=>{s.disconnect()})}function go(){const o=new MutationObserver(n=>{n.forEach(r=>{r.addedNodes.forEach(i=>{if(i.nodeType===Node.ELEMENT_NODE){const s=i;s.hasAttribute("data-bsod")&&Xt(s),s.querySelectorAll("[data-bsod]").forEach(l=>{Xt(l)})}})})}),e=document.getElementById("terminal-output");e&&o.observe(e,{childList:!0,subtree:!0}),document.querySelectorAll("[data-bsod]").forEach(n=>{Xt(n)})}const vt=new Map;function Ir(o,e){return{width:o,height:e,cells:new Uint8Array(o*e),generation:0}}function $n(o,e,t){return o.cells[t*o.width+e]}function ne(o,e,t,n){o.cells[t*o.width+e]=n}function Yn(o,e){return(o%e+e)%e}function $o(o,e,t){let n=0;for(let r=-1;r<=1;r++)for(let i=-1;i<=1;i++){if(i===0&&r===0)continue;const s=Yn(e+i,o.width),a=Yn(t+r,o.height);$n(o,s,a)>0&&n++}return n}function To(o){const e=Ir(o.width,o.height);e.generation=o.generation+1;for(let t=0;t<o.height;t++)for(let n=0;n<o.width;n++){const r=$o(o,n,t);$n(o,n,t)>0?ne(e,n,t,r===2||r===3?1:0):ne(e,n,t,r===3?2:0)}return e}function br(o,e){for(let t=0;t<o.cells.length;t++)o.cells[t]=Math.random()<e?1:0}function Ao(o,e){const t=Math.floor(o.width/2),n=Math.floor(o.height/2);switch(e){case"acorn":ne(o,t+1,n-1,1),ne(o,t+3,n,1),ne(o,t,n+1,1),ne(o,t+1,n+1,1),ne(o,t+4,n+1,1),ne(o,t+5,n+1,1),ne(o,t+6,n+1,1);break;case"glider":ne(o,t+1,n-1,1),ne(o,t-1,n,1),ne(o,t+1,n,1),ne(o,t,n+1,1),ne(o,t+1,n+1,1);break;case"blinker":ne(o,t-1,n,1),ne(o,t,n,1),ne(o,t+1,n,1);break;default:br(o,.3)}}function qn(){const o=getComputedStyle(document.documentElement);return{accent:o.getPropertyValue("--terminal-accent").trim(),dim:o.getPropertyValue("--terminal-dim").trim(),bg:o.getPropertyValue("--terminal-bg").trim()}}function Xn(o,e,t,n,r){o.fillStyle=t.bg,o.fillRect(0,0,o.canvas.width,o.canvas.height);for(let i=0;i<e.height;i++)for(let s=0;s<e.width;s++){const a=$n(e,s,i);a!==0&&(o.fillStyle=a===2?t.accent:t.dim,o.globalAlpha=a===2?1:.7,o.fillRect(s*n,i*r,n,r))}o.globalAlpha=1}function wr(){vt.forEach(o=>{o.stopAnimation()}),vt.clear()}function Eo(o,e){const t=()=>{e.stopAnimation()};window.addEventListener("scroll",t,{once:!0});const n=new MutationObserver(a=>{for(const l of a)if(l.type==="childList"&&l.addedNodes.length>0){for(const c of l.addedNodes)if(c instanceof HTMLElement&&c.classList.contains("output-line")){e.stopAnimation(),n.disconnect();return}}}),r=document.querySelector(".terminal-output");r&&n.observe(r,{childList:!0});const i=new MutationObserver(()=>{document.body.contains(o)||(e.stopAnimation(),i.disconnect())});i.observe(document.body,{childList:!0,subtree:!0});const s=e.stopAnimation;e.stopAnimation=()=>{window.removeEventListener("scroll",t),n.disconnect(),i.disconnect(),s()}}function Kn(o,e,t,n){wr();const r=o.getContext("2d");if(!r)return;const i=o.dataset.speed,s=o.dataset.density,a=o.dataset.pattern,l=i?parseFloat(i):e,c=s?parseFloat(s):t,d=a??n,g=10,f=Math.floor(o.width/g),E=Math.floor(o.height/g),S=o.width/f,y=o.height/E,T=Ir(f,E);d&&d!=="random"?Ao(T,d):br(T,c);const $={animationId:null,grid:T,canvas:o,speed:l,lastUpdate:performance.now(),cellWidth:S,cellHeight:y,stopAnimation:()=>{$.animationId!==null&&(cancelAnimationFrame($.animationId),$.animationId=null),vt.delete(o)}};vt.set(o,$);const k=qn();Xn(r,$.grid,k,$.cellWidth,$.cellHeight);function v(N){if(!$.animationId)return;const R=1e3/$.speed;if(N-$.lastUpdate>=R){$.grid=To($.grid);const G=qn();r&&Xn(r,$.grid,G,$.cellWidth,$.cellHeight),$.lastUpdate=N}$.animationId=requestAnimationFrame(v)}$.animationId=requestAnimationFrame(v),Eo(o,$)}function Lo(){new MutationObserver(e=>{for(const t of e)if(t.type==="childList"){for(const n of t.addedNodes)if(n instanceof HTMLElement){n.classList.contains("life-grid")&&n instanceof HTMLCanvasElement&&Kn(n,2,.3);const r=n.querySelectorAll(".life-grid");r.length>0&&requestAnimationFrame(()=>{r.forEach(i=>{Kn(i,2,.3)})})}}}).observe(document.body,{childList:!0,subtree:!0})}const Ke=new Map;function yo(){Ke.forEach(e=>{e.stopAnimation()}),Ke.clear(),document.querySelectorAll(".matrix-rain").forEach(e=>{e.querySelectorAll(".matrix-column").forEach(n=>{n.style.animationPlayState="paused"})})}function Kt(o){Ke.forEach((i,s)=>{i.stopAnimation(),s.querySelectorAll(".matrix-column").forEach(l=>{l.style.animationPlayState="paused"})}),Ke.clear();const e=o.dataset.matrixChars??"";if(!e){console.warn("[Matrix] No character set found in data-matrix-chars");return}const t={animationId:null,frameCount:0,matrixChars:e,rainElement:o,stopAnimation:()=>{t.animationId&&(cancelAnimationFrame(t.animationId),t.animationId=null),Ke.delete(o)}};Ke.set(o,t);function n(){return e[Math.floor(Math.random()*e.length)]}function r(){t.frameCount++,o.querySelectorAll(".matrix-column").forEach(s=>{const a=s.querySelectorAll(".matrix-char"),l=parseInt(s.dataset.trailLength??"20");a.forEach((c,d)=>{if(c.classList.contains("matrix-char-bright"))(t.frameCount%45===0||t.frameCount%60===0&&Math.random()<.5)&&(c.textContent=n());else{const f=l-d-1,E=Math.max(8,Math.floor(f/2));t.frameCount%E===0&&Math.random()<.3&&(c.textContent=n())}})}),t.animationId=requestAnimationFrame(r)}t.animationId=requestAnimationFrame(r),Io(o,t)}function Io(o,e){const t=document.getElementById("terminal-output");if(t){const i=()=>{e.stopAnimation()};t.addEventListener("scroll",i,{once:!0})}const n=new MutationObserver(()=>{o.nextElementSibling&&(e.stopAnimation(),n.disconnect())});t&&n.observe(t,{childList:!0,subtree:!0});const r=new MutationObserver(()=>{document.body.contains(o)||(e.stopAnimation(),r.disconnect())});r.observe(document.body,{childList:!0,subtree:!0})}function bo(){const o=new MutationObserver(n=>{n.forEach(r=>{r.addedNodes.forEach(i=>{if(i.nodeType===Node.ELEMENT_NODE){const s=i;s.classList.contains("matrix-rain")&&Kt(s),s.querySelectorAll(".matrix-rain").forEach(l=>{Kt(l)})}})})}),e=document.getElementById("terminal-output");e&&o.observe(e,{childList:!0,subtree:!0}),document.querySelectorAll(".matrix-rain").forEach(n=>{Kt(n)})}const ut=new Map;function wo(o){return()=>(o=o*1103515245+12345&2147483647,o/2147483647)}function Zt(){ut.forEach(t=>{t.cleanupFns.forEach(n=>n()),t.styleElement.remove(),t.container.remove()}),ut.clear(),document.querySelectorAll(".melt-container").forEach(t=>t.remove()),document.querySelectorAll("style[data-melt-styles]").forEach(t=>t.remove())}function So(o,e,t){const n=/linear-gradient\(\s*(\d+)deg\s*,\s*(.+)\)/.exec(e);if(!n)return null;const r=parseInt(n[1]),i=n[2];let s,a,l,c;s=t.left,a=t.top,l=t.right,c=t.top;const d=o.createLinearGradient(s,a,l,c),g=i.matchAll(/(#[0-9a-fA-F]{6}|rgb[a]?\([^)]+\))\s*(\d+)?%?/g);for(const f of g){const E=f[1],S=f[2]?parseInt(f[2])/100:0;try{d.addColorStop(S,E)}catch{}}return d}function Jt(o,e,t,n){try{const r=document.createTreeWalker(e,NodeFilter.SHOW_TEXT,null);let i;for(;i=r.nextNode();){const s=i.textContent||"";if(!s.trim())continue;const a=i.parentElement;if(!a)continue;const l=getComputedStyle(a),c=l.fontSize,d=l.fontFamily,g=l.fontWeight,f=document.createRange();if(f.selectNodeContents(i),typeof f.getClientRects!="function")continue;const E=f.getClientRects();if(E.length===0)continue;const y=(l.getPropertyValue("-webkit-background-clip")||l.backgroundClip)==="text";let T=l.color||n;if(y){const k=a.getBoundingClientRect(),v=l.backgroundImage;if(v?.includes("linear-gradient")){const N=So(o,v,k);N&&(T=N)}}o.fillStyle=T;const $=parseInt(g)>=600?"bold ":"";o.font=`${$}${c} ${d||t}`;for(const k of E)k.width>0&&k.height>0&&o.fillText(s,k.left,k.top+k.height*.85)}}catch{}}function vo(){const o=window.innerWidth,e=window.innerHeight,t=document.createElement("canvas");t.width=o,t.height=e;const n=t.getContext("2d"),r=getComputedStyle(document.documentElement),i=r.getPropertyValue("--terminal-bg").trim()||"#0a0a0a",s=r.getPropertyValue("--terminal-fg").trim()||"#00ff00",a=r.getPropertyValue("--terminal-font-family")||"monospace";n.fillStyle=i,n.fillRect(0,0,o,e);const l=document.querySelector("header");l&&Jt(n,l,a,s);const c=document.getElementById("terminal-output");c&&Jt(n,c,a,s);const d=document.querySelector(".terminal-input-container");return d&&Jt(n,d,a,s),t}function Zn(o){Zt();const e=window.innerWidth,t=window.innerHeight,n=document.createElement("style");n.setAttribute("data-melt-styles",""),n.textContent=`
    @keyframes melt-drop {
      0% {
  ...
  `,document.head.appendChild(n);const r=document.createElement("div");r.className="melt-container";const s=vo().toDataURL("image/png"),a=12,l=Math.ceil(e/a),c=wo(Date.now());for(let E=0;E<l;E++){const S=document.createElement("div");S.className="melt-column",S.style.left=`${E*a}px`,S.style.width=`${a}px`,S.style.height=`${t}px`,S.style.backgroundImage=`url(${s})`,S.style.backgroundPosition=`-${E*a}px 0`,S.style.backgroundSize=`${e}px ${t}px`;const T=Math.abs(E-l/2)/(l/2)*.4+c()*.3,$=2.5+c()*1.5;S.style.animation=`melt-drop ${$}s ease-in ${T}s forwards`,r.appendChild(S)}const d=document.createElement("div");d.className="melt-message",d.textContent="yeah, you probably shouldn't do that",d.style.animation="melt-message-fade 0.5s ease-out 2s forwards",r.appendChild(d),document.body.appendChild(r);const g={container:r,styleElement:n,cleanupFns:[]};ut.set(o,g);const f=setTimeout(()=>{ut.has(o)&&Zt()},6500);g.cleanupFns.push(()=>clearTimeout(f)),setTimeout(()=>{if(!ut.has(o))return;const E=()=>Zt(),S=T=>{["Shift","Control","Alt","Meta"].includes(T.key)||E()},y=()=>E();document.addEventListener("keydown",S,{once:!0}),document.addEventListener("click",y,{once:!0}),g.cleanupFns.push(()=>{document.removeEventListener("keydown",S),document.removeEventListener("click",y)})},500)}function Co(){const o=new MutationObserver(t=>{t.forEach(n=>{n.addedNodes.forEach(r=>{if(r.nodeType===Node.ELEMENT_NODE){const i=r;i.hasAttribute("data-melt")&&Zn(i),i.querySelectorAll("[data-melt]").forEach(a=>{Zn(a)})}})})}),e=document.getElementById("terminal-output");e&&o.observe(e,{childList:!0,subtree:!0}),o.observe(document.body,{childList:!0,subtree:!0})}class U{flags=new Map;positionals=[];static VALUE_FLAGS=new Set(["f","L","w"]);constructor(e){const t=[];for(const n of e)if(n.startsWith("-")&&!n.startsWith("--")&&n.length>2)for(let r=1;r<n.length;r++)t.push(`-${n[r]}`);else t.push(n);for(let n=0;n<t.length;n++){const r=t[n];if(r.startsWith("--")){const i=r.substring(2),s=t[n+1];s!==void 0&&!s.startsWith("--")&&!s.startsWith("-")?(this.flags.set(i,s),n++):this.flags.set(i,!0)}else if(r.startsWith("-")&&r.length===2){const i=r.substring(1),s=t[n+1];s!==void 0&&!s.startsWith("-")&&(U.VALUE_FLAGS.has(i)||/^\d+$/.test(s))?(this.flags.set(i,s),n++):this.flags.set(i,!0)}else this.positionals.push(r)}}getFlag(e){return this.flags.get(e)}hasFlag(e){return this.flags.has(e)}getPositional(e){return this.positionals[e]}getAllFlags(){return new Map(this.flags)}getAllPositionals(){return[...this.positionals]}get positionalCount(){return this.positionals.length}}function Ro(o){return{name:"alias",description:"Create or display command aliases",execute:(e,t)=>{if(new U(e).hasFlag("help"))return{output:`Usage: alias [name='command']
...
`)}}const r=e.join(" "),i=/^(\S+)=(.+)$/.exec(r);if(!i)return{output:`Usage: alias name='command'
       alias (to list all aliases)`,error:!0};const[,s,a]=i;try{return o.setAlias(s,a),{output:`Alias created: ${s}='${a}'`}}catch(l){return{output:l instanceof Error?l.message:String(l),error:!0}}}}}const xo={name:"date",description:"Display current date and time",execute:(o,e)=>new U(o).hasFlag("help")?{output:`Usage: date

Description:
  Display the current date and time in the system's default format

Examples:
  date                 # Show current date and time`}:{output:new Date().toString()}},No={name:"echo",description:"Display a line of text",execute:(o,e)=>{if(new U(o).hasFlag("help"))return{output:`Usage: echo [options] [text...]
...
`).replace(/\\t/g,"	").replace(/\\r/g,"\r").replace(/\\b/g,"\b").replace(/\\f/g,"\f").replace(/\\v/g,"\v").replace(/\\\\/g,"\\")),{output:i}}};function ko(o){return{name:"env",description:"Display all environment variables",execute:(e,t)=>{if(new U(e).hasFlag("help"))return{output:`Usage: env
...
`)}}catch(r){return{output:r instanceof Error?r.message:String(r),error:!0}}}}}const Jn=["There is no escape.","You can check out any time you like, but you can never leave.","no","no thank you","nope","exit: permission denied: too interesting to leave",`logout
Connection to darinchambers.com closed.

...just kidding. Welcome back.`];function Oo(o,e,t,n){return{name:"exit",description:"Exit the current session",aliases:["logout"],execute:(r,i)=>{if(new U(r).hasFlag("help"))return{output:`Usage: exit
...
Examples:
  ...
  logout               # Same as exit`};if(o.getUsername()==="root")return o.setUsername("darin"),e.setVariable("HOME","/home/darin"),e.setVariable("USER","darin"),e.setVariable("PWD","/home/darin"),t.changeDirectory("/home/darin"),n(t.getShortPath()),{output:""};const a=Math.floor(Math.random()*Jn.length);return{output:Jn[a]}}}}function Do(o){return{name:"export",description:"Set or display environment variables",execute:(e,t)=>{if(new U(e).hasFlag("help"))return{output:`Usage: export [VAR=value] [VAR]
...
`)}}catch(r){return{output:r instanceof Error?r.message:String(r),error:!0}}}}}function Mo(o){return{name:"history",description:"Display command history",execute:(e,t)=>{if(new U(e).hasFlag("help"))return{output:`Usage: history
...
`)}}}}function Po(o){return{name:"man",description:"Display manual pages for commands",execute:async(e,t)=>{const n=new U(e);if(n.hasFlag("help"))return{output:`Usage: man <command>
...
For example, try 'man help'.`,error:!0};const i=r[0].toLowerCase();if(!o.getCommandNames().includes(i))return{output:`No manual entry for ${r[0]}`,error:!0};const l=o.getCommands().find(k=>k.name===i),c=l?l.description:i,g=(await o.dispatch(`${i} --help`)).output,f=`${i}(1)`,E="User Commands",S=Math.max(0,60-f.length*2-E.length),y=`${f}${" ".repeat(Math.floor(S/2))}${E}${" ".repeat(Math.ceil(S/2))}${f}`,T=["help","which"].filter(k=>k!==i).map(k=>`${k}(1)`).join(", ");return{output:[y,"","NAME",`    ${i} - ${c}`,"",g,"","SEE ALSO",`    ${T}`].join(`
`)}}}}function Ne(o){return o.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;")}class Qn{static parse(e){if(!e.trim().startsWith("---"))return{frontmatter:null,content:e};const t=e.split(`
...
`)}}function Tn(){return{async:!1,breaks:!1,extensions:null,gfm:!0,hooks:null,pedantic:!1,renderer:null,silent:!1,tokenizer:null,walkTokens:null}}var Be=Tn();function Sr(o){Be=o}var _t={exec:()=>null};function z(o,e=""){let t=typeof o=="string"?o:o.source,n={replace:(r,i)=>{let s=typeof i=="string"?i:i.source;return s=s.replace(ue.caret,"$1"),t=t.replace(r,s),n},getRegex:()=>new RegExp(t,e)};return n}var Fo=(()=>{try{return!!new RegExp("(?<=1)(?<!1)")}catch{return!1}})(),ue={codeRemoveIndent:/^(?: {1,4}| {0,3}\t)/gm,outputLinkReplace:/\\([\[\]])/g,indentCodeCompensation:/^(\s+)(?:```)/,beginningSpace:/^\s+/,endingHash:/#$/,startingSpaceChar:/^ /,endingSpaceChar:/ $/,nonSpaceChar:/[^ ]/,newLineCharGlobal:/\n/g,tabCharGlobal:/\t/g,multipleSpaceGlobal:/\s+/g,blankLine:/^[ \t]*$/,doubleBlankLine:/\n[ \t]*\n[ \t]*$/,blockquoteStart:/^ {0,3}>/,blockquoteSetextReplace:/\n {0,3}((?:=+|-+) *)(?=\n|$)/g,blockquoteSetextReplace2:/^ {0,3}>[ \t]?/gm,listReplaceTabs:/^\t+/,listReplaceNesting:/^ {1,4}(?=( {4})*[^ ])/g,listIsTask:/^\[[ xX]\] +\S/,listReplaceTask:/^\[[ xX]\] +/,listTaskCheckbox:/\[[ xX]\]/,anyLine:/\n.*\n/,hrefBrackets:/^<(.*)>$/,tableDelimiter:/[:|]/,tableAlignChars:/^\||\| *$/g,tableRowBlankLine:/\n[ \t]*$/,tableAlignRight:/^ *-+: *$/,tableAlignCenter:/^ *:-+: *$/,tableAlignLeft:/^ *:-+ *$/,startATag:/^<a /i,endATag:/^<\/a>/i,startPreScriptTag:/^<(pre|code|kbd|script)(\s|>)/i,endPreScriptTag:/^<\/(pre|code|kbd|script)(\s|>)/i,startAngleBracket:/^</,endAngleBracket:/>$/,pedanticHrefTitle:/^([^'"]*[^\s])\s+(['"])(.*)\2/,unicodeAlphaNumeric:/[\p{L}\p{N}]/u,escapeTest:/[&<>"']/,escapeReplace:/[&<>"']/g,escapeTestNoEncode:/[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/,escapeReplaceNoEncode:/[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/g,unescapeTest:/&(#(?:\d+)|(?:#x[0-9A-Fa-f]+)|(?:\w+));?/ig,caret:/(^|[^\[])\^/g,percentDecode:/%25/g,findPipe:/\|/g,splitPipe:/ \|/,slashPipe:/\\\|/g,carriageReturn:/\r\n|\r/g,spaceLine:/^ +$/gm,notSpaceStart:/^\S*/,endingNewline:/\n$/,listItemRegex:o=>new RegExp(`^( {0,3}${o})((?:[	 ][^\\n]*)?(?:\\n|$))`),nextBulletRegex:o=>new RegExp(`^ {0,${Math.min(3,o-1)}}(?:[*+-]|\\d{1,9}[.)])((?:[ 	][^\\n]*)?(?:\\n|$))`),hrRegex:o=>new RegExp(`^ {0,${Math.min(3,o-1)}}((?:- *){3,}|(?:_ *){3,}|(?:\\* *){3,})(?:\\n+|$)`),fencesBeginRegex:o=>new RegExp(`^ {0,${Math.min(3,o-1)}}(?:\`\`\`|~~~)`),headingBeginRegex:o=>new RegExp(`^ {0,${Math.min(3,o-1)}}#`),htmlBeginRegex:o=>new RegExp(`^ {0,${Math.min(3,o-1)}}<(?:[a-z].*>|!--)`,"i")},Ho=/^(?:[ \t]*(?:\n|$))+/,Uo=/^((?: {4}| {0,3}\t)[^\n]+(?:\n(?:[ \t]*(?:\n|$))*)?)+/,Bo=/^ {0,3}(`{3,}(?=[^`\n]*(?:\n|$))|~{3,})([^\n]*)(?:\n|$)(?:|([\s\S]*?)(?:\n|$))(?: {0,3}\1[~`]* *(?=\n|$)|$)/,mt=/^ {0,3}((?:-[\t ]*){3,}|(?:_[ \t]*){3,}|(?:\*[ \t]*){3,})(?:\n+|$)/,Wo=/^ {0,3}(#{1,6})(?=\s|$)(.*)(?:\n+|$)/,An=/(?:[*+-]|\d{1,9}[.)])/,vr=/^(?!bull |blockCode|fences|blockquote|heading|html|table)((?:.|\n(?!\s*?\n|bull |blockCode|fences|blockquote|heading|html|table))+?)\n {0,3}(=+|-+) *(?:\n+|$)/,Cr=z(vr).replace(/bull/g,An).replace(/blockCode/g,/(?: {4}| {0,3}\t)/).replace(/fences/g,/ {0,3}(?:`{3,}|~{3,})/).replace(/blockquote/g,/ {0,3}>/).replace(/heading/g,/ {0,3}#{1,6}/).replace(/html/g,/ {0,3}<[^\n>]+>\n/).replace(/\|table/g,"").getRegex(),Go=z(vr).replace(/bull/g,An).replace(/blockCode/g,/(?: {4}| {0,3}\t)/).replace(/fences/g,/ {0,3}(?:`{3,}|~{3,})/).replace(/blockquote/g,/ {0,3}>/).replace(/heading/g,/ {0,3}#{1,6}/).replace(/html/g,/ {0,3}<[^\n>]+>\n/).replace(/table/g,/ {0,3}\|?(?:[:\- ]*\|)+[\:\- ]*\n/).getRegex(),En=/^([^\n]+(?:\n(?!hr|heading|lheading|blockquote|fences|list|html|table| +\n)[^\n]+)*)/,zo=/^[^\n]+/,Ln=/(?!\s*\])(?:\\[\s\S]|[^\[\]\\])+/,Vo=z(/^ {0,3}\[(label)\]: *(?:\n[ \t]*)?([^<\s][^\s]*|<.*?>)(?:(?: +(?:\n[ \t]*)?| *\n[ \t]*)(title))? *(?:\n+|$)/).replace("label",Ln).replace("title",/(?:"(?:\\"?|[^"\\])*"|'[^'\n]*(?:\n[^'\n]+)*\n?'|\([^()]*\))/).getRegex(),jo=z(/^( {0,3}bull)([ \t][^\n]+?)?(?:\n|$)/).replace(/bull/g,An).getRegex(),Ot="address|article|aside|base|basefont|blockquote|body|caption|center|col|colgroup|dd|details|dialog|dir|div|dl|dt|fieldset|figcaption|figure|footer|form|frame|frameset|h[1-6]|head|header|hr|html|iframe|legend|li|link|main|menu|menuitem|meta|nav|noframes|ol|optgroup|option|p|param|search|section|summary|table|tbody|td|tfoot|th|thead|title|tr|track|ul",yn=/<!--(?:-?>|[\s\S]*?(?:-->|$))/,Yo=z("^ {0,3}(?:<(script|pre|style|textarea)[\\s>][\\s\\S]*?(?:</\\1>[^\\n]*\\n+|$)|comment[^\\n]*(\\n+|$)|<\\?[\\s\\S]*?(?:\\?>\\n*|$)|<![A-Z][\\s\\S]*?(?:>\\n*|$)|<!\\[CDATA\\[[\\s\\S]*?(?:\\]\\]>\\n*|$)|</?(tag)(?: +|\\n|/?>)[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$)|<(?!script|pre|style|textarea)([a-z][\\w-]*)(?:attribute)*? */?>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$)|</(?!script|pre|style|textarea)[a-z][\\w-]*\\s*>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$))","i").replace("comment",yn).replace("tag",Ot).replace("attribute",/ +[a-zA-Z:_][\w.:-]*(?: *= *"[^"\n]*"| *= *'[^'\n]*'| *= *[^\s"'=<>`]+)?/).getRegex(),Rr=z(En).replace("hr",mt).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("|lheading","").replace("|table","").replace("blockquote"," {0,3}>").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)]) ").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",Ot).getRegex(),qo=z(/^( {0,3}> ?(paragraph|[^\n]*)(?:\n|$))+/).replace("paragraph",Rr).getRegex(),In={blockquote:qo,code:Uo,def:Vo,fences:Bo,heading:Wo,hr:mt,html:Yo,lheading:Cr,list:jo,newline:Ho,paragraph:Rr,table:_t,text:zo},er=z("^ *([^\\n ].*)\\n {0,3}((?:\\| *)?:?-+:? *(?:\\| *:?-+:? *)*(?:\\| *)?)(?:\\n((?:(?! *\\n|hr|heading|blockquote|code|fences|list|html).*(?:\\n|$))*)\\n*|$)").replace("hr",mt).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("blockquote"," {0,3}>").replace("code","(?: {4}| {0,3}	)[^\\n]").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)]) ").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",Ot).getRegex(),Xo={...In,lheading:Go,table:er,paragraph:z(En).replace("hr",mt).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("|lheading","").replace("table",er).replace("blockquote"," {0,3}>").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)]) ").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",Ot).getRegex()},Ko={...In,html:z(`^ *(?:comment *(?:\\n|\\s*$)|<(tag)[\\s\\S]+?</\\1> *(?:\\n{2,}|\\s*$)|<tag(?:"[^"]*"|'[^']*'|\\s[^'"/>\\s]*)*?/?> *(?:\\n{2,}|\\s*$))`).replace("comment",yn).replace(/tag/g,"(?!(?:a|em|strong|small|s|cite|q|dfn|abbr|data|time|code|var|samp|kbd|sub|sup|i|b|u|mark|ruby|rt|rp|bdi|bdo|span|br|wbr|ins|del|img)\\b)\\w+(?!:|[^\\w\\s@]*@)\\b").getRegex(),def:/^ *\[([^\]]+)\]: *<?([^\s>]+)>?(?: +(["(][^\n]+[")]))? *(?:\n+|$)/,heading:/^(#{1,6})(.*)(?:\n+|$)/,fences:_t,lheading:/^(.+?)\n {0,3}(=+|-+) *(?:\n+|$)/,paragraph:z(En).replace("hr",mt).replace("heading",` *#{1,6} *[^
]`).replace("lheading",Cr).replace("|table","").replace("blockquote"," {0,3}>").replace("|fences","").replace("|list","").replace("|html","").replace("|tag","").getRegex()},Zo=/^\\([!"#$%&'()*+,\-./:;<=>?@\[\]\\^_`{|}~])/,Jo=/^(`+)([^`]|[^`][\s\S]*?[^`])\1(?!`)/,xr=/^( {2,}|\\)\n(?!\s*$)/,Qo=/^(`+|[^`])(?:(?= {2,}\n)|[\s\S]*?(?:(?=[\\<!\[`*_]|\b_|$)|[^ ](?= {2,}\n)))/,Dt=/[\p{P}\p{S}]/u,bn=/[\s\p{P}\p{S}]/u,Nr=/[^\s\p{P}\p{S}]/u,ei=z(/^((?![*_])punctSpace)/,"u").replace(/punctSpace/g,bn).getRegex(),kr=/(?!~)[\p{P}\p{S}]/u,ti=/(?!~)[\s\p{P}\p{S}]/u,ni=/(?:[^\s\p{P}\p{S}]|~)/u,ri=z(/link|precode-code|html/,"g").replace("link",/\[(?:[^\[\]`]|(?<a>`+)[^`]+\k<a>(?!`))*?\]\((?:\\[\s\S]|[^\\\(\)]|\((?:\\[\s\S]|[^\\\(\)])*\))*\)/).replace("precode-",Fo?"(?<!`)()":"(^^|[^`])").replace("code",/(?<b>`+)[^`]+\k<b>(?!`)/).replace("html",/<(?! )[^<>]*?>/).getRegex(),Or=/^(?:\*+(?:((?!\*)punct)|[^\s*]))|^_+(?:((?!_)punct)|([^\s_]))/,oi=z(Or,"u").replace(/punct/g,Dt).getRegex(),ii=z(Or,"u").replace(/punct/g,kr).getRegex(),Dr="^[^_*]*?__[^_*]*?\\*[^_*]*?(?=__)|[^*]+(?=[^*])|(?!\\*)punct(\\*+)(?=[\\s]|$)|notPunctSpace(\\*+)(?!\\*)(?=punctSpace|$)|(?!\\*)punctSpace(\\*+)(?=notPunctSpace)|[\\s](\\*+)(?!\\*)(?=punct)|(?!\\*)punct(\\*+)(?!\\*)(?=punct)|notPunctSpace(\\*+)(?=notPunctSpace)",si=z(Dr,"gu").replace(/notPunctSpace/g,Nr).replace(/punctSpace/g,bn).replace(/punct/g,Dt).getRegex(),ai=z(Dr,"gu").replace(/notPunctSpace/g,ni).replace(/punctSpace/g,ti).replace(/punct/g,kr).getRegex(),li=z("^[^_*]*?\\*\\*[^_*]*?_[^_*]*?(?=\\*\\*)|[^_]+(?=[^_])|(?!_)punct(_+)(?=[\\s]|$)|notPunctSpace(_+)(?!_)(?=punctSpace|$)|(?!_)punctSpace(_+)(?=notPunctSpace)|[\\s](_+)(?!_)(?=punct)|(?!_)punct(_+)(?!_)(?=punct)","gu").replace(/notPunctSpace/g,Nr).replace(/punctSpace/g,bn).replace(/punct/g,Dt).getRegex(),ci=z(/\\(punct)/,"gu").replace(/punct/g,Dt).getRegex(),di=z(/^<(scheme:[^\s\x00-\x1f<>]*|email)>/).replace("scheme",/[a-zA-Z][a-zA-Z0-9+.-]{1,31}/).replace("email",/[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+(@)[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)+(?![-_])/).getRegex(),ui=z(yn).replace("(?:-->|$)","-->").getRegex(),_i=z("^comment|^</[a-zA-Z][\\w:-]*\\s*>|^<[a-zA-Z][\\w-]*(?:attribute)*?\\s*/?>|^<\\?[\\s\\S]*?\\?>|^<![a-zA-Z]+\\s[\\s\\S]*?>|^<!\\[CDATA\\[[\\s\\S]*?\\]\\]>").replace("comment",ui).replace("attribute",/\s+[a-zA-Z:_][\w.:-]*(?:\s*=\s*"[^"]*"|\s*=\s*'[^']*'|\s*=\s*[^\s"'=<>`]+)?/).getRegex(),Ct=/(?:\[(?:\\[\s\S]|[^\[\]\\])*\]|\\[\s\S]|`+[^`]*?`+(?!`)|[^\[\]\\`])*?/,mi=z(/^!?\[(label)\]\(\s*(href)(?:(?:[ \t]*(?:\n[ \t]*)?)(title))?\s*\)/).replace("label",Ct).replace("href",/<(?:\\.|[^\n<>\\])+>|[^ \t\n\x00-\x1f]*/).replace("title",/"(?:\\"?|[^"\\])*"|'(?:\\'?|[^'\\])*'|\((?:\\\)?|[^)\\])*\)/).getRegex(),Mr=z(/^!?\[(label)\]\[(ref)\]/).replace("label",Ct).replace("ref",Ln).getRegex(),Pr=z(/^!?\[(ref)\](?:\[\])?/).replace("ref",Ln).getRegex(),hi=z("reflink|nolink(?!\\()","g").replace("reflink",Mr).replace("nolink",Pr).getRegex(),tr=/[hH][tT][tT][pP][sS]?|[fF][tT][pP]/,wn={_backpedal:_t,anyPunctuation:ci,autolink:di,blockSkip:ri,br:xr,code:Jo,del:_t,emStrongLDelim:oi,emStrongRDelimAst:si,emStrongRDelimUnd:li,escape:Zo,link:mi,nolink:Pr,punctuation:ei,reflink:Mr,reflinkSearch:hi,tag:_i,text:Qo,url:_t},pi={...wn,link:z(/^!?\[(label)\]\((.*?)\)/).replace("label",Ct).getRegex(),reflink:z(/^!?\[(label)\]\s*\[([^\]]*)\]/).replace("label",Ct).getRegex()},an={...wn,emStrongRDelimAst:ai,emStrongLDelim:ii,url:z(/^((?:protocol):\/\/|www\.)(?:[a-zA-Z0-9\-]+\.?)+[^\s<]*|^email/).replace("protocol",tr).replace("email",/[A-Za-z0-9._+-]+(@)[a-zA-Z0-9-_]+(?:\.[a-zA-Z0-9-_]*[a-zA-Z0-9])+(?![-_])/).getRegex(),_backpedal:/(?:[^?!.,:;*_'"~()&]+|\([^)]*\)|&(?![a-zA-Z0-9]+;$)|[?!.,:;*_'"~)]+(?!$))+/,del:/^(~~?)(?=[^\s~])((?:\\[\s\S]|[^\\])*?(?:\\[\s\S]|[^\s~\\]))\1(?=[^~]|$)/,text:z(/^([`~]+|[^`~])(?:(?= {2,}\n)|(?=[a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-]+@)|[\s\S]*?(?:(?=[\\<!\[`*~_]|\b_|protocol:\/\/|www\.|$)|[^ ](?= {2,}\n)|[^a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-](?=[a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-]+@)))/).replace("protocol",tr).getRegex()},fi={...an,br:z(xr).replace("{2,}","*").getRegex(),text:z(an.text).replace("\\b_","\\b_| {2,}\\n").replace(/\{2,\}/g,"*").getRegex()},yt={normal:In,gfm:Xo,pedantic:Ko},nt={normal:wn,gfm:an,breaks:fi,pedantic:pi},gi={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},nr=o=>gi[o];function Re(o,e){if(e){if(ue.escapeTest.test(o))return o.replace(ue.escapeReplace,nr)}else if(ue.escapeTestNoEncode.test(o))return o.replace(ue.escapeReplaceNoEncode,nr);return o}function rr(o){try{o=encodeURI(o).replace(ue.percentDecode,"%")}catch{return null}return o}function or(o,e){let t=o.replace(ue.findPipe,(i,s,a)=>{let l=!1,c=s;for(;--c>=0&&a[c]==="\\";)l=!l;return l?"|":" |"}),n=t.split(ue.splitPipe),r=0;if(n[0].trim()||n.shift(),n.length>0&&!n.at(-1)?.trim()&&n.pop(),e)if(n.length>e)n.splice(e);else for(;n.length<e;)n.push("");for(;r<n.length;r++)n[r]=n[r].trim().replace(ue.slashPipe,"|");return n}function rt(o,e,t){let n=o.length;if(n===0)return"";let r=0;for(;r<n&&o.charAt(n-r-1)===e;)r++;return o.slice(0,n-r)}function $i(o,e){if(o.indexOf(e[1])===-1)return-1;let t=0;for(let n=0;n<o.length;n++)if(o[n]==="\\")n++;else if(o[n]===e[0])t++;else if(o[n]===e[1]&&(t--,t<0))return n;return t>0?-2:-1}function ir(o,e,t,n,r){let i=e.href,s=e.title||null,a=o[1].replace(r.other.outputLinkReplace,"$1");n.state.inLink=!0;let l={type:o[0].charAt(0)==="!"?"image":"link",raw:t,href:i,title:s,text:a,tokens:n.inlineTokens(a)};return n.state.inLink=!1,l}function Ti(o,e,t){let n=o.match(t.other.indentCodeCompensation);if(n===null)return e;let r=n[1];return e.split(`
`).map(i=>{let s=i.match(t.other.beginningSpace);if(s===null)return i;let[a]=s;return a.length>=r.length?i.slice(r.length):i}).join(`
`)}var Rt=class{options;rules;lexer;constructor(o){this.options=o||Be}space(o){let e=this.rules.block.newline.exec(o);if(e&&e[0].length>0)return{type:"space",raw:e[0]}}code(o){let e=this.rules.block.code.exec(o);if(e){let t=e[0].replace(this.rules.other.codeRemoveIndent,"");return{type:"code",raw:e[0],codeBlockStyle:"indented",text:this.options.pedantic?t:rt(t,`
`)}}}fences(o){let e=this.rules.block.fences.exec(o);if(e){let t=e[0],n=Ti(t,e[3]||"",this.rules);return{type:"code",raw:t,lang:e[2]?e[2].trim().replace(this.rules.inline.anyPunctuation,"$1"):e[2],text:n}}}heading(o){let e=this.rules.block.heading.exec(o);if(e){let t=e[2].trim();if(this.rules.other.endingHash.test(t)){let n=rt(t,"#");(this.options.pedantic||!n||this.rules.other.endingSpaceChar.test(n))&&(t=n.trim())}return{type:"heading",raw:e[0],depth:e[1].length,text:t,tokens:this.lexer.inline(t)}}}hr(o){let e=this.rules.block.hr.exec(o);if(e)return{type:"hr",raw:rt(e[0],`
`)}}blockquote(o){let e=this.rules.block.blockquote.exec(o);if(e){let t=rt(e[0],`
`).split(`
...
${c}`:c,r=r?`${r}
${d}`:d;let g=this.lexer.state.top;if(this.lexer.state.top=!0,this.lexer.blockTokens(d,i,!0),this.lexer.state.top=g,t.length===0)break;let f=i.at(-1);if(f?.type==="code")break;if(f?.type==="blockquote"){let E=f,S=E.raw+`
`+t.join(`
`),y=this.blockquote(S);i[i.length-1]=y,n=n.substring(0,n.length-E.raw.length)+y.raw,r=r.substring(0,r.length-E.text.length)+y.text;break}else if(f?.type==="list"){let E=f,S=E.raw+`
`+t.join(`
`),y=this.list(S);i[i.length-1]=y,n=n.substring(0,n.length-f.raw.length)+y.raw,r=r.substring(0,r.length-E.raw.length)+y.raw,t=S.substring(i.at(-1).raw.length).split(`
...
Try 'render --help' for more information`,error:!0};const i=r.trim().startsWith("---");return{output:q.render(r,i),html:!0}}}}const yi="hunter2",Ii=300*1e3;function bi(o,e){let t=null,n=3,r=null,i=null;function s(){return t===null?!1:Date.now()-t<Ii}function a(){n=3}function l(){o.setUsername("root"),e.execute("export HOME=/root"),e.execute("export USER=root"),o.executeCommand("cd /root")}function c(){const f=`[sudo] password for ${o.getUsername()}: `;o.getInput().setInputType("password"),o.getInput().setPrompt(f),o.setInputInterceptor(g)}function d(){o.getInput().setInputType("text"),o.setUsername(o.getUsername())}function g(f){if(f===yi){if(t=Date.now(),a(),d(),i&&r){const E=i,S=r;i=null,r=null,E==="su"||E==="su -"?(l(),S({output:""})):e.execute(E).then(y=>S(y))}}else n--,n<=0?(d(),r&&(r({output:"sudo: 3 incorrect password attempts",error:!0}),r=null,i=null),a()):(o.writeError("Sorry, try again."),c())}return{name:"sudo",description:"Execute a command as superuser",execute:(f,E)=>{if(new U(f).hasFlag("help"))return{output:`Usage: sudo <command>
...
Examples:
  ...
  sudo su -            # Switch to root user (login shell)`};if(f.length===0)return{output:"usage: sudo <command>",error:!0};const y=f.join(" ");if(y==="make me a sandwich")return{output:"Okay."};if(s()){const T=y.trim();return T==="su"||T==="su -"?(l(),{output:""}):e.execute(y)}return a(),new Promise(T=>{r=T,i=y,c()})}}}function wi(o){return{name:"unalias",description:"Remove command aliases",execute:(e,t)=>{if(new U(e).hasFlag("help"))return{output:`Usage: unalias <name>
...
Try 'unalias --help' for more information.`,error:!0};const r=e[0];return o.removeAlias(r)?{output:`Alias removed: ${r}`}:{output:`unalias: ${r}: not found`,error:!0}}}}const Si=new Set(["about","portfolio","blog","contact","settings"]);function vi(o,e){return{name:"which",description:"Locate a command and display its path",execute:(t,n)=>{const r=new U(t);if(r.hasFlag("help"))return{output:`Usage: which [-a] <command> [command ...]
...
Usage: which [-a] <command> [command ...]`,error:!0};const s=r.hasFlag("a"),a=[];let l=!1;for(const d of i){const g=Ci(d,o,e,s);g.error&&(l=!0),a.push(g.output)}const c={output:a.join(`
`)};return l&&(c.error=!0),c}}}function Ci(o,e,t,n){const r=[],i=t.getAlias(o);if(i&&(r.push(`${o}: aliased to ${i}`),!n))return{output:r.join(`
`)};if(e.getCommandNames().includes(o.toLowerCase())){const l=Si.has(o.toLowerCase())?`/usr/local/bin/${o}`:`/usr/bin/${o}`;r.push(l)}return r.length===0?{output:`which: ${o}: command not found`,error:!0}:{output:r.join(`
`)}}function Ri(o){return{name:"whoami",description:"Display current username",execute:(e,t)=>new U(e).hasFlag("help")?{output:`Usage: whoami

Description:
  Display the current username

Examples:
  whoami               # Show current user`}:{output:o.getUsername()}}}function xi(o){return{name:"cat",description:"Display file contents",execute:(e,t)=>{if(new U(e).hasFlag("help"))return{output:`Usage: cat <file>
...
Examples:
  ...
  cd -                 # Go to previous directory`};try{let s=n[0]||"~";if(s==="-"&&t){const a=t.getVariable("OLDPWD");if(!a)return{output:"cd: OLDPWD not set",error:!0};s=a}if(t){const a=t.getVariable("PWD")??o.getCurrentPath();t.setVariable("OLDPWD",a)}return o.changeDirectory(s),t&&t.setVariable("PWD",o.getCurrentPath()),e(o.getShortPath()),{output:""}}catch(s){return{output:s instanceof Error?s.message:String(s),error:!0}}}}}function ki(o,e){if(!e)return o.toString();const t=["B","K","M","G","T"];let n=o,r=0;for(;n>=1024&&r<t.length-1;)n/=1024,r++;return`${r===0?n.toString():n.toFixed(1)}${t[r]}`}function Oi(o){const t=["Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"][o.getMonth()],n=o.getDate().toString().padStart(2," "),r=o.getHours().toString().padStart(2,"0"),i=o.getMinutes().toString().padStart(2,"0");return`${t} ${n} ${r}:${i}`}function sr(o,e){const t=o.permissions??"-rw-r--r--",n="1",r=o.owner??"darin",i="staff",s=ki(o.size??0,e),a=Oi(o.modifiedTime??new Date),l=o.name,c=s.padStart(6," ");return`${t}  ${n} ${r}  ${i}  ${c} ${a} ${l}`}function Di(o){const e=o.reduce((t,n)=>t+(n.size??0),0);return Math.ceil(e/512)}function Mi(o){return{name:"ls",description:"List directory contents",execute:(e,t)=>{try{const n=new U(e);if(n.hasFlag("help"))return{output:`Usage: ls [options] [path]
...
Try 'ls --help' for more information`,error:!0};if(l.type==="file")return s?{output:sr(l,a)}:{output:l.name};if(!l.children)return{output:""};let c=Array.from(l.children.values());return i||(c=c.filter(d=>!d.isHidden)),c.length===0?{output:""}:(c.sort((d,g)=>d.name.localeCompare(g.name)),s?{output:[`total ${Di(c)}`,...c.map(f=>sr(f,a))].join(`
`)}:{output:c.map(g=>g.name).join("  ")})}catch(n){return{output:n instanceof Error?n.message:String(n),error:!0}}}}}const Pi=`Usage: mkdir [OPTION]... DIRECTORY...
...
Examples:
  ...
  mkdir dir1 dir2      # Create multiple directories`;function Fi(o){return{name:"mkdir",description:"Create directories",execute:(e,t)=>{const n=new U(e);if(n.hasFlag("help"))return{output:Pi};const r=n.hasFlag("p"),i=n.getAllPositionals();if(i.length===0)return{output:`mkdir: missing operand
Try 'mkdir --help' for more information`,error:!0};const s=[];let a=!1;for(const l of i)try{if(o.exists(l)&&o.isDirectory(l)){if(r)continue;s.push(`mkdir: cannot create directory '${l}': File exists`),a=!0;continue}if(!r){const c=l.replace(/\/+$/,"").split("/");if(c.length>1){const d=c.slice(0,-1).join("/")||"/";if(!o.exists(d)||!o.isDirectory(d)){s.push(`mkdir: cannot create directory '${l}': No such file or directory`),a=!0;continue}}}o.createDirectory(l)}catch(c){s.push(c instanceof Error?c.message:String(c)),a=!0}return{output:s.join(`
`),error:a}}}}function Hi(o){return{name:"pwd",description:"Print working directory",execute:(e,t)=>new U(e).hasFlag("help")?{output:`Usage: pwd

Description:
  Print current working directory path

Examples:
  pwd                  # Show current directory`}:{output:o.getCurrentPath()}}}const Ui=`Usage: rm [OPTION]... FILE...
...
Examples:
  ...
  rm -rf /             # Don't try this at home`;function Bi(){return'<div data-melt class="melt-trigger"></div>'}function Wi(o,e){return{name:"rm",description:"Remove files or directories",execute:(t,n)=>{const r=new U(t);if(r.hasFlag("help"))return{output:Ui};const i=r.getFlag("recursive"),s=r.getFlag("force"),a=r.getFlag("f"),l=r.hasFlag("r")||r.hasFlag("R")||i!==void 0,c=r.hasFlag("f")||s!==void 0,d=[...r.getAllPositionals()];if(typeof i=="string"&&d.push(i),typeof s=="string"&&d.push(s),typeof a=="string"&&d.push(a),d.length===0)return{output:`rm: missing operand
Try 'rm --help' for more information`,error:!0};if(l&&c&&d.some(S=>S==="/"||S==="/*"))return{output:Bi(),html:!0};const g=[];let f=!1;for(const E of d)try{if(!o.exists(E)){c||(g.push(`rm: cannot remove '${E}': No such file or directory`),f=!0);continue}if(o.isDirectory(E)){if(!l){g.push(`rm: cannot remove '${E}': Is a directory`),f=!0;continue}o.deleteDirectory(E,!0)}else{const T=E.startsWith("/")?E:`${o.getCurrentPath()}/${E}`.replace(/\/+/g,"/");if(T.startsWith("/usr/bin/")||T.startsWith("/usr/local/bin/")){const $=T.split("/").pop();$&&e.unregisterCommand($)}o.deleteFile(E)}}catch(S){c||(g.push(S instanceof Error?S.message:String(S)),f=!0)}return c?{output:"",error:!1}:{output:g.join(`
`),error:f}}}}const Gi=`Usage: rmdir DIRECTORY...
...
Examples:
  ...
  rmdir dir1 dir2      # Remove multiple empty directories`;function zi(o){return{name:"rmdir",description:"Remove empty directories",execute:(e,t)=>{const n=new U(e);if(n.hasFlag("help"))return{output:Gi};const r=n.getAllPositionals();if(r.length===0)return{output:`rmdir: missing operand
Try 'rmdir --help' for more information`,error:!0};const i=[];let s=!1;for(const a of r)try{if(!o.exists(a)){i.push(`rmdir: failed to remove '${a}': No such file or directory`),s=!0;continue}if(!o.isDirectory(a)){i.push(`rmdir: failed to remove '${a}': Not a directory`),s=!0;continue}o.deleteDirectory(a)}catch(l){const c=l instanceof Error?l.message:String(l);i.push(c.replace(/^rm:/,"rmdir:")),s=!0}return{output:i.join(`
`),error:s}}}}function Vi(o){return{name:"tree",description:"Display directory tree structure",execute:(e,t)=>{try{const n=new U(e);if(n.hasFlag("help"))return{output:`Usage: tree [options] [path]
...
`),scrollBehavior:"top"}}catch(n){return{output:n instanceof Error?n.message:String(n),error:!0}}}}}const Ae={HOME_DARIN:"/home/darin",HOME_GUEST:"/home/guest",CONTENT_BLOG:"/home/darin/blog",CONTENT_PORTFOLIO:"/home/darin/portfolio",CONTENT_POSTS:"/home/darin/posts",CONTENT_HELP:"/home/darin/content/help.md",CONTENT_ABOUT:"/home/darin/content/about.md",CONTENT_CONTACT:"/home/darin/content/contact.md",CONFIG_ALIASES:"/home/guest/.alias",CONFIG_SETTINGS:"/home/darin/.settings",CONFIG_ENV:"/home/darin/.env"},Fr={CLEAR_SCREEN:"__CLEAR__"},dn={SETTINGS:"terminal_settings",ENVIRONMENT:"terminal_env_vars"},Ze={EMPTY_PORTFOLIO:"No portfolio projects yet. Check back soon!",EMPTY_BLOG:"No blog posts yet. Check back soon!",EMPTY_POSTS:"No notes yet. Check back soon!",NO_TAGS_AVAILABLE:"No tags available yet."},ar={theme:{preset:"dc",customColors:void 0},font:{size:16,family:"Fira Code"},effects:{scanLines:!1,glow:!1,border:!0,animationSpeed:1,soundEffects:!1,autoScrollBehavior:!0},prompt:{format:"\\W \\$ "},screensaver:{enabled:!0,timeoutMinutes:5,activeScreensaver:"matrix"}},dt={MIN_TIMEOUT_MINUTES:1,MAX_TIMEOUT_MINUTES:60,ACTIVITY_DEBOUNCE_MS:100};class De{static makeCommandsClickable(e,t){const n=new Set(t);return e.replace(/<code>([^<]+)<\/code>/g,(r,i)=>{const s=i.trim();return n.has(s)?`<a data-command="${s}" class="command-link"><code>${s}</code></a>`:r})}static formatClickableTag(e,t){return`<button data-command="${`${t} --tags ${e}`}" class="tag-link">${e}</button>`}static formatPortfolioList(e,t){const n=t?`# Portfolio - Tag: ${t}`:"# Portfolio",r=e.map((s,a)=>{const l=s.tags?.map(d=>this.formatClickableTag(d,"portfolio")).join(" ")??"",c=l?`
...
<a href="/notes" data-command="notes">← Back to Notes</a>`}}function ji(o,e=[]){return{name:"about",description:"Display bio and expertise overview",execute:(t,n)=>{if(new U(t).hasFlag("help"))return{output:`Usage: about

Description:
  Display professional bio and expertise overview

Examples:
  about                # Show bio and background`};try{const i=o.readFile(Ae.CONTENT_ABOUT),s=q.render(i);return{output:De.makeCommandsClickable(s,e),html:!0,scrollBehavior:"top"}}catch(i){return{output:i instanceof Error?i.message:String(i),error:!0}}}}}function Yi(o){if(typeof o!="object"||o===null)return!1;const e=o;return typeof e.title=="string"&&typeof e.date=="string"&&typeof e.summary=="string"&&Array.isArray(e.tags)&&e.tags.every(t=>typeof t=="string")}class Hr{static parseFrontmatter(e){const t=e.split(`
`);if(t[0]?.trim()!=="---")throw new Error("Invalid frontmatter: must start with ---");let n=-1;for(let a=1;a<t.length;a++)if(t[a].trim()==="---"){n=a;break}if(n===-1)throw new Error("Invalid frontmatter: no closing ---");const r=t.slice(1,n),i=t.slice(n+1),s={};for(const a of r){const l=a.indexOf(":");if(l===-1)continue;const c=a.substring(0,l).trim(),d=a.substring(l+1).trim();if(d.startsWith("[")&&d.endsWith("]")){const g=d.substring(1,d.length-1);s[c]=g.split(",").map(f=>f.trim().replace(/^["']|["']$/g,"")).filter(f=>f.length>0)}else s[c]=d.replace(/^["']|["']$/g,"")}if(!Yi(s)){const a=[];throw s.title||a.push("title"),s.date||a.push("date"),s.summary||a.push("summary"),Array.isArray(s.tags)||a.push("tags"),new Error(`Invalid blog frontmatter: missing or invalid fields: ${a.join(", ")}`)}return{frontmatter:s,markdown:i.join(`
`).trim()}}static parseBlogPost(e,t){const{frontmatter:n,markdown:r}=this.parseFrontmatter(t);return{id:e.replace(/^\d{4}-\d{2}-\d{2}-/,"").replace(/\.md$/,""),title:n.title,date:n.date,summary:n.summary,content:r,tags:n.tags}}static getIdFromFilename(e){return e.replace(/^\d{4}-\d{2}-\d{2}-/,"").replace(/\.md$/,"")}}function qi(o){return{name:"blog",description:"List and read blog posts",execute:(e,t)=>{const n=new U(e);if(n.hasFlag("help"))return{output:`Usage: blog [options] [post-id|number]
...
Examples:
  ...
  blog post-id                  # Read specific post by ID`};const r=Ae.CONTENT_BLOG;try{const s=o.list(r).filter(y=>y.endsWith(".md")).sort().reverse(),a=n.getFlag("tags"),l=n.hasFlag("tags"),c=n.getPositional(0),d=[];for(const y of s){const T=o.readFile(`${r}/${y}`),$=Hr.parseBlogPost(y,T);d.push($)}if(d.length===0&&!l&&!c){const y=`# Blog

${Ze.EMPTY_BLOG}`;return{output:q.render(y),html:!0,scrollBehavior:"top"}}if(l&&(typeof a=="boolean"||!a)){const y=new Set,T=new Map;d.forEach(R=>{R.tags?.forEach(G=>{y.add(G),T.set(G,(T.get(G)??0)+1)})});const $=Array.from(y).sort();if($.length===0){const R=`# Blog Tags

${Ze.NO_TAGS_AVAILABLE}`;return{output:q.render(R),html:!0,scrollBehavior:"top"}}const v=`# Blog Tags

${$.map(R=>{const G=T.get(R)??0;return`- <button data-command="blog --tags ${R}" class="tag-link">${R}</button> (${G} post${G!==1?"s":""})`}).join(`
`)}

---

**Usage:** Type \`blog --tags <tag>\` to filter posts`;return{output:q.render(v),html:!0,scrollBehavior:"top"}}if(c){let y;const T=parseInt(c,10);if(!isNaN(T)&&T>0&&T<=d.length){const v=d.length-T;y=d[v]}else y=d.find(v=>v.id===c);if(!y)return{output:`Blog post '${c}' not found.
Use 'blog' to list all posts.
Try 'blog --help' for more information`,error:!0};const $=De.formatBlogPost(y);return{output:q.render($),html:!0,scrollBehavior:"top"}}let g=d;const f=typeof a=="string"?a:void 0;if(f&&(g=d.filter(y=>y.tags.some(T=>T.toLowerCase()===f.toLowerCase())),g.length===0)){const y=new Map;d.forEach(k=>{k.tags?.forEach(v=>{y.set(v,(y.get(v)??0)+1)})});const T=Array.from(y.entries()).sort((k,v)=>v[1]-k[1]).slice(0,5).map(([k])=>k),$=T.length>0?`
Try one of these tags: ${T.join(", ")}`:"";return{output:`No blog posts found with tag '${f}'.${$}
Use 'blog' to see all posts.`,error:!1}}const E=De.formatBlogList(g,f);return{output:q.render(E),html:!0,scrollBehavior:"top"}}catch(i){return{output:i instanceof Error?i.message:String(i),error:!0}}}}}class Pe{static parse(e){const t=[],n=e.split(`
...
`);return t+n}}function Xi(o){return{name:"changelog",description:"View project version history",execute:(e,t)=>{const n=new U(e);if(n.hasFlag("help"))return{output:`Usage: changelog [options] [version|number]
...
Examples:
  ...
  changelog 0.22.0           # Show specific version`};try{const r=Pe.parse(o);if(r.length===0)return{output:"No changelog entries found.",error:!0};const i=n.getPositional(0);if(i){if(i.toLowerCase()==="latest"){const f=r[0],E=Pe.formatEntry(f);return{output:q.render(E),html:!0,scrollBehavior:"top"}}if(/^\d+$/.test(i)){const f=parseInt(i,10);if(f>0){const E=Pe.getByIndex(r,f);if(!E)return{output:`Version at position ${f} not found. There are ${r.length} versions available.
Try 'changelog --help' for more information.`,error:!0};const S=Pe.formatEntry(E);return{output:q.render(S),html:!0,scrollBehavior:"top"}}}const c=Pe.getVersion(r,i);if(!c){const f=r.slice(0,5).map(E=>E.version).join(", ");return{output:`Version '${i}' not found.
Recent versions: ${f}
Try 'changelog --help' for more information.`,error:!0}}const d=Pe.formatEntry(c);return{output:q.render(d),html:!0,scrollBehavior:"top"}}const s=Pe.formatEntries(r);return{output:q.render(s),html:!0,scrollBehavior:"top"}}catch(r){return{output:r instanceof Error?r.message:String(r),error:!0}}}}}function Ki(o){return{name:"contact",description:"Display contact information",execute:(e,t)=>{if(new U(e).hasFlag("help"))return{output:`Usage: contact

Description:
  Display contact information and professional links

Examples:
  contact              # Show contact details`};try{const r=o.readFile(Ae.CONTENT_CONTACT);return{output:q.render(r),html:!0}}catch(r){return{output:r instanceof Error?r.message:String(r),error:!0}}}}}function Zi(o){if(typeof o!="object"||o===null)return!1;const e=o;return typeof e.title=="string"&&typeof e.date=="string"&&Array.isArray(e.tags)&&e.tags.every(t=>typeof t=="string")}function Ji(o){const e=[];let t=null;for(const n of o){const r=n.trim();if(r.startsWith("- ")){t?.platform&&t?.url&&e.push({platform:t.platform,url:t.url}),t={};const i=r.substring(2).trim(),s=i.indexOf(":");if(s!==-1){const a=i.substring(0,s).trim(),l=i.substring(s+1).trim().replace(/^["']|["']$/g,"");a==="platform"&&(t.platform=l),a==="url"&&(t.url=l)}}else if(t){const i=r.indexOf(":");if(i!==-1){const s=r.substring(0,i).trim(),a=r.substring(i+1).trim().replace(/^["']|["']$/g,"");s==="platform"&&(t.platform=a),s==="url"&&(t.url=a)}}}return t?.platform&&t?.url&&e.push({platform:t.platform,url:t.url}),e}class Ur{static parseFrontmatter(e){const t=e.split(`
`);if(t[0]?.trim()!=="---")throw new Error("Invalid frontmatter: must start with ---");let n=-1;for(let l=1;l<t.length;l++)if(t[l].trim()==="---"){n=l;break}if(n===-1)throw new Error("Invalid frontmatter: no closing ---");const r=t.slice(1,n),i=t.slice(n+1),s={};let a=0;for(;a<r.length;){const l=r[a],c=l.indexOf(":");if(c===-1){a++;continue}const d=l.substring(0,c).trim(),g=l.substring(c+1).trim();if(d==="posted"&&g===""){const f=[];for(a++;a<r.length;){const E=r[a];if(/^\s+(- |[\w])/.exec(E))f.push(E),a++;else break}s[d]=Ji(f);continue}if(g.startsWith("[")&&g.endsWith("]")){const f=g.substring(1,g.length-1);s[d]=f.split(",").map(E=>E.trim().replace(/^["']|["']$/g,"")).filter(E=>E.length>0)}else s[d]=g.replace(/^["']|["']$/g,"");a++}if(!Zi(s)){const l=[];throw s.title||l.push("title"),s.date||l.push("date"),Array.isArray(s.tags)||l.push("tags"),new Error(`Invalid post frontmatter: missing or invalid fields: ${l.join(", ")}`)}return{frontmatter:s,markdown:i.join(`
`).trim()}}static parsePost(e,t){const{frontmatter:n,markdown:r}=this.parseFrontmatter(t);return{id:this.getIdFromFilename(e),title:n.title,date:n.date,content:r,tags:n.tags,...n.posted&&n.posted.length>0&&{posted:n.posted}}}static getIdFromFilename(e){return e.replace(/^\d{4}-\d{2}-\d{2}-/,"").replace(/\.md$/,"")}}function Qi(o){return{name:"notes",description:"List and read short-form notes",execute:(e,t)=>{const n=new U(e);if(n.hasFlag("help"))return{output:`Usage: notes [options] [note-id|number]
...
Examples:
  ...
  notes note-id                 # Read specific note by ID`};const r=Ae.CONTENT_POSTS;try{const s=o.list(r).filter(y=>y.endsWith(".md")).sort().reverse(),a=n.getFlag("tags"),l=n.hasFlag("tags"),c=n.getPositional(0),d=[];for(const y of s){const T=o.readFile(`${r}/${y}`),$=Ur.parsePost(y,T);d.push($)}if(d.length===0&&!l&&!c){const y=`# Notes

${Ze.EMPTY_POSTS}`;return{output:q.render(y),html:!0,scrollBehavior:"top"}}if(l&&(typeof a=="boolean"||!a)){const y=new Set,T=new Map;d.forEach(R=>{R.tags?.forEach(G=>{y.add(G),T.set(G,(T.get(G)??0)+1)})});const $=Array.from(y).sort();if($.length===0){const R=`# Note Tags

${Ze.NO_TAGS_AVAILABLE}`;return{output:q.render(R),html:!0,scrollBehavior:"top"}}const v=`# Note Tags

${$.map(R=>{const G=T.get(R)??0;return`- <button data-command="notes --tags ${R}" class="tag-link">${R}</button> (${G} note${G!==1?"s":""})`}).join(`
`)}

---

**Usage:** Type \`notes --tags <tag>\` to filter notes`;return{output:q.render(v),html:!0,scrollBehavior:"top"}}if(c){let y;const T=parseInt(c,10);if(!isNaN(T)&&T>0&&T<=d.length){const v=d.length-T;y=d[v]}else y=d.find(v=>v.id===c);if(!y)return{output:`Note '${c}' not found.
Use 'notes' to list all notes.
Try 'notes --help' for more information`,error:!0};const $=De.formatPostDetail(y);return{output:q.render($),html:!0,scrollBehavior:"top"}}let g=d;const f=typeof a=="string"?a:void 0;if(f&&(g=d.filter(y=>y.tags.some(T=>T.toLowerCase()===f.toLowerCase())),g.length===0)){const y=new Map;d.forEach(k=>{k.tags?.forEach(v=>{y.set(v,(y.get(v)??0)+1)})});const T=Array.from(y.entries()).sort((k,v)=>v[1]-k[1]).slice(0,5).map(([k])=>k),$=T.length>0?`
Try one of these tags: ${T.join(", ")}`:"";return{output:`No notes found with tag '${f}'.${$}
Use 'notes' to see all notes.`,error:!1}}const E=De.formatPostList(g,f);return{output:q.render(E),html:!0,scrollBehavior:"top"}}catch(i){return{output:i instanceof Error?i.message:String(i),error:!0}}}}}function es(o){if(typeof o!="object"||o===null)return!1;const e=o;return typeof e.id=="string"&&typeof e.title=="string"&&typeof e.summary=="string"&&typeof e.year=="string"&&typeof e.order=="number"&&Array.isArray(e.technologies)&&e.technologies.every(t=>typeof t=="string")&&(e.impact===void 0||typeof e.impact=="string")&&(e.tags===void 0||Array.isArray(e.tags)&&e.tags.every(t=>typeof t=="string"))}class ts{static parseFrontmatter(e){const t=e.split(`
`);if(t[0]?.trim()!=="---")throw new Error("Invalid frontmatter: must start with ---");let n=-1;for(let a=1;a<t.length;a++)if(t[a].trim()==="---"){n=a;break}if(n===-1)throw new Error("Invalid frontmatter: no closing ---");const r=t.slice(1,n),i=t.slice(n+1),s={};for(const a of r){const l=a.indexOf(":");if(l===-1)continue;const c=a.substring(0,l).trim(),d=a.substring(l+1).trim();if(d.startsWith("[")&&d.endsWith("]")){const g=d.substring(1,d.length-1);s[c]=g.split(",").map(f=>f.trim().replace(/^["']|["']$/g,"")).filter(f=>f.length>0)}else{const g=d.replace(/^["']|["']$/g,"");if(c==="order"){const f=Number(g);s[c]=isNaN(f)?g:f}else s[c]=g}}if(!es(s)){const a=[];throw s.id||a.push("id"),s.title||a.push("title"),s.summary||a.push("summary"),s.year||a.push("year"),typeof s.order!="number"&&a.push("order"),Array.isArray(s.technologies)||a.push("technologies"),new Error(`Invalid portfolio frontmatter: missing or invalid fields: ${a.join(", ")}`)}return{frontmatter:s,markdown:i.join(`
`).trim()}}static parseProject(e,t){const{frontmatter:n,markdown:r}=this.parseFrontmatter(t);return{id:n.id||e.replace(/\.md$/,""),title:n.title,summary:n.summary,description:r,technologies:n.technologies,impact:n.impact,year:n.year,order:n.order,tags:n.tags}}static getIdFromFilename(e){return e.replace(/\.md$/,"")}}function ns(o){return{name:"portfolio",description:"Showcase projects and accomplishments",execute:(e,t)=>{const n=new U(e);if(n.hasFlag("help"))return{output:`Usage: portfolio [options] [project-id|number]
...
Examples:
  ...
  portfolio proj-id             # View specific project by ID`};const r=Ae.CONTENT_PORTFOLIO;try{const s=o.list(r).filter(T=>T.endsWith(".md")),a=n.getFlag("tags"),l=n.hasFlag("tags"),c=n.getPositional(0),d=[];for(const T of s){const $=o.readFile(`${r}/${T}`);if($)try{const k=ts.parseProject(T,$);d.push(k)}catch(k){console.error(`Error parsing ${T}:`,k)}}if(d.sort((T,$)=>T.order!==$.order?T.order-$.order:T.title.localeCompare($.title)),d.length===0&&!l&&!c){const T=`# Portfolio

${Ze.EMPTY_PORTFOLIO}`;return{output:q.render(T),html:!0,scrollBehavior:"top"}}if(l&&(typeof a=="boolean"||!a)){const T=new Set,$=new Map;d.forEach(G=>{G.tags?.forEach(re=>{T.add(re),$.set(re,($.get(re)??0)+1)})});const k=Array.from(T).sort();if(k.length===0){const G=`# Portfolio Tags

${Ze.NO_TAGS_AVAILABLE}`;return{output:q.render(G),html:!0,scrollBehavior:"top"}}const N=`# Portfolio Tags

${k.map(G=>{const re=$.get(G)??0;return`- <button data-command="portfolio --tags ${G}" class="tag-link">${G}</button> (${re} project${re!==1?"s":""})`}).join(`
`)}

---

**Usage:** Type \`portfolio --tags <tag>\` to filter projects`;return{output:q.render(N),html:!0,scrollBehavior:"top"}}if(c){let T;const $=parseInt(c,10);if(!isNaN($)&&$>0&&$<=d.length){const N=$-1;T=d[N]}else T=d.find(N=>N.id===c);if(!T)return{output:`Project '${c}' not found.
Use 'portfolio' to list all projects.
Try 'portfolio --help' for more information`,error:!0};const k=De.formatPortfolioDetail(T);return{output:q.render(k),html:!0,scrollBehavior:"top"}}let g=d,f=[];if(l&&typeof a=="string"&&(f=a.split(",").map(T=>T.trim().toLowerCase()),g=d.filter(T=>T.tags?.some($=>f.includes($.toLowerCase()))),g.length===0)){const T=f.map(N=>`'${N}'`).join(", "),$=new Map;d.forEach(N=>{N.tags?.forEach(R=>{$.set(R,($.get(R)??0)+1)})});const k=Array.from($.entries()).sort((N,R)=>R[1]-N[1]).slice(0,5).map(([N])=>N),v=k.length>0?`
Try one of these tags: ${k.join(", ")}`:"";return{output:`No projects found with tag${f.length>1?"s":""} ${T}.${v}
Use 'portfolio' to see all projects.`,error:!1}}const E=f.length>0?f.join(", "):void 0,S=De.formatPortfolioList(g,E);return{output:q.render(S),html:!0,scrollBehavior:"top"}}catch(i){return{output:`Error loading portfolio: ${String(i)}`,error:!0}}}}}function Br(o,e){const t=o.loadSettings(),n=e.getPresets();return`<aside class="settings-panel" role="complementary" aria-label="Terminal settings" data-settings-panel="true"><h2>Terminal Settings</h2><section class="settings-section"><h3>Color Theme</h3>${rs(n,t.theme.preset)}</section><section class="settings-section"><details ${t.theme.preset==="custom"?"open":""}><summary>Advanced: Custom Colors</summary>${os(t.theme.customColors)}</details></section><section class="settings-section"><h3>Font</h3>${is(t.font)}</section><section class="settings-section"><h3>Effects</h3>${ss(t.effects)}</section><section class="settings-section"><h3>Screensaver</h3>${as(t.screensaver)}</section><div class="settings-actions"><button data-command="settings reset" class="btn-reset">Reset to Defaults</button></div></aside>`}function rs(o,e){return'<div class="theme-buttons-container">'+o.map(t=>`<button class="theme-button ${t.name===e?"active":""}" data-command="settings set theme ${t.name}" data-theme="${t.name}" style="background: ${t.colors["--terminal-bg"]}; color: ${t.colors["--terminal-accent"]}; border-color: ${t.colors["--terminal-accent"]};"><span class="theme-preview" style="background: ${t.colors["--terminal-accent"]}"></span>${t.displayName}</button>`).join("")+"</div>"}function os(o){return[{key:"--terminal-bg",label:"Background",prop:"background"},{key:"--terminal-bg-secondary",label:"BG (Secondary)",prop:"backgroundSecondary"},{key:"--terminal-fg",label:"Foreground",prop:"foreground"},{key:"--terminal-accent",label:"Accent",prop:"accent"},{key:"--terminal-dim",label:"Dim",prop:"dim"},{key:"--terminal-error",label:"Error",prop:"error"},{key:"--terminal-cursor",label:"Cursor",prop:"cursor"}].map(t=>{const n=o?.[t.prop]??(typeof window<"u"?getComputedStyle(document.documentElement).getPropertyValue(t.key).trim():"#000000");return`<div class="color-picker-group"><label>${t.label}</label><input type="color" value="${n}" data-command-template="settings set color ${t.key}" data-color-var="${t.key}"/><span class="color-value">${o?.[t.prop]??"default"}</span></div>`}).join("")}function is(o){const e=["Fira Code","JetBrains Mono","Cascadia Code","Menlo","Monaco","Courier New","monospace"];return`<div class="setting-group"><label>Font Size: <span id="font-size-value">${o.size}px</span></label><input type="range" min="8" max="24" step="1" value="${o.size}" aria-label="Font size" aria-valuemin="8" aria-valuemax="24" aria-valuenow="${o.size}" aria-valuetext="${o.size} pixels" data-command-template="settings set font-size" data-setting-type="font-size"/></div><div class="setting-group"><label>Font Family</label><select aria-label="Font family" data-command-template="settings set font-family" data-setting-type="font-family">${e.map(t=>`<option value="${t}" ${t===o.family?"selected":""}>${t}</option>`).join("")}</select></div>`}function ss(o){return`<div class="setting-group"><label><input type="checkbox" ${o.scanLines?"checked":""} data-command-template="settings set scan-lines" data-setting-type="scan-lines"/>Scan Lines</label></div><div class="setting-group"><label><input type="checkbox" ${o.glow?"checked":""} data-command-template="settings set glow" data-setting-type="glow"/>Glow Effect</label></div><div class="setting-group"><label><input type="checkbox" ${o.border?"checked":""} data-command-template="settings set border" data-setting-type="border"/>Page Border</label></div><div class="setting-group"><label>Animation Speed: <span id="animation-speed-value">${o.animationSpeed}x</span></label><input type="range" min="0.5" max="2.0" step="0.1" value="${o.animationSpeed}" aria-label="Animation speed" aria-valuemin="0.5" aria-valuemax="2" aria-valuenow="${o.animationSpeed}" aria-valuetext="${o.animationSpeed} times speed" data-command-template="settings set animation-speed" data-setting-type="animation-speed"/></div><div class="setting-group"><label><input type="checkbox" ${o.soundEffects?"checked":""} data-command-template="settings set sound-effects" data-setting-type="sound-effects"/>Sound Effects (future feature)</label></div>`}function as(o){const e=[{value:"matrix",label:"Matrix Digital Rain"},{value:"life",label:"Conway's Game of Life"}];return`<div class="setting-group"><label><input type="checkbox" ${o.enabled?"checked":""} data-command-template="settings set screensaver-enabled" data-setting-type="screensaver-enabled"/>Enable Screensaver</label></div><div class="setting-group"><label>Timeout: <span id="screensaver-timeout-value">${o.timeoutMinutes}min</span></label><input type="range" min="1" max="60" step="1" value="${o.timeoutMinutes}" aria-label="Screensaver timeout" aria-valuemin="1" aria-valuemax="60" aria-valuenow="${o.timeoutMinutes}" aria-valuetext="${o.timeoutMinutes} minutes" data-command-template="settings set screensaver-timeout" data-setting-type="screensaver-timeout"/></div><div class="setting-group"><label>Screensaver Type</label><select aria-label="Screensaver type" data-command-template="settings set screensaver-type" data-setting-type="screensaver-type">${e.map(t=>`<option value="${t.value}" ${t.value===o.activeScreensaver?"selected":""}>${t.label}</option>`).join("")}</select></div>`}function ls(o,e,t){return{name:"settings",description:"Manage terminal settings and preferences",aliases:["preferences","config"],execute:(n,r)=>{const i=new U(n);if(i.hasFlag("help"))return{output:`Usage: settings [subcommand] [options]
...
Examples:
  ...
  settings reset       # Reset all settings`};if(n.length===0)return{output:Br(e,t),html:!0};const s=i.getPositional(0);switch(s){case"list":return cs(e,t);case"set":return lr(i,e,t);case"reset":return ds(e,t);case"theme":case"font-size":case"font-family":case"fontSize":case"fontFamily":case"scan-lines":case"scanLines":case"glow":case"border":case"animation-speed":case"animationSpeed":case"sound":case"auto-scroll":case"autoScroll":case"prompt":case"screensaver-enabled":case"screensaverEnabled":case"screensaver-timeout":case"screensaverTimeout":case"screensaver-type":case"screensaverType":return lr(new U(["set",s,...n.slice(1)]),e,t);default:return{output:`Unknown subcommand: ${s}.
Try 'settings --help' for more information`,error:!0}}}}}function cs(o,e){const t=us(o,e);return{output:q.render(t),html:!0}}function lr(o,e,t){const n=o.getPositional(1),r=o.getPositional(2);if(!n)return{output:`Usage: settings set <setting> <value>
Try 'settings --help' for more information`,error:!0};if(n!=="color"&&!r)return{output:`Usage: settings set <setting> <value>
Try 'settings --help' for more information`,error:!0};try{switch(n){case"theme":{const i=["green","yellow","white","light-blue","paper","dc"];return i.includes(r)?(e.setSetting("theme",{preset:r}),t.applyTheme(r),de(),{output:`Theme changed to: ${r}`}):{output:`Invalid theme: ${r}. Available: ${i.join(", ")}`,error:!0}}case"color":{const i=["terminal-bg","terminal-fg","terminal-accent","terminal-dim","terminal-error","terminal-cursor","terminal-bg-secondary"];let s,a;for(const c of i){const d=o.getFlag(c);if(d&&typeof d=="string"){s="--"+c,a=d;break}}if(!s||!a)return{output:`Usage: settings set color <variable> <value>
Example: settings set color --terminal-accent #ff0000`,error:!0};const l={[s]:a};return t.applyCustomColors(l),de(),{output:`Color ${s} set to ${a}`}}case"font-size":case"fontSize":{if(!r)return{output:"Font size value required",error:!0};const i=parseInt(r,10);return isNaN(i)?{output:"Font size must be a number (8-24)",error:!0}:(e.setFontSize(i),un(e),de(),{output:`Font size set to: ${i}px`})}case"font-family":case"fontFamily":{if(!r)return{output:"Font family value required",error:!0};const i=["Fira Code","JetBrains Mono","Cascadia Code","Menlo","Monaco","Courier New","monospace"];return i.includes(r)?(e.setFontFamily(r),un(e),de(),{output:`Font family set to: ${r}`}):{output:`Invalid font family: ${r}. Available: ${i.join(", ")}`,error:!0}}case"scan-lines":case"scanLines":{if(!r)return{output:"Scan lines value required (on/off)",error:!0};if(r!=="on"&&r!=="off")return{output:'Scan lines must be "on" or "off"',error:!0};const i=r==="on";return e.setScanLines(i),Wr(i),de(),{output:`Scan lines: ${r}`}}case"glow":{if(!r)return{output:"Glow value required (on/off)",error:!0};if(r!=="on"&&r!=="off")return{output:'Glow must be "on" or "off"',error:!0};const i=r==="on";return e.setGlow(i),Gr(i),de(),{output:`Glow: ${r}`}}case"border":{if(!r)return{output:"Border value required (on/off)",error:!0};if(r!=="on"&&r!=="off")return{output:'Border must be "on" or "off"',error:!0};const i=r==="on";return e.setBorder(i),zr(i),de(),{output:`Border: ${r}`}}case"animation-speed":case"animationSpeed":{if(!r)return{output:"Animation speed value required",error:!0};const i=parseFloat(r);return isNaN(i)?{output:"Animation speed must be a number (0.5-2.0)",error:!0}:(e.setAnimationSpeed(i),Vr(i),de(),{output:`Animation speed set to: ${i}x`})}case"sound-effects":case"sound":{if(!r)return{output:"Sound effects value required (on/off)",error:!0};if(r!=="on"&&r!=="off")return{output:'Sound effects must be "on" or "off"',error:!0};const i=r==="on";return e.setSoundEffects(i),de(),{output:`Sound effects: ${r}`}}case"autoscroll":case"auto-scroll":case"autoScroll":{if(!r)return{output:"Autoscroll value required (on/off)",error:!0};if(r!=="on"&&r!=="off")return{output:'Autoscroll must be "on" or "off"',error:!0};const i=r==="on";return e.setAutoScrollBehavior(i),de(),{output:`Autoscroll: ${r} - ${i?"Long content (>50 lines) scrolls to command line":"All content scrolls to bottom"}`}}case"prompt":return r?(e.setPromptFormat(r),de(),{output:`Prompt format set to: ${r}`}):{output:"Prompt format value required",error:!0};case"screensaver-enabled":case"screensaverEnabled":{if(!r)return{output:"Screensaver enabled value required (on/off)",error:!0};if(r!=="on"&&r!=="off")return{output:'Screensaver enabled must be "on" or "off"',error:!0};const i=r==="on";return e.setScreensaverEnabled(i),de(),{output:`Screensaver: ${r}`}}case"screensaver-timeout":case"screensaverTimeout":{if(!r)return{output:"Screensaver timeout value required (1-60 minutes)",error:!0};const i=parseInt(r,10);return isNaN(i)||i<1||i>60?{output:"Screensaver timeout must be between 1 and 60 minutes",error:!0}:(e.setScreensaverTimeout(i),de(),{output:`Screensaver timeout set to: ${i} minutes`})}case"screensaver-type":case"screensaverType":{if(!r)return{output:"Screensaver type value required",error:!0};const i=["matrix","life"];return i.includes(r)?(e.setActiveScreensaver(r),de(),{output:`Screensaver type set to: ${r}`}):{output:`Invalid screensaver type: ${r}. Available: ${i.join(", ")}`,error:!0}}default:return{output:`Unknown setting: ${n}. Available: theme, color, font-size, font-family, scan-lines, glow, border, animation-speed, sound-effects, autoscroll, prompt, screensaver-enabled, screensaver-timeout, screensaver-type`,error:!0}}}catch(i){return{output:i instanceof Error?i.message:String(i),error:!0}}}function ds(o,e){return o.reset(),e.applyCurrentTheme(),un(o),Wr(o.getScanLines()),Gr(o.getGlow()),zr(o.getBorder()),Vr(o.getAnimationSpeed()),de(),{output:"Settings reset to defaults."}}function us(o,e){const t=o.loadSettings(),n=e.getPresets();return`# Terminal Settings
...
Note: Messages appear with timed animation. Scroll or type to stop.`};const n=t.hasFlag("fast"),{html:r,welcomeDelay:i}=ms(n);return{output:`<div class="boot-sequence boot-startup" data-boot-type="boot">
${r}
</div>`,html:!0,clearBefore:!0,fullscreen:!0,fullscreenDuration:i,scrollBehavior:"top"}}},Xe=[{code:"SYSTEM_THREAD_EXCEPTION_NOT_HANDLED",description:"A system thread generated an exception that was not handled."},{code:"DRIVER_IRQL_NOT_LESS_OR_EQUAL",description:"A driver attempted to access a pageable memory at an inappropriate IRQL."},{code:"KERNEL_DATA_INPAGE_ERROR",description:"The requested page of kernel data from the paging file could not be read."},{code:"PAGE_FAULT_IN_NONPAGED_AREA",description:"Invalid system memory has been referenced."},{code:"CRITICAL_PROCESS_DIED",description:"A critical system process died unexpectedly."}];function ps(o,e){return`<div class="bsod-overlay bsod-modern" data-bsod="true" data-bsod-style="modern">
...
</div>`}function fs(o,e){const t=["0x0000007E","0xC0000005","0xBF8B4C62","0x00000000","0xBF8B4C62"];return`<div class="bsod-overlay bsod-classic" data-bsod="true" data-bsod-style="classic">
...
</div>`}const gs={name:"bsod",description:"Display a fake Windows Blue Screen of Death",execute:(o,e)=>{const t=new U(o);if(t.hasFlag("help")||t.hasFlag("h"))return{output:`Usage: bsod [options]
...
Options:
  ...
  --error <index>   Select specific error code (0-${Xe.length-1})
  --help, -h        Display this help message

Error codes:
${Xe.map((c,d)=>`  ${d}: ${c.code}`).join(`
`)}
...
Note: Click anywhere or press any key to dismiss the BSOD.`};const n=t.hasFlag("classic"),r=t.getFlag("reason"),i=t.getFlag("error");let s=Xe[Math.floor(Math.random()*Xe.length)];if(i!==void 0&&i!==!0){const c=parseInt(String(i),10);!isNaN(c)&&c>=0&&c<Xe.length&&(s=Xe[c])}const a=typeof r=="string"?r:s.description;return{output:n?fs(s.code,a):ps(s.code,a),html:!0,clearBefore:!0,scrollBehavior:"top"}}},$s=["Chaos","Discord","Confusion","Bureaucracy","The Aftermath"],Ts=["Sweetmorn","Boomtime","Pungenday","Prickle-Prickle","Setting Orange"],As=["Mungday","Mojoday","Syadday","Zaraday","Malbowday"],cr=73,Es=1166;function _n(o){return o%4===0&&o%100!==0||o%400===0}function Ls(o,e,t){const n=[31,28,31,30,31,30,31,31,30,31,30,31];_n(o)&&(n[1]=29);let r=t;for(let i=0;i<e-1;i++)r+=n[i];return r}function ys(o){const e=o.getFullYear(),t=o.getMonth()+1,n=o.getDate(),r=e+Es,i=Ls(e,t,n);if(_n(e)&&t===2&&n===29)return{weekday:"",season:"",dayOfSeason:0,yold:r,isStTibsDay:!0};let s=i;_n(e)&&i>60&&(s=i-1);const a=Math.floor((s-1)/cr),l=$s[a],c=(s-1)%cr+1,d=(s-1)%5,g=Ts[d],f=c===5?As[a]:void 0;return{weekday:g,season:l,dayOfSeason:c,yold:r,isStTibsDay:!1,apostleDay:f}}function Is(o){return o.isStTibsDay?`St. Tib's Day, ${o.yold} YOLD`:o.apostleDay?`${o.weekday}, ${o.apostleDay}, day ${o.dayOfSeason} of ${o.season}, ${o.yold} YOLD`:`${o.weekday}, ${o.season} ${o.dayOfSeason}, ${o.yold} YOLD`}function bs(o){if(/^\d{4}-\d{2}-\d{2}$/.test(o)){const e=new Date(o);if(!isNaN(e.getTime()))return e}if(/^\d{1,2}\/\d{1,2}\/\d{4}$/.test(o)){const e=new Date(o);if(!isNaN(e.getTime()))return e}return null}function ws(o,e,t){if(o<1||o>31||e<1||e>12||t<1)return null;const n=new Date(t,e-1,o);return isNaN(n.getTime())?null:n}const Ss={name:"ddate",description:"Display date in Discordian calendar",execute:(o,e)=>{const t=new U(o);if(t.hasFlag("help"))return{output:`Usage: ddate [DATE]
...
Options:
  --help                   Display this help message`};let n;if(t.positionalCount===0)n=new Date;else if(t.positionalCount===1){const s=t.getPositional(0),a=bs(s);if(!a)return{output:`ddate: invalid date '${s}'`,error:!0};n=a}else if(t.positionalCount===3){const s=parseInt(t.getPositional(0),10),a=parseInt(t.getPositional(1),10),l=parseInt(t.getPositional(2),10);if(isNaN(a)||isNaN(s)||isNaN(l))return{output:"ddate: invalid numeric date arguments",error:!0};const c=ws(a,s,l);if(!c)return{output:`ddate: invalid date ${s}/${a}/${l}`,error:!0};n=c}else return{output:`ddate: invalid arguments
Try 'ddate --help' for more information.`,error:!0};const r=ys(n);return{output:Is(r)}}},vs={FULL_WIDTH:0,FITTING:1,SMUSHING:2,CONTROLLED_SMUSHING:3};class Cs{constructor(){this.comment="",this.numChars=0,this.options={}}}const Qt=["1Row","3-D","3D Diagonal","3D-ASCII","3x5","4Max","5 Line Oblique","AMC 3 Line","AMC 3 Liv1","AMC AAA01","AMC Neko","AMC Razor","AMC Razor2","AMC Slash","AMC Slider","AMC Thin","AMC Tubes","AMC Untitled","ANSI Regular","ANSI Shadow","ANSI-Compact","ASCII 12","ASCII 9","ASCII New Roman","Acrobatic","Alligator","Alligator2","Alpha","Alphabet","Arrows","Avatar","B1FF","Babyface Lame","Babyface Leet","Banner","Banner3-D","Banner3","Banner4","Barbwire","Basic","Bear","Bell","Benjamin","Big ASCII 12","Big ASCII 9","Big Chief","Big Money-ne","Big Money-nw","Big Money-se","Big Money-sw","Big Mono 12","Big Mono 9","Big","Bigfig","Binary","Block","Blocks","Bloody","BlurVision ASCII","Bolger","Braced","Bright","Broadway KB","Broadway","Bubble","Bulbhead","Caligraphy","Caligraphy2","Calvin S","Cards","Catwalk","Chiseled","Chunky","Circle","Coinstak","Cola","Colossal","Computer","Contessa","Contrast","Cosmike","Cosmike2","Crawford","Crawford2","Crazy","Cricket","Cursive","Cyberlarge","Cybermedium","Cybersmall","Cygnet","DANC4","DOS Rebel","DWhistled","Dancing Font","Decimal","Def Leppard","Delta Corps Priest 1","DiamFont","Diamond","Diet Cola","Digital","Doh","Doom","Dot Matrix","Double Shorts","Double","Dr Pepper","Efti Chess","Efti Font","Efti Italic","Efti Piti","Efti Robot","Efti Wall","Efti Water","Electronic","Elite","Emboss 2","Emboss","Epic","Fender","Filter","Fire Font-k","Fire Font-s","Flipped","Flower Power","Four Tops","Fraktur","Fun Face","Fun Faces","Future","Fuzzy","Georgi16","Georgia11","Ghost","Ghoulish","Glenyn","Goofy","Gothic","Graceful","Gradient","Graffiti","Greek","Heart Left","Heart Right","Henry 3D","Hex","Hieroglyphs","Hollywood","Horizontal Left","Horizontal Right","ICL-1900","Impossible","Invita","Isometric1","Isometric2","Isometric3","Isometric4","Italic","Ivrit","JS Block Letters","JS Bracket Letters","JS Capital Curves","JS Cursive","JS Stick Letters","Jacky","Jazmine","Jerusalem","Katakana","Kban","Keyboard","Knob","Konto Slant","Konto","LCD","Larry 3D 2","Larry 3D","Lean","Letter","Letters","Lil Devil","Line Blocks","Linux","Lockergnome","Madrid","Marquee","Maxfour","Merlin1","Merlin2","Mike","Mini","Mirror","Mnemonic","Modular","Mono 12","Mono 9","Morse","Morse2","Moscow","Mshebrew210","Muzzle","NScript","NT Greek","NV Script","Nancyj-Fancy","Nancyj-Improved","Nancyj-Underlined","Nancyj","Nipples","O8","OS2","Octal","Ogre","Old Banner","Pagga","Patorjk's Cheese","Patorjk-HeX","Pawp","Peaks Slant","Peaks","Pebbles","Pepper","Poison","Puffy","Puzzle","Pyramid","Rammstein","Rebel","Rectangles","Red Phoenix","Relief","Relief2","Reverse","Roman","Rot13","Rotated","Rounded","Rowan Cap","Rozzo","RubiFont","Runic","Runyc","S Blood","SL Script","Santa Clara","Script","Serifcap","Shaded Blocky","Shadow","Shimrod","Short","Slant Relief","Slant","Slide","Small ASCII 12","Small ASCII 9","Small Block","Small Braille","Small Caps","Small Isometric1","Small Keyboard","Small Mono 12","Small Mono 9","Small Poison","Small Script","Small Shadow","Small Slant","Small Tengwar","Small","Soft","Speed","Spliff","Stacey","Stampate","Stampatello","Standard","Star Strips","Star Wars","Stellar","Stforek","Stick Letters","Stop","Straight","Stronger Than All","Sub-Zero","Swamp Land","Swan","Sweet","THIS","Tanja","Tengwar","Term","Terrace","Test1","The Edge","Thick","Thin","Thorned","Three Point","Ticks Slant","Ticks","Tiles","Tinker-Toy","Tmplr","Tombstone","Train","Trek","Tsalagi","Tubular","Twisted","Two Point","USA Flag","Univers","Upside Down Text","Varsity","Wavescape","Wavy","Weird","Wet Letter","Whimsy","WideTerm","Wow","miniwi"];function Rs(o){return/[.*+?^${}()|[\]\\]/.test(o)?"\\"+o:o}const ht=(()=>{const{FULL_WIDTH:o=0,FITTING:e,SMUSHING:t,CONTROLLED_SMUSHING:n}=vs,r={},i={font:"Standard",fontPath:"./fonts",fetchFontIfMissing:!0};function s(h,p,u){const m=Rs(h.trim().slice(-1))||"@",A=p===u-1?new RegExp(m+m+"?\\s*$"):new RegExp(m+"\\s*$");return h.replace(A,"")}function a(h=-1,p=null){let u={},m,A=[[16384,"vLayout",t],[8192,"vLayout",e],[4096,"vRule5",!0],[2048,"vRule4",!0],[1024,"vRule3",!0],[512,"vRule2",!0],[256,"vRule1",!0],[128,"hLayout",t],[64,"hLayout",e],[32,"hRule6",!0],[16,"hRule5",!0],[8,"hRule4",!0],[4,"hRule3",!0],[2,"hRule2",!0],[1,"hRule1",!0]];m=p!==null?p:h;for(const[I,b,w]of A)m>=I?(m-=I,u[b]===void 0&&(u[b]=w)):b!=="vLayout"&&b!=="hLayout"&&(u[b]=!1);return typeof u.hLayout>"u"?h===0?u.hLayout=e:h===-1?u.hLayout=o:u.hRule1||u.hRule2||u.hRule3||u.hRule4||u.hRule5||u.hRule6?u.hLayout=n:u.hLayout=t:u.hLayout===t&&(u.hRule1||u.hRule2||u.hRule3||u.hRule4||u.hRule5||u.hRule6)&&(u.hLayout=n),typeof u.vLayout>"u"?u.vRule1||u.vRule2||u.vRule3||u.vRule4||u.vRule5?u.vLayout=n:u.vLayout=o:u.vLayout===t&&(u.vRule1||u.vRule2||u.vRule3||u.vRule4||u.vRule5)&&(u.vLayout=n),u}function l(h,p,u=""){return h===p&&h!==u?h:!1}function c(h,p){let u="|/\\[]{}()<>";if(h==="_"){if(u.indexOf(p)!==-1)return p}else if(p==="_"&&u.indexOf(h)!==-1)return h;return!1}function d(h,p){let u="| /\\ [] {} () <>",m=u.indexOf(h),A=u.indexOf(p);if(m!==-1&&A!==-1&&m!==A&&Math.abs(m-A)!==1){const I=Math.max(m,A),b=I+1;return u.substring(I,b)}return!1}function g(h,p){let u="[] {} ()",m=u.indexOf(h),A=u.indexOf(p);return m!==-1&&A!==-1&&Math.abs(m-A)<=1?"|":!1}function f(h,p){return{"/\\":"|","\\/":"Y","><":"X"}[h+p]||!1}function E(h,p,u=""){return h===u&&p===u?u:!1}function S(h,p){return h===p?h:!1}function y(h,p){return c(h,p)}function T(h,p){return d(h,p)}function $(h,p){return h==="-"&&p==="_"||h==="_"&&p==="-"?"=":!1}function k(h,p){return h==="|"&&p==="|"?"|":!1}function v(h,p,u){return p===" "||p===""||p===u&&h!==" "?h:p}function N(h,p,u){if(u.fittingRules&&u.fittingRules.vLayout===o)return"invalid";let m,A=Math.min(h.length,p.length),I,b,w=!1,C;if(A===0)return"invalid";for(m=0;m<A;m++)if(I=h.substring(m,m+1),b=p.substring(m,m+1),I!==" "&&b!==" "){if(u.fittingRules&&u.fittingRules.vLayout===e)return"invalid";if(u.fittingRules&&u.fittingRules.vLayout===t)return"end";if(k(I,b)){w=w||!1;continue}if(C=!1,C=u.fittingRules&&u.fittingRules.vRule1?S(I,b):C,C=!C&&u.fittingRules&&u.fittingRules.vRule2?y(I,b):C,C=!C&&u.fittingRules&&u.fittingRules.vRule3?T(I,b):C,C=!C&&u.fittingRules&&u.fittingRules.vRule4?$(I,b):C,w=!0,!C)return"invalid"}return w?"end":"valid"}function R(h,p,u){let m=h.length,A=h.length,I,b,w,C=1,D,F,M;for(;C<=m;){for(I=h.slice(Math.max(0,A-C),A),b=p.slice(0,Math.min(m,C)),w=b.length,M="",D=0;D<w;D++)if(F=N(I[D],b[D],u),F==="end")M=F;else if(F==="invalid"){M=F;break}else M===""&&(M="valid");if(M==="invalid"){C--;break}if(M==="end")break;M==="valid"&&C++}return Math.min(m,C)}function G(h,p,u){let m,A=Math.min(h.length,p.length),I,b,w="",C;const D=u.fittingRules||{};for(m=0;m<A;m++)I=h.substring(m,m+1),b=p.substring(m,m+1),I!==" "&&b!==" "?D.vLayout===e||D.vLayout===t?w+=v(I,b):(C=!1,C=D.vRule5?k(I,b):C,C=!C&&D.vRule1?S(I,b):C,C=!C&&D.vRule2?y(I,b):C,C=!C&&D.vRule3?T(I,b):C,C=!C&&D.vRule4?$(I,b):C,w+=C):w+=v(I,b);return w}function re(h,p,u,m){let A=h.length,I=p.length,b=h.slice(0,Math.max(0,A-u)),w=h.slice(Math.max(0,A-u),A),C=p.slice(0,Math.min(u,I)),D,F,M,P=[],H;for(F=w.length,D=0;D<F;D++)D>=I?M=w[D]:M=G(w[D],C[D],m),P.push(M);return H=p.slice(Math.min(u,I),I),[...b,...P,...H]}function We(h,p){const u=" ".repeat(p);return h.map(m=>m+u)}function Ge(h,p,u){let m=h[0].length,A=p[0].length,I;return m>A?p=We(p,m-A):A>m&&(h=We(h,A-m)),I=R(h,p,u),re(h,p,I,u)}function we(h,p,u){const m=u.fittingRules||{};if(m.hLayout===o)return 0;let A,I=h.length,b=p.length,w=I,C=1,D=!1,F,M,P,H;if(I===0)return 0;e:for(;C<=w;){const ae=I-C;for(F=h.substring(ae,ae+C),M=p.substring(0,Math.min(C,b)),A=0;A<Math.min(C,b);A++)if(P=F.substring(A,A+1),H=M.substring(A,A+1),P!==" "&&H!==" "){if(m.hLayout===e){C=C-1;break e}else if(m.hLayout===t){(P===u.hardBlank||H===u.hardBlank)&&(C=C-1);break e}else if(D=!0,!(m.hRule1&&l(P,H,u.hardBlank)||m.hRule2&&c(P,H)||m.hRule3&&d(P,H)||m.hRule4&&g(P,H)||m.hRule5&&f(P,H)||m.hRule6&&E(P,H,u.hardBlank))){C=C-1;break e}}if(D)break;C++}return Math.min(w,C)}function X(h,p,u,m){let A,I,b=[],w,C,D,F,M,P,H,ae;const J=m.fittingRules||{};if(typeof m.height!="number")throw new Error("height is not defined.");for(A=0;A<m.height;A++){H=h[A],ae=p[A],M=H.length,P=ae.length,w=M-u,C=H.slice(0,Math.max(0,w)),D="";const $e=Math.max(0,M-u);let oe=H.substring($e,$e+u),Te=ae.substring(0,Math.min(u,P));for(I=0;I<u;I++){let le=I<M?oe.substring(I,I+1):" ",ee=I<P?Te.substring(I,I+1):" ";if(le!==" "&&ee!==" ")if(J.hLayout===e||J.hLayout===t)D+=v(le,ee,m.hardBlank);else{const Ut=J.hRule1&&l(le,ee,m.hardBlank)||J.hRule2&&c(le,ee)||J.hRule3&&d(le,ee)||J.hRule4&&g(le,ee)||J.hRule5&&f(le,ee)||J.hRule6&&E(le,ee,m.hardBlank)||v(le,ee,m.hardBlank);D+=Ut}else D+=v(le,ee,m.hardBlank)}u>=P?F="":F=ae.substring(u,u+Math.max(0,P-u)),b[A]=C+D+F}return b}function pe(h){return new Array(h).fill("")}const fe=function(h){return Math.max(...h.map(p=>p.length))};function ge(h,p,u){return h.reduce(function(m,A){return X(m,A.fig,A.overlap||0,u)},pe(p))}function Pt(h,p,u){for(let m=h.length-1;m>0;m--){const A=ge(h.slice(0,m),p,u);if(fe(A)<=u.width)return{outputFigText:A,chars:h.slice(m)}}return{outputFigText:pe(p),chars:h}}function Ft(h,p,u){let m,A,I=0,b,w,C,D=u.height,F=[],M,P={chars:[],overlap:I},H=[],ae,J,$e,oe,Te;if(typeof D!="number")throw new Error("height is not defined.");w=pe(D);const le=u.fittingRules||{};for(u.printDirection===1&&(h=h.split("").reverse().join("")),C=h.length,m=0;m<C;m++)if(ae=h.substring(m,m+1),J=ae.match(/\s/),A=p[ae.charCodeAt(0)],oe=null,A){if(le.hLayout!==o){for(I=1e4,b=0;b<D;b++)I=Math.min(I,we(w[b],A[b],u));I=I===1e4?0:I}if(u.width>0&&(u.whitespaceBreak?($e=ge(P.chars.concat([{fig:A,overlap:I}]),D,u),oe=ge(H.concat([{fig:$e,overlap:P.overlap}]),D,u),M=fe(oe)):(oe=X(w,A,I,u),M=fe(oe)),M>=u.width&&m>0&&(u.whitespaceBreak?(w=ge(H.slice(0,-1),D,u),H.length>1&&(F.push(w),w=pe(D)),H=[]):(F.push(w),w=pe(D)))),u.width>0&&u.whitespaceBreak&&((!J||m===C-1)&&P.chars.push({fig:A,overlap:I}),J||m===C-1)){for(Te=null;oe=ge(P.chars,D,u),M=fe(oe),M>=u.width;)Te=Pt(P.chars,D,u),P={chars:Te.chars},F.push(Te.outputFigText);M>0&&(Te?H.push({fig:oe,overlap:1}):H.push({fig:oe,overlap:P.overlap})),J&&(H.push({fig:A,overlap:I}),w=pe(D)),m===C-1&&(w=ge(H,D,u)),P={chars:[],overlap:I};continue}w=X(w,A,I,u)}return fe(w)>0&&F.push(w),u.showHardBlanks||F.forEach(function(ee){for(C=ee.length,b=0;b<C;b++)ee[b]=ee[b].replace(new RegExp("\\"+u.hardBlank,"g")," ")}),h===""&&F.length===0&&F.push(new Array(D).fill("")),F}const Ht=function(h,p){let u;const m=p.fittingRules||{};if(h==="default")u={hLayout:m.hLayout,hRule1:m.hRule1,hRule2:m.hRule2,hRule3:m.hRule3,hRule4:m.hRule4,hRule5:m.hRule5,hRule6:m.hRule6};else if(h==="full")u={hLayout:o,hRule1:!1,hRule2:!1,hRule3:!1,hRule4:!1,hRule5:!1,hRule6:!1};else if(h==="fitted")u={hLayout:e,hRule1:!1,hRule2:!1,hRule3:!1,hRule4:!1,hRule5:!1,hRule6:!1};else if(h==="controlled smushing")u={hLayout:n,hRule1:!0,hRule2:!0,hRule3:!0,hRule4:!0,hRule5:!0,hRule6:!0};else if(h==="universal smushing")u={hLayout:t,hRule1:!1,hRule2:!1,hRule3:!1,hRule4:!1,hRule5:!1,hRule6:!1};else return;return u},gt=function(h,p){let u={};const m=p.fittingRules||{};if(h==="default")u={vLayout:m.vLayout,vRule1:m.vRule1,vRule2:m.vRule2,vRule3:m.vRule3,vRule4:m.vRule4,vRule5:m.vRule5};else if(h==="full")u={vLayout:o,vRule1:!1,vRule2:!1,vRule3:!1,vRule4:!1,vRule5:!1};else if(h==="fitted")u={vLayout:e,vRule1:!1,vRule2:!1,vRule3:!1,vRule4:!1,vRule5:!1};else if(h==="controlled smushing")u={vLayout:n,vRule1:!0,vRule2:!0,vRule3:!0,vRule4:!0,vRule5:!0};else if(h==="universal smushing")u={vLayout:t,vRule1:!1,vRule2:!1,vRule3:!1,vRule4:!1,vRule5:!1};else return;return u},$t=function(h,p,u){u=u.replace(/\r\n/g,`
`).replace(/\r/g,`
`);let m=u.split(`
`),A=[],I,b,w;for(b=m.length,I=0;I<b;I++)A=A.concat(Ft(m[I],r[h],p));for(b=A.length,w=A[0],I=1;I<b;I++)w=Ge(w,A[I],p);return w?w.join(`
`):""};function Qe(h,p){let u;if(typeof structuredClone<"u"?u=structuredClone(h):u=JSON.parse(JSON.stringify(h)),u.showHardBlanks=p.showHardBlanks||!1,u.width=p.width||-1,u.whitespaceBreak=p.whitespaceBreak||!1,p.horizontalLayout){const m=Ht(p.horizontalLayout,h);m&&Object.assign(u.fittingRules,m)}if(p.verticalLayout){const m=gt(p.verticalLayout,h);m&&Object.assign(u.fittingRules,m)}return u.printDirection=p.printDirection!==null&&p.printDirection!==void 0?p.printDirection:h.printDirection,u}const B=async function(h,p,u){return B.text(h,p,u)};return B.text=async function(h,p,u){h=h+"";let m,A;typeof p=="function"?(A=p,m={font:i.font}):typeof p=="string"?(m={font:p},A=u):p?(m=p,A=u):(m={font:i.font},A=u);const I=m.font||i.font;try{const b=await B.loadFont(I),w=b?$t(I,Qe(b,m),h):"";return A&&A(null,w),w}catch(b){const w=b instanceof Error?b:new Error(String(b));if(A)return A(w),"";throw w}},B.textSync=function(h,p){h=h+"",typeof p=="string"?p={font:p}:p=p||{};const u=p.font||i.font;let m=Qe(B.loadFontSync(u),p);return $t(u,m,h)},B.metadata=async function(h,p){h=h+"";try{const u=await B.loadFont(h);if(!u)throw new Error("Error loading font.");const m=r[h]||{},A=[u,m.comment||""];return p&&p(null,u,m.comment),A}catch(u){const m=u instanceof Error?u:new Error(String(u));if(p)return p(m),null;throw m}},B.defaults=function(h){return h&&typeof h=="object"&&Object.assign(i,h),typeof structuredClone<"u"?structuredClone(i):JSON.parse(JSON.stringify(i))},B.parseFont=function(h,p,u=!0){if(r[h]&&!u)return r[h].options;p=p.replace(/\r\n/g,`
`).replace(/\r/g,`
`);const m=new Cs,A=p.split(`
`),I=A.shift();if(!I)throw new Error("Invalid font file: missing header");const b=I.split(" "),w={hardBlank:b[0].substring(5,6),height:parseInt(b[1],10),baseline:parseInt(b[2],10),maxLength:parseInt(b[3],10),oldLayout:parseInt(b[4],10),numCommentLines:parseInt(b[5],10),printDirection:b[6]?parseInt(b[6],10):0,fullLayout:b[7]?parseInt(b[7],10):null,codeTagCount:b[8]?parseInt(b[8],10):null};if((w.hardBlank||"").length!==1||[w.height,w.baseline,w.maxLength,w.oldLayout,w.numCommentLines].some(F=>F==null||isNaN(F)))throw new Error("FIGlet header contains invalid values.");if(w.height==null||w.numCommentLines==null)throw new Error("FIGlet header contains invalid values.");w.fittingRules=a(w.oldLayout,w.fullLayout),m.options=w;const D=[];for(let F=32;F<=126;F++)D.push(F);if(D.push(196,214,220,228,246,252,223),A.length<w.numCommentLines+w.height*D.length)throw new Error(`FIGlet file is missing data. Line length: ${A.length}. Comment lines: ${w.numCommentLines}. Height: ${w.height}. Num chars: ${D.length}.`);for(m.comment=A.splice(0,w.numCommentLines).join(`
`),m.numChars=0;A.length>0&&m.numChars<D.length;){const F=D[m.numChars];m[F]=A.splice(0,w.height);for(let M=0;M<w.height;M++)typeof m[F][M]>"u"?m[F][M]="":m[F][M]=s(m[F][M],M,w.height);m.numChars++}for(;A.length>0;){const F=A.shift();if(!F||F.trim()==="")break;let M=F.split(" ")[0],P;if(/^-?0[xX][0-9a-fA-F]+$/.test(M))P=parseInt(M,16);else if(/^-?0[0-7]+$/.test(M))P=parseInt(M,8);else if(/^-?[0-9]+$/.test(M))P=parseInt(M,10);else throw new Error(`Error parsing data. Invalid data: ${M}`);if(P===-1||P<-2147483648||P>2147483647){const H=P===-1?"The char code -1 is not permitted.":`The char code cannot be ${P<-2147483648?"less than -2147483648":"greater than 2147483647"}.`;throw new Error(`Error parsing data. ${H}`)}m[P]=A.splice(0,w.height);for(let H=0;H<w.height;H++)typeof m[P][H]>"u"?m[P][H]="":m[P][H]=s(m[P][H],H,w.height);m.numChars++}return r[h]=m,w},B.loadedFonts=()=>Object.keys(r),B.clearLoadedFonts=()=>{Object.keys(r).forEach(h=>{delete r[h]})},B.loadFont=async function(h,p){if(r[h]){const u=r[h].options;return p&&p(null,u),Promise.resolve(u)}try{if(!i.fetchFontIfMissing)throw new Error(`Font is not loaded: ${h}`);const u=await fetch(`${i.fontPath}/${h}.flf`);if(!u.ok)throw new Error(`Network response was not ok: ${u.status}`);const m=await u.text(),A=B.parseFont(h,m);return p&&p(null,A),A}catch(u){const m=u instanceof Error?u:new Error(String(u));if(p)return p(m),null;throw m}},B.loadFontSync=function(h){if(r[h])return r[h].options;throw new Error("Synchronous font loading is not implemented for the browser, it will only work for fonts already loaded.")},B.preloadFonts=async function(h,p){try{for(const u of h){const m=await fetch(`${i.fontPath}/${u}.flf`);if(!m.ok)throw new Error(`Failed to preload fonts. Error fetching font: ${u}, status code: ${m.statusText}`);const A=await m.text();B.parseFont(u,A)}p&&p()}catch(u){const m=u instanceof Error?u:new Error(String(u));if(p){p(m);return}throw u}},B.fonts=function(h){return new Promise(function(p,u){p(Qt),h&&h(null,Qt)})},B.fontsSync=function(){return Qt},B.figFonts=r,B})(),xs=`flf2a$ 8 7 54 0 12 0 64 185
...
255  LATIN SMALL LETTER Y WITH DIAERESIS
 ...
 | || |@
  \\_, |@
  |__/ @@
`,Os=`flf2a$ 6 5 16 15 13 0 24463 229
...
0xCA0  KANNADA LETTER TTHA
 ...
 $\\___/$ @
         @@
         `;ht.parseFont("Standard",Os);ht.parseFont("Slant",Ns);ht.parseFont("Banner",xs);ht.parseFont("Small",ks);const Ds={name:"figlet",description:"Convert text to ASCII art",execute:(o,e)=>{const t=new U(o);if(t.hasFlag("help"))return{output:`Usage: figlet [options] <text>
...
Try 'figlet --help' for more information.`,error:!0};const r=t.getFlag("f"),i=typeof r=="string"?r:"Standard",s=i.charAt(0).toUpperCase()+i.slice(1).toLowerCase();let a="default";t.hasFlag("c")?a="full":t.hasFlag("r")&&(a="fitted");try{return{output:ht.textSync(n,{font:s,horizontalLayout:a})}}catch(l){return l instanceof Error?l.message.includes("font")||l.message.includes("Font")||l.message.includes("FIGlet")?{output:`figlet: font '${s}' not found or invalid
Available fonts: standard, slant, banner, small`,error:!0}:{output:`figlet: ${l.message}`,error:!0}:{output:"figlet: unknown error occurred",error:!0}}}};function Ms(){const o=window.innerWidth,e=window.innerHeight,t=document.querySelector("header"),n=t?t.getBoundingClientRect().height:60,r=Math.max(400,Math.floor(o*.95)),i=Math.max(300,Math.floor(e-n));return{width:r,height:i}}function Ps(o){return{name:"life",description:"Conway's Game of Life cellular automaton",execute:(e,t)=>{const n=new U(e);if(n.hasFlag("help"))return{output:`Usage: life [options]
...
Note: Animation continues until you scroll, type, or run 'clear'`};let r=2;const i=n.getFlag("speed");if(i!==void 0){const v=parseFloat(String(i));if(isNaN(v)||v<.5||v>10)return{output:`life: invalid speed '${i}'
Speed must be between 0.5 and 10.0`,error:!0};r=v}let s=.3;const a=n.getFlag("density");if(a!==void 0){const v=parseFloat(String(a));if(isNaN(v)||v<0||v>1)return{output:`life: invalid density '${a}'
Density must be between 0.0 and 1.0`,error:!0};s=v}const l=n.getFlag("pattern");let c="random";if(l!==void 0){const v=String(l),N=["random","acorn","glider","blinker"];if(!N.includes(v))return{output:`life: invalid pattern '${v}'
Valid patterns: ${N.join(", ")}`,error:!0};c=v}const d=n.getFlag("theme");let g=o.getCurrentColors();if(d!==void 0){const v=String(d),N=["green","yellow","white","light-blue","paper","dc","custom"];if(!N.includes(v))return{output:`life: invalid theme '${v}'
Valid themes: ${N.join(", ")}`,error:!0};if(v!=="custom"){const R=o.getPreset(v);R&&(g=R.colors)}}const{width:f,height:E}=Ms(),S=Math.floor(E*.8),y=g["--terminal-accent"],T=g["--terminal-dim"];return{output:`
<div class="life-container" style="background-color: ${g["--terminal-bg"]}; min-height: ${S}px;">
  <canvas id="life-canvas" class="life-grid"
          ...
          data-accent-color="${y}"
          data-dim-color="${T}"
          style="width: 100%; height: ${S}px; display: block;">
  </canvas>
</div>
`,html:!0}}}}const dr=["#ff6b35","#ff8c42","#ffaa4f","#ffc85c","#e6e669","#c4e676","#9fe683","#7ae690","#5ad69d","#3ac6aa","#1bb6b7","#00a6c4","#0096d1","#0086de"];function mn(o,e,t,n){const r=o/t+e*n;return dr[Math.floor(Math.abs(r))%dr.length]}function Fs(o){return/<(div|span|pre)\s+(class|style)=/i.test(o)}function Hs(o,e,t){return o.split(`
`).map((n,r)=>{let i=0;return[...n].map(s=>s===" "||s==="	"?s:`<span style="color: ${mn(i++,r,e,t)}">${Ne(s)}</span>`).join("")}).join(`
`)}function Us(o,e,t){let n=0,r=0,i="",s=!1,a=!1,l="";for(const c of o)if(c==="<")s=!0,i+=c;else if(c===">")s=!1,i+=c;else if(s)i+=c;else if(c==="&")a=!0,l=c;else if(a){if(l+=c,c===";"){a=!1;const d=mn(r++,n,e,t);i+=`<span style="color: ${d}">${l}</span>`,l=""}}else if(c===`
`)i+=c,n++,r=0;else if(c===" "||c==="	")i+=c;else{const d=mn(r++,n,e,t);i+=`<span style="color: ${d}">${c}</span>`}return i}const Bs={name:"lolcat",description:"Rainbow-colorize text output",execute:(o,e)=>{const t=new U(o);if(t.hasFlag("help"))return{output:`Usage: lolcat [options] [text...]
...
Try 'lolcat --help' for more information.`,error:!0};return Fs(a)?{output:Us(a,r,s),html:!0}:{output:`<pre class="lolcat-output">${Hs(a,r,s)}</pre>`,html:!0}}},Ws=3600;function Gs(o){return{name:"make",description:"Build targets from a Makefile",execute:(e,t)=>{if(new U(e).hasFlag("help"))return{output:`Usage: make [target...]
...
Examples:
  ...
  make me a sandwich   # Try it and see`};const r=e.join(" ");if(r==="me a sandwich")return{output:"What? Make it yourself."};if(r==="coffee"){const i=[{text:"Grinding beans...",delay:0},{text:"Compiling bean.c...",delay:400},{text:"Linking libcaffeine.so...",delay:800}],s=1200,a=s+2200,l='<div class="make-container">'+i.map(c=>`<div class="make-line" style="animation-delay: ${c.delay}ms;">${c.text}</div>`).join("")+`<div class="make-line" style="animation-delay: ${s}ms;">Brewing dark roast <span class="make-progress-track"><span class="make-progress-bar" style="animation-delay: ${s}ms;"></span></span> 100%</div><div class="make-line" style="animation-delay: ${a}ms;">make: Ready. Careful, it's hot.</div></div>`;return o.setInputLineVisible(!1),setTimeout(()=>{o.setInputLineVisible(!0),o.focus(!0)},Ws),{output:l,html:!0}}return e.length===0?{output:"make: *** No targets specified. Stop.",error:!0}:{output:`make: *** No rule to make target '${e[0]}'. Stop.`,error:!0}}}}const hn="0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZｱｲｳｴｵｶｷｸｹｺｻｼｽｾｿﾀﾁﾂﾃﾄﾅﾆﾇﾈﾉﾊﾋﾌﾍﾎﾏﾐﾑﾒﾓﾔﾕﾖﾗﾘﾙﾚﾛﾜﾝ";function zs(){const o=document.getElementById("terminal-output");if(!o)return{cols:80,rows:24};const e=o.getBoundingClientRect(),t=parseFloat(getComputedStyle(document.documentElement).getPropertyValue("--terminal-font-size")||"16"),n=t*.6,r=t*1.5,i=Math.floor(e.width/n),s=Math.floor(e.height/r);return{cols:Math.max(i,20),rows:Math.max(s,10)}}function Vs(){return hn[Math.floor(Math.random()*hn.length)]}function js(o){return{name:"matrix",description:"Display Matrix digital rain animation",execute:(e,t)=>{const n=new U(e);if(n.hasFlag("help"))return{output:`Usage: matrix [options]
...
Note: Animation continues until you scroll, type, or run 'clear'`};let r=1;const i=n.getFlag("speed");if(i!==void 0){const R=parseFloat(String(i));if(isNaN(R)||R<.1||R>5)return{output:`matrix: invalid speed value '${i}'
Speed must be between 0.1 and 5.0`,error:!0};r=R}const s=n.getFlag("theme");let a=o.getCurrentColors();if(s!==void 0){const R=String(s),G=["green","yellow","white","light-blue","paper","dc","custom"];if(!G.includes(R))return{output:`matrix: invalid theme '${R}'
Valid themes: ${G.join(", ")}`,error:!0};if(R!=="custom"){const re=o.getPreset(R);re&&(a=re.colors)}}const{cols:l,rows:c}=zs(),d=1.2,g=Math.floor(l/d)+5,f=Math.min(c,20),E=a["--terminal-accent"],S=a["--terminal-dim"],y=a["--terminal-bg"],T=c*1.5,$=-f*1.5,k=T,v=[];for(let R=0;R<g;R++){const G=-Math.random()*5,re=(5+Math.random()*5)/r,We=R*d,Ge=[];for(let we=0;we<f;we++){const X=we/f,pe=Math.pow(X,2),fe=we===f-1,ge=Vs();Ge.push(`<span class="matrix-char${fe?" matrix-char-bright":""}" data-char-index="${we}" style="color: ${fe?E:S}; opacity: ${pe};">${ge}</span>`)}v.push(`
  <div class="matrix-column" data-column-index="${R}" data-trail-length="${f}" style="
    left: ${We}em;
    animation: matrix-fall ${re}s linear ${G}s infinite;
    --matrix-start: ${$}em;
    --matrix-end: ${k}em;
  ">${Ge.join("")}</div>`)}return{output:`
<div class="matrix-rain" data-matrix-chars="${hn}" style="height: ${T}em; background-color: ${y};">
${v.join("")}
</div>
`,html:!0}}}}function Ys(){return[{type:"info",text:"Broadcast message from root@darinchambers.com:"},{type:"info",text:"The system is going down for poweroff NOW!"},{type:"ok",text:"Stopped Session c1 of user darin"},{type:"ok",text:"Stopped Target - Graphical Interface"},{type:"ok",text:"Stopped Code Editor Process"},{type:"ok",text:"Stopped Docker Container Runtime"},{type:"ok",text:"Stopped OpenSSH Server"},{type:"failed",text:"Stopped Bluetooth Service (timeout)"},{type:"ok",text:"Stopped Network Manager"},{type:"ok",text:"Stopped D-Bus System Message Bus"},{type:"ok",text:"Stopped Journal Service"},{type:"ok",text:"Stopped System Logging Service"},{type:"info",text:"Sending SIGTERM to remaining processes..."},{type:"info",text:"Sending SIGKILL to remaining processes..."},{type:"ok",text:"Unmounted /home"},{type:"ok",text:"Unmounted /var"},{type:"ok",text:"Unmounted /tmp"},{type:"info",text:"All filesystems unmounted."},{type:"ok",text:"Reached target - Power-Off"}]}function jr(o){const e=Ys(),t=150,n=e.map((a,l)=>{const c=l*t,d=`boot-line boot-line-${a.type}`,g=a.text.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;");return`<div class="${d}" style="animation-delay: ${c}ms;">${g}</div>`}),r=e.length*t,i=o?"System halted.":"Power off.";n.push(`<div class="boot-line boot-line-info" style="animation-delay: ${r}ms;">${i}</div>`);const s=r+500;return n.push(`<div class="boot-overlay" style="animation-delay: ${s}ms;" data-boot-overlay="true"><span class="boot-overlay-text">Screen off</span></div>`),n.join(`
`)}const qs={name:"shutdown",description:"Display simulated Linux shutdown sequence",execute:(o,e)=>{const t=new U(o);if(t.hasFlag("help"))return{output:`Usage: shutdown [options]
...
${jr(n)}
</div>`,html:!0,clearBefore:!0,fullscreen:!0,fullscreenExitCommand:"boot",scrollBehavior:"top"}}},Xs={name:"reboot",description:"Display simulated system reboot sequence",execute:(o,e)=>{const t=new U(o);if(t.hasFlag("help"))return{output:`Usage: reboot [options]
...
Note: The full sequence takes about 10 seconds. Scroll or type to stop.`};const n=t.hasFlag("fast"),i=jr(!1).split(`
...
<div class="boot-line boot-line-info" style="animation-delay: ${c}ms;">Rebooting...</div>
</div>`,html:!0,clearBefore:!0,fullscreen:!0,scrollBehavior:"top",scheduledCommand:{command:n?"boot --fast":"boot",delayMs:d,clearBefore:!0}}}};class ur{static generateHeader(){return`
 ██████╗  █████╗ ██████╗ ██╗███╗   ██╗     ██████╗██╗  ██╗ █████╗ ███╗   ███╗██████╗ ███████╗██████╗ ███████╗
 ██╔══██╗██╔══██╗██╔══██╗██║████╗  ██║    ██╔════╝██║  ██║██╔══██╗████╗ ████║██╔══██╗██╔════╝██╔══██╗██╔════╝
 ██║  ██║███████║██████╔╝██║██╔██╗ ██║    ██║     ███████║███████║██╔████╔██║██████╔╝█████╗  ██████╔╝███████╗
 ██║  ██║██╔══██║██╔══██╗██║██║╚██╗██║    ██║     ██╔══██║██╔══██║██║╚██╔╝██║██╔══██╗██╔══╝  ██╔══██╗╚════██║
 ██████╔╝██║  ██║██║  ██║██║██║ ╚████║    ╚██████╗██║  ██║██║  ██║██║ ╚═╝ ██║██████╔╝███████╗██║  ██║███████║
 ╚═════╝ ╚═╝  ╚═╝╚═╝  ╚═╝╚═╝╚═╝  ╚═══╝     ╚═════╝╚═╝  ╚═╝╚═╝  ╚═╝╚═╝     ╚═╝╚═════╝ ╚══════╝╚═╝  ╚═╝╚══════╝
`}static getTagline(){return"Technologist, Inventor | Building What's Next on Rock-Solid Foundations"}}const{entries:Yr,setPrototypeOf:_r,isFrozen:Ks,getPrototypeOf:Zs,getOwnPropertyDescriptor:Js}=Object;let{freeze:_e,seal:Ee,create:pn}=Object,{apply:fn,construct:gn}=typeof Reflect<"u"&&Reflect;_e||(_e=function(e){return e});Ee||(Ee=function(e){return e});fn||(fn=function(e,t){for(var n=arguments.length,r=new Array(n>2?n-2:0),i=2;i<n;i++)r[i-2]=arguments[i];return e.apply(t,r)});gn||(gn=function(e){for(var t=arguments.length,n=new Array(t>1?t-1:0),r=1;r<t;r++)n[r-1]=arguments[r];return new e(...n)});const It=me(Array.prototype.forEach),Qs=me(Array.prototype.lastIndexOf),mr=me(Array.prototype.pop),ot=me(Array.prototype.push),ea=me(Array.prototype.splice),wt=me(String.prototype.toLowerCase),en=me(String.prototype.toString),tn=me(String.prototype.match),it=me(String.prototype.replace),ta=me(String.prototype.indexOf),na=me(String.prototype.trim),Le=me(Object.prototype.hasOwnProperty),ce=me(RegExp.prototype.test),st=ra(TypeError);function me(o){return function(e){e instanceof RegExp&&(e.lastIndex=0);for(var t=arguments.length,n=new Array(t>1?t-1:0),r=1;r<t;r++)n[r-1]=arguments[r];return fn(o,e,n)}}function ra(o){return function(){for(var e=arguments.length,t=new Array(e),n=0;n<e;n++)t[n]=arguments[n];return gn(o,t)}}function W(o,e){let t=arguments.length>2&&arguments[2]!==void 0?arguments[2]:wt;_r&&_r(o,null);let n=e.length;for(;n--;){let r=e[n];if(typeof r=="string"){const i=t(r);i!==r&&(Ks(e)||(e[n]=i),r=i)}o[r]=!0}return o}function oa(o){for(let e=0;e<o.length;e++)Le(o,e)||(o[e]=null);return o}function xe(o){const e=pn(null);for(const[t,n]of Yr(o))Le(o,t)&&(Array.isArray(n)?e[t]=oa(n):n&&typeof n=="object"&&n.constructor===Object?e[t]=xe(n):e[t]=n);return e}function at(o,e){for(;o!==null;){const n=Js(o,e);if(n){if(n.get)return me(n.get);if(typeof n.value=="function")return me(n.value)}o=Zs(o)}function t(){return null}return t}const hr=_e(["a","abbr","acronym","address","area","article","aside","audio","b","bdi","bdo","big","blink","blockquote","body","br","button","canvas","caption","center","cite","code","col","colgroup","content","data","datalist","dd","decorator","del","details","dfn","dialog","dir","div","dl","dt","element","em","fieldset","figcaption","figure","font","footer","form","h1","h2","h3","h4","h5","h6","head","header","hgroup","hr","html","i","img","input","ins","kbd","label","legend","li","main","map","mark","marquee","menu","menuitem","meter","nav","nobr","ol","optgroup","option","output","p","picture","pre","progress","q","rp","rt","ruby","s","samp","search","section","select","shadow","slot","small","source","spacer","span","strike","strong","style","sub","summary","sup","table","tbody","td","template","textarea","tfoot","th","thead","time","tr","track","tt","u","ul","var","video","wbr"]),nn=_e(["svg","a","altglyph","altglyphdef","altglyphitem","animatecolor","animatemotion","animatetransform","circle","clippath","defs","desc","ellipse","enterkeyhint","exportparts","filter","font","g","glyph","glyphref","hkern","image","inputmode","line","lineargradient","marker","mask","metadata","mpath","part","path","pattern","polygon","polyline","radialgradient","rect","stop","style","switch","symbol","text","textpath","title","tref","tspan","view","vkern"]),rn=_e(["feBlend","feColorMatrix","feComponentTransfer","feComposite","feConvolveMatrix","feDiffuseLighting","feDisplacementMap","feDistantLight","feDropShadow","feFlood","feFuncA","feFuncB","feFuncG","feFuncR","feGaussianBlur","feImage","feMerge","feMergeNode","feMorphology","feOffset","fePointLight","feSpecularLighting","feSpotLight","feTile","feTurbulence"]),ia=_e(["animate","color-profile","cursor","discard","font-face","font-face-format","font-face-name","font-face-src","font-face-uri","foreignobject","hatch","hatchpath","mesh","meshgradient","meshpatch","meshrow","missing-glyph","script","set","solidcolor","unknown","use"]),on=_e(["math","menclose","merror","mfenced","mfrac","mglyph","mi","mlabeledtr","mmultiscripts","mn","mo","mover","mpadded","mphantom","mroot","mrow","ms","mspace","msqrt","mstyle","msub","msup","msubsup","mtable","mtd","mtext","mtr","munder","munderover","mprescripts"]),sa=_e(["maction","maligngroup","malignmark","mlongdiv","mscarries","mscarry","msgroup","mstack","msline","msrow","semantics","annotation","annotation-xml","mprescripts","none"]),pr=_e(["#text"]),fr=_e(["accept","action","align","alt","autocapitalize","autocomplete","autopictureinpicture","autoplay","background","bgcolor","border","capture","cellpadding","cellspacing","checked","cite","class","clear","color","cols","colspan","controls","controlslist","coords","crossorigin","datetime","decoding","default","dir","disabled","disablepictureinpicture","disableremoteplayback","download","draggable","enctype","enterkeyhint","exportparts","face","for","headers","height","hidden","high","href","hreflang","id","inert","inputmode","integrity","ismap","kind","label","lang","list","loading","loop","low","max","maxlength","media","method","min","minlength","multiple","muted","name","nonce","noshade","novalidate","nowrap","open","optimum","part","pattern","placeholder","playsinline","popover","popovertarget","popovertargetaction","poster","preload","pubdate","radiogroup","readonly","rel","required","rev","reversed","role","rows","rowspan","spellcheck","scope","selected","shape","size","sizes","slot","span","srclang","start","src","srcset","step","style","summary","tabindex","title","translate","type","usemap","valign","value","width","wrap","xmlns","slot"]),sn=_e(["accent-height","accumulate","additive","alignment-baseline","amplitude","ascent","attributename","attributetype","azimuth","basefrequency","baseline-shift","begin","bias","by","class","clip","clippathunits","clip-path","clip-rule","color","color-interpolation","color-interpolation-filters","color-profile","color-rendering","cx","cy","d","dx","dy","diffuseconstant","direction","display","divisor","dur","edgemode","elevation","end","exponent","fill","fill-opacity","fill-rule","filter","filterunits","flood-color","flood-opacity","font-family","font-size","font-size-adjust","font-stretch","font-style","font-variant","font-weight","fx","fy","g1","g2","glyph-name","glyphref","gradientunits","gradienttransform","height","href","id","image-rendering","in","in2","intercept","k","k1","k2","k3","k4","kerning","keypoints","keysplines","keytimes","lang","lengthadjust","letter-spacing","kernelmatrix","kernelunitlength","lighting-color","local","marker-end","marker-mid","marker-start","markerheight","markerunits","markerwidth","maskcontentunits","maskunits","max","mask","mask-type","media","method","mode","min","name","numoctaves","offset","operator","opacity","order","orient","orientation","origin","overflow","paint-order","path","pathlength","patterncontentunits","patterntransform","patternunits","points","preservealpha","preserveaspectratio","primitiveunits","r","rx","ry","radius","refx","refy","repeatcount","repeatdur","restart","result","rotate","scale","seed","shape-rendering","slope","specularconstant","specularexponent","spreadmethod","startoffset","stddeviation","stitchtiles","stop-color","stop-opacity","stroke-dasharray","stroke-dashoffset","stroke-linecap","stroke-linejoin","stroke-miterlimit","stroke-opacity","stroke","stroke-width","style","surfacescale","systemlanguage","tabindex","tablevalues","targetx","targety","transform","transform-origin","text-anchor","text-decoration","text-rendering","textlength","type","u1","u2","unicode","values","viewbox","visibility","version","vert-adv-y","vert-origin-x","vert-origin-y","width","word-spacing","wrap","writing-mode","xchannelselector","ychannelselector","x","x1","x2","xmlns","y","y1","y2","z","zoomandpan"]),gr=_e(["accent","accentunder","align","bevelled","close","columnsalign","columnlines","columnspan","denomalign","depth","dir","display","displaystyle","encoding","fence","frame","height","href","id","largeop","length","linethickness","lspace","lquote","mathbackground","mathcolor","mathsize","mathvariant","maxsize","minsize","movablelimits","notation","numalign","open","rowalign","rowlines","rowspacing","rowspan","rspace","rquote","scriptlevel","scriptminsize","scriptsizemultiplier","selection","separator","separators","stretchy","subscriptshift","supscriptshift","symmetric","voffset","width","xmlns"]),bt=_e(["xlink:href","xml:id","xlink:title","xml:space","xmlns:xlink"]),aa=Ee(/\{\{[\w\W]*|[\w\W]*\}\}/gm),la=Ee(/<%[\w\W]*|[\w\W]*%>/gm),ca=Ee(/\$\{[\w\W]*/gm),da=Ee(/^data-[\-\w.\u00B7-\uFFFF]+$/),ua=Ee(/^aria-[\-\w]+$/),qr=Ee(/^(?:(?:(?:f|ht)tps?|mailto|tel|callto|sms|cid|xmpp|matrix):|[^a-z]|[a-z+.\-]+(?:[^a-z+.\-:]|$))/i),_a=Ee(/^(?:\w+script|data):/i),ma=Ee(/[\u0000-\u0020\u00A0\u1680\u180E\u2000-\u2029\u205F\u3000]/g),Xr=Ee(/^html$/i),ha=Ee(/^[a-z][.\w]*(-[.\w]+)+$/i);var $r=Object.freeze({__proto__:null,ARIA_ATTR:ua,ATTR_WHITESPACE:ma,CUSTOM_ELEMENT:ha,DATA_ATTR:da,DOCTYPE_NAME:Xr,ERB_EXPR:la,IS_ALLOWED_URI:qr,IS_SCRIPT_OR_DATA:_a,MUSTACHE_EXPR:aa,TMPLIT_EXPR:ca});const lt={element:1,text:3,progressingInstruction:7,comment:8,document:9},pa=function(){return typeof window>"u"?null:window},fa=function(e,t){if(typeof e!="object"||typeof e.createPolicy!="function")return null;let n=null;const r="data-tt-policy-suffix";t&&t.hasAttribute(r)&&(n=t.getAttribute(r));const i="dompurify"+(n?"#"+n:"");try{return e.createPolicy(i,{createHTML(s){return s},createScriptURL(s){return s}})}catch{return console.warn("TrustedTypes policy "+i+" could not be created."),null}},Tr=function(){return{afterSanitizeAttributes:[],afterSanitizeElements:[],afterSanitizeShadowDOM:[],beforeSanitizeAttributes:[],beforeSanitizeElements:[],beforeSanitizeShadowDOM:[],uponSanitizeAttribute:[],uponSanitizeElement:[],uponSanitizeShadowNode:[]}};function Kr(){let o=arguments.length>0&&arguments[0]!==void 0?arguments[0]:pa();const e=O=>Kr(O);if(e.version="3.3.0",e.removed=[],!o||!o.document||o.document.nodeType!==lt.document||!o.Element)return e.isSupported=!1,e;let{document:t}=o;const n=t,r=n.currentScript,{DocumentFragment:i,HTMLTemplateElement:s,Node:a,Element:l,NodeFilter:c,NamedNodeMap:d=o.NamedNodeMap||o.MozNamedAttrMap,HTMLFormElement:g,DOMParser:f,trustedTypes:E}=o,S=l.prototype,y=at(S,"cloneNode"),T=at(S,"remove"),$=at(S,"nextSibling"),k=at(S,"childNodes"),v=at(S,"parentNode");if(typeof s=="function"){const O=t.createElement("template");O.content&&O.content.ownerDocument&&(t=O.content.ownerDocument)}let N,R="";const{implementation:G,createNodeIterator:re,createDocumentFragment:We,getElementsByTagName:Ge}=t,{importNode:we}=n;let X=Tr();e.isSupported=typeof Yr=="function"&&typeof v=="function"&&G&&G.createHTMLDocument!==void 0;const{MUSTACHE_EXPR:pe,ERB_EXPR:fe,TMPLIT_EXPR:ge,DATA_ATTR:Pt,ARIA_ATTR:Ft,IS_SCRIPT_OR_DATA:Ht,ATTR_WHITESPACE:gt,CUSTOM_ELEMENT:$t}=$r;let{IS_ALLOWED_URI:Qe}=$r,B=null;const h=W({},[...hr,...nn,...rn,...on,...pr]);let p=null;const u=W({},[...fr,...sn,...gr,...bt]);let m=Object.seal(pn(null,{tagNameCheck:{writable:!0,configurable:!1,enumerable:!0,value:null},attributeNameCheck:{writable:!0,configurable:!1,enumerable:!0,value:null},allowCustomizedBuiltInElements:{writable:!0,configurable:!1,enumerable:!0,value:!1}})),A=null,I=null;const b=Object.seal(pn(null,{tagCheck:{writable:!0,configurable:!1,enumerable:!0,value:null},attributeCheck:{writable:!0,configurable:!1,enumerable:!0,value:null}}));let w=!0,C=!0,D=!1,F=!0,M=!1,P=!0,H=!1,ae=!1,J=!1,$e=!1,oe=!1,Te=!1,le=!0,ee=!1;const Ut="user-content-";let Bt=!0,et=!1,ze={},Ve=null;const Rn=W({},["annotation-xml","audio","colgroup","desc","foreignobject","head","iframe","math","mi","mn","mo","ms","mtext","noembed","noframes","noscript","plaintext","script","style","svg","template","thead","title","video","xmp"]);let xn=null;const Nn=W({},["audio","video","img","source","image","track"]);let Wt=null;const kn=W({},["alt","class","for","id","label","name","pattern","placeholder","role","summary","title","value","style","xmlns"]),Tt="http://www.w3.org/1998/Math/MathML",At="http://www.w3.org/2000/svg",Se="http://www.w3.org/1999/xhtml";let je=Se,Gt=!1,zt=null;const to=W({},[Tt,At,Se],en);let Et=W({},["mi","mo","mn","ms","mtext"]),Lt=W({},["annotation-xml"]);const no=W({},["title","style","font","a","script"]);let tt=null;const ro=["application/xhtml+xml","text/html"],oo="text/html";let Q=null,Ye=null;const io=t.createElement("form"),On=function(_){return _ instanceof RegExp||_ instanceof Function},Vt=function(){let _=arguments.length>0&&arguments[0]!==void 0?arguments[0]:{};if(!(Ye&&Ye===_)){if((!_||typeof _!="object")&&(_={}),_=xe(_),tt=ro.indexOf(_.PARSER_MEDIA_TYPE)===-1?oo:_.PARSER_MEDIA_TYPE,Q=tt==="application/xhtml+xml"?en:wt,B=Le(_,"ALLOWED_TAGS")?W({},_.ALLOWED_TAGS,Q):h,p=Le(_,"ALLOWED_ATTR")?W({},_.ALLOWED_ATTR,Q):u,zt=Le(_,"ALLOWED_NAMESPACES")?W({},_.ALLOWED_NAMESPACES,en):to,Wt=Le(_,"ADD_URI_SAFE_ATTR")?W(xe(kn),_.ADD_URI_SAFE_ATTR,Q):kn,xn=Le(_,"ADD_DATA_URI_TAGS")?W(xe(Nn),_.ADD_DATA_URI_TAGS,Q):Nn,Ve=Le(_,"FORBID_CONTENTS")?W({},_.FORBID_CONTENTS,Q):Rn,A=Le(_,"FORBID_TAGS")?W({},_.FORBID_TAGS,Q):xe({}),I=Le(_,"FORBID_ATTR")?W({},_.FORBID_ATTR,Q):xe({}),ze=Le(_,"USE_PROFILES")?_.USE_PROFILES:!1,w=_.ALLOW_ARIA_ATTR!==!1,C=_.ALLOW_DATA_ATTR!==!1,D=_.ALLOW_UNKNOWN_PROTOCOLS||!1,F=_.ALLOW_SELF_CLOSE_IN_ATTR!==!1,M=_.SAFE_FOR_TEMPLATES||!1,P=_.SAFE_FOR_XML!==!1,H=_.WHOLE_DOCUMENT||!1,$e=_.RETURN_DOM||!1,oe=_.RETURN_DOM_FRAGMENT||!1,Te=_.RETURN_TRUSTED_TYPE||!1,J=_.FORCE_BODY||!1,le=_.SANITIZE_DOM!==!1,ee=_.SANITIZE_NAMED_PROPS||!1,Bt=_.KEEP_CONTENT!==!1,et=_.IN_PLACE||!1,Qe=_.ALLOWED_URI_REGEXP||qr,je=_.NAMESPACE||Se,Et=_.MATHML_TEXT_INTEGRATION_POINTS||Et,Lt=_.HTML_INTEGRATION_POINTS||Lt,m=_.CUSTOM_ELEMENT_HANDLING||{},_.CUSTOM_ELEMENT_HANDLING&&On(_.CUSTOM_ELEMENT_HANDLING.tagNameCheck)&&(m.tagNameCheck=_.CUSTOM_ELEMENT_HANDLING.tagNameCheck),_.CUSTOM_ELEMENT_HANDLING&&On(_.CUSTOM_ELEMENT_HANDLING.attributeNameCheck)&&(m.attributeNameCheck=_.CUSTOM_ELEMENT_HANDLING.attributeNameCheck),_.CUSTOM_ELEMENT_HANDLING&&typeof _.CUSTOM_ELEMENT_HANDLING.allowCustomizedBuiltInElements=="boolean"&&(m.allowCustomizedBuiltInElements=_.CUSTOM_ELEMENT_HANDLING.allowCustomizedBuiltInElements),M&&(C=!1),oe&&($e=!0),ze&&(B=W({},pr),p=[],ze.html===!0&&(W(B,hr),W(p,fr)),ze.svg===!0&&(W(B,nn),W(p,sn),W(p,bt)),ze.svgFilters===!0&&(W(B,rn),W(p,sn),W(p,bt)),ze.mathMl===!0&&(W(B,on),W(p,gr),W(p,bt))),_.ADD_TAGS&&(typeof _.ADD_TAGS=="function"?b.tagCheck=_.ADD_TAGS:(B===h&&(B=xe(B)),W(B,_.ADD_TAGS,Q))),_.ADD_ATTR&&(typeof _.ADD_ATTR=="function"?b.attributeCheck=_.ADD_ATTR:(p===u&&(p=xe(p)),W(p,_.ADD_ATTR,Q))),_.ADD_URI_SAFE_ATTR&&W(Wt,_.ADD_URI_SAFE_ATTR,Q),_.FORBID_CONTENTS&&(Ve===Rn&&(Ve=xe(Ve)),W(Ve,_.FORBID_CONTENTS,Q)),Bt&&(B["#text"]=!0),H&&W(B,["html","head","body"]),B.table&&(W(B,["tbody"]),delete A.tbody),_.TRUSTED_TYPES_POLICY){if(typeof _.TRUSTED_TYPES_POLICY.createHTML!="function")throw st('TRUSTED_TYPES_POLICY configuration option must provide a "createHTML" hook.');if(typeof _.TRUSTED_TYPES_POLICY.createScriptURL!="function")throw st('TRUSTED_TYPES_POLICY configuration option must provide a "createScriptURL" hook.');N=_.TRUSTED_TYPES_POLICY,R=N.createHTML("")}else N===void 0&&(N=fa(E,r)),N!==null&&typeof R=="string"&&(R=N.createHTML(""));_e&&_e(_),Ye=_}},Dn=W({},[...nn,...rn,...ia]),Mn=W({},[...on,...sa]),so=function(_){let L=v(_);(!L||!L.tagName)&&(L={namespaceURI:je,tagName:"template"});const x=wt(_.tagName),Y=wt(L.tagName);return zt[_.namespaceURI]?_.namespaceURI===At?L.namespaceURI===Se?x==="svg":L.namespaceURI===Tt?x==="svg"&&(Y==="annotation-xml"||Et[Y]):!!Dn[x]:_.namespaceURI===Tt?L.namespaceURI===Se?x==="math":L.namespaceURI===At?x==="math"&&Lt[Y]:!!Mn[x]:_.namespaceURI===Se?L.namespaceURI===At&&!Lt[Y]||L.namespaceURI===Tt&&!Et[Y]?!1:!Mn[x]&&(no[x]||!Dn[x]):!!(tt==="application/xhtml+xml"&&zt[_.namespaceURI]):!1},be=function(_){ot(e.removed,{element:_});try{v(_).removeChild(_)}catch{T(_)}},Me=function(_,L){try{ot(e.removed,{attribute:L.getAttributeNode(_),from:L})}catch{ot(e.removed,{attribute:null,from:L})}if(L.removeAttribute(_),_==="is")if($e||oe)try{be(L)}catch{}else try{L.setAttribute(_,"")}catch{}},Pn=function(_){let L=null,x=null;if(J)_="<remove></remove>"+_;else{const K=tn(_,/^[\r\n\t ]+/);x=K&&K[0]}tt==="application/xhtml+xml"&&je===Se&&(_='<html xmlns="http://www.w3.org/1999/xhtml"><head></head><body>'+_+"</body></html>");const Y=N?N.createHTML(_):_;if(je===Se)try{L=new f().parseFromString(Y,tt)}catch{}if(!L||!L.documentElement){L=G.createDocument(je,"template",null);try{L.documentElement.innerHTML=Gt?R:Y}catch{}}const ie=L.body||L.documentElement;return _&&x&&ie.insertBefore(t.createTextNode(x),ie.childNodes[0]||null),je===Se?Ge.call(L,H?"html":"body")[0]:H?L.documentElement:ie},Fn=function(_){return re.call(_.ownerDocument||_,_,c.SHOW_ELEMENT|c.SHOW_COMMENT|c.SHOW_TEXT|c.SHOW_PROCESSING_INSTRUCTION|c.SHOW_CDATA_SECTION,null)},jt=function(_){return _ instanceof g&&(typeof _.nodeName!="string"||typeof _.textContent!="string"||typeof _.removeChild!="function"||!(_.attributes instanceof d)||typeof _.removeAttribute!="function"||typeof _.setAttribute!="function"||typeof _.namespaceURI!="string"||typeof _.insertBefore!="function"||typeof _.hasChildNodes!="function")},Hn=function(_){return typeof a=="function"&&_ instanceof a};function ve(O,_,L){It(O,x=>{x.call(e,_,L,Ye)})}const Un=function(_){let L=null;if(ve(X.beforeSanitizeElements,_,null),jt(_))return be(_),!0;const x=Q(_.nodeName);if(ve(X.uponSanitizeElement,_,{tagName:x,allowedTags:B}),P&&_.hasChildNodes()&&!Hn(_.firstElementChild)&&ce(/<[/\w!]/g,_.innerHTML)&&ce(/<[/\w!]/g,_.textContent)||_.nodeType===lt.progressingInstruction||P&&_.nodeType===lt.comment&&ce(/<[/\w]/g,_.data))return be(_),!0;if(!(b.tagCheck instanceof Function&&b.tagCheck(x))&&(!B[x]||A[x])){if(!A[x]&&Wn(x)&&(m.tagNameCheck instanceof RegExp&&ce(m.tagNameCheck,x)||m.tagNameCheck instanceof Function&&m.tagNameCheck(x)))return!1;if(Bt&&!Ve[x]){const Y=v(_)||_.parentNode,ie=k(_)||_.childNodes;if(ie&&Y){const K=ie.length;for(let he=K-1;he>=0;--he){const Ce=y(ie[he],!0);Ce.__removalCount=(_.__removalCount||0)+1,Y.insertBefore(Ce,$(_))}}}return be(_),!0}return _ instanceof l&&!so(_)||(x==="noscript"||x==="noembed"||x==="noframes")&&ce(/<\/no(script|embed|frames)/i,_.innerHTML)?(be(_),!0):(M&&_.nodeType===lt.text&&(L=_.textContent,It([pe,fe,ge],Y=>{L=it(L,Y," ")}),_.textContent!==L&&(ot(e.removed,{element:_.cloneNode()}),_.textContent=L)),ve(X.afterSanitizeElements,_,null),!1)},Bn=function(_,L,x){if(le&&(L==="id"||L==="name")&&(x in t||x in io))return!1;if(!(C&&!I[L]&&ce(Pt,L))){if(!(w&&ce(Ft,L))){if(!(b.attributeCheck instanceof Function&&b.attributeCheck(L,_))){if(!p[L]||I[L]){if(!(Wn(_)&&(m.tagNameCheck instanceof RegExp&&ce(m.tagNameCheck,_)||m.tagNameCheck instanceof Function&&m.tagNameCheck(_))&&(m.attributeNameCheck instanceof RegExp&&ce(m.attributeNameCheck,L)||m.attributeNameCheck instanceof Function&&m.attributeNameCheck(L,_))||L==="is"&&m.allowCustomizedBuiltInElements&&(m.tagNameCheck instanceof RegExp&&ce(m.tagNameCheck,x)||m.tagNameCheck instanceof Function&&m.tagNameCheck(x))))return!1}else if(!Wt[L]){if(!ce(Qe,it(x,gt,""))){if(!((L==="src"||L==="xlink:href"||L==="href")&&_!=="script"&&ta(x,"data:")===0&&xn[_])){if(!(D&&!ce(Ht,it(x,gt,"")))){if(x)return!1}}}}}}}return!0},Wn=function(_){return _!=="annotation-xml"&&tn(_,$t)},Gn=function(_){ve(X.beforeSanitizeAttributes,_,null);const{attributes:L}=_;if(!L||jt(_))return;const x={attrName:"",attrValue:"",keepAttr:!0,allowedAttributes:p,forceKeepAttr:void 0};let Y=L.length;for(;Y--;){const ie=L[Y],{name:K,namespaceURI:he,value:Ce}=ie,qe=Q(K),Yt=Ce;let te=K==="value"?Yt:na(Yt);if(x.attrName=qe,x.attrValue=te,x.keepAttr=!0,x.forceKeepAttr=void 0,ve(X.uponSanitizeAttribute,_,x),te=x.attrValue,ee&&(qe==="id"||qe==="name")&&(Me(K,_),te=Ut+te),P&&ce(/((--!?|])>)|<\/(style|title|textarea)/i,te)){Me(K,_);continue}if(qe==="attributename"&&tn(te,"href")){Me(K,_);continue}if(x.forceKeepAttr)continue;if(!x.keepAttr){Me(K,_);continue}if(!F&&ce(/\/>/i,te)){Me(K,_);continue}M&&It([pe,fe,ge],Vn=>{te=it(te,Vn," ")});const zn=Q(_.nodeName);if(!Bn(zn,qe,te)){Me(K,_);continue}if(N&&typeof E=="object"&&typeof E.getAttributeType=="function"&&!he)switch(E.getAttributeType(zn,qe)){case"TrustedHTML":{te=N.createHTML(te);break}case"TrustedScriptURL":{te=N.createScriptURL(te);break}}if(te!==Yt)try{he?_.setAttributeNS(he,K,te):_.setAttribute(K,te),jt(_)?be(_):mr(e.removed)}catch{Me(K,_)}}ve(X.afterSanitizeAttributes,_,null)},ao=function O(_){let L=null;const x=Fn(_);for(ve(X.beforeSanitizeShadowDOM,_,null);L=x.nextNode();)ve(X.uponSanitizeShadowNode,L,null),Un(L),Gn(L),L.content instanceof i&&O(L.content);ve(X.afterSanitizeShadowDOM,_,null)};return e.sanitize=function(O){let _=arguments.length>1&&arguments[1]!==void 0?arguments[1]:{},L=null,x=null,Y=null,ie=null;if(Gt=!O,Gt&&(O="<!-->"),typeof O!="string"&&!Hn(O))if(typeof O.toString=="function"){if(O=O.toString(),typeof O!="string")throw st("dirty is not a string, aborting")}else throw st("toString is not a function");if(!e.isSupported)return O;if(ae||Vt(_),e.removed=[],typeof O=="string"&&(et=!1),et){if(O.nodeName){const Ce=Q(O.nodeName);if(!B[Ce]||A[Ce])throw st("root node is forbidden and cannot be sanitized in-place")}}else if(O instanceof a)L=Pn("<!---->"),x=L.ownerDocument.importNode(O,!0),x.nodeType===lt.element&&x.nodeName==="BODY"||x.nodeName==="HTML"?L=x:L.appendChild(x);else{if(!$e&&!M&&!H&&O.indexOf("<")===-1)return N&&Te?N.createHTML(O):O;if(L=Pn(O),!L)return $e?null:Te?R:""}L&&J&&be(L.firstChild);const K=Fn(et?O:L);for(;Y=K.nextNode();)Un(Y),Gn(Y),Y.content instanceof i&&ao(Y.content);if(et)return O;if($e){if(oe)for(ie=We.call(L.ownerDocument);L.firstChild;)ie.appendChild(L.firstChild);else ie=L;return(p.shadowroot||p.shadowrootmode)&&(ie=we.call(n,ie,!0)),ie}let he=H?L.outerHTML:L.innerHTML;return H&&B["!doctype"]&&L.ownerDocument&&L.ownerDocument.doctype&&L.ownerDocument.doctype.name&&ce(Xr,L.ownerDocument.doctype.name)&&(he="<!DOCTYPE "+L.ownerDocument.doctype.name+`>
`+he),M&&It([pe,fe,ge],Ce=>{he=it(he,Ce," ")}),N&&Te?N.createHTML(he):he},e.setConfig=function(){let O=arguments.length>0&&arguments[0]!==void 0?arguments[0]:{};Vt(O),ae=!0},e.clearConfig=function(){Ye=null,ae=!1},e.isValidAttribute=function(O,_,L){Ye||Vt({});const x=Q(O),Y=Q(_);return Bn(x,Y,L)},e.addHook=function(O,_){typeof _=="function"&&ot(X[O],_)},e.removeHook=function(O,_){if(_!==void 0){const L=Qs(X[O],_);return L===-1?void 0:ea(X[O],L,1)[0]}return mr(X[O])},e.removeHooks=function(O){X[O]=[]},e.removeAllHooks=function(){X=Tr()},e}var ga=Kr();function vn(o){return ga.sanitize(o,{ALLOWED_TAGS:["p","div","span","br","strong","b","em","i","u","s","a","code","pre","h1","h2","h3","h4","h5","h6","ul","ol","li","blockquote","table","thead","tbody","tr","th","td","img","canvas","button","input","select","option","label","aside","section","details","summary"],ALLOWED_ATTR:["class","id","href","target","rel","src","alt","title","width","height","type","value","checked","selected","disabled","min","max","step","placeholder","data-command","data-command-template","data-setting-type","data-color-var","data-theme","data-settings-panel","data-graph","data-graph-src","data-graph-theme","data-graph-initialized","data-graph-error","data-speed","data-density","data-pattern","data-accent-color","data-dim-color","style","open","role","aria-label","aria-labelledby","aria-describedby","aria-valuemin","aria-valuemax","aria-valuenow","aria-valuetext","aria-live","aria-atomic","aria-current"],RETURN_DOM:!1,RETURN_DOM_FRAGMENT:!1})}class $a{headerElement;constructor(e){this.headerElement=e,this.render(),this.setupClickHandler()}render(){const e=ur.generateHeader(),t=ur.getTagline();this.headerElement.innerHTML=vn(`
...
`,Ra=Object.freeze(Object.defineProperty({__proto__:null,default:Ca},Symbol.toStringTag,{value:"Module"})),xa=`---
...
`,Na=Object.freeze(Object.defineProperty({__proto__:null,default:xa},Symbol.toStringTag,{value:"Module"})),ka=`---
...
`,Oa=Object.freeze(Object.defineProperty({__proto__:null,default:ka},Symbol.toStringTag,{value:"Module"})),Da=`---
...
`,Ma=Object.freeze(Object.defineProperty({__proto__:null,default:Da},Symbol.toStringTag,{value:"Module"})),Pa=`---
...
`,Fa=Object.freeze(Object.defineProperty({__proto__:null,default:Pa},Symbol.toStringTag,{value:"Module"})),Ha=`# Darin Chambers
...
`,Ua=Object.freeze(Object.defineProperty({__proto__:null,default:Ha},Symbol.toStringTag,{value:"Module"})),Ba=`# Contact Information
...
- Darin
`));for(const N of n.children.values())N.owner="root";const r=this.createDirectoryNode("home");t.set("home",r);const i=this.createDirectoryNode("guest");r.children.set("guest",i),i.children.set("README.txt",this.createFileNode("README.txt",`Welcome to darinchambers.com!
